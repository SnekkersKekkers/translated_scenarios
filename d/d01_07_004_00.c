...
StlEyeOpenLevel(7,#1);
MsgDisp("主人公","(Ah, ｛Mikage＊＊｝'s hand...)");
VoicePlay("D010700400_42_080");
MsgDisp("Student A","I also love Vice Principal Himuro!");
StlEye(7,1);
StlMouth(7,0);
...
MsgDisp("Student B","Mikagechi, that scared you way too much～!");
SEPlay("EV_SE_GAYA_016");
