...
MsgDisp("Student A","Sigh... Is it over already?");
...
MsgDisp("主人公","Uhm... I-I love ｛Mikage＊＊｝ too!");
StlNear(1,0,15);
Wait(15,1);
StlEyeOpenLevel(7,0);
StlMouth(7,1);
