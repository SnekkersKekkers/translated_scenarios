...
MsgDisp("Nanatsumori","Even though the school cafeteria is a bit
...
MsgDisp("Kazama","But it's not just the looks and the name.
...
MsgDisp("Nanatsumori","...I guess so. What about \"Habataki Gozen\", a
recipe passed down through the Kazama family,
head suppliers to Habataki Castle royals.");
