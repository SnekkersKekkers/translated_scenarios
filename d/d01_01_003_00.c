...
MsgDisp("Kazama","I learn a lot at Grandpa's store,
things I can't experience elsewhere.");
StlMouth(1,1);
...
MsgDisp("主人公","Geez. ｛風真＊＊｝, are you okay? That
seemed like a serious phone call......?");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,0);
...
lookout like that. I didn't do anything
wrong, okay?");
