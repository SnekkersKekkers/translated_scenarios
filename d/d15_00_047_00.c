...
ChMouth ( 4,3 ) ;
ChMotion ( 4,0 ) ;
VoicePlay ( "D150004700_04_000" ) ;
MsgDisp ( "七ツ森","There are a lot of filling dishes, huh." ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,3 ) ;
VoicePlay ( "D150004700_07_000" ) ;
MsgDisp ( "御影","Ahh, that makes me want to take some home
for dinner." ) ;
...
ChMouth ( 4,0 ) ;
ChMotion ( 4,2 ) ;
VoicePlay ( "D150004700_04_010" ) ;
MsgDisp ( "七ツ森","But it's hard to carry the soup." ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,0 ) ;
...
ChMouth ( 7,3 ) ;
ChMotion ( 7,5 ) ;
VoicePlay ( "D150004700_07_020" ) ;
MsgDisp ( "御影","Then your parents would get to enjoy some." ) ;
ChEye ( 4,4 ) ;
ChMouth ( 4,3 ) ;
ChMotion ( 4,1 ) ;
VoicePlay ( "D150004700_04_020" ) ;
MsgDisp ( "七ツ森","That's true......
That's a fun idea, Mikage-sensei." ) ;
ChEye ( 7,4 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,1 ) ;
VoicePlay ( "D150004700_07_030" ) ;
MsgDisp ( "御影","Right? Today is the faculty meeting so
...
MsgDisp ( "御影","I'm dead serious, though." ) ;
