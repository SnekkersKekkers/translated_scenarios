...
MsgDisp ( "Nanatsumori","There are a lot of filling dishes, huh." ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,3 ) ;
...
MsgDisp ( "Nanatsumori","But it's hard to carry the soup." ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,0 ) ;
...
MsgDisp ( "Mikage","Then your parents would get to enjoy some." ) ;
ChEye ( 4,4 ) ;
ChMouth ( 4,3 ) ;
ChMotion ( 4,1 ) ;
