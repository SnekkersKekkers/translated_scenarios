...
MsgDisp("主人公","Hehe. I think I know what you mean.
...
MsgDisp("Honda","Right. I always feel like I have to look up.
But when I talk to you and Nori-kun, it's
easier on my neck.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,4);
...
MsgDisp("主人公","Really?
I think ｛Himuro＊＊｝ is fine the way he is
now～...");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
