...
MsgDisp ( "氷室","That's definitely one way to say it." ) ;
ChEye ( 3,1 ) ;
ChMouth ( 3,2 ) ;
ChMotion ( 3,1 ) ;
VoiceEVSPlay ( 3 ) ;
VoicePlay ( "D150003600_03_010" ) ;
MsgDisp ( "本多","｛主人公｝, compare us." ) ;
MsgDisp ( "主人公","Uhm......
...
MsgDisp ( "本多","Oh. Maybe I was just imagining things." ) ;
ChEye ( 6,0 ) ;
ChMouth ( 6,0 ) ;
ChMotion ( 6,1 ) ;
VoicePlay ( "D150003600_06_010" ) ;
MsgDisp ( "氷室","Do you actually have a height complex,
Iku-senpai?" ) ;
ChEye ( 3,0 ) ;
ChMouth ( 3,3 ) ;
ChMotion ( 3,0 ) ;
VoicePlay ( "D150003600_03_030" ) ;
MsgDisp ( "本多","I'm not sure. But talking to Nori-kun is
...
MsgDisp ( "本多","Right. I always feel like I have to look
...
MsgDisp ( "氷室","I guess it's not a complex then. I'll keep
growing though." ) ;
...
MsgDisp ( "氷室","What. Why? Iku-senpai already explained
