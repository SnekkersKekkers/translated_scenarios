...
These babies are flying for the first time!");
...
MsgDisp("Honda","Yeah, since it's that time of year we can see
them again in two months.");
MsgDisp("主人公","Were you watching over them the whole time?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("D010300400_03_080");
MsgDisp("Honda","That's right, they were my special project.
They were hibernating in the pepper tree in
the gardening club.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
Since it's the insect season, you can find a
lot of insects!");
MsgDisp("主人公","Y-Yeah.
That's true...");
MsgDisp("主人公","(A lot of bugs huh...
I bet there's a lot of them for ｛Honda＊＊｝
to observe at school...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChClose(3,0,0);
