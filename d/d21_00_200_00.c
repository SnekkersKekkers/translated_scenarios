BGOpen("ho210",0);
ScrFadeIn(0);
MsgDisp("主人公","(Today I'm on the hunt for a new
Habacha Article, I think I'll walk 
around town!)");
MsgClose();
ScrFadeOut(0);
MsgDisp("","　　　　　　　　　　 ・
...
MsgDisp("Goro","Hello.
I can see you're hard at work looking
for an interview.");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,2);
VoicePlay("D200000200_31_020");
MsgDisp("Goro","But you can't only focus on that,
don't waste all of your energy in one
place.");
MsgDisp("主人公","Eh?");
ChEye(31,2);
ChMouth(31,2);
...
There is a man at your side who is
...
MsgDisp("Goro","You're something of a player, aren't
you?
...
MsgDisp("Goro","If you want to quell the flames, 
bring your boyfriend here when the
fireflies come out.");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,0);
...
Those ones have a mysterious ability
to soothe jealousy.");
...
MsgDisp("主人公","(It's didn't know the fireflies
had such a power. But hmm, jealousy......
Right. Maybe I can write a story
about this too?)");
MsgClose();
ScrFadeOut(0,0);
