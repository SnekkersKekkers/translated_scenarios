...
MsgDisp("Kazama","There are so many of them, but this
is the only one that's orange.");
StlEye(1,1);
...
MsgDisp("Kazama","For me, I wish that I'm no longer such
a child that has to obey the demands of
my parents.");
