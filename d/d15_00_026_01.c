...
MsgDisp ( "氷室","In my head I had pictured Nozomu-senpai as
...
MsgDisp ( "颯砂","What's wrong?? Inori. Would you like it if
...
MsgDisp ( "氷室","Huh? What are you talking about. That
...
ChMotion ( 2,4 ) ;
ChEyeOpenLevel ( 2,0 ) ;
VoicePlay ( "D150002601_02_030" ) ;
MsgDisp ( "颯砂","Haha, Inorikitty." ) ;
ChEye ( 6,0 ) ;
ChMouth ( 6,1 ) ;
ChMotion ( 6,1 ) ;
ChCheek ( 6,0 ) ;
