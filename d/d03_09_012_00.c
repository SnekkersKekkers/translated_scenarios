...
I'll also work hard so I won't regret
it.");
VoicePlay("D030901200_09_080");
MsgDisp("Kuya","Yep. Even if we're apart, we're
working towards the same goal. Improving
our \"studies\" and our \"art\".");
MsgDisp("主人公","Yes!");
VoicePlay("D030901200_09_090");
MsgDisp("Kuya","It's getting late so, that's all for
now. I'll call you again soon.
Good night.");
MsgDisp("主人公","Okay, good night......");
SEPlay("SYS_SE_PHONE_POWER_ON");
SEWait();
MsgDisp("主人公","(Kuya-san seems to be studying hard
