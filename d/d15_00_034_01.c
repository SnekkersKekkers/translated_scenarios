...
MsgDisp ( "主人公","｛本多＊＊｝. Do you have gym class next?" ) ;
ChEye ( 3,0 ) ;
ChMouth ( 3,3 ) ;
ChMotion ( 3,1 ) ;
VoicePlay ( "D150003401_03_010" ) ;
MsgDisp ( "Honda","Yepyep.
Biology." ) ;
ChEye ( 4,2 ) ;
ChMouth ( 4,2 ) ;
ChMotion ( 4,0 ) ;
VoicePlay ( "D150003401_04_000" ) ;
MsgDisp ( "Nanatsumori","Biology doesn't need much energy." ) ;
ChEye ( 3,0 ) ;
ChMouth ( 3,3 ) ;
ChMotion ( 3,5 ) ;
VoicePlay ( "D150003401_03_020" ) ;
MsgDisp ( "Honda","But my brain and body are both running at
full speed! Today I'm searching for
microorganisms in the garden." ) ;
ChEye ( 4,2 ) ;
ChMouth ( 4,4 ) ;
ChMotion ( 4,2 ) ;
VoicePlay ( "D150003401_04_010" ) ;
MsgDisp ( "Nanatsumori","......Wait. This is a bad thing to talk
about while we eat." ) ;
ChEye ( 3,4 ) ;
ChMouth ( 3,0 ) ;
ChMotion ( 3,4 ) ;
...
MsgDisp ( "主人公","Um, yeah. How about we talk about that
