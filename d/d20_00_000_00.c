...
BGOpen("wf000",1);
ScrFadeIn(0);
MsgDisp("主人公","(I walked around a lot, maybe I 
should start to head back now?)");
...
ScrFadeIn(4,30);
MsgDisp("主人公","U-Uhm......
You're the world famous fashion
designer, Goro Hanatsubaki, right?");
ChEye(31,4);
ChMouth(31,4);
ChMotion(31,2);
VoicePlay("D200000000_31_060");
MsgDisp("Goro","Hello♪　But right now I'm Goro
Hanatsubaki, special advisor of 
Habacha!");
...
And starting today, you're a new member
of Habacha's editorial team.");
MsgDisp("主人公","Eh?");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,0);
...
MsgDisp("Goro","That's right. Young people with
shimmering talent hidden within......
Beautiful Diamonds in the Rough!");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,4);
VoicePlay("D200000000_31_100");
MsgDisp("Goro","You are the one who will take those
diamonds and polish them into a 
wonderful and shining person♪");
MsgDisp("主人公","Ehh∋
I'm not sure if I'm the kind of person
who can do that——");
ChEye(31,2);
ChMouth(31,2);
ChMotion(31,2);
...
You can do it. Just think of it as a 
part-time job.");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,0);
VoicePlay("D200000000_31_120");
MsgDisp("Goro","Whenever you're in the mood, just
walk around Habataki City and then
write a nice article about it.");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,4);
