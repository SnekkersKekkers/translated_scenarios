...
MsgDisp ( "Nanatsumori","We have biology in the afternoon, right?" ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,3 ) ;
...
MsgDisp ( "Mikage","Nanatsumori, are you maybe afraid of bugs?" ) ;
ChEye ( 4,1 ) ;
ChMouth ( 4,2 ) ;
ChMotion ( 4,1 ) ;
VoicePlay ( "D150004701_04_030" ) ;
MsgDisp ( "Nanatsumori","To put it lightly, I really dislike them.
Are there bugs you like?" ) ;
ChEye ( 7,0 ) ;
ChMouth ( 7,3 ) ;
ChMotion ( 7,5 ) ;
VoicePlay ( "D150004701_07_020" ) ;
MsgDisp ( "Mikage","I like them.
What about you?" ) ;
