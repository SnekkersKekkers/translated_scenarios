...
MsgDisp("主人公","(Alright, as Habacha's newest
staff member, let's get to it!)");
MsgClose();
ScrFadeOut(0);
MsgDisp("","　　　　　　　　　　 ・
　　　　　　　　　　 ・
...
Thanks to the reconstruction of the dam,
I heard there will be a lot more
fireflies now in the summer.");
...
The \"Home of the Fireflies\" has a 
hidden and mysterious power.");
MsgDisp("主人公","A mysterious power...?");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,1);
VoicePlay("D210000110_31_030");
MsgDisp("Goro","That's right. If you visit the gazebo with
your beloved while the fireflies are
glowing——");
ChEye(31,3);
ChMouth(31,3);
ChMotion(31,4);
...
MsgDisp("Goro","Okay then! I'm looking forward to
reading an article all full of your
unique style. Adieuー♪");
MsgClose();
SEPlay("EV_SE_626");
ChClose(31);
MsgDisp("主人公","(A brand new date spot
\"The Home of the Fireflies\", huh?
