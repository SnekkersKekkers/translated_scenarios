...
ChMouth ( 5,4 ) ;
ChMotion ( 5,3 ) ;
VoicePlay ( "D150004500_05_000" ) ;
MsgDisp ( "Hiiragi","Yes. Sometimes I have unexpected work with
the company but most of the time, you can
contact me right away." ) ;
MsgDisp ( "主人公","Both of you seem so busy." ) ;
ChEye ( 4,1 ) ;
ChMouth ( 4,1 ) ;
ChMotion ( 4,1 ) ;
...
MsgDisp ( "Hiiragi","I see. I keep my school time seperate from
work time." ) ;
ChEye ( 4,0 ) ;
ChMouth ( 4,0 ) ;
ChMotion ( 4,0 ) ;
