...
ChMotion(4,0,1);
ChCheek(4,0);
MsgDisp("主人公","By the way have you been
able to contact ｛風真＊＊｝?");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,1,1);
...
He's not responding to neither 
...
MsgDisp("Nanatsumori","It's lunch break now, so he 
went home to get it.
...
Therefore, he's not here because
he's searching for it and has 
lost contact with us.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,0,1);
VoicePlay("D140B04100_03_030");
MsgDisp("Honda","Heeh.
It must be convenient to 
have your house so close by.
...Right?");
MsgDisp("主人公","(It's definitely convenient but
But it's a big shock when you 
forget something. I'm sure ｛風真＊＊｝
is super frustrated about now...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChClose(3,0,0);
