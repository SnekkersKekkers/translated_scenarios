...
MsgDisp("主人公","No, it was a result of all your hard
work, ｛颯砂＊＊｝.");
StlEye(2,1);
StlMouth(2,0);
VoicePlay("D010200800_02_030");
MsgDisp("Sassa","By \"hard work\", do you mean all
the training I did? Because, you know.");
StlEye(2,1);
StlMouth(2,0);
...
Mikage-sensei, and you who created a
place where I could work hard.");
StlEye(2,0);
StlMouth(2,0);
...
MsgDisp("Sassa","I'm completely burned out when it
comes to training for my next goal.");
StlEye(2,0);
StlMouth(2,0);
StlEyeOpenLevel(2,5);
...
ChEyeOpenLevel(2,10);
MsgDisp("主人公","It's thanks to ｛颯砂＊＊｝ that I got
to experience so many new things. Things
...
form.");
MsgDisp("主人公","(｛颯砂＊＊｝......
He worked hard carrying everyone's
hopes and dreams......)");
MsgClose();
ScrFadeOut(0);
ChPrmTblAdd(2,0);
