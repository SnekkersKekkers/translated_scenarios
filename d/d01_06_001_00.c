...
MsgDisp("主人公","(The weather is nice today so let's
...
EfctOpen(14);
ScrFadeIn(0);
MsgDisp("主人公","......Hey, is that maybe all you're
having for lunch?");
StlEye(6,0);
StlMouth(6,0);
StlEyeOpenLevel(6,5);
...
MsgDisp("主人公","But in terms of nutrition, maybe
it would be better to add some side
dishes?");
StlEye(6,0);
StlMouth(6,0);
...
the broth.");
MsgDisp("主人公","Geez.
Right, maybe you would like to have
...
I'm giving this back!　Take it, quickly!");
MsgDisp("主人公","Eh?");
ChEye(6,0);
ChMouth(6,1);
ChMotion(6,1);
...
MsgDisp("Himuro","It's black on the outside and white
on the inside, and when it gets heated
up, the texture becomes gross and mushy.");
