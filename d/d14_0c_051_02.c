...
MsgDisp("主人公","Hehe, it's mostly just vegetables
isn't it?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,4);
ChEyeOpenLevel(6,8);
VoicePlay("D140C05102_06_000");
MsgDisp("Himuro","...Seems fun.");
MsgDisp("主人公","Eh?");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
...
Please leave those two alone a
little longer.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("D140C05102_06_010");
MsgDisp("Himuro","Ah, that's right.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
...
ChMouth(5,4);
ChMotion(5,0,1);
VoicePlay("D140C05102_05_020");
MsgDisp("Hiiragi","Then, I'm the eldest son.");
VoicePlay("D140C05102_06_040");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,5);
MsgDisp("Himuro","Eh, Yanosuke-senpai?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("D140C05102_05_030");
MsgDisp("Hiiragi","That's Yanosuke-nii san.
It's good right, Inori?");
VoicePlay("D140C05102_06_050");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
ChEyeOpenLevel(6,8);
