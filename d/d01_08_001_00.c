...
MsgDisp("Shirahane","The shop would also go bankrupt due
to coffee costs, so let's help each
other out!");
VoicePlay("D010800100_39_040");
MsgDisp("Man B","Dai-chan, how many candies are okay
to take?");
StlEye(8,1,0);
