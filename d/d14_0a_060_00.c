...
MsgDisp("Himuro","It feels weird that 
Ryota-senpai isn't here.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("D140A06000_02_000");
MsgDisp("Sassa","He's surrounded by 
his juniors over there.
They're even having lunch together.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("D140A06000_02_010");
MsgDisp("Sassa","You're pretty calm, aren't you?
When we say juniors, for the
most part they're girls.");
MsgDisp("主人公","Yeah, they're customers at Simon's.
They want to hear recommendations 
from ｛風真＊＊｝, I think.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,2);
...
If it were me, I wouldn't go and 
...
MsgDisp("Sassa","Inori, 
are you taking this time whilst
