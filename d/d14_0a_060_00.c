...
MsgDisp("Himuro","It feels weird that Ryota-senpai
isn't here.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("D140A06000_02_000");
MsgDisp("Sassa","He's surrounded by his juniors over there.
...
MsgDisp("Himuro","Sigh...you really are a good person.
...
Don't mind if we do.");
MsgDisp("主人公","(Ehh∋
What do you mean by \"Don't mind if
we do\"??)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
