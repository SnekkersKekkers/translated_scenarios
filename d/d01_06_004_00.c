...
I need to watch my step on the way
home.)");
VoicePlay("D010600400_06_000");
MsgDisp("Himuro?","You're slow.
How long were you going to make me
wait?");
MsgClose();
SEPlay("EV_SE_544");
...
MsgDisp("Male Student B","I guess that's exactly what you'd 
expect from Himuro?");
StlEye(6,0,0);
StlMouth(6,0);
...
MsgDisp("Male Student B","Legend has it that once Vice
Principal Himuro caught a blackboard
eraser before it fell on his head——");
StlEye(6,1);
StlMouth(6,0);
VoicePlay("D010600400_06_060");
MsgDisp("Himuro","How does that catch just now have
...
MsgDisp("Himuro","It's fine isn't it? We made them
just now.");
MsgDisp("主人公","Ehh?");
BGMStop();
MsgClose();
