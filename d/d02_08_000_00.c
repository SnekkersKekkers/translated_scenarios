...
MsgDisp("Shirahane","Lately there's been a rumour goin' around
school—");
...
MsgDisp("Shirahane","You know, I also have a reputation as the
\"Young Master of Stallion Oil\".");
MsgDisp("主人公","Hehe, really?");
ChEye(8,1);
ChMouth(8,3);
ChMotion(8,1,1);
VoicePlay("D020800000_08_050");
MsgDisp("Shirahane","Ya. Aren't I also worthy of a rumour?");
MsgDisp("主人公","That's right.
Come to think of it, the customers seem to
