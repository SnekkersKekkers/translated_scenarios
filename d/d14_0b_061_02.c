...
MsgDisp("Kazama","How much more are you
going to make us say... geez.");
MsgDisp("主人公","Umm...");
ChEye(3,2);
ChMouth(3,3);
ChMotion(3,5,1);
...
MsgDisp("Kazama","Honda. Please. That's enough.
There's no point in clarifying it.");
MsgDisp("主人公","?");
MsgDisp("主人公","(I think I'm getting along
well with ｛七ツ森＊｝ but...
