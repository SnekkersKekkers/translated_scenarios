...
MsgDisp("Himuro","...Hey, does Nozomu-senpai do things like
...
MsgDisp("Himuro","Why is Ryota-senpai the one getting
surprised?");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,0);
...
MsgDisp("Kazama","You don't have to force yourself to say
it.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
...
MsgDisp("Himuro","Ryota-senpai, if you don't want to listen,
please just cover your ears.");
ChEye(1,0);
ChEyeOpenLevel(1,8);
ChEye(6,0);
ChMouth(6,0);
