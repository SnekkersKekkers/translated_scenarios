...
MsgDisp("Hiiragi","I dreamt about you earlier so I hurried here
to check on you.");
MsgDisp("主人公","Hehe, oh.");
ChEye(5,4);
ChMouth(5,4);
...
MsgDisp("Hiiragi","Yes. Sorry for disturbing you.
I don't remember the exact details of the
dream, but I guess it smelled like roses?");
ChMotion(5,0);
...
BGMStop();
ChClose(5);
MsgDisp("主人公","(The smell of roses...
What's with that? A dream, huh...
Did ｛Hiiragi＊＊＊｝ doze off during class?)");
MsgClose();
ScrFadeOut(0,0);
