...
ChMouth ( 7,3 ) ;
ChMotion ( 7,0 ) ;
VoicePlay ( "D150001700_07_000" ) ;
MsgDisp ( "Mikage","For today's lunch, a lesson with Mikage." ) ;
...
ChMouth ( 1,3 ) ;
ChMotion ( 1,0 ) ;
VoicePlay ( "D150001700_01_020" ) ;
MsgDisp ( "Kazama","You don't need to do anything.
