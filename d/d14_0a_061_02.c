...
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("D140A06102_02_030");
MsgDisp("Sassa","If he's like that when he's with you too,
then I can relax.");
ChEye(1,2);
ChMouth(1,0);
ChMotion(1,1);
...
ChMouth(1,0);
ChMotion(1,0);
VoicePlay("D140A06102_01_060");
MsgDisp("Kazama","There's no way.
There's still a long way to go.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("D140A06102_02_050");
MsgDisp("Sassa","Hm, me too.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
