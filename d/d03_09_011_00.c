...
MsgDisp("主人公","(I might not make it in time but shouldn't I
go to Hanegasaki High School?)");
...
MsgDisp("Kuya","I may have just graduated from high school,
...
MsgDisp("Kuya","The pleasure is all mine.
It's too perfect that my last high school
memory will be walking home with you.");
MsgDisp("主人公","Hehe, I'm happy.");
VoicePlay("D030901100_09_050");
MsgDisp("Kuya","Yeah.
Starting tomorrow, I'll be taking a gap year.");
...
MsgDisp("Kuya","I have to study like crazy this year so I can
get into a first-rate university.");
ChMotion(9,4,1);
VoicePlay("D030901100_09_090");
MsgDisp("Kuya","Because of that, I think we'll see each other
less often.");
MsgDisp("主人公","Kuya-san...");
ChEye(9,2);
ChMouth(9,0);
...
Let's work hard on \"studies\" and \"art\" and
aim for a first-rate university!");
MsgDisp("主人公","Yes!");
ChEye(9,2);
ChMouth(9,0);
ChMotion(9,4,1);
