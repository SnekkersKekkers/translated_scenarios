...
ScrFadeIn(0);
ChMotion(8,1,1);
VoicePlay("D020800500_08_000");
MsgDisp("Shirahane","The term is finally over!
How'd ya do?");
MsgDisp("主人公","Yeah, I got good scores.");
ChEye(8,2);
ChMouth(8,0);
ChMotion(8,2,1);
VoicePlay("D020800500_08_010");
MsgDisp("Shirahane","I did too. But it seems like no matter 
how hard I try, I can't get perfect 
...
school. I'm always in the top 3.");
MsgDisp("主人公","Amazing!
...
MsgDisp("Shirahane","I can't speak for you but I think you'd
be able to go to a first-rate 
university.");
ChEye(8,0);
ChMouth(8,3);
ChMotion(8,3,1);
