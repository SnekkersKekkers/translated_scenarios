...
SEStop("EV_SE_577",0);
Wait(30,0);
MsgDisp("主人公","Hello, ｛風真＊＊｝? That's amazing. I was
...
SEPlay("EV_SE_604",1);
ScrFadeIn(0);
MsgDisp("主人公","Woah...... ｛風真＊＊｝, are you actually
good at cooking?");
SEVol(0.5,0.8);
StlMouth(1,1);
...
MsgDisp("Kazama","Yep. That flavor is better for me, after
all.");
