...
on the rooftop ｛風真＊＊｝ was on
the phone with his parents......)");
MsgDisp("主人公","(It sounded like they were talking
...
MsgDisp("Kazama","Hey, why don't you come over here
for lunch?");
MsgDisp("主人公","Eh?");
...
MsgDisp("Kazama","This is something I used to eat for
lunch when I was abroad.");
StlEyeOpenLevel(1,5);
VoicePlay("D010100500_01_060");
MsgDisp("Kazama","Sausage, Bacon, Mushrooms, Eggs, Baked
Beans with Roasted Tomatoes. And of
course, fried fish.");
MsgDisp("主人公","Hehe, that sounds delicious!");
StlEye(1,1);
VoicePlay("D010100500_01_070");
MsgDisp("Kazama","I mostly ate Japanese food, but
sometimes I ate this kind of food too.
I don't hate it.");
...
MsgDisp("Kazama","Well, I'll think about it some more 
after we eat?");
...
I've once again realized that I don't
want a British lunch, I'd prefer soba.");
MsgDisp("主人公","Soba?");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
