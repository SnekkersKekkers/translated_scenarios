...
MsgDisp ( "御影","Hm? That can't be... ......Wait, you're
right. No one else is here." ) ;
ChEye ( 2,0 ) ;
ChMouth ( 2,0 ) ;
ChMotion ( 2,4 ) ;
VoicePlay ( "D150002700_02_010" ) ;
MsgDisp ( "颯砂","Mikage-sensei, what's up?" ) ;
ChEye ( 7,2 ) ;
ChMouth ( 7,2 ) ;
ChMotion ( 7,0 ) ;
VoicePlay ( "D150002700_07_010" ) ;
MsgDisp ( "御影","You know, I don't think that's the case
...
MsgDisp ( "颯砂","Oh, Vice Principal Himuro is over there." ) ;
ChEye ( 7,5 ) ;
ChMouth ( 7,1 ) ;
ChMotion ( 7,5 ) ;
...
MsgDisp ( "颯砂","Mikage-sensei, why are you hiding?" ) ;
VoicePlay ( "D150002700_07_030" ) ;
MsgDisp ( "御影","Please pretend I'm not here." ) ;
ChEye ( 2,2 ) ;
ChMouth ( 2,4 ) ;
ChMotion ( 2,4 ) ;
