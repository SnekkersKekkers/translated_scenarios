...
He said he was quitting his part-time job
here. I was so shocked...");
MsgDisp("主人公","Ehh∋");
MsgClose();
ScrFadeOut(0);
MsgDisp("","　　　　　　　　　　 ・
...
Just like ya'd expect from a scholar like
yourself. Now I'm fired up too!");
