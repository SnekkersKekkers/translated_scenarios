...
You thought that person was amazing, huh?");
MsgDisp("主人公","Yes!");
ChEye(31,2);
ChMouth(31,2);
ChMotion(31,0);
...
Secondly, be sure to keep an eye on trends
and what's in \"style\". Bye～▼");
MsgClose();
...
Maybe I'll see him if I go there again.
He said he was \"working\", right?)");
    break ;
    case 1:
