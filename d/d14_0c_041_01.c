...
MsgDisp("Hiiragi","I've been transferring schools over and over
since elementary school.
So, I've become numb to that sort of feeling.");
MsgDisp("主人公","I see...");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
It's because of everyone here. This is the
first time I've had this sort of school life.");
MsgDisp("主人公","｛Hiiragi＊＊＊｝...");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
...
You can stay at Haba High until your
graduation.");
ChEye(5,4);
ChEye(7,3);
ChMouth(7,3);
...
MsgDisp("Hiiragi","Ahh, yes.
That's right. If I don't study hard now,
