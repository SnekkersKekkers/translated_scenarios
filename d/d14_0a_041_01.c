...
MsgDisp("Himuro","...Now that I think about it, I don't
remember Nozomu-senpai ever getting angry.");
MsgDisp("主人公","Yeah, maybe?
I guess he doesn't sweat the small stuff.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,3);
ChEyeOpenLevel(1,8);
...
MsgDisp("Kazama","......｛主人公｝, do you also think so?");
