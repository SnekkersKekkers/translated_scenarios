...
MsgDisp("Shirahane","｛主人公｝, it's already break time,
yeah? I'll finish up here so you can go
back to the office first.");
MsgDisp("主人公","Okay. I'll make some tea then. Do you want
the same as usual?");
ChEye(8,3);
ChMouth(8,3);
ChMotion(8,0,1);
...
person, an honor student too......It's
inspiring.");
...
MsgDisp("Shirahane","Hmm. If we're talking about Hane High, I'm
...
MsgDisp("Shirahane","Haha! But, Hane High and Haba High are
like night and day.");
...
MsgDisp("Shirahane","I just enrolled in the same school as my
bro without thinking about it, but maybe I
