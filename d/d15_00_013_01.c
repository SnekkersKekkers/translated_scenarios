...
MsgDisp("Kazama","Eating lunch with everyone is nice, huh?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Kazama","Well, that's because you only have
one mouth.");
ChEye(3,2);
ChMouth(3,2);
ChMotion(3,2);
...
MsgDisp("Kazama","Isn't that fine?
...
Okay, so today's topic is kind of a
long one.");
ChEye(1,2);
ChMouth(1,2);
VoicePlay("D150001301_01_030");
MsgDisp("Kazama","Ah, no, I didn't mean...");
ChMotion(3,4);
ChEyeOpenLevel(3,0);
