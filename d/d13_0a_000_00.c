...
There's no way your acting 
is that top-notch right?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","Haa... well, it's only natural
for three guys to talk to each 
other on that kind of day.");
MsgClose();
...
MsgDisp("Himuro","Yeah, he was looking 
forward to it quite a lot.
...
ChClose(2,0,30);
ChClose(6,0,30);
MsgDisp("主人公","(I see, today is Valentine's day so 
I guess he's getting excited over that...)");
MsgClose();
ScrFadeOut(0);
ChLayout(1);
