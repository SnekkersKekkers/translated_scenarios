...
MsgDisp("主人公","Hey, come on now, what are you
talking about?");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","Sigh...well, what three guys would
talk about on a day like this is
obvious, right?");
MsgClose();
...
MsgDisp("Sassa","Ryota was anxiously looking around
for you.");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,3);
