...
radiant light that guides and protects you.
Now, march onwards.");
...
A sequel \"Habataki Castle: On Fire\".
That was lovely.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
Nobody wants to see ｛Hiiragi＊＊＊｝ on the
sidelines...");
ChEye(5,3);
ChMouth(5,2);
ChMotion(5,5);
...
MsgDisp("主人公","(｛Hiiragi＊＊＊｝ looks like he's having fun.
