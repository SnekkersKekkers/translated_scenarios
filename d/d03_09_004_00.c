...
MsgDisp("Kuya","By the way, did you see anyone in
trouble around here?");
...
MsgDisp("Kuya","Hmm.
You can interview me, but I don't think
it will be very interesting......");
MsgDisp("主人公","Hehe. Okay, here comes the first
question: How did you become a \"Jack
Of All Trades\"?");
ChEye(9,0);
ChMouth(9,4);
ChMotion(9,0,1);
...
MsgDisp("Kuya","Yeah.");
MsgDisp("主人公","Okay, here's the second question:
Why is it rewarding to be a 
\"Jack Of All Trades\"?");
ChEye(9,2);
ChMouth(9,4);
ChMotion(9,0,1);
...
rewarding about it? What do you think?");
MsgDisp("主人公","(Umm......
...
Kuya-san, if you don't mind, maybe we
can do a close coverage interview?");
    ChEye(9,3);
    ChMouth(9,4);
    ChMotion(9,4,1);
    ChEyeOpenLevel(9,10);
...
forever?");
    MsgDisp("主人公","Well......It's not for forever but
next time, Kuya-san and I can cover
more topics.");
    ChEye(9,3);
    ChMouth(9,0);
    ChMotion(9,0,1);
    VoicePlay("D030900400_09_120");
    MsgDisp("Kuya","Like always, I'm okay with
...
good at that sort of thing.");
    MsgDisp("主人公","(Alright! I'll learn more about 
Kuya-san next interview! I
need to research what's in \"style\", too.)");
    break ;
    case 1:
    MsgDisp("主人公","(I'm having a hard time getting
to know Kuya-san......)");
    ChEye(9,3);
    ChMouth(9,4);
    ChMotion(9,4,1);
...
Thanks for your time today.");
    MsgDisp("主人公","(Yeah. I don't think I'll be able 
to write an article on Kuya-san, maybe 
