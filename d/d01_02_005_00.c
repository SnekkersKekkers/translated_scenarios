...
MsgClose();
ChClose(2);
MsgDisp("主人公","(I hope ｛Sassa＊＊｝ has a good race...
...
｛Sassa＊＊｝ is falling behind more and
more...)");
...
MsgDisp("Manager","Well, the overall win is already locked
in, so relax.");
MsgDisp("主人公","｛Sassa＊＊｝...");
MsgClose();
ScrFadeOut(0);
...
MsgDisp("主人公","｛Sassa＊＊｝, congrats on your victory.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
