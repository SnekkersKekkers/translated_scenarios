...
BGOpen("wf000",0);
ScrFadeIn(0);
MsgDisp("主人公","(I wonder what I should write about for the
next Habatcher Column...
...
ScrFadeIn(0);
MsgDisp("主人公","(Ah... They've built a new sculpture!)");
BGOpen("wf231",0);
...
It's said that you can predict your love life
...
SEPlay("EV_SE_517");
Wait(110,0);
MsgDisp("主人公","(! What a beautiful sound...
Is that a good sign?)");
SEStop("EV_SE_517",2);
MsgDisp("主人公","(Yep, this is a perfect date spot.
A new trendy spot, \"The Wharf\", I'll go back
now and write an article about it!)");
MsgClose();
EnvAutoSet(1);
ScrFadeOut(0);
