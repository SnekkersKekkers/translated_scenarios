...
Wait(10,0);
SEStop("EV_SE_752",2);
MsgDisp("主人公","(Phew... I managed to finish my performance.
This joint practice session makes me
nervous.)");
MsgDisp("主人公","(Ah... Next up it's ｛ひかる＊｝'s turn.)");
MsgClose();
ScrFadeOut(0);
StlOpen("ev_22_02");
StlEye(22,0);
...
MsgDisp("主人公","(Woah... ｛ひかる＊｝, so beautiful!)");
...
MsgDisp("Girl B","The performance and visuals are both great...
You could watch her for hours...");
MsgDisp("主人公","(Hehe.
People from other schools are also watching.)");
...
MsgDisp("Hikaru","Ehe▼ Hikaru really enjoyed it too～♪");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("D012200100_22_020");
MsgDisp("Hikaru","After all, dancing is most fun when you dance
with all your heart!");
