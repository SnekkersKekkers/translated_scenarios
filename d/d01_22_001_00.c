...
MsgDisp("School Girl B","The performance and visuals are
both great......You could watch her for
hours......");
MsgDisp("主人公","(Hehe.
...
performance. Everyone was really
impressed!");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,4,1);
...
MsgDisp("Hikaru","After all, dancing is most fun when
