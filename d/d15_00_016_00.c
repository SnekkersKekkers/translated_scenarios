...
MsgDisp ( "Himuro","Ryota-senpai, are you frozen again?" ) ;
ChEye ( 1,5 ) ;
ChMouth ( 1,2 ) ;
ChMotion ( 1,5 ) ;
ChCheek ( 1,5 ) ;
...
MsgDisp ( "Himuro","I-I don't know what you mean..." ) ;
MsgDisp ( "主人公","What are you guys talking about?" ) ;
ChEye ( 1,0 ) ;
ChMouth ( 1,0 ) ;
ChMotion ( 1,0 ) ;
ChEyeOpenLevel ( 1, - 1 ) ;
