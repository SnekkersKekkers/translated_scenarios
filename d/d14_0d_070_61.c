...
MsgDisp("Michiru","Mari is interested in 
a boy the year below us?");
MsgDisp("主人公","Eh∋
What's this, all of a sudden...?");
ChEye(21,4);
ChMouth(21,0);
ChMotion(21,4);
VoicePlay("D140D07061_21_010");
MsgDisp("Michiru","I mean, it looks like you
really get along with Himuro-chan.
I'm curious.");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,5,1);
...
If you like him, Hikaru can 
advise you at any time.");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("D140D07061_22_020");
MsgDisp("Hikaru","Hikaru can tell you about his 
