MsgDisp("主人公","(Okay, let's take a little detour
so we can see the beautiful sunset on
our way home.)");
MsgDisp("","　　　　　　　　　　 ・
　　　　　　　　　　 ・
　　　　　　　　　　 ・");
...
riding the waves, Inori took it
seriously.");
StlEye(7,2);
StlMouth(7,0);
...
MsgDisp("Himuro","Kojiro-sensei, I didn't tell you to
stop, did I?");
StlEye(7,1,0);
...
MsgDisp("Hiiragi","As you can see, we have Inori's 
...
MsgDisp("Himuro","What are you laughing at? Do you want
to join them");
MsgDisp("主人公","Ehh?");
StlEye(7,2);
StlMouth(7,1);
...
MsgDisp("Himuro","If you don't keep your head up, you
won't be able to see the waves!");
MsgDisp("主人公","(I wonder if the two of them will
be okay tomorrow......)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
