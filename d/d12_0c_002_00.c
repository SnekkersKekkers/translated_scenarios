BGOpen("sc510",0);
ScrFadeIn(0);
MsgDisp("主人公","(Okay, today I'll finish up some
student council work during lunch.)");
MsgClose();
ScrFadeOut(0,0);
Wait(40,0);
...
MsgDisp("Himuro","I know what you're trying to say, but
...
MsgDisp("Himuro","It would be better to try to convey
the message to everyone, instead of just
using your own personal preferences.");
StlEye(5,2,0);
...
MsgDisp("主人公","Yeah. I have a few more things to do, 
so why don't you go ahead? I'll lock 
the door when I'm done.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0,1);
...
You also have a tendency to work too 
hard. Try not to overdo it.");
...
SEWait();
MsgDisp("主人公","(Alright, let me just tidy things up
and then I'll go to class......Ah──)");
SEPlay("EV_SE_591");
Wait(30,1);
MsgDisp("主人公","(That's the poster from earlier!
I wonder what slogan they decided on
in the end?)");
SEWait();
SEPlay("EV_SE_635");
SEWait();
