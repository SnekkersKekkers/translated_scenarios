...
MsgDisp("Honda","Yep, that's the exact same reaction
I had. But you know, this isn't a
pattern, it's a fossil.");
MsgDisp("主人公","Eh?
...
MsgDisp("Honda","Exactly. It's an ammonite from 150
million years ago. Isn't that awesome?");
...
My mother introduced me to him when I
...
confirm the things I learn by seeing
and touching them with my own eyes.");
BGMVol(0.5,2);
MsgClose();
ScrFadeOut(0);
StlClose();
...
MsgDisp("主人公","I get it. For you, this is an
important place. Thanks for teaching
me about it, ｛本多＊＊｝.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0);
