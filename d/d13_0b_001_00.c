...
This is a party venue isn't it?");
MsgDisp("主人公","Ah, you guys.
I wasn't really spacing out?");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
...
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("D130B00100_04_000");
MsgDisp("Nanatsumori","I'll take this one.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
MsgDisp("Kazama","Wait.
At times like this, it's ladies
first right?");
