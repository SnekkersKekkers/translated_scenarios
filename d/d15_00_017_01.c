...
MsgDisp("Mikage","Good.
But it's only a trump card for when you're
in trouble. Don't abuse it too much.");
ChEye(1,1);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","Mikage-sensei's secret for living alone is
to defy the notion that meals need rice as
a side dish.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
...
MsgDisp("主人公","Ahh, so you just eat bread in place
of rice?");
ChEye(1,3);
ChMouth(1,3);
ChMotion(1,3);
...
MsgDisp("主人公","(I'm worried about the diet of
these two...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
