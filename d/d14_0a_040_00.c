...
MsgDisp("主人公","He's talking to ｛Mikage＊＊｝.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
Inori, quick. Is there anything we can
talk about now that Ryota is gone?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,5);
VoicePlay("D140A04000_06_020");
MsgDisp("Himuro","I can't think of anything if you put me on
the spot...
...
MsgDisp("Himuro","What do you think about
Ryota-senpai's bangs?");
