...
It's definitely something that's unthinkable
normally.");
ChEye(22,3);
ChMouth(22,0);
ChMotion(22,3,1);
...
MsgDisp("Michiru","When you're in a position of authority, you
need the resolve to protect your people, even
at the cost of yourself.");
ChEye(22,0);
ChMouth(22,0);
ChMotion(22,2,1);
VoicePlay("D140D07050_22_030");
MsgDisp("Hikaru","Yanosuke-san doesn't let it show on his face
much, but Hikaru wonders if he's actually
suffering?");
MsgDisp("主人公","(The chairman is a position of authority...
It's definitely a feeling we can't understand
