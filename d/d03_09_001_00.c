...
Thank you, Kuya-san. You're always 
helping us.");
ChEye(9,3);
ChMouth(9,0);
ChMotion(9,1,1);
...
MsgDisp("Kuya?","It's nothing, please don't worry
about it. This is my job.");
MsgDisp("主人公","(......Job?)");
BGMVol(0.5,2);
MsgClose();
ScrFadeOut(0);
...
MsgDisp("Kuya?","That used to be the only way to get
him to stop crying.");
MsgDisp("Kuya?","Sometimes I'd have
to carry him around for hours, so I had
...
MsgDisp("Kuya?","I have something important to do so
I'll leave here.");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
BGMStop();
ChClose(9);
MsgDisp("主人公","He also had something urgent to do 
the other day......");
MsgDisp("主人公","(Ah. I forgot to properly thank him
again! He didn't even introduce himself
properly, but I heard \"Kuya-san\".)");
MsgClose();
ScrFadeOut(0,0);
