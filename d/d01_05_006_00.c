...
MsgDisp("Male Student","Since we've been cleaning up all
morning, I thought it would be better
to say hello in a more fun way.");
...
MsgDisp("主人公","Hehe, that's an interesting way
to say hello.");
StlEyeOpenLevel(5,5);
StlMouth(5,1);
...
StlEye(5,0);
MsgDisp("主人公","Thanks for your hard work on cleaning
duty this morning.");
StlEyeOpenLevel(5,5);
...
MsgDisp("Hiiragi","Sometimes people see me and go \"Rerere\"
...
Look, when I slack off, more leaves
