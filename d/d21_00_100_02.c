...
ScrFadeIn(0);
MsgDisp("主人公","(There's so many cats and dogs!
Hehe, the kids are cute too!)");
SEPlay("EV_SE_548");
MsgDisp("主人公","(...Hmm? What? Everyone is coming this
way∋)");
SEPlay("EV_SE_555");
Wait(30,0);
ScrQuake(1);
...
lovers.)");
MsgDisp("主人公","(...I can't get distracted! I have to tell
everyone about the charm of this place.)");
