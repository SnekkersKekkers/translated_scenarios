...
did you get hurt?");
    ...
    MsgDisp("主人公","It's not okay,
it's frustrated.");
    ChEye(1,2);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("O020100001_01_030");
    MsgDisp("Kazama","That's right, you're were
serious about this.
My bad.");
    ChEye(1,0);
    ChMouth(1,3);
    ...
    MsgDisp("Kazama","The dance is next, so maybe
...
Thanks.");
    ...
    MsgDisp("Kazama","C'mon, there's still the
last event, right?");
    ...
    MsgDisp("Kazama","I'll definitely come for you,
so just wait for me.");
