...
I suppose I'm getting a little more into it?");
    MsgDisp("主人公","Yeah, let's win, okay?");
    ChEye(5,0);
    ChMotion(5,4);
    VoicePlay("O040501000_05_030");
    MsgDisp("Hiiragi","Yes, I believe that there is a chance that I
will be successful in this event.");
    break ;
    case 4:
    case 5:
    MsgDisp("主人公","Hm, my team is...");
    ...
    MsgDisp("主人公","｛Hiiragi＊＊＊｝, let's do our best!");
    ChEye(5,0);
    ChMouth(5,3);
    ChMotion(5,4);
    VoicePlay("O040501000_05_050");
    MsgDisp("Hiiragi","Yes, please watch me.
This sports festival, I will put my all into
this event.");
    MsgDisp("主人公","(｛Hiiragi＊＊＊｝ is really into it...?)");
    break ;
    default :
    DbgAssert(1);
    break ;
