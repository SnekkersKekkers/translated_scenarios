...
when the teams are made last-minute.");
...
But it's still frustrating.");
    ...
    MsgDisp("Honda","You said it? I didn't want to say
anything in case I would end up
regretting it, but I'm super frustrated.");
    ChEye(3,4);
    ChMouth(3,4);
    ChMotion(3,5);
...
You don't need to apologize.");
    ...
    MsgDisp("Honda","It's a three-legged race, so
you weren't running alone, right?");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,3);
    VoicePlay("O030300002_03_070");
    MsgDisp("Honda","It's not like just one of us would
be at fault, so don't feel responsible
for it. Okay?");
    MsgDisp("主人公","Okay......");
    ChEye(3,4);
    ChMouth(3,3);
    ...
    MsgDisp("Honda","Good.
Even if the results say differently,
I think you're the best partner for me!");
    MsgDisp("主人公","(｛本多＊＊｝......
That's why last place is
so frustrating......)");
    break ;
    default :
    DbgAssert(1);
