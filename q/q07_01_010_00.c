...
MsgDisp("Kazama","You can thank me when we've both seen it
together.
Let's go back.");
ChEye(1,0);
ChMouth(1,2);
VoicePlay("Q070101000_07_040");
MsgDisp("Mikage","Don't go to the 12th floor, and return
...
For being with me this whole time on the
field trip.");
StlEye(1,1);
VoicePlay("Q070101000_01_100");
MsgDisp("Kazama","It was way more fun than I imagined before
high school.");
StlEye(1,0);
BGMVol(0.5,2);
MsgClose();
