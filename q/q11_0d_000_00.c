...
MsgDisp("Hikaru","A matching set for all of us, as a memory of
the school trip▼
What do you think?");
ChEye(21,4);
ChMouth(21,4);
...
I also bought something for the three of us
as a memory... Look...");
...
MsgDisp("Hikaru","They're all different colored glass beads...?
