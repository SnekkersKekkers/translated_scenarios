...
It's called Domtoren.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
VoicePlay("Q070200000_02_060");
MsgDisp("Sassa","Hmm, 105 metres......
It looks much higher from here.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,2);
VoicePlay("Q070200000_02_070");
MsgDisp("Sassa","Are we able to to climb it up?");
MsgDisp("主人公","Eh?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
So my body has weakend.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("Q070200000_02_090");
MsgDisp("Sassa","So let's go together!
Give me your hand.");
MsgDisp("主人公","Eeeh∋");
MsgClose();
SEPlay("EV_SE_504");
...
city. we have to enjoy Huis ten Bosch
until the end!)");
BGMStop(2);
Wait(60,0);
MsgDisp("","　　　　　　　　　　 ・
...
MsgDisp("Sassa","Cmon, I'm sure not gonna do that.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
