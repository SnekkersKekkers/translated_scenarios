...
Let's take a foto with the windmill♪");
...
Both your eyes are half closed!");
ChEye(21,4);
ChMouth(21,4);
ChMotion(21,5);
ChCheek(21,10);
VoicePlay("Q070D00000_21_020");
MsgDisp("Michiru","Oh no...... One more shot, please!");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,4,1);
VoicePlay("Q070D00000_22_040");
MsgDisp("Hikaru","But it's so funny.
Well, even I would ask for another take♪");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,3);
VoicePlay("Q070D00000_21_030");
MsgDisp("Michiru","C'mon, let's take one more shot.
Because it's gonna be memorable,
Right?");
...
MsgDisp("Hikaru","These are also huge!");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,3);
VoicePlay("Q070D00000_21_040");
MsgDisp("Michiru","Looks like it's made after a tall tower
locateed overseas.
...
MsgDisp("Michiru","Here also has the vibe,
...
MsgDisp("Hikaru","Ikr!
Let's go one day to see the real one!");
...
MsgDisp("Hikaru","It's as if we're time traveling.
Ehm......fashionable?");
MsgDisp("主人公","Yeah, fashionable!");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,2);
VoicePlay("Q070D00000_21_090");
MsgDisp("Michiru","Now I remember......");
MsgDisp("主人公","Are you searching something?");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,4);
VoicePlay("Q070D00000_21_100");
MsgDisp("Michiru","This flagstone contains a heart shaped
stone, And it's said that if you're able
...
MsgDisp("Michiru","And me too of course,
Leave this side to me!");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
ChClose(21);
MsgDisp("主人公","(It became a heart hunting......
