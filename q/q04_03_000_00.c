...
go around together?");
    ...
    MsgDisp("Honda","｛主人公｝, good morning! Did you need
something?");
...
places in my head.");
    MsgDisp("主人公","I see. If you're fine with it, wanna look
around together with me?");
    break ;
    case 4:
    case 5:
    MsgDisp("主人公","｛本多＊＊｝,good morning!");
...
refreshing!");
    MsgDisp("主人公","Yeah, I guess so? We're in a hotel lobby
after all.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
