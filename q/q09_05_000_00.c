...
I could not sleep out of excitement.");
    MsgDisp("主人公","You look like a child before a field
trip, don't you?");
    ChEye(5,4);
    ChMotion(5,0);
...
But waiting for excitement doesn't feel
bad at all.");
    ...
    MsgDisp("Hiiragi","But the anticipation and
joy when I saw you, I wouldn't mind 
having a taste of it again.");
    ChEye(5,0);
    ChMotion(5,0);
    VoicePlay("Q090500000_05_070");
    MsgDisp("Hiiragi","From the scene of the appearance, 
start over.");
    MsgDisp("主人公","Eeh∋");
    ChEye(5,3);
    ChMouth(5,4);
...
You said mean things, so I'm getting 
back at you.");
    MsgDisp("主人公","Come on......
Ah, look, Shall we go?");
    ChEye(5,4);
