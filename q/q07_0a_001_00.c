...
MsgDisp("Sassa","It looks pretty like an orange
carpet, huh?");
ChEye(1,3);
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("Q070A00100_01_010");
MsgDisp("Kazama","Huh, how rare of you to be poetic.");
...
MsgDisp("Sassa","Even though I'm a track and
field idiot, I do have a poetic side,
you know.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("Q070A00100_01_020");
MsgDisp("Kazama","This place is really impressive if
it gets Sassa to say things like this.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,4,1);
VoicePlay("Q070A00100_02_020");
MsgDisp("Sassa","Now's your turn, Ryota. 
The charming Simon's employee. 
What do you think?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
ChMotion(2,1);
ChEyeOpenLevel(2,0);
VoicePlay("Q070A00100_02_040");
MsgDisp("Sassa","Better luck next time, Ryota.");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,3);
ChEyeOpenLevel(1,8);
ChCheek(1,0);
VoicePlay("Q070A00100_01_050");
...
ChMouth(2,0);
ChMotion(2,4);
VoicePlay("Q070A00100_02_060");
MsgDisp("Sassa","\"Bell tower\"-what's that?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("Q070A00100_01_080");
MsgDisp("Kazama","Yes, a church bell.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("Q070A00100_02_070");
MsgDisp("Sassa","I wanna hear it. 
When will it ring?");
SEPlay("EV_SE_837");
Wait(20,0);
ChEye(1,3);
...
It says...\"Please enjoy yourself as much
as possible.\" Did he have something
else to say?");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,4,1);
ChEyeOpenLevel(2,0);
VoicePlay("Q070A00100_02_090");
MsgDisp("Sassa","How cute of him.");
MsgDisp("主人公","Hehe, I'm sure he's curious about us.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0,1);
VoicePlay("Q070A00100_01_110");
MsgDisp("Kazama","Well, let's send him a picture of
this tower and answer him.");
ChEye(1,0);
ChMouth(1,2);
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,0);
VoicePlay("Q070A00100_02_100");
MsgDisp("Sassa","A picture with all three of us in it
will just make him sad. So let's take one
of Ryota by himself.");
MsgClose();
SEPlay("EV_SE_856");
ChClose(1,0,30);
ChClose(2,0,30);
VoicePlay("Q070A00100_01_120");
