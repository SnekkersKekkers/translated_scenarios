...
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("Q070B00100_04_000");
MsgDisp("Nanatsumori","Let's begin by taking pictures.");
SEPlay("EV_SE_041");
SEWait();
ChEye(3,4);
ChMouth(3,3);
...
MsgDisp("Honda","Heyhey, now we have the opportunity, how
about we take one together.");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,2,1);
VoicePlay("Q070B00100_04_010");
MsgDisp("Nanatsumori","Well, let's ask someone then.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0,1);
VoicePlay("Q070B00100_01_010");
MsgDisp("Kazama","You're coming here.");
ChMouth(1,0);
MsgDisp("主人公","Eh?");
ChEye(3,3);
ChMouth(3,3);
...
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("Q070B00100_01_020");
MsgDisp("Kazama","Oh wow.");
ChEye(4,1);
ChMouth(4,3);
...
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("Q070B00100_03_030");
MsgDisp("Honda","Come on!
Let's climb the tower.
The view there is even better.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
...
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("Q070B00100_04_050");
MsgDisp("Nanatsumori","Let's take another photo there.");
ChMotion(1,0);
MsgDisp("主人公","Agreed!");
