...
MsgDisp("Mikage","How are you enjoying yourself? The real
charm of the school trip starts here,
don't you agree?");
MsgDisp("主人公","Huh?");
ChEye(7,0);
ChMouth(7,3);
...
MsgDisp("Mikage","Not at all. Truth is, I want to join in on
one too.");
...
MsgDisp("Mikage","What's going on? I'll be going over there
to deal with that.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,0);
VoicePlay("Q010703100_07_050");
MsgDisp("Mikage","You too, go have fun back in your room! Or
