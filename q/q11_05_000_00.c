...
I wonder when ｛柊＊＊＊｝ is done......)");
MsgClose();
BGMPlay("BGM_HANYOU_A",0.01);
ChOpen(5,254,4,2,4,9,#1,0,0);
VoiceEVSPlay(5);
VoicePlay("Q110500000_05_000");
MsgDisp("Hiiragi","｛主人公｝. Excuse me dearly for
letting you wait.");
...
MsgDisp("Hiiragi","And also...... a matching with you. A
chopstick rest in the shape of the Megane
Bridge.");
...
Could you use it?");
MsgDisp("主人公","Yeah, of course. Thanks, ｛柊＊＊＊｝!
Where did you find such a pretty one?");
ChEye(5,0);
ChMotion(5,4);
VoicePlay("Q110500000_05_050");
MsgDisp("Hiiragi","I found it near the Megane Bridge and was
curious about it.
I rushed to it.");
MsgDisp("主人公","Eeh∋ You went all the way back and bought
it for me?");
ChEye(5,4);
ChMotion(5,0);
