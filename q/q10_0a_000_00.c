...
MsgDisp("Sassa","Huh, seems like something girls
would like.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
...
I should also go buy some stuff for home and people I know.");
MsgDisp("主人公","Me too.
...
MsgDisp("Kazama","After we all buy our souvenirs, let's meet here again.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,1);
