...
MsgDisp("Sassa","Huh, seems something girls
would like.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
...
MsgDisp("Sassa","You're getting very worked up.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("Q100A00000_01_030");
MsgDisp("Kazama","The one who finds it first......
UNderstood?");
...
MsgDisp("Sassa","Hey, that's a false start!");
MsgDisp("主人公","Eh?");
VoicePlay("Q100A00000_01_040");
MsgDisp("Kazama","Wait there!
I'll find it first.");
MsgClose();
SEPlay("EV_SE_FOOT_RUN_AWAY_ALONE");
ChClose(2);
VoicePlay("Q100A00000_02_050");
MsgDisp("Sassa","My eyesight and legs are better 
than yours!");
...
MsgDisp("Sassa","Well, 
I guess the search for the Heartstone 
was a draw.");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","
But why would we touch it together?
What's gonna happen to us.");
MsgDisp("主人公","Maybe we get to be friends forever?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Sassa","What a good timing.
Maybe he's looking from somewhere?");
...
MsgDisp("Kazama","
\"I'll have a less sweet castella\"
it says. At times like these,
It's handy that he's straightforward.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,4,1);
...
and people I know.");
MsgDisp("主人公","Me too,
I wanna look for souvenirs to take 
home.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0,1);
