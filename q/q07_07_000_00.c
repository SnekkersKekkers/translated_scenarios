...
MsgDisp("Mikage","The Netherlands used those windmills, to
build and reclaim land which expanded the
country.");
...
MsgDisp("主人公","Of course. An extracurricular lesson with
...
company. Huis Ten Bosch was so fun!
Let's move on now.)");
BGMStop(2);
MsgClose();
ScrFadeOut(0,0);
