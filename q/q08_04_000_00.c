...
switch (ChPrmGet(4,6)){
    ...
    MsgDisp("Nanatsumori","Ahh! We did a lot of sightseeing.");
    MsgDisp("主人公","Yeah. Thanks for inviting me.");
    ChEye(4,3);
    ChMouth(4,3);
    ChMotion(4,1,1);
    VoicePlay("Q080400000_04_010");
    MsgDisp("Nanatsumori","So.
For the next free period, is booking you OK?");
    MsgDisp("主人公","OK!");
    break ;
    case 4:
    case 5:
    ...
    MsgDisp("主人公","Me too.
Thanks for inviting me, ｛Nanatsumori＊｝.");
    ChEye(4,3);
    ChMouth(4,3);
    ChMotion(4,1,1);
