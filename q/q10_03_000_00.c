...
MsgDisp("Honda","It's a beautiful archway.
Even though it's been restored, it's amazing
how the shape hasn't changed for centuries.");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,0,1);
...
MsgDisp("Honda","Actually, I was thinking yesterday about what
I could talk about at the Glasses Bridge.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
VoicePlay("Q100300000_03_070");
MsgDisp("Honda","Like, I have so much to tell you, so I was in
trouble.");
...
MsgDisp("Honda","You seem to enjoy my explanations, but I've
decided to talk today about what I feel, not
what I know.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
