...
But you know, the school trip isn't over
yet.");
...
MsgDisp("Kazama","So, it's settled.
We're going to spend the next free period
together.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
I'm sure someone from the city of Habataki
will interrupt us too?");
