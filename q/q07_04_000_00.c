...
shall I take a picture, ｛Nanatsumori＊｝?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("Q070400000_04_010");
MsgDisp("Nanatsumori","Isn't together better?");
MsgDisp("主人公","Eh?");
MsgClose();
...
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("Q070400000_04_080");
MsgDisp("Nanatsumori","The Netherlands.
I wanna go there.");
MsgDisp("主人公","Hehe!");
ChEye(4,0);
ChMouth(4,3);
