...
MsgClear();
MsgDisp("","Even though it's my house...my
family home, I'm even more nervous
than she is.");
...
living room.");
MsgDisp("","The handmade sweets, apparently for
her, were laid out on the table as if
that weren't already enough.");
...
hadn't changed since we were high
school students.");
...
MsgDisp("","My mother without restraint, barged
...
MsgDisp("Nanatsumori","\"I'm really sorry about today. That
you had to talk to my sister and my
Mom. Are you tired?\"");
MsgDisp("","She shook her head, laughing. It
was...a genuine laugh.");
