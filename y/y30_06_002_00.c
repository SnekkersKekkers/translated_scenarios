...
MsgDisp("","Generally, this means that plans
for work and play overlap,
but what about this?");
MsgDisp("","My New Year's shrine visit 
...
MsgClear();
MsgDisp("","So, technically speaking, 
I didn't double-book.");
VoicePlay("Y300600200_45_000");
MsgDisp("Yuki","\"Big brother, are you going?\"");
MsgDisp("","Already having gotten ready, 
My brother Yuuki called out for me, 
...
BGOpen("ad621",0);
ScrFadeIn(0);
MsgDisp("","My brother was in between my
parents in formal attire.");
...
MsgDisp("","I can also imagine her faltering 
on her feet, but even such a 
sight would be adorable.");
MsgClear();
MsgDisp("","The moment I thought of that, 
my heartbeat grew stronger.");
MsgDisp("","Is it really okay like this?
To start the year like this...");
MsgDisp("","Finally answering my own question,
I stopped walking.");
MsgClear();
