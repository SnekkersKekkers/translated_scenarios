...
MsgDisp("School Girl","\"Because they're our seniors? It
seems like they'd be hard to
talk to.\"");
MsgClear();
MsgDisp("","What a narrow way to think... If
anything, I have far less in common
...
MsgDisp("Kazama","\"Now that you mention it, Inori is
our junior huh?\"");
...
MsgClear();
MsgDisp("","I felt my classmates sneaking glances
at the four of us gathered in the
cafeteria.");
MsgDisp("","They weren't interested in me, but
the seniors around me.");
...
MsgDisp("Sassa","\"Inori, if you're full, I'll
take it?\"");
MsgClear();
MsgDisp("","Pretending to change the subject,
these two were trying to gauge how
I felt.");
...
this school. Leaving me behind.");
MsgClear();
MsgClose();
ScrFadeOut(0);
BGOpen("ex990",0);
ScrFadeIn(0);
MsgDisp("","Was that girl saying \"amazing\" with
such a vision in mind?");
