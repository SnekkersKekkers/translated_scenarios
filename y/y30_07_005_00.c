...
new life, she helped me with the
packing.");
MsgDisp("","I would dispatch my plants and
technical books off first, only my
...
MsgDisp("Mikage","\"It's alright. Since then, I haven't
had the opportunity to wear my best
outfit.\"");
...
graduating, she had never made this
...
MsgClear();
MsgDisp("","It's been three months since we
parted with that silly sort of
conversation. It went by in a flash.");
MsgClear();
MsgClose();
ScrFadeOut(0);
BGOpen("ad751",0);
ScrFadeIn(0);
MsgDisp("","This feeling is so familiar. We used
to meet up here all the time before
...
feel warm and fuzzy.");
MsgDisp("","The voice I had imagined calling
my name every day beneath that
faraway sky.");
MsgClear();
