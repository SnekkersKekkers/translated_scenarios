...
MsgDisp("Kazama","\"Hearing the sound of cooking, it's like
we're a newlywed household.\"");
MsgDisp("主人公","\"Ehh? Are we not?\"");
MsgDisp("","｛主人公名前｝, from time to time, will come
to my house and cook for me.");
MsgClear();
MsgDisp("","After graduating, while attending
university, I help out at my
Grandpa's shop.");
MsgDisp("","Even though she's supposed to be busy
with her new life too, she'll still be
overly helpful like this.");
...
MsgDisp("Kazama","\"This looks way better than the one
I made.\"");
MsgDisp("","She watches me eat energetically, with a
happy expression on her face.");
MsgDisp("主人公","\"...Hey, is it good?\"");
MsgClear();
MsgDisp("","I nodded greatly, and softly put a hand
on ｛主人公名前｝'s head.");
MsgDisp("主人公","\"｛Kazama＊＊｝...?\"");
...
BGOpen("ad151",0);
ScrFadeIn(0);
MsgDisp("主人公","\"Your room is just the same as it was in
elementary school, ｛Kazama＊＊｝. \"");
VoicePlay("Y300100500_01_040");
MsgDisp("Kazama","\"I've been thinking about changing it up
a little though.\"");
MsgDisp("","This room is filled with so much of my
feelings.");
MsgClear();
MsgDisp("","I want the me from back then to know
that I'm with ｛主人公名前｝ like this.");
MsgDisp("","I think it's fine to leave it like
this...until we move to our new home.");
MsgClear();
MsgClose();
BGMStop();
ScrFadeOut(0,0);
