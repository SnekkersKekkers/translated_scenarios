...
Theatre Troupe.");
MsgDisp("","I can picture the time they came
to my dressing room to greet me
even now.");
MsgClear();
BGOpen("ad531",0);
ScrFadeIn(0);
...
people's dreams.");
MsgDisp("","And I did it without even
realising... I'm the worst.");
MsgClear();
...
MsgDisp("Hiiragi","(But, what I should do... I don't
even know that.)");
BGMStop();
MsgClear();
MsgClose();
