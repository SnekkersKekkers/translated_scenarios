...
EnvAutoSet(0);
BGOpen("ad550",0);
EnvPlay("SE_ENV_BG_WF411_CO0");
ScrFadeIn(0);
VoicePlay("Y300500500_05_000");
MsgDisp("Hiiragi","\"I look forward to your evaluation.\"");
MsgClear();
...
that time, she thought I wouldn't
be performing and had a worried,
sad, and indescribable expression
on her face.");
MsgClear();
...
me, I will perform with everything
I have.");
MsgDisp("","Please forgive me.");
MsgClear();
MsgClose();
ScrFadeOut(0);
MsgDisp("","｛主人公苗字｝ ｛主人公名前｝ This heart of
mine, will be with you for all of
eternity.");
MsgClear();
BGMStop();
MsgType(0);
