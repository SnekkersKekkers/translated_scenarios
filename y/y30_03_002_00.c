...
and the gown felt great. I wish they
had given them to me...");
MsgClear();
MsgDisp("","The host listens properly not only to
my answers, but my explanations too.
The audience members are also
delighted.");
MsgDisp("","Because of that, there wasn't
time for the final winner's
interview. I guess that's how
live broadcasts are...");
MsgClear();
MsgClose();
ScrFadeOut(0);
...
Habatcher!\"");
MsgDisp("","She said it while breathing
heavily. She must have ran to catch
up with me.");
