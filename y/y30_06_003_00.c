...
MsgDisp("","I didn't have the leeway to take
the lack of communication as proof
...
I got into my bed at the same time.");
...
MsgDisp("Himuro","\"If I were to contact her now,
how would it go...\"");
MsgDisp("","That thought crossed my mind. Maybe
this is what they mean when they talk
about nighttime tension.");
MsgClear();
MsgDisp("","I was undecided, but 
first of all...
I opened her name in my contacts.");
MsgDisp("","If I lightly press this button
once more, I can connect with her,
who is at a distant place.");
...
MsgDisp("","After talking so much about 
the school trip to everyone, 
