...
MsgDisp("Student A","\"Honestly speaking! That Haba High
...
tidying up!\"");
MsgDisp("","Hey, we're gettin' scolded. It's
because we started talkin' about
stupid things.");
MsgClear();
MsgDisp("","...Might be rude ta call it stupid.");
MsgDisp("","Yesterday's cultural festival. Maybe
I caused some trouble for her?");
MsgClear();
...
there with their jaws dropped,
starin' at us. That's what you call a
dumb look...");
...
she's a special girl to both of the
Shirahane brothers!\"");
