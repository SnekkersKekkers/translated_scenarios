...
SEPlay("EV_SE_820");
ScrFadeIn(0);
MsgDisp("","The day after the Hanegasaki
Academy cultural festival ended.");
...
It's because we started talkin' 
about stupid things.");
MsgClear();
...
MsgClear();
MsgDisp("","Partially forcin' her, 
we took her to Hane high.");
MsgDisp("","Along with big-bro, we hurriedly
dragged her along but....");
MsgDisp("","That's not really enjoyin' 
...
why don't we put it bluntly?\"");
MsgDisp("","...Eh?");
MsgClear();
VoicePlay("Y300800400_09_010");
MsgDisp("Kuya","\"Just tell everyone exactly
what we say at home.\"");
MsgDisp("","Ah!
I see, that's it!");
MsgClear();
VoicePlay("Y300800400_08_010");
MsgDisp("Daichi","\"We're going to tell ya the truth, 
so listen well alright?\"");
