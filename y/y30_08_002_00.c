...
MsgDisp("","Full marks! 100 points,
perfect score!");
MsgClear();
MsgDisp("","I can get full marks in other
subjects, but only in modern
japanese do I misinterpret the same
kind of parts.");
MsgDisp("","Because of that, I'd never once
scored perfect on every subject at
finals.");
MsgClear();
...
MsgClear();
MsgDisp("","...It's childish, huh? Maybe, if I
go to show it to her, I'll get
laughed at.");
...
Academy...");
MsgClear();
MsgDisp("","Before I knew it, I stopped in my
tracks.");
SEPlay("EV_SE_820");
...
MsgDisp("Shirahane","\"Yeah, that's right! There's no point
in thinkin' about that now.\"");
...
MsgDisp("","I need ta hurry, or she might
go home!");
