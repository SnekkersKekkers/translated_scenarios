...
Hazuki Kei.");
MsgClear();
MsgDisp("","...This is a strange feeling. How
should I put it—");
...
MsgClear();
MsgDisp("","I was chosen for a dream feature. I
felt as if I was on par with the
legendary high school model.");
...
MsgDisp("Staff B","\"NANA-kun, are you tired? Let's take
a bit of a break!\"");
...
forming in my head were swallowed
down along with the piping hot
coffee.");
BGMStop();
MsgClear();
MsgClose();
