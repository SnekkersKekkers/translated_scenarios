...
MsgDisp("","The Gardening Club's farming corner. We
planted Nagasaki's specialty bulb.");
MsgDisp("","These are the bulbs left after I gave
some to that girl.");
MsgClear();
SEPlay("EV_SE_821");
Wait(60,0);
MsgDisp("","Another thing to look forward to this
spring. So many plants have taken
root here.");
MsgDisp("","Each one has someone's wishes put into
them. When you look at it like that, it
is divine to look at.");
MsgClear();
SEPlay("EV_SE_627",0,0.6);
SEWait();
MsgDisp("主人公","\"Ah, ｛Mikage＊＊｝! What are you
planting?\"");
MsgDisp("","Perfect timing. That's just the kind
of person she is — it's what makes
her fun.");
MsgClear();
...
bulbs I got as a souvenir from Nagasaki
on our school trip.");
MsgDisp("主人公","\"Can I plant some here too?\"");
MsgDisp("","Her smile is as lively as a plant damp
with morning dew.");
MsgClear();
...
MsgDisp("","Haha, is she walking to get them? She
really is a funny person.");
...
anyone, but whenever I see her, I just
can't help smiling.");
...
our fortunes based on the colour of the
flowers.\"");
MsgDisp("主人公","\"Hehe! Yes, I look forward to it.\"");
SEPlay("EV_SE_SCHOOL_001");
Wait(60,0);
VoicePlay("Y300700300_07_040");
MsgDisp("Mikage","\"That's the warning bell. The afternoon
lessons are starting.\"");
SEStop("EV_SE_SCHOOL_001",4);
MsgClear();
MsgDisp("","In tulip fortune-telling, each colour
has its own meaning in the language of
flowers.");
MsgDisp("","I cheated a little, and gave Miss
Diligent a bulb that would bloom
into pink.");
