...
skilled....");
MsgDisp("","Maybe she's gotten tired of
waiting, and is in the resthouse...
Let me go check.");
MsgClear();
...
BGOpen("ad512",0);
ScrFadeIn(0);
MsgDisp("主人公","\"｛Hiiragi＊＊＊｝, thanks for today. I
had so much fun.\"");
MsgDisp("","She said to me at Habataki
station, looking as if she was
reluctant to part.");
MsgClear();
...
to go.\"");
MsgDisp("主人公","\"Yes, me too. Let's practise
together.\"");
MsgClear();
VoicePlay("Y300500100_05_060");
MsgDisp("Hiiragi","\"Then, let's pray.\"");
MsgDisp("","I gathered the snow at my feet, made
a snowball and showed it to her.");
MsgDisp("主人公","\"Snowball?\"");
MsgClear();
VoicePlay("Y300500100_05_070");
MsgDisp("Hiiragi","\"Yeah. If this doesn't melt by the
time we get back, We'll go to the
advanced course this season.\"");
