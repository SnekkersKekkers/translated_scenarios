...
BGOpen("ad310",0);
ScrFadeIn(0);
MsgDisp("","His swirl is lovely today too. If I
come to the shopping mall, my feet
naturally gravitate here.");
MsgDisp("","In middle school, my Mom told me
about him. Since then, I've often
come here by myself to see him.");
MsgClear();
MsgDisp("","But the other day, for the first
time I took someone outside of my
family here.");
MsgDisp("","｛主人公苗字｝ ｛主人公名前｝.");
MsgClear();
...
middle school? But, it's a little bit
different...)");
MsgDisp("","She nodded happily, and asked
more questions as if she wanted
to hear more.");
MsgClear();
MsgDisp("","I wonder if I'd be able to feel this
strange feeling in my chest again if
