...
MsgDisp("","I was the same. I still can't believe
I took on such a troublesome task.");
MsgDisp("","But, I have no regrets at all.");
MsgClear();
MsgDisp("","At first, I just wanted something
I could report to her. Anything
was fine.");
MsgClear();
...
work, it became exactly the kind
of reassuring news I had hoped to
give her.");
MsgClear();
...
MsgDisp("School Boy","\"Is it really?! I'm glad! Thank you
very much, senpai!\"");
