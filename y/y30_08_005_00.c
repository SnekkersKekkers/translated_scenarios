...
MsgDisp("Girl B","\"Isn't that amazing? For him to wait
...
MsgDisp("Student A","\"Seriously? Well, the track team
should be fine though.\"");
MsgDisp("","...Hmm, now I'm curious. Is the track
and field club at Haba High really
that amazin'?");
MsgClear();
...
of my skin.");
MsgDisp("","Whoa, this teacher is really
tall... And the look in his eyes is
kinda scary?");
MsgClear();
...
MsgDisp("Daichi","\"I'm just waitin' for my friend. I'm
not a shady person...\"");
BGOpen("ad852",0);
...
to see ya, so I waited here. Heheh!\"");
