...
I think Inori-kun wants to go out
together as well.\"");
VoicePlay("Y300700400_07_010");
MsgDisp("Mikage","\"Isn't that nice. Then, are you
inviting me too?\"");
...
little put out. He used to stiffen up
way more though...");
MsgDisp("","Maybe he's opened up considerably.");
MsgClear();
BGOpen("ad742",0);
VoicePlay("Y300700400_07_050");
MsgDisp("Mikage","\"Then, where should the three of
us go?\"");
