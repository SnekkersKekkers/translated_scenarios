...
continued at a steady rhythm.
Somehow, a strange feeling started
to weigh on me.");
...
drink it.");
MsgDisp("","But, it's really strange. I don't
...
changes my tastebuds. What does
it mean?");
MsgClear();
MsgClose();
ScrFadeOut(0);
...
BGOpen("ad221",0);
ScrFadeIn(0);
MsgDisp("","When we left Habataki ranch, she
...
cow milk?\"");
MsgClear();
MsgDisp("","I said I didn't like it if it
was warm— but, I just didn't
like it much.");
MsgDisp("","Even though my Mom told me I needed
to drink it to build muscle when I
was a kid, I didn't drink it very
much...");
MsgClear();
MsgClose();
ScrFadeOut(0);
