...
　　　　　　　　　　 ・
　　　　　　　　　　 ・");
MsgDisp("","That wish of ours quickly turned into
despair.");
MsgClear();
BGOpen("ad111",0);
ScrFadeIn(0);
VoicePlay("Y300100100_47_000");
MsgDisp("Ryota's Mom","\"Sorry, Ryota.
It's because of your father's job.\"");
...
MsgDisp("","I couldn't write or call.
