...
MsgDisp("","The manager noticed that I couldn't
take my eyes off her. That's super
embarrassing...");
MsgDisp("","But, her way of workin' was perfect,
so there was no need ta help her.");
MsgClear();
MsgDisp("","While watchin' her as I did my own
work, an opportunity arose!");
SEPlay("EV_SE_519");
Wait(100,0);
MsgDisp("","I've never seen that car before... A
new customer!");
SEStop("EV_SE_519",3);
...
BGOpen("ad812",0);
ScrFadeIn(0);
MsgDisp("","The road home from work. I found
myself feelin' elated.");
MsgDisp("","Startin' from now, I'll see her twice
a week. I'm gettin' excited to work!");
MsgClear();
