...
BGOpen("ad611",0);
ScrFadeIn(0);
MsgDisp("","Connections, leaking exam questions.
...
MsgDisp("","When I look at the sea, all that
I carry appears small, and I
feel light.");
MsgClear();
...
of myself that was my own. I
challenged myself, getting knocked
down by the waves again and again.");
MsgClear();
MsgDisp("","And then, that time I first rode a
wave...");
MsgDisp("","I experienced a magnificent wave on
a board that was only a few
centimetres thick. I had an
epiphany, feeling as though I had
conquered the entire ocean.");
