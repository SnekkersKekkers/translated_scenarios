...
wouldn't be a bother to anyone.");
MsgDisp("","The reason I woke up from that dream
just a little was, ironically due to
a meeting in that dream world.");
MsgClear();
MsgClose();
ScrFadeOut(0);
MsgDisp("","　　　　　　　　　　 ・
...
ScrFadeIn(0);
MsgDisp("","I always lingered on the internet,
and a guy friend I met there
started talking about meeting up
for real. Honestly, it was a pain,
and I thought about turning him
down, but...");
...
that, aimlessly in front of
Habataki City train station, when a
person I didn't know suddenly
called out to me.");
...
MsgDisp("Man","\"Ah, this is what I do. I am in
...
MsgClear();
MsgDisp("","Since I was young, I found him
stylish. Good looks, great fashion,
and even part non-Japanese. His
...
out the business card that was
crudely crammed into my trouser
pocket.");
MsgDisp("","Model office. If I accept their
offer, I'll become a model too.");
MsgClear();
...
MsgClear();
MsgDisp("","My modelling contract would start
...
MsgDisp("","It's time already∋ I have to hurry
up and head to the shoot.");
