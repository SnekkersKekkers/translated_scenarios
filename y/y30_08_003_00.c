...
MsgDisp("Daichi","\"Haa...\"");
MsgDisp("","I can't believe she was
in this room just now...");
MsgDisp("","Somehow, I feel like her
scent still lingers.");
MsgClear();
...
MsgDisp("Daichi","\"Big bro.
I wonder if I'm fallin' in love.\"");
VoicePlay("Y300800300_09_010");
MsgDisp("Kuya","\"I see how it is.
I think it's a good love.\"");
MsgDisp("","I was so surprised,
I jumped ta my feet from my bed.");
MsgClear();
MsgDisp("","I took a long, hard look at 
big bro who had answered so readily.");
...
MsgDisp("","(*CLICK*)");
MsgDisp("","In his place, big sis
entered my room, smilin' widely.");
MsgDisp("","After this, it goes without sayin' 
that big sis barraged me
with with questions....");
MsgClear();
MsgClose();
BGMStop();
