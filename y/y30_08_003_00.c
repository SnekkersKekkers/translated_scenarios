...
weird feelin'.\"");
MsgClear();
MsgDisp("","Big bro narrowed his eyes warmly and
laughed, \"Haha.\"");
MsgDisp("","That got me going too. \"Hehehe.\"");
MsgDisp("","Right now, I'm so glad Big bro is here.");
MsgClear();
VoicePlay("Y300800300_08_020");
MsgDisp("Daichi","\"Big bro. I wonder if I'm fallin'
in love.\"");
VoicePlay("Y300800300_09_010");
MsgDisp("Kuya","\"I see how it is. I think it's a
good love.\"");
MsgDisp("","I was so surprised, I jumped ta my feet
from my bed.");
MsgClear();
MsgDisp("","I took a long, hard look at big bro who
had answered so readily.");
VoicePlay("Y300800300_08_030");
MsgDisp("Daichi","\"Why...dy'a think that?\"");
VoicePlay("Y300800300_09_020");
MsgDisp("Kuya","\"Big sis said the same thing. I also
think that way.\"");
MsgClear();
MsgDisp("","...Big sis?");
MsgDisp("","We've barely even met face-to-face, and
she only just visited our place for the
first time...");
...
MsgDisp("","(*CLICK*)");
MsgDisp("","In his place, big sis entered my room,
smilin' widely.");
MsgDisp("","After this, it goes without sayin' that
big sis barraged me with questions....");
MsgClear();
MsgClose();
BGMStop();
ScrFadeOut(0);
