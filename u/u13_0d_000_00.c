...
love?");
    ...
    MsgDisp("Hikaru","Right? I wonder if Kazama-kun and
...
Neither too close nor too far.");
    ...
    MsgDisp("Hikaru","Like the main character of a
shoujo manga that can't make up her
mind!");
    StlEye(22,2);
    StlMouth(22,1);
...
No way, Mari.");
    ...
    MsgDisp("Michiru","No, it's okay. I just thought it's
amusing to watch.");
    StlEye(22,1);
    StlMouth(22,1);
    StlCheek(22,5);
    VoicePlay("U130D00000_22_040");
    MsgDisp("Hikaru","Hikaru wants to push you two a bit
more, but sis will get mad if I do.");
    StlEyeOpenLevel(21,0,1);
    StlNear(0,0,15);
...
Their love is good as it is.");
    ...
    MsgDisp("Hikaru","That's how it is. Ok, Hikaru will
keep watching over you two▼");
    StlEyeOpenLevel(21,5,1);
    MsgDisp("主人公","(?
