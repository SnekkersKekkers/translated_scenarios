...
switch (ChPrmGet(4,6)){
    ...
    MsgDisp("Hikaru","Heh～! Minoru-kun is a bit hard
to deal with, isn't he?
Mari, don't give up!");
    StlEyeOpenLevel(21,5,1);
    StlMouth(21,0);
    VoicePlay("U130D00003_21_010");
    MsgDisp("Michiru","He may seem to be unfriendly but
deep down, he's a really kind person.");
    MsgDisp("主人公","(Yeah, I guess I need to be
patient......)");
    break ;
    case 3:
    StlEye(22,0);
    ...
    MsgDisp("Michiru","Recently, it feels like Minoru-kun
is changing.");
    VoicePlay("U130D00003_22_010");
    MsgDisp("Hikaru","Uh-huh, right now it's the 
biggest gossip in the modeling scene!");
    MsgDisp("主人公","Really?");
    StlEye(21,0);
    VoicePlay("U130D00003_21_030");
    MsgDisp("Michiru","I get a much different impression
of him now than when he first started
modeling. Did Mari cause that?");
    StlEye(22,2);
    VoicePlay("U130D00003_22_020");
    MsgDisp("Hikaru","Aha▼ 
Minoru-kun isn't as strong-willed as he
lets on. Fight for it, Mari!");
    StlEye(22,0);
...
behind those glasses he wears.");
    ...
    MsgDisp("Hikaru","At work, he's been taking 
initiative and has become more friendly
with the staff.");
    StlEye(22,2);
    StlMouth(22,0);
    StlCheek(22,7);
    VoicePlay("U130D00003_22_050");
    MsgDisp("Hikaru","You know, and when the staff make
comments about his girlfriend, he starts
blushing! Super cute～♪");
    MsgDisp("主人公","｛七ツ森＊｝ is?
That's hard to believe......");
    ...
    MsgDisp("Michiru","Thanks to Mari, I feel like he's
been reborn in a sense. In a good way,
of course.");
    MsgDisp("主人公","(I see.
