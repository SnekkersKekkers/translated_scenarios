...
still a child at heart. So, perhaps...");
    ...
    MsgDisp("Michiru","For now, I think it's important
to be a good student to Mikage-sensei.");
    MsgDisp("主人公","(Falling in love with a teacher
can be difficult. Be a good student,
huh......)");
    break ;
    case 3:
    StlEye(22,1);
    ...
    MsgDisp("Michiru","I see. I love what
you have with Mikage-sensei.");
    StlEye(22,0);
    StlMouth(22,1);
    VoicePlay("U130D00006_22_010");
    MsgDisp("Hikaru","Hikaru supports it too, romance
...
Mikage-sensei has any special feelings
for Mari, but he does like Mari.♪");
    StlEyeOpenLevel(21,5,1);
    StlMouth(21,0);
    VoicePlay("U130D00006_21_030");
    MsgDisp("Michiru","You should continue to be a good
student to him and treat him a little.");
...
Ok, I'll try my best!)");
    ...
    MsgDisp("Michiru","Mikage-sensei is really starting
to notice Mari.");
    StlEyeOpenLevel(21,5,1);
    StlEye(22,2);
    StlCheek(22,5);
    ...
    MsgDisp("Hikaru","Hikaru was really surprised. His
usual delinquent behavior is a facade.
Deep down he's quite serious, right?");
    StlEye(21,2);
    StlMouth(21,0);
    VoicePlay("U130D00006_21_050");
    MsgDisp("Michiru","He seems to be a bit worried about
his first love and the conflict it has
with his position.");
    StlEyeOpenLevel(22,5,1);
    StlMouth(22,1);
...
to be mindful of his feelings.");
    ...
    MsgDisp("Michiru","That's right. Take his position
into consideration and be mindful of
how he feels, okay?");
    MsgDisp("主人公","(It's important to be considerate
in a student-teacher relationship, huh?)");
    break ;
    default :
    DbgAssert(1);
    break ;
