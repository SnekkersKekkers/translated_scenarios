...
ScrFadeIn(0);
ChMotion(22,3,1);
VoicePlay("U022200002_22_000");
MsgDisp("Hikaru","Summer nights are really the 
...
MsgDisp("Hikaru","I wonder what's going on inside
Mari's heart～?");
MsgDisp("主人公","Um......");
ChEye(22,3);
ChMouth(22,3);
...
MsgDisp("Hikaru","There's a legend about this fountain♪
If you come here on a summer night with
someone you love, they say you'll be
able to know the truth of their heart.");
MsgDisp("主人公","｛ひかる＊｝.
...
If you have a secret, maybe it's about
a boy you like～?");
MsgDisp("主人公","Haha......");
