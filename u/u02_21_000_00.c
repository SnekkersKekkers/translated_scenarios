...
MsgDisp("Michiru","Even if I have trouble choosing 
something I can just ask for your 
advice. We have so much fun chatting.");
MsgDisp("主人公","I agree!");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,4);
...
day. I was able to make friends with a lot of
new stuff, right? ");
MsgDisp("主人公","Yes!");
