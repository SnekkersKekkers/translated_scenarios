...
StlEye(22,1);
StlMouth(22,2);
VoicePlay("U140D00006_22_000");
MsgDisp("Hikaru","Hey.
Mari, haven't you been hanging out with 
sis a lot lately?");
...
How can you just leave Hikaru behind!");
StlEyeOpenLevel(21,5,1);
VoicePlay("U140D00006_21_010");
MsgDisp("Michiru","Sorry. 
But I haven't forgotten about Hikaru.");
MsgDisp("主人公","(It's true, I guess I really 
