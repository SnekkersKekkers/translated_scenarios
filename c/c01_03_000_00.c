...
properly with you?");
MsgDisp("主人公","(Ugh... Seems like he's really mad.
But I need to talk to him properly now...)");
MsgDisp("主人公","Even so, please just listen?
So, uhm...");
MsgDisp("","　　　　　　　　　　 ・
　　　　　　　　　　 ・
　　　　　　　　　　 ・");
...
MsgDisp("Honda","...Sorry!");
MsgDisp("主人公","Eh? Why is ｛Honda＊＊｝ the one saying...");
