...
MsgDisp("Sassa","My senior was giving me advice, but I
couldn't listen.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,2);
...
But I couldn't suppress it or relax.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,0);
...
You would think things over with me, worry
...
I don't know why. I've been thinking about
