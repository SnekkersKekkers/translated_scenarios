...
MsgDisp("Himuro","...That's right. Do you remember? That time I
taught those two how to surf at the beach.
And I stealthily sent you a message—");
MsgClose();
StlOpen("ev_06_20");
StlEye(1,0);
StlMouth(1,0);
...
MsgDisp("Sassa","...Yes, this strengthens your core as you
