...
MsgDisp("Sassa","Maybe. Well then, 
shall these longterm liabilities
go home together? ");
MsgClose();
ScrFadeOut(0);
MsgDisp("","　　　　　　　　　　 ・
...
MsgDisp("Himuro","I'll let Ryota-senpai off the hook,
after all, he was rushing over here 
from England and barely made it.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
...
MsgDisp("Sassa","I understand. Inori, I'll do 
anything you say.");
ChEye(1,0);
ChMouth(1,2);
ChEye(6,0);
...
MsgDisp("Sassa","Right, a man never goes back on
his word. Right, Ryota? ");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,0,1);
ChEyeOpenLevel(1,0);
...
MsgDisp("Himuro","Then, here's a request for 
the three of you.");
ChEye(1,0);
ChEye(2,0);
ChMouth(2,4);
...
I'll forgive you guys for leaving 
me out of the loop.");
ChMotion(1,0);
MsgDisp("主人公","Hehe, that's good. Now, 
