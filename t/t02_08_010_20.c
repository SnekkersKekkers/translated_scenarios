...
MsgDisp("主人公","Ah......that's right. The church and
lighthouse door both opened, right?");
...
ChEye(8,4);
ChMouth(8,3);
MsgDisp("Shirahane","Hey, even when I go to University, 
...
ChMotion(8,2,1);
ChEyeOpenLevel(8,0);
MsgDisp("Shirahane","I'm a beginner boyfriend, 
