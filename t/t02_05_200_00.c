...
MsgDisp("Hiiragi","If it had just been me, I might not have been
able to find you.");
MsgDisp("主人公","Eh?");
ChMotion(5,0);
Wait(16,0);
...
They saw us off, then they said you
were here.");
ChEyeOpenLevel(5,0);
Wait(16,0);
ChEye(5,0);
...
But after this, is a conversation between you
and me.");
MsgDisp("主人公","yes...");
Wait(40,0);
ChEye(5,4);
ChMotion(5,4);
ChEyeOpenLevel(5,0);
VoicePlay("T020520000_05_040");
MsgDisp("Hiiragi","I still can't believe I was able to graduate
with everyone.");
Wait(60,0);
ChMotion(5,0);
ChEyeOpenLevel(5,0);
...
ChMotion(5,0);
ChEyeOpenLevel(5,0);
VoicePlay("T020520000_05_060");
MsgDisp("Hiiragi","But, since I didn't attend elementary or
middle school properly, there was no value in
me being a student.");
MsgDisp("主人公","That's... Even though ｛Hiiragi＊＊＊｝ struggles
within the Theatre Company, I think he gives
it his best in many different ways.");
ChMotion(5,2);
Wait(12,0);
ChEyeOpenLevel(5,9);
...
ChMouth(5,4);
ChEyeOpenLevel(5,10);
VoicePlay("T020520000_05_130");
MsgDisp("Hiiragi","Your smile was my only compass.");
ChMotion(5,0,1);
Wait(16,0);
ChEye(5,4);
ChMouth(5,3);
