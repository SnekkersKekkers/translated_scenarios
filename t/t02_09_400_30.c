...
MsgDisp("Kuya","I was in awe of your kindness, but it wasn't
directed at just me.");
ChEye(9,4);
ChMouth(9,4);
ChEyeOpenLevel(9,0);
...
I feel like I've changed, even just a little,
thanks to you.");
ChEye(9,4);
ChMouth(9,0);
ChMotion(9,0,1);
VoicePlay("T020940030_09_050");
MsgDisp("Kuya","Even with this ending, it doesn't change the
fact that you're special to me.");
ChEye(9,4);
ChMouth(9,4);
ChMotion(9,0,1);
VoicePlay("T020940030_09_060");
MsgDisp("Kuya","If we get accepted to the same university, we
might cross paths a few times there...");
ChEye(9,3);
ChMouth(9,0);
ChMotion(9,4,1);
ChEyeOpenLevel(9,0);
VoicePlay("T020940030_09_070");
MsgDisp("Kuya","But, I would be happy if you would smile like
you have until now ...okay?");
BGMStop(3.6);
MsgClose();
ScrFadeOut(0,1,120);
ChClose(9,0,0);
