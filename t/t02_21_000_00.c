...
ChLayout(1);
ScrFadeIn(0);
VoicePlay("T022100000_21_000");
MsgDisp("Michiru?","I found you.");
MsgClear();
...
MsgDisp("主人公","No. I'm glad you came.
I feel so relieved.");
ChEye(21,2);
ChMouth(21,4);
ChMotion(21,0);
VoicePlay("T022100000_21_030");
...
ChMotion(21,3);
ChCheek(21,0);
VoicePlay("T022100000_21_080");
MsgDisp("Michiru","Hey Mari.
Do you remember the first time we met?");
MsgDisp("主人公","Hehe. I was surprised when you suddenly
started calling me \"Mari\".
...Hey, why did you call me \"Mari\"?");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,0);
VoicePlay("T022100000_21_090");
MsgDisp("Michiru","Hehe. You finally asked.");
MsgDisp("主人公","After all...");
ChEye(21,4);
ChMouth(21,0);
ChMotion(21,0);
VoicePlay("T022100000_21_100");
MsgDisp("Michiru","\"Mari\" is a sound.
When we saw you, Hikaru and I both thought
the same thing.");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,4);
...
MsgDisp("Michiru","Hehe. Mari really is a goddess of happiness.
...
MsgDisp("Michiru","I owe it all to Mari that I was able to have
such a fun high school life. Even after we
graduated, will we still be friends?");
...
ChMouth(21,3);
ChMotion(21,3);
VoicePlay("T022100000_21_170");
MsgDisp("Michiru","Yes! Let's go home.");
MsgDisp("主人公","Hehe!");
BGMStop(6);
MsgClose();
ScrFadeOut(0,1,120);
