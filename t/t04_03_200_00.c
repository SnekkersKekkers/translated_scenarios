...
Do you remember some time ago when Ryo-kun,
Mi-kun and I waved to you from the rooftop?");
MsgClose();
StlOpen("ev_03_21");
...
ScrFadeIn(0);
Wait(60);
MsgDisp("主人公","(Even if you ask me whose telepathy
it was...)");
...
loudly at school, do you?
And Ryo-kun is too cool looking.");
...
MsgDisp("Nanatsumori","Sigh... I'm starting to get confused.");
MsgClose();
BGMStop(5);
ScrFadeOut(0,0,300);
StlClose();
