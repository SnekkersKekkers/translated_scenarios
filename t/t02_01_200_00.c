...
ChMouth(1,2);
ChMotion(1,3);
VoicePlay("T020120000_01_020");
MsgDisp("Kazama","∋
Seriously...?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("T020120000_01_030");
...
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("T020120000_01_040");
MsgDisp("Kazama","Sassa and Inori.
The three of us were looking all over the
school for you and that's when we heard it.");
ChEyeOpenLevel(1,0);
Wait(12,0);
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("T020120000_01_050");
MsgDisp("Kazama","They told me to trust the church legend.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
ChEyeOpenLevel(1,0);
...
ChMouth(1,2);
ChMotion(1,0,1);
VoicePlay("T020120000_01_160");
MsgDisp("Kazama","Now I can finally say it to you.");
Wait(60,0);
ChEyeOpenLevel(1,0);
Wait(12,0);
ChEye(1,4);
