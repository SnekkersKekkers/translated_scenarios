...
MsgDisp("主人公","As for me...thanks to ｛Mikage＊＊｝, I had
a very happy three years of high school.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
ChEyeOpenLevel(7,10);
...
MsgDisp("Mikage","That's my Miss Diligent.");
...
MsgDisp("Mikage","My most precious Miss Diligent.");
MsgClear();
StlEffect(1,1,60);
Wait(60,0);
SEPlay("EV_SE_695");
