...
MsgDisp("Shirahane","I guess this is what it means to be happy...");
MsgDisp("主人公","Hehe.");
NSSEye(8,3);
...
MsgDisp("Shirahane","It's completely different from \"liking\" your
...
MsgDisp("Shirahane","...Ah! Could this be—");
MsgDisp("主人公","Eh?");
NSSEye(8,3);
NSSMouth(8,5);
VoicePlay("T040800000_08_050");
MsgDisp("Shirahane","\"True love\", that's what this is, isn't it?");
NSSEye(8,3);
NSSMouth(8,0);
NSSEyeOpenLevel(8,0);
VoicePlay("T040800000_08_060");
MsgDisp("Shirahane","Yeah! I love you so absurdly much. Hehe▼");
