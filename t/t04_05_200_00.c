...
MsgDisp("Hiiragi","Yes.
I got some advice from Inori-kun, so I could
make everyone understand clearly.");
...
Yanosuke-senpai's simple series of posters.
This gives more time to put it into effect.");
MsgClose();
BGMStop(5);
ScrFadeOut(0,0,300);
StlClose();
VoicePlay("T040520000_05_030");
MsgDisp("Hiiragi","Inori-kun gave me the gift of time.
Thanks to that, I now have a little more time
to spend with you.");
MsgClose();
ScrFadeOut(0,0,300);
Wait(300,0);
