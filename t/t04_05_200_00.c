...
The message you want to deliver is 
just 'don't run in the halls'.");
...
posters. This gives more time to put it
into effect.");
MsgClose();
BGMStop(5);
ScrFadeOut(0,0,300);
...
MsgDisp("Hiiragi","Inori-kun gave me the gift of time. Thanks
to that, I now have a little more time to
spend with you.");
MsgClose();
ScrFadeOut(0,0,300);
Wait(300,0);
