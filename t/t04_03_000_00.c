...
During the christmas party we went to 
the Junior High School library, right?");
MsgDisp("主人公","Yes.
A cute pop-up book.");
NSSEye(3,4);
NSSMouth(3,0);
...
A family of four's christmas 
whilst living in a white house.");
NSSEye(3,0);
NSSMouth(3,0);
VoicePlay("T040300000_03_020");
MsgDisp("Honda","A big tree pops out. When I was younger I
thought it was like my own house.");
