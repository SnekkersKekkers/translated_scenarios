...
ChMotion(6,4);
ChCheek(6,10);
MsgDisp("Himuro","Just hugging people out of nowhere like
that...
What are you thinking∋");
MsgDisp("主人公","I just wanted to express how much I like
...
ChMouth(6,0);
ChMotion(6,0);
MsgDisp("Himuro","So by all of what you did until now, is
that what you meant?");
VoicePlay("T020621000_06_320");
ChEye(6,0);
ChEyeOpenLevel(6,8);
MsgDisp("Himuro","Like the two of us playing together and
...
ChMotion(6,2);
ChCheek(6,0);
MsgDisp("Himuro","What? Hey...Why do I feel like I held back
on all kinds of things for nothing...");
MsgDisp("主人公","Huh?");
