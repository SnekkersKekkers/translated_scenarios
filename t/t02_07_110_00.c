...
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("T020711000_07_010");
MsgDisp("Mikage","Something is wrong with me.
Please forgive me.");
MsgClose();
ScrFadeOut(0,0);
ChClose(7);
...
MsgDisp("Mikage","If I leave my feelings for you at Haba
High, I can't go any further.");
ChEye(7,4);
ChMouth(7,4);
ChMotion(7,0);
VoiceEVSPlay(7);
VoicePlay("T020711000_07_230");
