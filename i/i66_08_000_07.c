...
We look forward to your next visit!");
    ...
    MsgDisp("Shirahane","That regular only comes when
you're on shift, y'know?");
    MsgDisp("主人公","Really?");
    ChEye(8,3);
    ChMouth(8,3);
    ChMotion(8,0,1);
    VoicePlay("I660800007_08_020");
    MsgDisp("Shirahane","Rumor has it that our stand has a
cute attendant. Th' increase in
customers has our manager happy, too.");
    MsgDisp("主人公","That's......");
    ChEye(8,3);
    ChMouth(8,3);
    ChMotion(8,3,1);
...
We look forward to your next visit!");
    ...
    MsgDisp("Shirahane","That regular only comes on days
you're working.
What a perv.");
    MsgDisp("主人公","Huh∋");
    ChEye(8,3);
    ...
    MsgDisp("Shirahane","The manager's happy that our
customers and sales are up 'cuz of you,
but......");
    ChEye(8,2);
    ChMouth(8,4);
    ChMotion(8,4,1);
    ...
    MsgDisp("Shirahane","......Wait, as if I got the time to
be gettin' jealous of the customers!
Get it together, me!");
    ChEye(8,2);
    ChMouth(8,0);
    ChMotion(8,0,1);
