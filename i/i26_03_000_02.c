...
customers, right, ｛本多＊＊｝?");
    ...
    MsgDisp("Honda","But, finding things to do and
doing it on your own means you're
getting used to your job, right?");
...
Let's get the manager's approval
and put it out properly.");
    ChEye(3,2);
    ChMouth(3,4);
    ChMotion(3,4,1);
    VoicePlay("I260300000_03_270");
    MsgDisp("Honda","Small publishers are putting out
great books that get buried under
promotions for bigger books.");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,1,1);
    VoicePlay("I260300000_03_280");
    MsgDisp("Honda","I've made pop ads in the past
...
it, it was all full of words.");
    ...
    MsgDisp("Honda","Compared to that, yours is easy
to read and the content is perfect.");
    MsgClose();
