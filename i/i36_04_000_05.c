...
I think it's fine if you just leave
that on the table.");
    MsgDisp("主人公","Okay.
I'll do that.");
    ChEye(4,4);
    ...
    MsgDisp("Nanatsumori","Nah, I just felt the power of
the service industry. Impressive.");
    MsgDisp("主人公","(Hehe!
｛七ツ森＊｝ praised me.
I did it!)");
    break ;
...
I came to deliver this!");
    MsgDisp("主人公","......Hm?　There aren't many people
around.
Did you just get on break?");
    ...
    MsgDisp("主人公","Then, I'll leave the food and
drinks here. I'll come to collect the
empty dishes later. Until then......");
    ChEye(4,4);
    ChMouth(4,2);
    ChMotion(4,1,1);
