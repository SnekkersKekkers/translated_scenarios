...
that smile ups your ability to
attract customers.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,1,1);
...
Are you looking for something?");
    ...
    MsgDisp("Honda","I was just passing through,
and I saw you in the store.");
    ChEye(3,4);
    ChMouth(3,0);
    ChMotion(3,4,1);
    VoicePlay("I150300000_03_060");
    MsgDisp("Honda","Then, trying to see
what was going on, I just came in.");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,2,1);
    VoicePlay("I150300000_03_070");
    MsgDisp("Honda","Ah, but I feel bad
leaving without buying anything......");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,1,1);
    VoicePlay("I150300000_03_080");
    MsgDisp("Honda","Ah, this looks useful! I was
just thinking of getting a notebook
to jot down my thoughts on my walk.");
    MsgDisp("主人公","(Hehe, I'm glad he found
something he liked!)");
    break ;
    case 4:
    case 5:
...
It was in a magazine my younger sis
was reading. So it's already in stock.");
    MsgDisp("主人公","Hehe, thanks!");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,4,1);
    VoicePlay("I150300000_03_120");
    MsgDisp("Honda","Hm, it doesn't really stand out
over there, so maybe you could add a
recommendation or adjust the layout?");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
    VoicePlay("I150300000_03_130");
    MsgDisp("Honda","I think it'll appeal
to more customers that way.");
    MsgDisp("主人公","I see. I'll talk to my manager
about it. Thanks!");
    ChEye(3,3);
    ChMouth(3,3);
    ChMotion(3,3,1);
...
Well, keep up the good work.");
    MsgDisp("主人公","(......Hm?　Did he really just
come here to give me advice?
｛本多＊＊｝ is so kind......)");
    break ;
    default :
    DbgAssert(1);
