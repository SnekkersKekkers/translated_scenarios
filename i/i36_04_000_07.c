...
switch (ChPrmGet(4,6)){
    ...
    case 2:
    case 3:
    MsgDisp("主人公","(Today, I have to deliver coffee
and snacks to ｛七ツ森＊｝'s
modeling agency.)");
...
I'm delivering from Cafe Alucard.");
    MsgDisp("主人公","Hm?
There's no one here, I wonder
if they're all on break......");
...
And......");
    MsgDisp("主人公","The manager is thankful for your
continued patronage and added these new
sweets. Please enjoy them if you'd like.");
    ChEye(4,3);
    ChMouth(4,4);
    ChMotion(4,0,1);
    VoicePlay("I360400007_04_020");
    MsgDisp("Nanatsumori","Seriously godly...... Manager, thank
you...... please tell them that.");
    ...
    MsgDisp("Nanatsumori","Is your smile also part
of the special service we're getting?");
    MsgDisp("主人公","Hm?");
    ChMotion(4,2,1);
...
Thanks.");
    ...
    MsgDisp("主人公","The manager of Alucard also added
some new sweets to the delivery as a
service. Please enjoy it with everyone.");
    ChEye(4,2);
    ChMouth(4,3);
    ChMotion(4,0,1);
...
I'm happy, I guess?");
    MsgDisp("主人公","?
I thought you'd be the most happy
about this, ｛七ツ森＊｝......");
    ChEye(4,4);
