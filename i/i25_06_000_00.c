...
You work here?");
    MsgDisp("主人公","Yeah.
You're looking for the reference book
corner, right? I'll take you there.");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0);
...
See you.");
    ...
    BGMStop();
    ChClose(6);
    MsgDisp("主人公","(I thought he was looking for it,
...
Are you shopping?");
    ...
    MsgDisp("Himuro","You could also say I'm checking
if there are any people bothering you
at work.");
    MsgDisp("主人公","Geez.");
    ChEye(6,0);
    ChMouth(6,0);
...
I still have a long way to go.");
    ...
    MsgDisp("Himuro","That's a natural feeling when
you're learning. As long as it doesn't
bother you too much, you'll be fine.");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0,1);
...
award-winning novel?");
    MsgDisp("主人公","Ah, that novel has a special
display next to the entrance.");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0);
...
Looking good.");
    ...
    MsgDisp("Himuro","......By the way, how far are you
planning to carry all those books?");
    MsgDisp("主人公","Ah, um,
...
I wouldn't be doing my job if I didn't.");
    ...
    MsgDisp("主人公","It's hard work, but it's worth
doing, you know?");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0);
