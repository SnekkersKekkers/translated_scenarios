...
I'll look 'em up and give 'em a call.");
    ...
    MsgDisp("Shirahane","It's rare seeing ya make a mistake
like that.
...
I would've noticed if I had looked
over at you, ｛大地＊＊｝......");
    ChEye(8,0);
    ChMouth(8,0);
    ChMotion(8,0,1);
    ...
    MsgDisp("Shirahane","Then from now on, you should jus'
keep making eye contact with me!
Yeah?");
