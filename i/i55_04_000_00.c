...
go with coffee?");
    MsgDisp("主人公","Yes, we do. I recommend these
small daifuku, made with citrus zest,
fresh cream, and sweet bean paste.");
    ChEye(4,4);
    ChMouth(4,1);
    ChMotion(4,0,1);
    VoicePlay("I550400000_04_060");
    MsgDisp("Nanatsumori","I'll drool just listening to you......");
    MsgDisp("主人公","Hehe! I have other
recommendations if you'd like?");
    ...
    MsgDisp("Nanatsumori","Ah, keep one of those daifuku for
me. Now tell me about the next one.");
    MsgDisp("主人公","(Hehe.
...
Welcome!");
    ...
    MsgDisp("Nanatsumori","Hm. I thought someone was calling
me from inside the store.
Was it the Japanese sweets, or you?");
    MsgDisp("主人公","Hehe, thank you for your
continued patronage!
...
......How about you?");
    ...
    MsgDisp("Nanatsumori","What do you eat when you're
...
A very good mood, and kinda happy......");
    ...
    MsgDisp("Nanatsumori","Well, anything you'd choose for
me would be the correct answer, though.");
    MsgDisp("主人公","(Is ｛七ツ森＊｝ testing me?
Alright, I'll choose something that
