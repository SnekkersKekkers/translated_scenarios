...
MsgDisp("Manager","Then, would it be alright to have you come
in every Tuesday and Thursday?");
...
Princess Tsubaki Japanese Sweets on
Tuesday and Thursday. I'll do my best!");
MsgClose();
