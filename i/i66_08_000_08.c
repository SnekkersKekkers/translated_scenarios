...
Time for us high schoolers to get home.");
    ...
    MsgDisp("Shirahane","Though I wanna stay with ya
...
we have some tea together?");
    ...
    MsgDisp("Shirahane","Doesn't it seem like the manager
really likes us both?
Haha!");
    MsgDisp("主人公","(Hehe!
...
My heart's poundin'-");
    ...
    MsgDisp("Manager","You two over there,
save that for after work!");
    MsgDisp("主人公","......Looks like the manager
got mad at us?");
    ChEye(8,2);
    ChMouth(8,4);
    ChMotion(8,4,1);
...
That's their playing voice,
they're not actually mad.");
    ChEye(8,2);
    ChMouth(8,3);
    ChMotion(8,0,1);
    VoicePlay("I660800008_08_110");
    MsgDisp("Shirahane","The other day, they even said
\"if you two take over this place, I can
finally retire\".");
    MsgDisp("主人公","Huh?");
    ChEye(8,3);
    ChMouth(8,3);
    VoicePlay("I660800008_08_120");
    MsgDisp("Shirahane","We're being relied on,
th' two of us.
So, don't worry 'bout it.");
    ...
    MsgDisp("Shirahane","......But I don't really wanna take
over the store, do you?
Right?");
