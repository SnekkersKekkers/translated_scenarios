...
Are you shopping, ｛柊＊＊＊｝?");
    ...
    MsgDisp("Hiiragi","Yes, our troupe is quite large,
so there is much we need.");
    MsgDisp("主人公","It seems hard.");
    ChMotion(5,4);
    VoicePlay("I150500000_05_020");
    MsgDisp("Hiiragi","Not at all, shopping is 
quite fun, is it not?");
    ChEye(5,0);
    ChMotion(5,0);
    VoicePlay("I150500000_05_030");
    MsgDisp("Hiiragi","Incidentally, would you happen
to have 10 hangers here?");
    MsgDisp("主人公","Hangers?
We don't carry household goods.");
    ...
    MsgDisp("Hiiragi","Ah, I see. I had just heard of General
Store Simon......");
    ChEye(5,0);
    ChMouth(5,4);
    ChMotion(5,0);
    ...
    BGMStop();
    ChClose(5);
    MsgDisp("主人公","(｛柊＊＊＊｝ looks busy. ......But it
looks like he likes shopping?)");
    break ;
    case 3:
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_COME_ALONE");
...
｛柊＊＊＊｝?");
    ...
    MsgDisp("Hiiragi","No.
I'm having fun simply watching
this shop.");
    ChEye(5,2);
    ChMouth(5,4);
    ChMotion(5,4);
    ...
    MsgDisp("Hiiragi","Ah, but this may put a damper
on the mood of the store.");
...
something specific today?");
    ...
    MsgDisp("Hiiragi","No, while I was out shopping,
your face suddenly came to my mind, and-");
    ChMotion(5,0);
    ...
    MsgDisp("Hiiragi","Heheh, if you think about it,
I suppose you were the thing
I was searching for?");
    MsgDisp("主人公","Huh!?");
    ChEye(5,0);
    ChMotion(5,4);
    VoicePlay("I150500000_05_150");
    MsgDisp("Hiiragi","As I have fulfilled my objective,
I will go ahead and take a look
around the store before heading home.");
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    BGMStop();
    ChClose(5);
    MsgDisp("主人公","(｛柊＊＊＊｝,
does that mean he came to see me??)");
    break ;
    default :
    DbgAssert(1);
    break ;
