...
Thanks.");
    ...
    MsgDisp("Mikage","......Are you curious who
I'm giving it to?");
    ...
    MsgDisp("Mikage","There's a baby shower at
my parent's place. I was going to take a
picture of the bouquet and send that.");
    MsgDisp("主人公","Congratulations!");
    ChEye(7,2);
    ChMouth(7,3);
    ChMotion(7,1);
    VoicePlay("I450700000_07_100");
    MsgDisp("Mikage","I wanted to send the real bouquet,
but it'd get eaten, right?");
    MsgDisp("主人公","(Eaten??
...
Welcome!");
    ...
    MsgDisp("Mikage","Oh, you've completely become
a proper clerk.");
...
okay?");
    ...
    MsgDisp("Mikage","Then, I'll request a flower
arrangement to put on the desk in
the staff room.");
...
and just seeing it will cheer us up.");
    MsgDisp("主人公","Yes. I hope that this will
make the staff room even a little more
comfortable for you, ｛御影＊＊｝.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,0);
    ChEyeOpenLevel(7,8);
