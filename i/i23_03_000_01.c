...
today, was that you?");
    MsgDisp("主人公","Yes, it's me. ｛Honda＊＊｝, I'm looking
...
at the same part-time job.");
    ...
    MsgDisp("Honda","Me too. Did the manager already show you
the ropes? Should I explain?");
    MsgDisp("主人公","Yeah, could you?");
    ChEye(3,3);
    ChMouth(3,3);
    ChMotion(3,3,1);
    VoicePlay("I230300000_03_040");
    MsgDisp("Honda","Of course. You don't need to understand
everything right away, so ask me if you
have questions, okay?");
    MsgDisp("主人公","Thanks!");
    MsgDisp("主人公","(Alright, I'll do my best!)");
    break ;
...
me to do the heavy lifting.");
    ...
    MsgDisp("Honda","Ah, just saying, but don't expect to do
