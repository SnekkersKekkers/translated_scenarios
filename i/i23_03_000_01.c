...
the same part-time job.");
    ...
    MsgDisp("Honda","Me too.
Did the manager already show you the ropes?
Should I explain?");
...
You don't need to understand everything right
away, so ask me if you have questions, okay?");
    MsgDisp("主人公","Thanks!");
    MsgDisp("主人公","(Alright, I'll do my best!)");
    break ;
    case 4:
...
Welcome.");
    ...
    MsgDisp("Honda","But you know, working here made me realise
