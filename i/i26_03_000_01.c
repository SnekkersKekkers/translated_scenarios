...
so at this rate......");
    ...
    MsgDisp("Honda","I know that work might be
hard at first, since you just started.");
    ChMotion(3,0,1);
    VoicePlay("I260300000_03_140");
    MsgDisp("Honda","But you can't just try hard,
you have to rest properly, too.");
    MsgDisp("主人公","......Okay.
...
\"Draw your favorite person\" contest
here, right?");
    ChEye(3,3);
    ChMouth(3,3);
    ChMotion(3,3,1);
    VoicePlay("I260300000_03_170");
    MsgDisp("Honda","Yeah! As a small, local bookstore,
...
with the community!");
    ...
    MsgDisp("Honda","......And, the manager planned
the event, right?
I heard a lot of people applied.");
    MsgDisp("主人公","Right.
About that, one of the little girls
...
She captured your traits well!");
    ...
    MsgDisp("Honda","This means that there are people
who recognize your hard work.");
    ChEye(3,4);
    ChMouth(3,3);
    ChMotion(3,4,1);
