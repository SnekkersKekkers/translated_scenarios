...
If you go all out, there's going to
be a traffic jam in this area.");
    MsgClose();
...
What's up?");
    ...
    MsgDisp("Kazama","What.
Is it that weird that I'd come to
a gas station?");
...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Kazama","......Haa, thanks for the full tank
of high octane.");
    MsgDisp("主人公","Huh?");
    ChEye(1,0);
    ChMouth(1,3);
    ...
    MsgDisp("Kazama","Just seeing your smile like this
means I'll be okay for a while.");
    MsgDisp("主人公","｛風真＊＊｝?");
    ChEye(1,4);
    ChMouth(1,2);
    ChMotion(1,0);
    VoicePlay("I650100000_01_100");
    MsgDisp("Kazama","Ah, but careful you don't do
this too much for other customers, okay?
See you.");
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    BGMStop();
...
｛風真＊＊｝ could be fully refueled
with just a smile, you know?)");
    break ;
    case 4:
    case 5:
    SEPlay("EV_SE_657");
...
......Hey, does that guy come often?");
    ...
    MsgDisp("Kazama","What are you going to do if you
get caught up by something like that
when I'm not here?");
...
......Geez. Don't make me worry.");
    MsgDisp("主人公","They jokingly ask me if I want
a ride pretty often.");
    ChEye(1,0);
    ChMouth(1,2);
    ChMotion(1,3);
    ...
    MsgDisp("Kazama","Listening? Your powers of
attraction work on all ages.
...
See you.");
    ...
    BGMStop();
    ChClose(1);
    MsgDisp("主人公","(Geez...... I can't help customers
with an angry face.)");
    break ;
    default :
    DbgAssert(1);
