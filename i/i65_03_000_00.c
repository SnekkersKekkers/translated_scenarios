...
What's up?");
    ...
    MsgDisp("Honda","I was just passing by when I remembered
that you work part-time here.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,1,1);
...
to the job, too.");
    ...
    MsgDisp("Honda","But, I'm sure you'll pick it up quickly.
Good luck!");
    ...
    MsgDisp("Honda","I heard you were working part-time here,
so I thought I'd check on you.");
    ChEye(3,4);
    ChMouth(3,3);
    ChMotion(3,0,1);
    VoicePlay("I650300000_03_060");
    MsgDisp("Honda","But I'm not used to seeing you in those
clothes, so I thought it was someone else.");
...
...... But, I'm a little surprised.");
    ...
    MsgDisp("Honda","Working at a gas station must be pretty
hard work, so I thought that all the staff
here would be male.");
    MsgDisp("主人公","Aah, I see what you mean.
But my work mostly just involves cleaning
the car windows.");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,0,1);
    VoicePlay("I650300000_03_100");
    MsgDisp("Honda","But weren't you the one carrying tires
around earlier?");
    MsgDisp("主人公","You saw?");
    ChEye(3,4);
    ChMouth(3,4);
    ...
    MsgDisp("Honda","Yeah. Aren't they pretty heavy? You know,
you'll hurt your back if you carry them
