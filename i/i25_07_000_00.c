...
Is that so?　I like books, so......");
    ...
    MsgDisp("Mikage","Making friends at school and at work
is something you can only do now, right?
Keep it up.");
    MsgDisp("主人公","Ah, okay.");
    ChEye(7,0);
    ChMouth(7,0);
    ...
    ChClose(7);
    MsgDisp("主人公","(Huh...... ｛御影＊＊｝,
didn't you come to look for books?)");
    MsgClose();
    ScrFadeOut(0,0);
    break ;
    case 3:
...
serious girl.");
    ...
    MsgDisp("Mikage","I was in the area, so I thought
I'd come by. Show me how you work
for a bit.");
    MsgDisp("主人公","Huh?");
    ChEye(7,2);
    ChMouth(7,0);
...
Excuse me.");
    ...
    MsgDisp("Mikage","Maybe I'll get a part-time job
somewhere too?");
    MsgDisp("主人公","Huh!?");
    ChEye(7,0);
    ChMouth(7,3);
...
a part-time job?)");
    ...
    case 4:
    case 5:
    MsgDisp("主人公","(Haa, there were a lot of
customers today.)");
    MsgClose();
    BGMPlay("BGM_C07_MIKAGE_A",0.01);
    ChOpen(7,255,0,0,0,-1,-1,0,0);
...
Sorry if I bothered you. See you.");
    ChClose(7);
    MsgDisp("主人公","Ah, ｛御影＊＊｝......
Thank you very much!");
    MsgDisp("","　　　　　　　　　　 ・
...
The store might finally be calming down.)");
    MsgDisp("主人公","(｛御影＊＊｝ came all that way
just to check on me......)");
    VoicePlay("I250700000_42_010");
    MsgDisp("Manager","Just now, your homeroom teacher
came by with gifts for everyone.");
    MsgDisp("主人公","Huh?
｛御影＊＊｝ brought gifts?");
