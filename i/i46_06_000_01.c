...
Maybe it wasn't watered enough.");
    MsgDisp("主人公","Should we check the other flowers
and report to the manager?");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,3);
    VoicePlay("I460600001_06_010");
    MsgDisp("Himuro","\"Should we\"? It's a given.
...
better and better.");
    ...
    MsgDisp("主人公","I wonder if we can learn that
technique, too?");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,2);
    ...
    MsgDisp("Himuro","Learning things halfway
...
I'll need to learn.");
    ...
    MsgDisp("Himuro","But, in your case, I think a little
less sociability might do you some good.");
    MsgDisp("主人公","Huh, why?");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,4);
