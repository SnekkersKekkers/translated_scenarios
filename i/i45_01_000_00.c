...
Welcome!");
    ...
    MsgDisp("Kazama","I came to order a flower
arrangement today.");
...
From a long time ago.");
    ...
    MsgDisp("Kazama","Something I feel like I can give as a
celebratory gift, please.");
...
Since I decided to take it for myself.");
    ...
    MsgDisp("Kazama","Yeah, I'm not giving your masterpiece to
anyone else.");
    ChEye(1,0);
    ChMouth(1,0);
    ChMotion(1,0);
