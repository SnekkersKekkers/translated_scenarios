...
for the theater company staff as well.
Not all of it is for myself.");
    MsgDisp("主人公","Hehe. Yes, of course.
You won't be able to finish all that
on your own.");
    ChEye(5,3);
    ChMouth(5,2);
    ChMotion(5,0);
...
Excuse me.");
    ...
    ChClose(5);
    MsgDisp("主人公","(｛柊＊＊＊｝,
so you're going to be eating it all
by yourself......)");
    break ;
    case 3:
    MsgClose();
...
recommendations?");
    MsgDisp("主人公","Interesting...... ah,
how about chocolate fugashi?");
    ChEye(5,3);
    ChMouth(5,3);
    ChMotion(5,3);
    VoicePlay("I550500000_05_100");
    MsgDisp("Hiiragi","And just what is that irresistable
snack? It is as though I can already
feel its deliciousness in my mouth.");
    MsgDisp("主人公","Hehe.
...
The karinto manju has been surpassed.");
    ...
    MsgDisp("Hiiragi","The chocolate seeped into the layers
of the fugashi and hardened there.
I'll take 20 to go.");
...
Today's goal is neither karinto manju
nor chocolate fugashi.");
    MsgDisp("主人公","Really?");
    ChEye(5,3);
    ChMouth(5,4);
    ChMotion(5,0);
    VoicePlay("I550500000_05_150");
    MsgDisp("Hiiragi","Indeed. I had wanted to head home
with you. My rehearsal just finished
a few minutes ago.");
    ChEye(5,4);
    ChMouth(5,2);
    VoicePlay("I550500000_05_160");
    MsgDisp("Hiiragi","Perhaps, you simply think that I
frequent here simply due to a love
for Japanese confections?");
...
Let us talk at length about this
on our way back.");
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    BGMStop();
