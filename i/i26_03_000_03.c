...
I'm sorry!");
    ...
    MsgDisp("Honda","No, I should've written it on the box.
Sorry.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
...
The register was so busy...");
    ...
    MsgDisp("Honda","There's no helping it if you were busy.
But, just tell me sooner next time.");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,1,1);
...
MsgDisp("Honda","Well, I'm going to go organize the
shelves!");
MsgClose();
