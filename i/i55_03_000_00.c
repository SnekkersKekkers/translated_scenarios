...
What's up?");
    ...
    MsgDisp("Honda","I found you when I was passing by
earlier. You should've told me that you
got a part-time job here!");
    MsgDisp("主人公","It's a little embarrassing
to go out of my way to tell you......");
    ChEye(3,4);
    ChMouth(3,4);
    ChMotion(3,4,1);
...
Work hard, 'kay? See you.");
    MsgDisp("主人公","(It suits me......
It makes me happy that ｛本多＊＊｝
said that.)");
    break ;
    case 3:
    ChEye(3,0);
...
Welcome.");
    ...
    MsgDisp("Honda","I was thinking of buying some
Japanese sweets as a gift, and I
remembered that you work here.");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,1,1);
...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Honda","Thanks! Your sense for this kind
of thing is good.
...
Running an errand?");
    ...
    MsgDisp("Honda","Right, right. Getting some snacks
to go with tea for the guests
...
The mild sweetness makes it popular
...
You're getting used to customer service,
huh? You know a lot about the products.");
    MsgDisp("主人公","I won't give you anything even
if you compliment me, you know?");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,4,1);
    VoicePlay("I550300000_03_130");
    MsgDisp("Honda","I meant what I said. Rather than
just promoting it because it's new,
you actually know what's special about it.");
    MsgDisp("主人公","Hehe, thanks. ......By the way, are you
doing okay on time?");
    ChEye(3,5);
    ChMouth(3,4);
    ChMotion(3,5,1);
