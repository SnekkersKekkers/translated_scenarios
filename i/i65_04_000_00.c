...
But, he came to check on me, right?)");
    ...
    MsgDisp("主人公","｛七ツ森＊｝! Are you about to go on a
trip?");
    ChMotion(4,1,1);
...
hands. Care for them with this.");
    MsgDisp("主人公","Yeah. Waah, it really does smell
good......! Thanks!");
    ChEye(4,3);
    ChMouth(4,3);
    ChMotion(4,1,1);
...
this, so I could wait for you......");
    MsgDisp("主人公","(｛七ツ森＊｝? He came to cheer me on,
right? I'm so happy he gave me hand
cream!)");
    BGMStop();
    break ;
    default :
