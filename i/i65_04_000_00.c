...
Welcome!");
    ...
    MsgDisp("Nanatsumori","I just headed this way
'cuz I saw you.
...
Taking some pictures in the night view.");
    MsgDisp("主人公","I see. So there are shoots that
take place late at night, too.
...
but I'll cheer you on. Do your best.");
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    BGMStop();
    MsgClose();
    ChClose(4,0,30);
...
Um, not for another hour......");
    ...
    MsgDisp("Nanatsumori","I wish I had a real car for times
like this, so I could wait for you......");
    MsgDisp("主人公","(｛七ツ森＊｝?
