...
MsgDisp("主人公","Um...... I was thinking of quitting
my part-time job......");
...
I just about stopped breathing......");
    ...
    SEWait();
    MsgDisp("主人公","(Yeah, let's keep this part-time
job a little longer.)");
    break ;
    case 1:
...
I'll tell the manager.");
    ...
    MsgDisp("Shirahane","We won't be seeing each other,
I guess......
See ya.");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
    MsgDisp("主人公","It's not like we can't-
｛大地＊＊｝ seemed really sad......
