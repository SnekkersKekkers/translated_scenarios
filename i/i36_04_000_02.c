...
in a cafe?");
    MsgDisp("主人公","I was taking care of the plants
earlier, so I guess that's when it
happened.");
    ChEye(4,0);
    ChMouth(4,3);
    ChMotion(4,0,1);
...
　　　　　　　　　　 ・");
    ...
    MsgDisp("主人公","Uh.
Why did you start laughing after
you saw my face?");
    ChEye(4,0);
    ChMouth(4,3);
    ChMotion(4,0,1);
...
taking care of them. You're good.");
    MsgDisp("主人公","(I'm so happy to get such
a good compliment!)");
    break ;
    default :
    DbgAssert(1);
