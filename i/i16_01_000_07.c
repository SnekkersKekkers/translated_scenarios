...
reputation for being a good mentor.
Kind and polite, they say.");
    MsgDisp("主人公","Really?
It must be because everyone is
a good student.");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,3);
    ...
    MsgDisp("Kazama","Wow.
Then, maybe I'll ask you to teach
me too, next time?");
    MsgDisp("主人公","(There's nothing I can teach you,
｛風真＊＊｝......! But, I'm happy everyone
is saying that.)");
    break ;
    case 4:
    case 5:
...
Thanks to their mentor.");
    ...
    MsgDisp("Kazama","Having you as their partner really
helps. The newcomers are being
trained well.");
    MsgDisp("主人公","Thanks......
Hearing you say that makes me happy.");
    ...
    MsgDisp("主人公","(It makes me a little shy
