...
Welcome!");
    ...
    MsgDisp("主人公","Hm, but, I am working at this
store, so......");
    ChEye(4,2);
    ChMouth(4,2);
    ChMotion(4,1,1);
...
but...... Good luck with work. See you.");
    ...
    BGMStop();
    ChClose(4,0,30);
    MsgDisp("主人公","(I get it. ｛七ツ森＊｝ is a popular model,
after all.)");
    break ;
    case 3:
    MsgClose();
...
How's it going?");
    MsgDisp("主人公","There were a lot of customers
today, so it might be busy.");
    ChEye(4,0);
    ChMouth(4,0);
    ChMotion(4,0,1);
    VoicePlay("I150400000_04_060");
    MsgDisp("Nanatsumori","I see.
Working without any hiccups is a
good thing.");
...
you sound like a teacher, you know?");
    ...
    MsgDisp("Nanatsumori","I have more work experience
than you, you know.
Well, do your best until you're off.");
    ...
    BGMStop();
    ChClose(4,0,30);
    MsgDisp("主人公","(Could it be that ｛七ツ森＊｝
came to check on me?)");
    break ;
    case 4:
    case 5:
...
Thanks.");
    ...
    MsgDisp("Nanatsumori","......Ah, that product over there
is pretty hot on the market right now.
Nice. The display's good, too.");
    MsgDisp("主人公","Really?
I set that display.
I'm glad!");
    VoicePlay("I150400000_04_110");
    MsgDisp("Nanatsumori","I like the product and the way
it's presented, too.
