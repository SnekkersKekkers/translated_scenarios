...
MsgDisp("Woman Customer","Thank you for helping me choose
the sweets.");
MsgDisp("主人公","Not at all. It's fine as long as
you know what kind of sweets you'd like.
Please feel free to ask for help.");
VoicePlay("I562100008_49_010");
MsgDisp("Woman Customer","Oh, is that so? I'll leave it to you next
time, too, then. Thank you.");
...
MsgDisp("Michiru","She always makes sure to ask you
to choose sweets for them, Mari.
Seems like she likes your taste.");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,3);
VoicePlay("I562100008_21_030");
MsgDisp("Michiru","You've already become such
a charismatic saleswoman, hm?
I'm counting on you.");
