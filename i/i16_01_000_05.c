...
Even though I ordered extra...");
    ...
    MsgDisp("主人公","Ah, now that you mention it, didn't
the orange rhinestone bag sell out
quickly, too?");
    ChEye(1,0);
    ChMouth(1,2);
    ChMotion(1,3);
...
for right now?");
    ...
    MsgDisp("Kazama","Shall we take the chance and order more
expensive rhinestone bags?");
