...
unwell. To get so caught up in talking...");
...
MsgDisp("Hiiragi","Yes, these past few days,
I have come to understand something.");
MsgDisp("主人公","Understand something?");
ChEye(5,4);
ChMouth(5,4);
VoicePlay("M010500000_05_060");
MsgDisp("Hiiragi","Despite knowing you were absent,
my eyes were seeking you out.");
ChEye(5,2);
ChMotion(5,1);
VoicePlay("M010500000_05_070");
MsgDisp("Hiiragi","I became a wandering-eyed,
and strange person.");
MsgDisp("主人公","Hehe, ｛柊＊＊＊｝, that doesn't sound like you.");
ChEye(5,0);
ChMotion(5,0);
VoicePlay("M010500000_05_080");
MsgDisp("Hiiragi","With that,
a smile that is more like you 
...
If you don't recover soon, I will
be established as a shifty-eyed oddity.");
