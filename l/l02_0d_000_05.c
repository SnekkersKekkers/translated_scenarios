...
It's our last Valentine's in high school, are
you ready?");
...
MsgDisp("Michiru","Since it's the last one, I really wanted to
make chocolate together, but...you know?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("L020D00005_22_010");
MsgDisp("Hikaru","But Hikaru would be happy receiving chocolate
from Mari too▼
Right?");
