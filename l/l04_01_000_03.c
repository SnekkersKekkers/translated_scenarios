...
It feels like you know everything about
me, almost uncomfortably so. Almost.");
...
Remember this, okay?");
    ...
    BGMStop();
    ChClose(1);
    MsgDisp("主人公","(I don't know if he's being
sincere or just teasing, but
he looked super happy!)");
    MsgClose();
    ScrFadeOut(0,0);
    break ;
    case 4:
    ...
    MsgDisp("Kazama","You incorporated my tastes,
so I know it's handmade, but......
...
Thank you.");
    ...
    MsgDisp("Kazama","Stupid, I'm the one who should be
saying that, right?
Thank you.");
    ...
    MsgDisp("Kazama","I can't break it, and biting is
out of the question.
What should I do......");
    MsgClose();
