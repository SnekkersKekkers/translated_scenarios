switch (ChPrmGet(2,6)){
    ...
    MsgDisp("主人公","If you're wondering, I did
make these myself......");
    ChEye(2,0);
    ChMouth(2,0);
    ChMotion(2,0);
...
I'm happy about your feelings.");
    ...
    ChClose(2);
    Wait(30);
    MsgDisp("主人公","(Ha...... maybe I should've given
...
I kinda like how it feels like it's
...
you know?");
    ...
    MsgDisp("Sassa","In any case, I'm happy
that you spent your time on me.
Thanks.");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,3);
    ...
    MsgDisp("主人公","You don't have to force yourself
to eat it, okay?");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,4);
...
Even if you didn't say anything, I'd
eat it, you know?");
    ChEye(2,0);
    ChMouth(2,0);
    ChMotion(2,4);
    VoicePlay("L040200006_02_110");
    MsgDisp("Sassa","......Just checking,
but there's nothing but chocolate in
it, right?");
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    BGMStop();
