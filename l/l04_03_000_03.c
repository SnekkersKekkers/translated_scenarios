...
Thank you!");
    MsgDisp("主人公","(It was worth the effort
to make this myself.)");
    break ;
    case 3:
    ChEye(3,5);
    ...
    MsgDisp("Honda","Yeah, I can see that! Because this
has my taste and preferences in it, too!
It's almost a waste to eat it.");
...
How are they?");
    ...
    MsgDisp("Honda","I've been waiting for this since
morning, but now that I have the
chocolate, I'm speechless. Weird, huh?");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,0);
    VoicePlay("L040300003_03_100");
    MsgDisp("Honda","Do people stop thinking
...
I'll savor it, okay?");
    ...
    MsgDisp("Honda","I got it! Before I eat it,
can we take a picture with the
chocolate?");
    MsgDisp("主人公","(｛本多＊＊｝
seemed really happy!
I did it!!)");
