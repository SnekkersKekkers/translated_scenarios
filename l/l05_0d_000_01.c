...
MsgDisp("Hikaru","Make sure to properly accept his feelings in
return, 'kay?");
MsgDisp("主人公","Y-Yeah.
...
MsgDisp("Michiru","It'll be fine. Just try to be considerate of
them. The thought of Mari is surely building
up inside them.");
