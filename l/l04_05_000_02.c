switch (ChPrmGet(5,6)){
    ...
    MsgDisp("Hiiragi","This is a famous brand......
I've received it once before from a
patron. ......You're giving it to me?");
    MsgDisp("主人公","Yeah!");
    ChMouth(5,4);
    ChMotion(5,4);
...
for this.");
    ...
    MsgDisp("Hiiragi","This chocolate is the fruit of
...
you're exaggerating a bit.");
    ...
    MsgDisp("Hiiragi","Not at all. Many believe handmade to
be superior, but I believe time is also
important. You gave me your time.");
    ChEye(5,3);
    ChMotion(5,4);
    VoicePlay("L040500002_05_110");
    MsgDisp("Hiiragi","And...... would you give me your time
to eat this as well?
