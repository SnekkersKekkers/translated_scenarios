...
Here's a present.");
    ...
    MsgDisp("主人公","Yeah! Do you want to open it now?");
    break ;
    case 3:
    MsgDisp("主人公","｛Himuro＊＊｝.");
    MsgClose();
    ...
    MsgDisp("Himuro","Ah, it's you. What?");
...
Then, I'll go ahead and take it.");
    MsgDisp("主人公","Yeah! If you'd like, you can open it now!");
    break ;
    case 4:
    case 5:
    MsgDisp("主人公","｛Himuro＊＊｝.");
...
A gift to celebrate.");
    ...
    MsgDisp("Himuro","Oh. Then, I'll take it.
...Can I open it?");
