...
I'm quite used to receiving gifts,
but the reverse is quite difficult.");
MsgDisp("主人公","Hehe, it's something that
you chose for me, ｛柊＊＊＊｝.");
ChEye(5,4);
ChMotion(5,4);
VoicePlay("K020501100_05_040");
MsgDisp("Hiiragi","......If it's to your liking, then
that's how it is.
However, if not......");
...
MsgDisp("Hiiragi","Yes, please don't set your
expectations too high when you open it.
