...
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("K010100101_01_000");
MsgDisp("Kazama","As expected of my childhood friend.
...
If I ever said I didn't like it, I'd be
a fake.");
MsgDisp("主人公","Hehe, then I guess this ｛Kazama＊＊｝ is the
real one.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
