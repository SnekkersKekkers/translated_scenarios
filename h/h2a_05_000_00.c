...
is something I understand well.");
    ...
    MsgDisp("Hiiragi","It would simply not be possible
without their constant efforts and
a great support.");
...
work you've done as manager.");
    ...
    MsgDisp("Hiiragi","Please, go on and show that smile
to all of the team members as soon
as possible.");
    MsgDisp("主人公","Yes!");
    MsgDisp("主人公","(I'm so glad I did my best for
