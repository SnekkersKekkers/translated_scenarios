...
MsgDisp("Honda","When I heard that you won an award
...
MsgDisp("Honda","But you really are amazing,
to raise your flowers to an award-winning
level even despite that.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("H5G0300000_03_040")
MsgDisp("Honda","Next time, could you come take a look
at the Pachira plant in my room?");
