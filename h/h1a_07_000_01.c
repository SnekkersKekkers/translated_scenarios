...
I feel a little jealous.");
    ...
    MsgDisp("Mikage","It means you've made friends, all
aiming for the same goal.
The Haba High baseball club is nice, 
huh.");
    MsgDisp("主人公","Yes......");
    ChEye(7,0);
    ChMouth(7,3);
    ...
    MsgDisp("Mikage","Now, it's time for your last job
as manager.
Go be with everyone.");
    MsgDisp("主人公","(｛御影＊＊｝, thank you.
We lost, but this will become
a cherished memory......)");
    break ;
    default :
    DbgAssert(1);
