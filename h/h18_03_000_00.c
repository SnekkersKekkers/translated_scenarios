...
MsgDisp("Honda","You know, I was so excited that I
stayed up all night to make a
spectator's guide to watch this game.");
MsgDisp("主人公","Wow, this looks just like a
roster of players!");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Honda","If I'm going to be cheering for them,
I want to know more about the players.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
