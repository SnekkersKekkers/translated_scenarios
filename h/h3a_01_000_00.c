...
We did it!");
    ...
    MsgDisp("Kazama","Guess I'm risking my life if
I ever pick a fight with you.");
    MsgDisp("主人公","Hehe, jeez!");
    ChEye(1,4);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("H3A0100000_01_020");
    MsgDisp("Kazama","The pinnacle of high school
...
It felt like that stage was made
just for you.");
    MsgDisp("主人公","｛風真＊＊｝,
you came to cheer for me!");
    ...
    MsgDisp("Kazama","Yeah, I didn't want to see you
get hurt, but looks like I was
worrying for nothing.");
    ...
    MsgDisp("Kazama","What was amazing wasn't just that
you were strong.
......It was kind of beautiful.");
    ...
    MsgDisp("Kazama","Even though I
doesn't know much about judo, I feel like
I could understand the appeal.");
    MsgDisp("主人公","That makes me happy. Thanks!");
    ChEye(1,2);
    ChMouth(1,3);
    ChMotion(1,3);
    VoicePlay("H3A0100000_01_080");
    MsgDisp("Kazama","Ah, I'm just telling you now, but
don't go off too far on your own. I'll
be in trouble if I can't reach you.");
    MsgDisp("主人公","(Hehe, ｛風真＊＊｝ 
congratulated me!
I'm glad I practiced so much!)");
    break ;
