...
It's Mari and the rest of the talented track
team's glorious show.");
    MsgDisp("主人公","Hehe, the team will be so happy, too!");
    ChEye(21,0);
    ChMouth(21,3);
    ChMotion(21,4);
    VoicePlay("H282100000_21_020");
    MsgDisp("Michiru","I'll be cheering you on from my seat in the
audience.
Good luck.");
    MsgDisp("主人公","(Alright.
...
strong. That's why I'll be cheering for Mari,
who's supporting the team.");
    ...
    MsgDisp("主人公","(Alright, for ｛みちる＊｝ too, let's do
our best!)");
    BGMStop();
    MsgClose();
    ScrFadeOut(0,0);
