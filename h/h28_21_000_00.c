...
too!");
    ...
    MsgDisp("Michiru","I'll be cheering you on from my seat
in the audience. Good luck.");
...
But, the person I'll be cheering most
for is Mari.");
    MsgDisp("主人公","Hm?");
    ChEye(21,0);
    ChMouth(21,0);
    ...
    MsgDisp("Michiru","Haba High's track team has always
been strong. That's why I'll be cheering
for Mari, who's supporting the team.");
    ...
    MsgDisp("主人公","(Alright, for ｛みちる＊｝ too,
let's do our best!)");
    BGMStop();
    MsgClose();
    ScrFadeOut(0,0);
