...
MsgDisp("Manager","Let's do our best together to give some
great performances.");
...
MsgDisp("VP Himuro","I'm Himuro, the advisor for the brass
band.");
ChEye(32,0);
ChMouth(32,0);
VoicePlay("H510000000_32_010");
MsgDisp("VP Himuro","New members, begin learning the basics
...
MsgDisp("VP Himuro","If I remember correctly, you're a student
in Mikage-sensei's class.
Do you enjoy music?");
MsgDisp("主人公","Yes, I like it.");
ChEye(32,2);
ChMouth(32,0);
VoicePlay("H510000000_32_030");
MsgDisp("VP Himuro","Very well. Take it seriously. It's from
there that the joy of music comes.");
ChEye(32,1);
ChMouth(32,1);
...
MsgDisp("VP Himuro","I'll have those who skip our general
practices or who cannot balance this with
their studies leave.");
ChEye(32,0);
ChMouth(32,0);
