...
MsgDisp("Vice Principal Himuro","I'm Himuro, the advisor for
the brass band.");
ChEye(32,0);
ChMouth(32,0);
VoicePlay("H510000000_32_010");
MsgDisp("Vice Principal Himuro","New members, begin learning the
...
MsgDisp("Vice Principal Himuro","If I remember correctly, you're a
...
MsgDisp("Vice Principal Himuro","Very well.
Take it seriously. It's from there that
the joy of music comes.");
ChEye(32,1);
ChMouth(32,1);
VoicePlay("H510000000_32_040");
MsgDisp("Vice Principal Himuro","Everyone, just remember this as well.
...
MsgDisp("Vice Principal Himuro","I'll have those who skip our
