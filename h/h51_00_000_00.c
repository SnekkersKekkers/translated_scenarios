...
MsgDisp("VP Himuro","I'm Himuro, the advisor for the brass band.");
ChEye(32,0);
ChMouth(32,0);
VoicePlay("H510000000_32_010");
MsgDisp("VP Himuro","New members, begin learning the basics from
...
MsgDisp("VP Himuro","If I remember correctly, you're a student in
Mikage-sensei's class.
Do you enjoy music?");
