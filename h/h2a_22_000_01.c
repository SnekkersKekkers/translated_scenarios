...
Yeah, we lost......");
    ...
    MsgDisp("Hikaru","I never thought the Haba High
track and field team would lose.
The world really is full of surprises.");
    ChEye(22,0);
    ChMouth(22,0);
    ChMotion(22,0,1);
    VoicePlay("H2A2200001_22_040");
    MsgDisp("Hikaru","But you know, Hikaru was super
inspired. The track team was cool too,
and Mari's support was perfect.");
    ChEye(22,0);
    ChMouth(22,3);
    ChMotion(22,3,1);
    VoicePlay("H2A2200001_22_050");
    MsgDisp("Hikaru","Hikaru will give you and your
team the grand prize!
So, cheer up. Okay?");
