...
switch (ChPrmGet(6,6)){
    ...
    MsgDisp("Himuro","It just means that that's the
extent of your skills right now.
Nothing more than that.");
    ChEye(6,0);
    ChMouth(6,4);
    ChMotion(6,0,1);
    VoicePlay("H1A0600001_06_020");
    MsgDisp("Himuro","But, being able to make it to
a place like this deserves some credit.
So...... head up.");
...
It wasn't a match that you should
be ashamed to lose.");
    ChEye(6,0);
    ChMouth(6,4);
    ChMotion(6,0,1);
