...
You're working pretty hard.");
    MsgDisp("主人公","｛風真＊＊｝, did you come to cheer
us on?");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,0);
...
Let's aim for the championship together!)");
    ...
    MsgDisp("Kazama","It's amazing, winning enough to
make it this far.");
    MsgDisp("主人公","Ah, ｛風真＊＊｝!
You came?");
    ChEye(1,3);
    ...
    MsgDisp("Kazama","Yeah, you brought me all the
way to the Koshien.");
    MsgDisp("主人公","It wasn't just me, but the whole
team brought you here, you know?");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("H180100000_01_060");
    MsgDisp("Kazama","No, I wouldn't have come if
it weren't for you.");
...
Without you, I don't think they
would've been able to make it this far.");
    ChEye(1,4);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("H180100000_01_080");
    MsgDisp("Kazama","It's thanks to your hard work that
the baseball team has been this
successful. That's a fact.");
    MsgDisp("主人公","Thank you, ｛風真＊＊｝.");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,1);
    VoicePlay("H180100000_01_090");
    MsgDisp("Kazama","So, I need you to get a result
you're happy with.");
    ChEye(1,4);
    ChMouth(1,2);
    ChMotion(1,1);
    ...
    MsgDisp("Kazama","Since you cut down on our precious
time together for this......");
    MsgDisp("主人公","Huh?");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,3);
