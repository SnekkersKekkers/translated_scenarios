...
If I was the referee, I would've
declared you the winner.");
    MsgDisp("主人公","Hehe, but you're not.");
    ChEye(1,4);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("H3A0100001_01_020");
    MsgDisp("Kazama","But it's true that you did your
best. Today's results aren't everything.");
...
But I lost that last match.");
    ...
    MsgDisp("Kazama","Yeah, I really can't forgive
them for that.");
    MsgDisp("主人公","It's a match, so it couldn't
be helped, you know?");
    ChEye(1,2);
    ChMouth(1,3);
    ChMotion(1,0);
    VoicePlay("H3A0100001_01_050");
    MsgDisp("Kazama","Well, at least I won't have to
worry about you for a while.");
