...
I'd be in trouble if you won and went
out of reach.");
    MsgDisp("主人公","(I'm disappointed that I lost,
...
Thank you.");
    ...
    MsgDisp("Kazama","I didn't see the winning
performance, but to me, you were the
best.");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,0);
...
proudly until the end.");
    ChEye(1,0);
    ChMouth(1,4);
    ChMotion(1,0);
    VoicePlay("H4A0100001_01_090");
    MsgDisp("Kazama","I'll watch the closing ceremony
with you, as your close associate.");
    MsgDisp("主人公","Hehe.
...
Come on, let's go.");
    MsgDisp("主人公","......Yeah!");
    MsgDisp("主人公","(I'm frustrated that I didn't
win, but...... I worked hard.
Thank you, ｛風真＊＊｝......)");
    break ;
    default :
    DbgAssert(1);
