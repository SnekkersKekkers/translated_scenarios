...
MsgDisp("Mikage","｛主人公｝, our track team really is strong.");
MsgDisp("主人公","Geez, please don't talk about it like you're
not involved at all.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,2);
VoicePlay("H280700000_07_010");
MsgDisp("Mikage","Haha, sorry for being such an irresponsible
advisor.
...
MsgDisp("主人公","(Let's support the players as best as we can,
and aim for an overall victory!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChClose(7);
