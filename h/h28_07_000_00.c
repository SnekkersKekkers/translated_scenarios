...
MsgDisp("Mikage","｛主人公｝,
our track team really is strong.");
...
MsgDisp("主人公","Your cheers will give everyone
strength, ｛御影＊＊｝.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,3);
...
Let's divide everyone into two groups
for cheering during the events, okay?");
MsgDisp("主人公","Hehe, okay!");
MsgDisp("主人公","(Let's support the players as best
as we can, and aim for an overall
victory!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
