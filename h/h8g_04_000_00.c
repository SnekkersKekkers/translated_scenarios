...
MsgDisp("Nanatsumori","I wanted to see the 
model student of Haba High.");
MsgDisp("主人公","Huh?");
ChEye(4,2);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","This award, and you doing stuff like
that too, all of it just makes you so
dazzling to me. Congrats on the award.");
