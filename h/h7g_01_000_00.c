...
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("H7G0100000_01_010");
MsgDisp("Kazama","Your work won an award in the
...
ChMouth(1,1);
ChMotion(1,3);
VoicePlay("H7G0100000_01_020");
MsgDisp("Kazama","The grand prize?");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,3);
VoicePlay("H7G0100000_01_030");
MsgDisp("Kazama","Why didn't you tell me that you won
such a great prize?");
...
recognized your work, right?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("H7G0100000_01_060");
MsgDisp("Kazama","Really, you do such amazing things
so casually.
Makes me proud.");
