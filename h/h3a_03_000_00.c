...
I was so moved when you won that I forgot
...
MsgDisp("Honda","Why are you thanking me? I should be the
one that's grateful. I was so shocked it's
like I was thrown. In a good way!");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,3);
...
too∋");
MsgDisp("主人公","(How curious! But I'm really glad I stayed
