...
MsgDisp("Honda","I guess there's no point in
hypotheticals about a match.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("H3A0300001_03_030");
MsgDisp("Honda","If you did this or that, you could've
won or turned it around - that thinking
is disrespectful of your hard work.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Honda","Thank you too.
I'm glad I got to see the fruit of your
efforts. Good work!");
