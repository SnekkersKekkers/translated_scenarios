...
We did it!");
    ...
    MsgDisp("Sassa","Yeah. Almost everyone set new personal bests.
And Haba High won the championship as a team!");
    MsgDisp("主人公","Yes, it was the best result we could
have gotten.
Congrats!");
    ChEye(2,0);
    ChMouth(2,0);
    ...
    MsgDisp("Sassa","Your support has always reassured me.
Even today, just seeing you in the stands
gave me confidence.");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,4);
