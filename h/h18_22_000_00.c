...
Aim for victory～!
Right?");
    MsgDisp("主人公","(Victory...... Alright, let's do our
best!)");
    BGMStop();
    MsgClose();
    ScrFadeOut(0,0);
...
I came to cheer you on～▼");
    MsgDisp("主人公","Ah, ｛ひかる＊｝. Thanks!");
    ChEye(22,0);
    ChMotion(22,0,1);
    VoicePlay("H182200000_22_040");
    MsgDisp("Hikaru","Mari's so amazing.
Making it all the way to Koshien.");
    MsgDisp("主人公","Hehe. Not just me, it's thanks to the
power of everyone on the baseball team.");
    ChMotion(22,4,1);
...
Make sure you win!");
    MsgDisp("主人公","(Victory...... that's right. Alright,
let's do our best!)");
    BGMStop();
    MsgClose();
    ScrFadeOut(0,0);
