...
MsgDisp("Manager","Let's do our best to improve
...
I get it, but let's take it easy.");
    ...
    MsgDisp("Mikage","I know, why don't you try growing
some herbs? You naturally become relaxed.");
    MsgDisp("主人公","Yes......!");
    break ;
    case 3:
    MsgClose();
    ...
    MsgDisp("Mikage","｛主人公｝,
so you joined the gardening club.");
    MsgDisp("主人公","Yes.
｛御影＊＊｝, I'm looking forward to
working with you.");
    ChEye(7,0);
...
You've found a lifelong hobby, huh?");
    ...
    MsgDisp("Mikage","The swamp of gardening is so
deep, and the temperature so nice,
that I can't leave.");
    ...
    MsgDisp("Mikage","Yeah, let's get into it together,
okay?
...
｛御影＊＊｝, you were waiting for me?");
    ...
    MsgDisp("Mikage","Yeah, I knew from the beginning
that you'd suit the gardening club.
...
gardening?");
    ...
    MsgDisp("Mikage","Yeah, a lot. Plants grow more
beautifully the more you care for them.
...
the same.");
    ...
    MsgDisp("Mikage","Yeah, and that's why I'm already
looking forward to seeing how the plants
you grow will turn out.");
