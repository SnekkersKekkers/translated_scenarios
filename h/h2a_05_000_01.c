...
frustrating......");
    ...
    MsgDisp("主人公","But you know,
a lot of members also set new personal
bests today.");
    ChMotion(5,4);
    Wait(12,0);
    ChEyeOpenLevel(5,0);
    VoicePlay("H2A0500001_05_010");
    MsgDisp("Hiiragi","Then this must be even more
disappointing to those players.");
    MsgDisp("主人公","Hm?");
    ChEye(5,0);
    ChMotion(5,0);
    ChEyeOpenLevel(5,-1);
...
with the team members. They are waiting
over there.");
    MsgDisp("主人公","(Thank you, ｛柊＊＊＊｝. We might
have lost, but I'm glad that I stayed as
