...
I thought Mari could win......");
    MsgDisp("主人公","｛ひかる＊｝...... I'm sorry you had
to see me so uncool.");
    ChEye(22,2);
    ChMouth(22,0);
    ChMotion(22,3,1);
...
Because Mari's number one!");
    MsgDisp("主人公","(｛ひかる＊｝...... I'm glad I worked
so hard at judo club.)");
    break ;
    case 4:
    case 5:
    MsgClose();
    ...
    MsgDisp("Hikaru","Mari......");
    MsgDisp("主人公","｛ひかる＊｝. I lost......");
    ChMouth(22,0);
    ChMotion(22,0,1);
    VoicePlay("H3A2200001_22_030");
    MsgDisp("Hikaru","Yeah. But it was really cool. Hikaru
...
Mari's bravery.");
    MsgDisp("主人公","(｛ひかる＊｝...... Yeah, I'm glad I
worked so hard at judo club.)");
    break ;
    default :
    DbgAssert(1);
    break ;
