...
This is uncharted territory, after all.");
    MsgDisp("主人公","Did you want to learn more about
rhythmic gymnastics?");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0);
...
Ah, ｛氷室＊＊｝.");
    ...
    MsgDisp("Himuro","If you just perform as usual,
the natural result will follow, too.");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,0);
    VoicePlay("H480600000_06_060");
    MsgDisp("Himuro","You've worked hard for these
past three years, after all.");
    MsgDisp("主人公","......Yeah.");
    ChEye(6,0);
    ChMouth(6,0);
    ChMotion(6,4);
...
It's not like you.");
    ...
    MsgDisp("Himuro","Have some confidence. Messing up
because you're nervous is the stupidest
thing you could do now. Don't let me down.");
