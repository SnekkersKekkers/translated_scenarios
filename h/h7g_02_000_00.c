...
MsgDisp("Sassa","I wanted to come lift you into the
air, but maybe I'll hold back this time.");
MsgDisp("主人公","Huh∋");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,3);
...
MsgDisp("Sassa","Haha, just kidding.
But I really think you've accomplished
something amazing. Congrats");
MsgDisp("主人公","Thank you, ｛颯砂＊＊｝.");
MsgDisp("主人公","(I don't want to get lifted, but I'm
happy to be congratulated......I'm glad I
worked so hard for the handicrafts club!)");
MsgClose();
ScrFadeOut(0,0);
ChClose(2,0,0);
