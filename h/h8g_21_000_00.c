...
ChLayout(1);
ScrFadeIn(0);
VoicePlay("H8G2100000_21_000");
MsgDisp("Michiru","Mari!
I heard all about it, about your award
for being in the student council.");
MsgDisp("主人公","Ah, ｛みちる＊｝.
Yes, I received an award.");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,4);
VoicePlay("H8G2100000_21_010");
...
You're the best high school student
in the world.");
