...
MsgDisp("Honda","It was so beautiful that it felt like
it wasn't the you that I knew
who performed.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
...
MsgDisp("Honda",
"Your graceful movements, the way the
balls and ribbons seemed to gravitate
to you, it was the result of your 
hard work......");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("主人公","(I got thanked...... But I'm really
