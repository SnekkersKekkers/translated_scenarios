...
Thank you!");
    ...
    MsgDisp("Nanatsumori","Well, not like you're the one going
out there, though. This is your last job
as manager, right? Go and do your best.");
...
Did you come to cheer us on?");
    ...
    MsgDisp("Nanatsumori","Well, that's how it is. ......I don't know
much about track, though.");
    MsgDisp("主人公","Hm?");
    ChEye(4,4);
    ChMouth(4,4);
    ChMotion(4,0,1);
