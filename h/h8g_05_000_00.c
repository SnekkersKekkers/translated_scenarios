...
MsgDisp("Hiiragi","｛主人公｝. ......No, perhaps I should
address you as model student?");
MsgDisp("主人公","Um......
That makes me feel a little shy.");
ChEye(5,0);
VoicePlay("H8G0500000_05_010");
MsgDisp("Hiiragi","Not at all.
As it's you, I'm sure there would be no
...
MsgDisp("Hiiragi","Thank you. But today, it is your award
ceremony. You're the star of today's show,
so have fun.");
MsgClose();
ChClose(5);
MsgDisp("主人公","(I'm so happy.
I'm glad I worked so hard in the student
council!)");
MsgClose();
ScrFadeOut(0,0);
