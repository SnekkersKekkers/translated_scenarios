...
glad your efforts are being recognised,
but to be honoured as an individual...");
ChEyeOpenLevel(5,#1);
...
But today, it is your award ceremony.
You're the star of today's show, so have fun.");
MsgClose();
ChClose(5);
