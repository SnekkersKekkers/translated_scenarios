...
Let's do our best to help everyone!)");
    ...
    MsgDisp("Sassa","｛主人公｝,
you're the manager?");
    MsgDisp("主人公","Yes, I'm looking forward to
...
working with you.");
    ...
    MsgDisp("Sassa","Same here. But you know, with your
sense, I think you could be great in
both short and long distance.");
    MsgDisp("主人公","Thanks! But, I'll be helping out as
a manager to support you and everyone
else, ｛颯砂＊＊｝.");
    ChEye(2,3);
    ChMouth(2,3);
    ChMotion(2,3);
    ...
    MsgDisp("Sassa","Oh, I see. Got it.");
    ChEye(2,0);
    ChMouth(2,3);
    ChMotion(2,3);
    VoicePlay("H210000001_02_070");
    MsgDisp("Sassa","With your support, I'll be able
to do anything!
Just watch me.");
...
I'll be supporting you with everything
