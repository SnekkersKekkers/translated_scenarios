...
ScrFadeIn(0);
MsgDisp("主人公","The bunnies were so cute!");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
...
MsgDisp("Honda","Because the black goat ate it!");
ChEye(4,0);
ChMouth(4,1);
ChMotion(4,1,1);
...
Because this zoo uses plant-derived inks on
their tickets.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Nanatsumori","No no, Dahon instead of watching, you should
have told me.");
ChEye(1,2);
ChEyeOpenLevel(1,0);
ChEye(3,3);
