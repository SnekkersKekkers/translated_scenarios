...
summer and autumn. Are you okay? Aren't
you cold?");
...
Then, shall we get closer?");
    ...
    MsgDisp("Hiiragi","It was so colorful with the fireflies and
the autumn leaves. But I also like this
atmosphere that looks like an ink
painting.");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
