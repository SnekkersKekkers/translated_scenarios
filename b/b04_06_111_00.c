...
switch (MsgSelRsltGet()){
    ...
    if (PlPrmGet(2)>=40){
        ...
        MsgDisp("Himuro","You're hesitant now but you still
want to be called princess? ");
        MsgDateResultDisp();
        }
    break ;
    case 1:
...
so be careful.");
    ...
    MsgDisp("Himuro","Even though we came all the 
way here, that's all you've got?");
    MsgDateResultDisp();
    break ;
    default :
    DbgAssert(0);
