...
MsgDisp("Hiiragi","Why is the amusement park so fun
...
I wasn't able to come much when I 
was a kid, so now I'm having fun.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
And, I'm sorry.");
        ...
        MsgDisp("Hiiragi","You're kind, so you put up
with my strange anxieties.");
        ChEyeOpenLevel(5,0);
        VoicePlay("B040523602_05_060");
        MsgDisp("Hiiragi","But I don't want you
...
apologizing in this situation.");
        ...
        MsgDisp("Hiiragi","Look. even that tuna
over there is smiling.");
        ChMouth(5,3);
        ChMotion(5,0);
        VoicePlay("B040523602_05_100");
        MsgDisp("Hiiragi","Well, let's hurry and head home!");
        MsgDisp("主人公","(｛柊＊＊＊｝, thank you for
