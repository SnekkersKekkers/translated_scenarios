...
I actually read the original, borrowed
it from my sister. I really related
to the heroine.");
...
My favorite part.");
MsgDisp("主人公","(｛本多＊＊｝ looks
really invested!)");
StlEye(3,0);
StlMouth(3,0);
VoicePlay("B050300000_03_030");
MsgDisp("Honda","\"The nostalgic sound of your footsteps
as you approach me\"——");
StlEye(3,1);
StlMouth(3,1);
...
MsgDisp("Honda","Totally.
It was a little bit different from
what I imagined, though.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0,1);
...
MsgDisp("Honda","\"The nostalgic sound of your footsteps
as you approach me\"——,
That scene really draws you in.");
ChEye(3,0);
ChMouth(3,4);
ChMouth(3,4);
ChEyeOpenLevel(3,0);
VoicePlay("B050300000_03_080");
MsgDisp("Honda","The original story described a
somber melody that tugs at your
heartstrings, so I was imagining
all kinds of music as I read......");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,1,1);
VoicePlay("B050300000_03_090");
MsgDisp("Honda","But it was completely different than
what I expected.");
...
MsgDisp("Honda","It was my a song from my sister's
favorite idol group.
...
MsgDisp("Honda","At first I thought \"Huh?\" but it's
a good song. Especially since we
listened to it together. We can listen
to it again later!");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
BGMStop();
ChClose(3);
MsgDisp("主人公","(It wasn't what he expected, but
it is still a good song...... That's
｛本多＊＊｝ rating, huh?)");
MsgClose();
ScrFadeOut(0,0);
ChPrmTblAdd(3,0);
