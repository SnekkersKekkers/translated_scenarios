...
one asking he would answer. He wouldn't
even give you a dirty look.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
...
MsgDisp("Honda","If it were me, I'd be willing to talk to
...
MsgDisp("主人公","(｛Honda＊＊｝ seems to idolize ｛Kazama＊＊｝...!)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(3,#1);
