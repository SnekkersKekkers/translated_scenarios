...
MsgDisp("Mikage","I think the reason I'm here, 
talking to you now is thanks 
to the living things that have 
...
MsgDisp("Mikage","Animals and plants have had
a huge influence on me.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("B070700000_07_530");
MsgDisp("Mikage","Love is with a person, 
and only that person. I don't think
there's much point in 
being that selective.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
...
MsgDisp("主人公","(I feel like I've seen a
surprising side to ｛御影＊＊｝...)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(7,-1);
