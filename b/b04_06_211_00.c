...
MsgSel("Let's get a closer look!","Let's take a picture with the animals!","｛Himuro＊＊｝, is there anywhere you want to go?");
...
What do you want to see first?");
    ...
    MsgDisp("Himuro","I'll take the picture for you, feel free to
take some solo.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
