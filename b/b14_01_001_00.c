...
MsgDisp("主人公","Hehe!｛風真＊＊｝, did you 
already know about this?");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("B140100100_01_010");
MsgDisp("Kazama","It's a thanks for tending to the store 
in your christmas outfit. I thought you
...
MsgDisp("Kazama","You should thank the people of
Habataki City instead, right?");
...
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("B140100100_01_030");
MsgDisp("Kazama","...Our graduation ceremony is coming up.");
MsgDisp("主人公","Yeah, it's already so soon.");
ChEye(1,4);
ChMouth(1,4);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("B140100100_01_040");
MsgDisp("Kazama","As I thought, the changes in 
circumstance will be scary...");
MsgDisp("主人公","Eh...?");
ChMotion(1,0);
Wait(12,0);
ChMouth(1,3);
