...
MsgDisp("Nanatsumori","Right. That's why, when I go out to eat, I
make sure to fill my stomach a little.");
MsgDisp("主人公","Hmm...
...
MsgDisp("Nanatsumori","Yeah. If it's a dish I like, I can usually
make it.");
...
MsgDisp("Nanatsumori","Yeah. If you can win a man's heart with
your cooking, your future is secure,
right?");
MsgDisp("主人公","Y-Yeah?");
ChEye(4,0);
ChMouth(4,3);
