...
ScrFadeIn(0);
MsgDisp("主人公","｛七ツ森＊｝
ordered a lot of sweets...");
ChEye(4,4);
ChMouth(4,3);
VoicePlay("B360450301_04_000");
MsgDisp("Nanatsumori","Well, it's half of
my dinner as well.");
MsgDisp("主人公","Ah... I see.
Since ｛七ツ森＊｝ lives alone after all.");
ChEye(4,0);
ChMotion(4,1,1);
VoicePlay("B360450301_04_010");
MsgDisp("Nanatsumori","Right.
That's why, when I go out to eat, 
I make sure to fill my stomach a little.");
MsgDisp("主人公","Hmm...
...
MsgDisp("Nanatsumori","Well for me, if it was something
sweet or spicy, you can win me 
