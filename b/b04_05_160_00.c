...
MsgSel("I want to try the medal game!","How about taking on the quiz game?","Do you want to try the compatibility horoscope?");
switch (MsgSelRsltGet()){
    case 0:
    DateRateSet(2);
    ChMotion(5,4);
    VoicePlay("B040516000_05_010");
    MsgDisp("Hiiragi","Yes, I don't know what it is, but I'll leave
it up to you.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
