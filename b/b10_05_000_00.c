...
MsgDisp("Hiiragi","Only we know of what happened today.
If both us forgot it, it would no
longer exist in this world.
I've forgotten, so it's only you.");
...
MsgDisp("Hiiragi","From now on too, can I see and
hear the same things with you, 
