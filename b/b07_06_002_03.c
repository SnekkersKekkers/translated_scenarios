MsgDisp("主人公","Recently it's been 
lively around you, ｛氷室＊＊｝.");
ChEye(6,2);
ChMouth(6,0);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
...
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600002_06_170");
MsgDisp("Himuro","But it's surprising even to me.
I haven't really hung out with 
other people like this before.");
...
ChMotion(6,2);
ChEyeOpenLevel(6,0);
VoicePlay("B070600002_06_190");
MsgDisp("Himuro","But those two just came over 
...
MsgDisp("Himuro","...But I don't think it's
a bad thing. I'm not going
to kick them out now either.");
MsgDisp("主人公","(I feel like 
｛柊＊＊＊｝ and ｛御影＊＊｝ are 
good relationships for ｛氷室＊＊｝.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(6,#1);
