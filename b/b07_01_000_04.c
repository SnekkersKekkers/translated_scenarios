MsgDisp("主人公","Do you listen to music,
｛風真＊＊｝?
Do you have a genre you like?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
VoicePlay("B070100000_01_170");
MsgDisp("Kazama","When I was away, I listened to classical
...
music though.");
MsgDisp("主人公","Heeh, Rakugo huh? Come to think of it,
...
MsgDisp("主人公","(Hehe. ｛風真＊＊｝ looks like
he's having fun. Maybe one day I'll get to
hear it.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
