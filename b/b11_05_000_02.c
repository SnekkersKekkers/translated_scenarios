...
MsgDisp("?Boy","Ehh?
The girl I approached was a member 
of Habataki Theatre Troupe～?");
VoicePlay("B110500002_35_010");
MsgDisp("?Boy","That makes it easier, right?
Theatre is lowly, tough work so 
dangle a debut in front of them,
...
you stop that work and come to us?");
MsgDisp("主人公","Ehh?");
ChEye(35,1);
ChMouth(35,0);
VoicePlay("B110500002_35_030");
MsgDisp("Guy","It's fine, just quit. If you
come to us, we'll double the 
lesson fees and get 
you debuted right away.");
...
MsgDisp("Hiiragi","I don't understand why I
would have to lie.");
MsgDispSksp(0);
ChEye(35,2);
ChMouth(35,1);
...
But I ended up looking like a member
