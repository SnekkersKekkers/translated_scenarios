...
But you know, this is kind of a new feeling
for me.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,4,1);
VoicePlay("B360350101_03_020");
MsgDisp("Honda","I never really knew what it was like to be so
caught up in the moment that I can't see
what's ahead.");
...
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("B360350101_03_030");
MsgDisp("Honda","Yeah, but today, I couldn't see even a little
bit ahead.
It's a first for me!");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,4,1);
VoicePlay("B360350101_03_040");
MsgDisp("Honda","People are fascinating, huh?
It's like there are parts of myself I'm still
discovering.");
