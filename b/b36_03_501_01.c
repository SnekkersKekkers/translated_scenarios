...
MsgDisp("Honda","I never really knew what it was like to be
...
MsgDisp("Honda","Yeah, but today, I couldn't see even a
little bit ahead.
It's a first for me!");
ChEye(3,4);
ChMouth(3,3);
...
MsgDisp("Honda","Could be. But you're the one who sparked
it. Thanks to you, I've realized something
