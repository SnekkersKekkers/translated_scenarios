...
talking to ｛Himuro＊＊｝ a lot, haven't you?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
...
MsgDisp("Mikage","Seriously, what an interesting guy.");
MsgDisp("主人公","Isn't he looking for ｛Mikage＊＊｝?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,3);
...
likely to be, like the science prep room
