...
talking to ｛氷室＊＊｝ a lot haven't you?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("B070700001_07_080");
MsgDisp("Mikage","That might be true.
Even though he's a year below, he's always
hanging around our classrooms.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("Mikage","Right? You're also older than him, so you
should have a good grasp on these things.");
MsgDisp("主人公","Umm,
so what should I do...");
ChEye(7,0);
ChMouth(7,0);
...
That's enough.");
MsgDisp("主人公","Yes. But, ｛御影＊＊｝ why are you so
close to ｛氷室＊＊｝?");
ChEye(7,4);
ChMouth(7,3);
ChMotion(7,4);
...
MsgDisp("主人公","(Overthrow... What does ｛御影＊＊｝
and ｛氷室＊＊｝ intend to do together?)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(7,#1);
