...
BGOpen("ne600",0);
ChLayout(2);
ChOpen(6,253,0,0,4,#1,#1,0,3);
ChOpen(1,253,0,0,0,#1,#1,0,3);
ChOpen(2,253,0,0,0,#1,#1,0,3);
ScrFadeIn(0);
MsgDisp("主人公","As expected of Indian movies!
They had some amazing dances huh?");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,3);
VoicePlay("B330A30600_06_000");
MsgDisp("Himuro","Yeah, the sheep were dancing too.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
ChEyeOpenLevel(2,7);
VoicePlay("B330A30600_02_000");
MsgDisp("Sassa","Yeah, what's the reasoning behind that?
I wonder if it's actually interesting.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Himuro","Ehhh...that's a pretty nice summary coming
from Ryota-senpai.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","Huh? ...Geez, you're so cynical.");
...
ChMouth(2,3);
ChMotion(2,0);
VoicePlay("B330A30600_02_020");
MsgDisp("Sassa","Sounds good.
I'm gonna eat some curry.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("B330A30600_01_030");
MsgDisp("Kazama","I'm in.");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,0);
