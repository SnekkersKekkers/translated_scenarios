...
MsgDisp("主人公","｛Sassa＊＊｝, do you like aquariums that much?");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
VoicePlay("B360203101_02_010");
MsgDisp("Sassa","Mmm, maybe like a normal amount?");
MsgDisp("主人公","Ehh?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
When I see you in this blue light, I'm glad
...
MsgDisp("主人公","(｛Sassa＊＊｝ seems to be in high spirits...?)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEye(2,0);
