...
MsgDisp("Himuro","...What will you do 
once you know?");
...
MsgDisp("Himuro","There's no reason to tell
...
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600000_06_460");
MsgDisp("Himuro","I don't like noisy people.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600000_06_470");
MsgDisp("Himuro","But you know.
