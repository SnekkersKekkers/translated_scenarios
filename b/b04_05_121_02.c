...
MsgSel("There might be some future masters here?","There's also a caricature artist.","Hmm, I don't see any prices tags...");
...
still for a long time.");
        ...
        MsgDisp("主人公","｛Hiiragi＊＊＊｝, do you not like it
that much?");
        ChEye(5,2);
        ChMotion(5,4);
...
such a shock that I'd tug at my eyes with
my fingers to make them droopier.");
...
The caricature portrait.");
        ...
        MsgDisp("Hiiragi","If I'm with you, anything is bound to be
enjoyable.
Let's go.");
        MsgClose();
