...
BGOpen("ex000",1);
ScrFadeIn(0);
MsgDisp("主人公","(Haaa... I feel like I messed up somewhat
today....)");
SEPlay("EV_SE_579");
...
MsgDisp("Sassa","It'll feel weird if there's always 
this unpleasant air hanging over us.");
