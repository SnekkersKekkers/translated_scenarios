...
MsgDisp("Kazama","So, who's who in this family?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
Are ｛Kazama＊＊｝ and ｛Himuro＊＊｝ brothers?");
ChMouth(1,1);
...
MsgDisp("Sassa","You're really claiming you've got that
kind of \"presence\"?");
ChMouth(1,0);
ChEyeOpenLevel(1,0);
ChEye(2,0);
...
MsgDisp("Sassa","Well, either way Inori is definitely
the son.");
ChEye(1,0);
ChMouth(1,2);
ChEye(6,0);
