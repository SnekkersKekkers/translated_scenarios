...
ChMouth(3,3);
ChMotion(3,0,1);
VoicePlay("B360350201_03_020");
MsgDisp("Honda","Well, Ryo-kun would probably be like...");
ChEye(3,1);
ChMouth(3,4);
ChMotion(3,2,1);
VoicePlay("B360350201_03_030");
MsgDisp("Honda","\"Hah? The two of you together? Why?\"");
...
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
VoicePlay("B360350201_03_060");
MsgDisp("Honda","Yepyep, but that's just the surface.
I think he'd be really interested deep down.
Especially in you.");
MsgDisp("主人公","R-Really?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,4,1);
VoicePlay("B360350201_03_070");
MsgDisp("Honda","Yeah.
If I were in his place, I'd feel the
same way.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,0,1);
VoicePlay("B360350201_03_080");
MsgDisp("Honda","It would be a shock to find out you went
out with someone else after hanging out
with us four.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("B360350201_03_090");
MsgDisp("Honda","So, let's keep today a secret from
them, okay?");
