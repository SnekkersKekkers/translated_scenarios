...
MsgDisp("Honda","I was just imagining how Ryou-kun and Mi-kun
...
MsgDisp("Honda","Well, Ryou-kun would probably be like...");
ChEye(3,1);
ChMouth(3,4);
ChMotion(3,2,1);
...
MsgDisp("Honda","Yeah, but that's just the surface.
...
MsgDisp("Honda","Yeah.
If I were in his place, I'd feel the same
way.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,0,1);
VoicePlay("B360350201_03_080");
MsgDisp("Honda","It would be a shock to find out you went out
with someone else after hanging out with us
four.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
