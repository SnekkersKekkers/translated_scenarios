...
ScrFadeIn(0);
VoicePlay("B150300300_03_000");
MsgDisp("Honda","Okay, I've got it.");
MsgDisp("主人公","Got what?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("B150300300_03_030");
MsgDisp("Honda","I think I feel this way because of the 
romantic feelings I have for you.");
MsgDisp("主人公","Huh...?");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
...
ChMouth(3,4);
ChMotion(3,5,1);
VoicePlay("B150300300_03_060");
MsgDisp("Honda","Probably∋");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("B150300300_03_070");
MsgDisp("Honda","Haha, you're the best! I guess there's
no rush to figure this out.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,4,1);
VoicePlay("B150300300_03_080");
MsgDisp("Honda","So, keep touching me, okay? And try to 
figure out your reasons for doing it.");
MsgDisp("主人公","Hehe, sure. I got it.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
