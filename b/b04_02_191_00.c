...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Sassa","The best huh...
I think I'm into flashier entertainment than
stuff that requires me to use my head.");
    MsgDateResultDisp();
    break ;
    case 1:
    DateRateSet(2);
...
Even I could watch it without getting bored.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
