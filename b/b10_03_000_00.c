...
MsgDisp("Honda","Hey, it's me. Are you still outside by any
chance?");
MsgDisp("主人公","Yeah, I am.");
VoicePlay("B100300000_03_010");
MsgDisp("Honda","I am too. I didn't want to go home
feeling uneasy. I'm sorry about today!");
...
home.");
MsgDisp("主人公","Haha, me too. Thank you for calling.");
VoicePlay("B100300000_03_040");
MsgDisp("Honda","Yeah, let's go out together again! See
you.");
SEPlay("SYS_SE_PHONE_POWER_ON");
SEWait();
