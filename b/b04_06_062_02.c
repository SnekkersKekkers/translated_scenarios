...
To think this is in Habataki City; I can't
believe it.");
    MsgDispSksp(1,7);
    MsgDateResultDisp();
    MsgDispSksp(0);
    ...
    switch (ChPrmGet(6,6)){
        ...
        MsgDisp("Himuro","It wouldn't hurt for you to be a bit more
sensitive.");
        MsgDateResultDisp();
        break ;
        case 4:
        ...
        MsgDisp("Himuro","Aren't you aware that you're part of the
...
a trip to the convenience store.");
        ...
        MsgDisp("Himuro","...But, that's the kind of fresh thrill I
