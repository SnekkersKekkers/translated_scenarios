...
MsgDisp("Nanatsumori","...There was a time when I thought I'd
never be involved in anything like that.");
MsgDisp("主人公","So that means, there has been something
like that for you?");
ChEye(4,0);
ChMouth(4,0);
ChCheek(4,7);
...
MsgDisp("Nanatsumori","Not like that.
...
positive. That presence is incredible.");
ChEye(4,2);
ChMouth(4,2);
ChMotion(4,1,1);
VoicePlay("B070400000_04_620");
MsgDisp("Nanatsumori","...But maybe you should question how mean
you are yourself for asking me something
like that so innocently? ...Haa.");
