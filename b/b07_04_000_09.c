...
MsgDisp("Nanatsumori","...There was a time when I thought I'd never
be involved in anything like that.");
MsgDisp("主人公","So that means, there has been something like
that for you?");
ChEye(4,0);
ChMouth(4,0);
ChCheek(4,7);
...
mask...even though I hate it because it goes
against my principles.");
MsgDisp("主人公","Doesn't sound like you think too positively
about it...?");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,1,1);
