...
ChMouth(4,5);
ChMotion(4,5,1);
VoicePlay("B330B20300_04_000");
MsgDisp("Nanatsumori","Uwa∋");
ChEye(1,3);
ChMouth(1,2);
ChMotion(1,3);
VoicePlay("B330B20300_01_000");
MsgDisp("Kazama","What, what's wrong?");
ChEye(4,2);
ChMouth(4,1);
ChMotion(4,2,1);
VoicePlay("B330B20300_04_010");
MsgDisp("Nanatsumori","Something that looked like a bug just
darted past in front of me...");
ChEye(1,2);
ChMotion(1,0);
ChEye(3,0);
ChMouth(3,3);
...
ChMouth(4,1);
ChMotion(4,5,1);
VoicePlay("B330B20300_04_040");
MsgDisp("Nanatsumori","...I thought so!");
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("B330B20300_01_030");
MsgDisp("Kazama","Sorry, Nanatsumori!");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("B330B20300_03_030");
MsgDisp("Honda","Let's all go take a closer look!");
MsgDisp("主人公","(｛Honda＊＊｝ is so lively.
As for ｛Nanatsumori＊｝...he looks a bit
pitiful?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
