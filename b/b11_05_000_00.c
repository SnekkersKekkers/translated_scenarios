...
MsgDisp("Guy","It's alright, you look like
the seeing type.
C'mon, come with me.");
ChPosition(33,2);
...
MsgDisp("Guy","I-I'm sorry.
Today's one is only visible to respectable
individuals so I'll come back next
time when there's something 
that can be seen.");
MsgClose();
...
ChPosition(5,0);
Wait(60,0);
MsgDisp("主人公","...I wonder what that guy saw 
in ｛柊＊＊＊｝?");
ChEye(5,2);
ChMouth(5,4);
ChEyeOpenLevel(5,-1);
...
had to face this scary situation.");
MsgDisp("主人公","No.
