...
MsgDisp("Honda","Oh it's starting!
Look at the horizon - the sun is setting!");
MsgDisp("主人公","Wow...!");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("B360302300_03_020");
MsgDisp("Honda","If anything deserves the word
\"breathtaking,\" it's a view like this.");
ChEye(3,4);
ChMotion(3,4,1);
...
ChMouth(3,4);
ChMotion(3,2,1);
VoicePlay("B360302300_03_050");
MsgDisp("Honda","...Yeah.");
ChEye(3,2);
ChMouth(3,4);
ChMotion(3,4,1);
VoicePlay("B360302300_03_060");
MsgDisp("Honda","You might think I'm being a jerk, but I
really wanted to see this with you.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,0,1);
...
ChMouth(3,4);
ChMotion(3,4,1);
VoicePlay("B360302300_03_080");
MsgDisp("Honda","That's just how I feel.
So, is it okay if it's just the two of us?");
MsgDisp("主人公","...Yeah.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,1,1);
...
you home?");
MsgDisp("主人公","Sure. Thank you, ｛Honda＊＊｝.");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChEye(3,0);
