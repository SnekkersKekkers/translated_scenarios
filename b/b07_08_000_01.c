...
MsgDisp("Shirahane","Coincidentally, when the comedy shows are on,
the show my older sister wants to watch is on
at the same time.");
ChEye(8,4);
ChMouth(8,3);
ChMotion(8,3,1);
VoicePlay("B070800000_08_050");
MsgDisp("Shirahane","And so, at those times the lady of the house,
my older sister is top priority.");
MsgDisp("主人公","(I see..
｛Daichi＊＊｝ is interested in everything.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(8,#1);
