...
MsgDisp("Nanatsumori","Ahh...that was so funny.
I could watch this kind of movie over and
over again.");
ChEye(1,3);
ChMotion(1,3);
VoicePlay("B330B30600_01_000");
MsgDisp("Kazama","When you watch a movie in a big group of
people, you can't help but laugh.");
ChEye(1,0);
ChMotion(1,0);
ChEye(3,0);
ChMouth(3,3);
...
MsgDisp("Kazama","Who was it that laughed so hard
they cried?");
MsgDisp("主人公","Um...");
ChEye(3,0);
ChMouth(3,4);
