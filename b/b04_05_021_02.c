...
It looks like I can do some vocal exercises.");
...
sunset on a beach, correct?");
        ...
        MsgDisp("Hiiragi","It's neither sunset, nor are we at a beach,
...
Let's do it together.");
        ...
        MsgDisp("Hiiragi","Uh... So that's how you went about it...");
