...
MsgDisp("Mikage","To him, school is second to 
theatre. He only goes so he can 
get by without any problems.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("B070700001_07_030");
MsgDisp("Mikage","But, you know, he's the 
kind of serious kid I like.
He told me he can't stand t
hat part of himself.");
MsgDisp("主人公","So that's how it is.");
ChEye(7,4);
ChMouth(7,3);
ChMotion(7,3);
VoicePlay("B070700001_07_040");
MsgDisp("Mikage","I was happy.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("B070700001_07_060");
MsgDisp("Mikage","So, if he ever comes to you
