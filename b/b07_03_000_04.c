MsgDisp("主人公","What kind of music does ｛Honda＊＊｝ like?");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,0,1);
...
MsgDisp("Honda","My sister often listens to songs by idols.
I can remember those.
Maybe that means I like those too?");
...
My sister dislikes it.
She calls it \"Strange Dancing\".");
