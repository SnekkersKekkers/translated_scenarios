...
MsgSel("｛Hiiragi＊＊＊｝, you're excited, huh!","The guy playing the shamisen was so cool!","It seems like they could do a collab with Habataki Theatre Company.");
...
I feel better now, so that's the end
of it.");
...
A combination of live music and
drama huh...");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
