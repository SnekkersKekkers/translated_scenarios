...
not good with these sorts of things.");
        ...
        MsgDisp("Honda","Nuh—uh. I wouldn't ride a teacup by
myself, right? And then I wouldn't have
come to that conclusion just now.");
        ChEye(3,3);
        ChMouth(3,3);
        ChMotion(3,3);
        ChEyeOpenLevel(3,0);
...
gears. The teacups are a ride that uses
this principle.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
