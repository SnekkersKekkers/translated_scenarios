...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","Hm...looks like ｛Honda＊＊｝ isn't
here yet.");
MsgDisp("","　　　　　　　　　　 ・
　　　　　　　　　　 ・
　　　　　　　　　　 ・");
...
MsgDisp("Honda","I'll go with you and knock on the
door too.
That's fine, right?");
MsgDispSksp(0);
ChEye(33,1);
...
MsgDisp("Guy","Tch, enough!
It's clear you're not lost at all.");
...
MsgDisp("Honda","Alright, let's refocus.
Let's go!");
