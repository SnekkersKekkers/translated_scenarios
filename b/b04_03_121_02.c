...
I think there aren't many stalls here aiming
for big sales.");
        MsgDateResultDisp();
        break ;
        case 4:
...
figuring out how to achieve it.");
        MsgDisp("主人公","｛Honda＊＊｝, what sort of stall would you set
up?");
        ChEye(3,0);
        ChMouth(3,4);
        ChMotion(3,0);
        VoicePlay("B040312102_03_040");
        MsgDisp("Honda","It seems easy to sell the things you already
have at home...");
        ChEye(3,0);
        ChMouth(3,3);
        ChMotion(3,1);
...
winter. That way I could do the flea market
in any season?");
        ChEye(3,0);
        ChMouth(3,0);
        ChMotion(3,4);
...
Should we run one together?");
    ...
    MsgDisp("Honda","It depends on how it was presented, but I'm
sure they'll get more customers.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
