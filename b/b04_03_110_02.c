...
MsgDisp("Honda","If I also wore a high speed, 
competitive swim suit, 
I wonder if I could swim quicker?");
...
here... But floating is the first
step, right?");
...
relaxed floating, don't you?");
        ...
        MsgDisp("Honda","Huh?
Your words somewhat have 
a bite to them today.");
...
Yeah, exactly. Starting with the look is
