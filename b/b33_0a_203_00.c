...
MsgDisp("Kazama","That doesn't mean you should tailgate me on
the waterslide.");
MsgDisp("主人公","Then, next time should we change the order?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
MsgClose();
ChClose(1,0,30);
MsgDisp("主人公","(Seems like ｛Kazama＊＊｝ really hates being
chased by ｛Sassa＊＊｝?)");
BGMStop();
SEStop("EV_SE_562",1);
MsgClose();
