...
MsgDisp("Guy","Heeh, that gear looks
good on you.");
MsgDisp("主人公","(This guy is pretty weird 
himself though...)");
ChEye(34,0);
ChMouth(34,0);
VoicePlay("B110400001_34_020");
MsgDisp("Guy","The limited-time quest 
\"Big Wave of Love\"; you're going right?
You'll be late.");
MsgClose();
ChPosition(34,1);
ChClose(34,0,10);
...
I lost my locker key somewhere 
...
MsgDisp("Nanatsumori","You're still here. If you're serious about
picking up girls—— That's right... yeah.");
MsgDispSksp(0);
MsgDispSksp(1,5);
ChEye(4,2);
ChMouth(4,3);
...
MsgDisp("Nanatsumori","Well, we're going to go and ride 
that \"Big Wave\" or whatever... thing.
Farewell～");
MsgDispSksp(0);
ChEye(34,1);
ChMouth(34,1);
...
ChClose(34,0,30);
ChPosition(4,0);
MsgDisp("主人公","What was that 'whatever' 
thing again?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,1,1);
