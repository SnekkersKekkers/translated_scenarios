...
MsgDisp("Nanatsumori","Dumbass. What's with that lame
...
MsgDisp("Nanatsumori","Sorry. I lost my locker key somewhere and
was looking for it.");
MsgDisp("主人公","Ehh∋
Did you find it?");
ChEye(4,0);
...
MsgDisp("主人公","Hey... Be careful not to lose anything,
okay?");
ChEye(4,4);
ChMouth(4,2);
ChMotion(4,2,1);
...
Wave\" or whatever... thing. Farewell～");
MsgDispSksp(0);
ChEye(34,1);
ChMouth(34,1);
