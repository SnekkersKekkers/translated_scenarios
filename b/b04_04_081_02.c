...
I want a separate space for relaxed
people and lively people.");
    ...
    MsgDisp("Nanatsumori","Haa. You sure 
are strangely excited, aren't you?");
    MsgDispBGSksp(1,1);
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
of drunkards there...");
        ...
        MsgDisp("Nanatsumori","It'll be lit up and 
have a different atmosphere.");
        ChEye(4,2);
        ChMouth(4,2);
        ChMotion(4,2,1);
        VoicePlay("B040408102_04_050");
        MsgDisp("Nanatsumori","...But, there'll be more
troublesome cherry
blossom viewers...");
...
The cherry blossoms at night...");
        ...
        MsgDisp("Nanatsumori","Maybe it's a bit much for a date
spot for us high schoolers?");
        MsgDisp("主人公","Really?");
        ChMotion(4,0,1);
        VoicePlay("B040408102_04_090");
        MsgDisp("Nanatsumori","Really.
You might even get taken 
in by the police for protection.");
        MsgDisp("主人公","Ah...
That's true.");
        ChEye(4,4);
        ChMouth(4,3);
