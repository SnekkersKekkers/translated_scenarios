...
Is that okay?");
        ...
        MsgDisp("Himuro","...By the way, 
Have you gone on here with other guys?");
...
next time after all.");
        ...
        MsgDisp("Himuro","Whether it's the ferris
wheel or whatever you like.");
        ChEye(6,0);
        ChMouth(6,1);
        ChMotion(6,4);
...
If that's what you say, I'll come
along. That's fine I guess.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
    ...
    MsgDisp("Himuro","You should pay more attention
