...
A pitch black cat is sitting in
the corner.");
...
So what? Are you going to stay here for
the rest of your life and play with him?");
MsgDisp("主人公","Huh?");
ChEye(6,1);
ChMouth(6,0);
ChMotion(6,2);
...
MsgDisp("Himuro","You get him attached to you while
you're here, then just leave whenever
it suits you.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
