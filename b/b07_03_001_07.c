MsgDisp("主人公","(Huh? What's going on with me?
...
MsgDisp("Honda","Is it because of me..? Did I do
something?");
ChMotion(3,2);
...
MsgDisp("主人公","Um... it's because we're staring at 
each other...");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("B070300001_03_540");
MsgDisp("Honda","Oh, is that it? I was surprised——");
ChEye(3,5);
ChMouth(3,0);
ChMotion(3,0);
