...
ChMouth(4,1);
ChMotion(4,1,1);
VoicePlay("B070400001_04_620");
MsgDisp("Nanatsumori","Oi, I'll get mad for real you know?");
...
MsgDisp("主人公","Ugh... If you say that, I'll get embarrassed.");
ChEye(4,0);
ChMouth(4,3);
