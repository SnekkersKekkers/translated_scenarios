...
MsgSel("Is it okay to have so many people here?","｛Honda＊＊｝ is what I'm most curious about.","Habataki City is beautiful.");
...
You should look at the scenery.");
    ...
    MsgDisp("Honda","Yepyep, looking at it again this way, I think
so too.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
