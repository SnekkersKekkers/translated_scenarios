...
MsgDisp("Sassa","OOH!");
MsgDisp("主人公","I think I'm starting to get the
hang of it.
......Look!");
SEPlay("EV_SE_522");
SEWait();
...
MsgDisp("Sassa","I can drink it. But isn't it kind
of warm?");
...
squeezed it, huh?");
MsgDisp("主人公","Come to think of it. ｛颯砂＊＊｝ didn't
try at all. ......Ah, maybe it's
because——");
ChEye(2,5);
ChMouth(2,0);
ChMotion(2,0);
