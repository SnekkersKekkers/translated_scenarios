...
ChMouth(2,4);
ChMotion(2,0,1);
VoicePlay("B020202127_02_000");
MsgDisp("Sassa","I used to think that girly clothes were the
best, but these ones are good too!");
...
MsgDisp("Sassa","I mean, it works the same way for me, right?");
