...
MsgDisp("Kazama","...You're kinda used to that 
...
but it's just a normal greeting.");
MsgDisp("主人公","Normal...");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","But, you're the other party so
It's troubling that I can't 
deal with you normally.");
MsgDisp("主人公","Eh, why?");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,3);
...
MsgDisp("Kazama","Listen, okay? Responding 
normally means I'd have to return
the physical affection, right? 
...
MsgDisp("Kazama","Don't do something to someone if 
you know it would trouble you.
...See you.");
MsgClose();
