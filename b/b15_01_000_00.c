...
I didn't live overseas 10 years for nothing.");
MsgDisp("主人公","I see.
...
I don't know what you're imagining but it's
...
MsgDisp("Kazama","But, you're the other party so it's troubling
that I can't deal with you normally.");
MsgDisp("主人公","Eh, why?");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,3);
...
MsgDisp("Kazama","Listen, okay?
Responding normally would mean I'd return the
physical affection. Are you okay with that?");
...
MsgDisp("Kazama","Don't do something to someone if you know it
would trouble you.
...See you.");
MsgClose();
