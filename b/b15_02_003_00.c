...
Even though I thought we were pretty
close to understanding each other.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,0);
...
MsgDisp("Sassa","Even though I told you to stop, 
you energetically kept at it 
with a smile. It's a bit scary.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,0);
