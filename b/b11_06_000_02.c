...
MsgDisp("Guy","Oh! You can even make that kind 
of expression? You'd totally 
nail acting too!～");
ChPosition(35,2);
...
MsgDisp("Guy","It's been years since I stepped
away from the spotlight... For me
...
MsgDisp("Himuro","...Ha? Why would I be 
