...
ChLayout(1);
ScrFadeIn(0);
MsgSel("Want to take a walk on the brick road?","How about going to the wharf?","I want to go on the sightseeing boat");
...
There's something that caught your eye, yes?");
    MsgDispSksp(0);
    SEPlay("EV_SE_FOOT_WALK_AWAY_TWO");
    MsgClose();
    ScrFadeOut(0);
