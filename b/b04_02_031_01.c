...
MsgDisp("Sassa","For us land creatures, this place is
...
What else can we say?");
    ...
    MsgDisp("Sassa","I found some information about it
over there. It seems that the amount
and frequency of the feeding is 
well-controlled.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
