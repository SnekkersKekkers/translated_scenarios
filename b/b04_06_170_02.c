...
MsgDisp("Himuro","...How do I say this, I'm surprised
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Himuro","Well the fact that you're 
enjoying it is most important.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
shall we sing together?");
        ...
        MsgDisp("主人公","Eh!
then I want to hear ｛氷室＊＊｝
sing all the more now.");
        ChEye(6,0);
        ChMouth(6,0);
        ChMotion(6,0);
...
worth listening to.");
        MsgDisp("主人公","It doesn't matter if 
you're good or not though?");
        ChEye(6,0);
        ChMouth(6,0);
        ChMotion(6,4);
        ChCheek(6,0);
...
Haa, I understand.");
        ...
        MsgDisp("Himuro","But, this is on the 
condition my mic is muted.");
