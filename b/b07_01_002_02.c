...
MsgDisp("Kazama","Despite how he looks, he's got a
sweet tooth.
...
MsgDisp("主人公","What other sorts of things do you
talk about?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
Now that you suddenly mention it, nothing
comes to mind...");
...
MsgDisp("主人公","There's no need to get that worked up
though...");
ChEye(1,3);
ChMouth(1,3);
ChMotion(1,3,1);
...
We ran into each other by chance the other
day in Alucard.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,3);
