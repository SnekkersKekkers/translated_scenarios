...
are really popular among girls right?");
MsgSel("Have you ever taken one?","This room is a private booth, right?","Where would you stick them?");
...
special album for these ages ago.
