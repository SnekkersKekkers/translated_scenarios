...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Honda","Well after all, when you think about it, I
feel like it makes the fear fade away?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
too.");
        ...
        MsgDisp("Honda","Why?
It's because I want to know more about the
things you enjoy and are interested in.");
        ChEye(3,0);
        ChMouth(3,3);
        ChMotion(3,1);
...
I see.");
        ...
        MsgDisp("Honda","Being able to be next to you while you're
having fun...
That's what I want.");
        ChEye(3,3);
        ChMouth(3,3);
...
I think that's fine for now.");
        MsgDisp("主人公","(｛Honda＊＊｝, thank you for challenging
yourself.)");
        break ;
        default :
        DbgAssert(1);
