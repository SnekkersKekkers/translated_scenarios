...
MsgDisp("Kazama","The rough seas in the winter
bring all kinds of things ashore.");
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Kazama","The color and shape are the same. Even the
cross section fibers look similar!");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
