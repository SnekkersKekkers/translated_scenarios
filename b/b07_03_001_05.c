MsgDisp("主人公","We've been spending a lot of time with
｛Kazama＊＊｝ and ｛Nanatsumori＊｝ lately.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Honda","Ryo-kun, Mi-kun, and I have different
...
MsgDisp("Honda","But because you're here, it all just works
between us.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,1);
VoicePlay("B070300001_03_360");
MsgDisp("Honda","This is just my perspective, though.
If you ask those two, they might say
something completely different.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("B070300001_03_370");
MsgDisp("Honda","But I'm sure they both, just like
me, think you're an essential part
of our group.");
ChMotion(3,4);
