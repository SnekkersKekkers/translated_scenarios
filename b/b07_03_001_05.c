...
MsgDisp("主人公","But I'm the only girl among you guys... I
wonder if it seems weird from the outside?");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,0);
VoicePlay("B070300001_03_300");
MsgDisp("Honda","Why are you asking that all of a sudden?
Did someone say it was weird?");
MsgDisp("主人公","Oh, no, it's not like that... 
I was just wondering.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,2);
VoicePlay("B070300001_03_310");
MsgDisp("Honda","Hmm, I see. You're kind of like the hub
in our group.");
ChSet(3,0);
VoicePlay("B070300001_03_320");
MsgDisp("Honda","And I mean a bicycle hub, not a bicycle 
wheel, you know?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,1);
...
connecting multiple locations. That's
what a hub is.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
...
ChMouth(3,3);
ChMotion(3,0);
VoicePlay("B070300001_03_350");
MsgDisp("Honda","But because you're here, it all just
works between us.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,1);
VoicePlay("B070300001_03_360");
MsgDisp("Honda","This is just my perspective, though. If
you ask those two, they might say
