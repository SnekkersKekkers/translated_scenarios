...
MsgDisp("Mikage","\"Quickly, quickly!\" I understand what that
feels like.");
MsgDisp("主人公","Hehe. ｛御影＊＊｝, you're also
...
MsgDisp("Mikage","Yeah. Let's chat once we get inside. We're
losing time aren't we?");
MsgClose();
