...
amusement park before, like how he's
not really gone bowling...?)");
MsgClose();
...
MsgDisp("Mikage","Yes, it looks like
it's sparkling in my eyes too.
...
｛御影＊＊｝ wants to do is go to the theme
park... Alright, I'll enjoy it with him
too!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
