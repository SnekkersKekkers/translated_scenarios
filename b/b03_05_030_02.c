...
MsgSel("Let's go to the Aquarium.","The Water Garden sounds good.","Let's go to the Deep Sea Corner.");
...
I thought the same.");
    ...
    MsgDisp("Hiiragi","The words 'deep sea' have a strange charm to
them.
