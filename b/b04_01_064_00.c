...
MsgDisp("主人公","And this is the first time we've ever come
here together.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Night Market Clerk","Right away! ...Oh? You're Kazama-san's
...
MsgDisp("Kazama","The candied apple guy told me about a good
place to watch from.
Let's go.");
MsgClose();
SEPlay("EV_SE_568");
