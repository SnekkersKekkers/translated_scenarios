MsgDisp("主人公","｛Honda＊＊｝, you and ｛Nanatsumori＊｝
...
Though most of the time, I'm the one doing
all the talking.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Honda","He always has a sullen look on his face.
Especially when I talk to him at school.");
MsgDisp("主人公","Really?");
ChEye(3,1);
ChMouth(3,3);
ChMotion(3,1);
