...
MsgDisp("Kazama","Doesn't it feel weird to ride
...
We're used to Honda's talks now aren't
we? The view is really great.");
ChEye(1,2);
ChMouth(1,1);
ChMotion(1,3);
ChEyeOpenLevel(1,8);
...
MsgDisp("主人公","(Umm... is there something
I haven't noticed?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
