...
ChMouth(3,4);
ChMotion(3,4,1);
VoicePlay("B150300000_03_010");
MsgDisp("Honda","It's not about what you did exactly...
more about the distance between us.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1,1);
...
MsgDisp("Honda","Why are you apologizing? If it was a 
problem, I'd let you know.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("B150300000_03_070");
MsgDisp("Honda","Actually, I'm happy! It means we've
gotten closer since we first met, right?");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
ChEyeOpenLevel(3,0);
...
MsgDisp("主人公","(Family huh... But it seems like
｛本多＊＊｝, doesn't mind physical
closeness at all?)");
MsgClose();
ScrFadeOut(0,0);
ChClose(3,0,0);
