...
I feel something other than fear...");
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Mikage","The feeling of looking at yourself
...
Is that the other side?");
    ...
    switch (ChPrmGet(7,6)){
        ...
        MsgDisp("Mikage","If that's what you really 
...
This is enough after all.");
        ...
        MsgDisp("Mikage","I see. But if you're serious, don't hold
back. You always accompany me, after all.");
...
　　　　　　　　　　 ・");
        ...
        MsgDisp("主人公","(I wonder if ｛御影＊＊｝ will be okay?)");
        break ;
        default :
        DbgAssert(1);
        break ;
...
I gave up. Don't make me elaborate.");
    MsgDateResultDisp();
    break ;
    default :
    DbgAssert(0);
