...
MsgSel("I could get used to that thrill!","The Sky Lounge sounds nice.","That was a very interesting experience...");
...
Next time just watch from below.");
    ...
    MsgDisp("Sassa","Yeah, this was born as a ritual, and changed
into an attraction.
