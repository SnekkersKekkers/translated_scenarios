...
representing the school\", that sorta thing.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
But you know, your voice is pretty loud too.");
        MsgDisp("主人公","Ehhh∈");
        VoicePlay("B040703202_42_000");
        MsgDisp("School Boy","Aren't you two being way louder than the rest
of us?");
...
I wanted to hear a girl say, \"Boys～\" once in
my life!");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
