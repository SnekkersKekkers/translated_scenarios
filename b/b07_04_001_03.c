MsgDisp("主人公","It's been very lively around 
you recently, ｛七ツ森＊｝.");
...
Really, I never thought I'd live such
a lively high school lifeー......");
MsgDisp("主人公","Hehe!");
ChEye(4,4);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","But, then there was you...and Kazama,
Dahon. What? What's with this absurd
quartet?");
MsgDisp("主人公","Eh?");
ChEye(4,0);
ChMouth(4,3);
