...
ChMotion(2,0);
ChEyeOpenLevel(2,0);
VoicePlay("B150200200_02_020");
MsgDisp("Sassa","The other day, I told you I would think of
a counter-attack.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,4);
...
I couldn't keep up at all. Grabbing your
hand to stop you was impossible.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,4);
ChEyeOpenLevel(2,0);
...
I'm good at controlling myself...but I'd
hate it if something happened.");
MsgDisp("主人公","Y-Yeah.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
VoicePlay("B150200200_02_070");
MsgDisp("Sassa","You understood.
I'm counting on you?");
MsgClose();
