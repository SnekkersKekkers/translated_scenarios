...
MsgDisp("Sassa","The other day, I told you
I would think of a 
counter-attack.");
ChEye(2,2);
ChMouth(2,0);
...
MsgDisp("Sassa","I thought I could grab your hand,
...
Trying to clasp your hand 
in mine was impossible.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,4);
ChEyeOpenLevel(2,0);
...
ChClose(2);
MsgDisp("主人公","(As I thought, it seems like
I really did worry ｛颯砂＊＊｝...)");
MsgClose();
ScrFadeOut(0,0);
