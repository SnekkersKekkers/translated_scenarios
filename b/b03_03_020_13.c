...
ChMotion(3,0,1);
ScrFadeIn(0);
MsgSel("Want to take a walk on the brick road?","Want to go to the wharf?","I want to ride the boat");
...
Just looking at that statue is fun.");
    ...
    MsgDisp("Honda","It's exciting from the moment you step up the
ramp, isn't it?");
    MsgDispSksp(0);
    break ;
    default :
