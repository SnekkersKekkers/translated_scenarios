...
MsgDisp("Hiiragi","The cat we raised at the theatre
company I told you about once, ran
away from home because I 
...
MsgDisp("Hiiragi","No, it's too late for 
that now. We'll switch
offence and defence now.");
MsgDisp("主人公","Eh?");
ChMouth(5,3);
ChMotion(5,4);
VoicePlay("B150500500_05_070");
MsgDisp("Hiiragi","Even if you end up in tears
from my counterattack, I won't
stop...Heh, this is going to 
be fun, isn't it?");
ChMouth(5,4);
ChMotion(5,0);
ChEyeOpenLevel(5,9);
