...
Come on, let's go.");
MsgSel("｛Mikage＊＊｝, come with us too.","What are we supposed to learn here?","How about we cool off at the beach hut?");
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Mikage","Ohhh, there she is, Miss Diligent.
