...
MsgDisp("Mikage","When you think about summer break
as a high school student, you think 
of your friends and the beach right?");
...
Calm down.");
        ...
        MsgDisp("Mikage","It's not about whether it's good
or bad. It's just a different way 
of enjoying it.");
        ChEye(7,0);
        ChMouth(7,0);
        ChMotion(7,5);
...
beach as a couple in the future.
...
Come on. let's go to the rest area.");
        MsgDisp("主人公","(I hope me and ｛御影＊＊｝... 
can come here as a two one day.)");
        break ;
        default :
        DbgAssert(1);
        break ;
