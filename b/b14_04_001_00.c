...
MsgDisp("Nanatsumori","Unless I got the wrong idea, 
I thought it woudl be the 
best present for both of us.");
MsgDisp("主人公","｛七ツ森＊｝……");
ChEye(4,4);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","For the first time in my life, I was 
able to experience what it was like
