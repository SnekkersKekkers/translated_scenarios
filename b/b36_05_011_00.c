...
ChMotion(5,4,1);
ScrFadeIn(0);
VoicePlay("B360501100_05_000");
MsgDisp("Hiiragi","I wanted to see this view with you.");
...
You can see the sea, mountains, the town, all
of Habataki City.");
VoicePlay("B360501100_05_020");
MsgDisp("Hiiragi","This is really a wonderful spot.");
MsgDisp("主人公","Yeah.
You can see all the great parts of Habataki
City from here.");
ChEye(5,3);
ChMotion(5,0);
...
MsgDisp("Hiiragi","To me, you are also one of the attractions of
this city.");
MsgDisp("主人公","Eh?
I'm happy, but I think that's a bit of an
exaggeration.");
ChEye(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","Haha, just kidding.
