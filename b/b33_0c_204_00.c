...
I was young.");
MsgDisp("主人公","Yeah.
I came here a lot on elementary
school trips.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
...
Is there a part of the forest park that
interests you?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,4);
...
MsgDisp("Hiiragi","Yes. When you actually ride it, your feet
have be to be quite busy. If I didn't
