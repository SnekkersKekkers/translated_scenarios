...
I've been treated like the cat at the
theatre troupe again.");
MsgDisp("主人公","Ah, did you dislike it?");
ChEye(5,0);
ChMotion(5,4);
VoicePlay("B150500100_05_010");
MsgDisp("Hiiragi","I wonder?
But even that gentle cat had moments of
being irritable right?");
...
pretending to be angry, ｛Hiiragi＊＊＊｝?");
ChEye(5,3);
ChMouth(5,3);
ChMotion(5,3);
VoicePlay("B150500100_05_040");
MsgDisp("Hiiragi","Yes.
A counterattack of this level is
alright, right?");
...
MsgDisp("Hiiragi","In other words, you have a little bit of a
...
ChClose(5);
MsgDisp("主人公","(Ahh, my heart might be racing a
little...)");
MsgClose();
ScrFadeOut(0,0);
