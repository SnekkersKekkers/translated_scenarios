...
MsgSel("Are you alright? Don't push yourself.","Let's figure which it is. By going again!","I'm still a bit scared.");
...
What about you?");
        MsgDisp("主人公","Yeah, I think I'm getting used to it
a little.");
        ChEye(3,0);
        ChMouth(3,3);
        ChMotion(3,5);
