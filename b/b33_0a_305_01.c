...
MsgDisp("Himuro","If you can get your throw down,
you're good.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0,1);
...
It's because you two started chipping in.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
...
MsgDisp("Sassa","I mean, wouldn't it be most effective
for the most skilled person; me, to
teach them?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
