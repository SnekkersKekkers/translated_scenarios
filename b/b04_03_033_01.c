...
deep-sea corner. Which creature do you
like?");
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Honda","Yay, me too! The mascot of the deep-sea
corner, Guso-kun!");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    ...
    MsgDisp("Honda","Is that so? Then, let's go to the
jellyfish tank instead of the deep-sea
corner.");
    MsgDateResultDisp();
    break ;
    case 2:
