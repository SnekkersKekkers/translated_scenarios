...
MsgDisp("Himuro","Ryota-senpai, you confirmed that just now.");
ChEye(1,0); 
ChMouth(1,2);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
MsgDisp("Kazama","Inori, why do you like autumn?");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,0,1);
...
MsgDisp("Himuro","That sounds amazing.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Kazama","Ah, I've come with my Grandpa before.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Sassa","Ryota, shouldn't we all go?");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0,1);
VoicePlay("B330A30400_01_080");
MsgDisp("Kazama","Sorry, that's right.
We all like it here, I guess.");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,0);
