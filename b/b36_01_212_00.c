...
MsgDisp("Kazama","Going to the zoo at this time is quite
original.");
...
MsgDisp("Kazama","You won't get tired if we go to the goods
shop right?
...
MsgDisp("Kazama","That's fine, but who are the
souvenirs for?");
MsgDisp("主人公","Umm...");
ChEye(1,0);
ChMouth(1,2);
