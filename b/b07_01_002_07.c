...
MsgDisp("Kazama","You're always a bit dazed out, but
thos was different?");
MsgDisp("主人公","Hey.
...
MsgDisp("Kazama","Even I'm like that when
...
MsgDisp("Kazama","Right? We've been the same 
since long ago, haven't we?");
MsgDisp("主人公","Yeah.");
BGMStop();
MsgClose();
ScrFadeOut(0);
