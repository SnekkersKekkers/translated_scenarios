...
MsgDisp("Shirahane","Eh... Ah, no.
It's nothing?");
MsgDisp("主人公","It doesn't look like 
it's nothing though.");
ChEye(8,3);
ChMouth(8,4);
ChMotion(8,4,1);
...
MsgDisp("Shirahane","｛主人公｝. D'ya think——");
ChMotion(8,0,1);
...
Since you're kind.");
MsgDisp("主人公","｛大地＊＊｝. Why would you say something
like that?");
ChEye(8,3);
ChMouth(8,4);
ChMotion(8,2,1);
...
decision. A single path... he's found his
goal.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
