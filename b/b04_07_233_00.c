...
MsgSel("I could get used to this thrill!","The Sky Lounge sounds nice.","It was a very interesting experience...");
...
Once is enough.");
    ...
    MsgDisp("Mikage","How can you say something like that when your
voice is like that?
Women are amazing.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
