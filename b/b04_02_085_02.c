...
approximately around one lap in
track right?");
...
can aim at the world stage.");
    ...
    MsgDisp("Sassa","If you ask me why, I can only say it's a
feeling.");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
Even more so if you're watching.");
        ...
        MsgDisp("Sassa","But if I go all out here, I'll hurt
my ankle.");
        MsgDisp("主人公","I see.
...
anytime.");
        ...
        MsgDisp("Sassa","I mean, I think it's good when you
time me.");
        MsgDisp("主人公","Huh?");
        ChEye(2,0);
        ChMouth(2,4);
        ...
        MsgDisp("Sassa","When you're watching, it's like I shift
into a higher gear without even trying.");
        ChEye(2,0);
        ChMouth(2,4);
        ChMotion(2,4);
        ...
        MsgDisp("Sassa","...Crap, something's coming on.
