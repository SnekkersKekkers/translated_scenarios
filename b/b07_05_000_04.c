...
MsgDisp("Hiiragi","Yes, I like music.
But I'm not fussy about genre.
...
Ah, rap is a bit difficult
for me to understand.");
ChMotion(5,2);
VoicePlay("B070500000_05_170");
MsgDisp("Hiiragi","A member of the troupe recommended
it to me, so I tried to
give it a listen.");
MsgDisp("主人公","Hehe, it would definitely be 
surprising if ｛柊＊＊＊｝
liked rap music.");
ChEye(5,0);
ChMotion(5,0);
VoicePlay("B070500000_05_180");
MsgDisp("Hiiragi","Ah, just now you were laughing 
about how much of mismatch me 
and rap music are.");
...
But, you know, something might 
come out of the mismatch?");
