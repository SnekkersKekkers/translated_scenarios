...
It's a matter of whether I like the melody.");
...
MsgDisp("Hiiragi","A member of the troupe recommended it to me,
so I tried to give it a listen.");
MsgDisp("主人公","Hehe, it would definitely be surprising if
｛Hiiragi＊＊＊｝ liked rap music.");
ChEye(5,0);
ChMotion(5,0);
VoicePlay("B070500000_05_180");
MsgDisp("Hiiragi","Ah, just now you were laughing at how much of
a mismatch me and rap are.");
