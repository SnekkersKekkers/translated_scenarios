...
MsgDisp("Mikage","Let's observe the penguins at 
an angle we can't normally see.");
MsgSel("Let's run under the tube","I want to swim with them too","The penguins are about to start walking");
