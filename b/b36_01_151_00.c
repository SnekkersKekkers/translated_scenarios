...
MsgDisp("主人公","｛風真＊＊｝, amazing∈ You kept
getting strikes one after the other.");
MsgClose();
...
MsgDisp("主人公","Hehe, it's ｛風真＊＊｝ after
all.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
...
Alright, then if the next one is also a
strike, I want a reward.");
