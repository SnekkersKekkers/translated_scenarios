...
MsgDisp("Hiiragi","There's a training room in here, and some
members even live on-site.
It's always noisy, you know?");
MsgSel("It's quiet today huh?","Is this the only place where you can be alone, ｛Hiiragi＊＊＊｝?","Do you memorize your lines in this room?");
