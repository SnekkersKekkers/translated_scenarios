...
business alongside farming and manage things
on a larger scale.");
...
skills, but management skills too, I'm sure
...
But, you need to put in the effort to make it
succeed.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
at business, they must love their work and
take pride in it.");
        MsgDisp("主人公","I see...");
        ChEye(8,4);
        ChMouth(8,4);
