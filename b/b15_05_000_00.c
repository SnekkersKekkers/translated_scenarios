...
MsgDisp("主人公","Umm... Did I do something strange?");
ChEye(5,0);
ChMotion(5,4);
VoicePlay("B150500000_05_010");
MsgDisp("Hiiragi","No, no. I just remembered something.");
...
MsgDisp("Hiiragi","He would purr with delight, then look
annoyed.");
ChEye(5,2);
ChMotion(5,0);
ChEyeOpenLevel(5,9);
VoicePlay("B150500000_05_050");
MsgDisp("Hiiragi","I understand that cat's feelings very
well now.");
MsgDisp("主人公","Hmm?");
ChEye(5,3);
ChMotion(5,4);
...
ChClose(5);
MsgDisp("主人公","(Ehh...? Having my belly rubbed is a bit...)");
MsgClose();
ScrFadeOut(0,0);
