...
How's it different from the regular stuff?");
MsgSel("It seems like it has a seashell pattern.","It's completely different?","Is it just the name?");
...
I completely don't get it though.");
    ...
    MsgDisp("Sassa","You say it's completely different, but
to my eyes it just looks like normal
pottery though.");
    MsgDateResultDisp();
    break ;
    case 2:
