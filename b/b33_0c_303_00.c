...
MsgDisp("Hiiragi","I can barely stand, so I would be honoured
if you were to teach me.");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,1);
VoicePlay("B330C30300_06_010");
MsgDisp("Himuro","So that means you've lured us to a place
where you've got the upper hand?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,2);
...
MsgDisp("主人公","｛Hiiragi＊＊＊｝, you've gotten better.");
ChEye(5,4);
...
You can conquer both the waves and
the ice.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0);
...
Don't lean forward, and keep your centre
of gravity. It's the same as surfing.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
