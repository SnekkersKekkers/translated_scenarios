...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Hiiragi","They catch it at sea, then eat it right away?
...seems fun.");
    MsgDispSksp(1,7);
    MsgDateResultDisp();
    MsgDispSksp(0);
    ...
    MsgDisp("Hiiragi","Ooh... Hey, why don't we go?");
    MsgDispSksp(1,7);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
    ...
    switch (ChPrmGet(5,6)){
        ...
        MsgDisp("Hiiragi","So that's why your body is unusually shiny.");
        MsgDateResultDisp();
        break ;
        case 4:
        case 5:
...
It's too radiant...");
        ...
        MsgDisp("Hiiragi","You're shining even more than usual in that
swimsuit.
