...
I managed to do it without hurting
myself.");
...
Besides, I found something new to
look forward to.");
...
MsgDisp("Hiiragi","After this it seems that the 
Igloo Cafe next to the rest house
will be open.");
...
that time, we built an igloo in the 
school yard.");
MsgDisp("主人公","Eh......that's amazing!");
StlEyeOpenLevel(5,5);
StlMouth(5,0);
VoicePlay("B050500300_05_070");
MsgDisp("Hiiragi","I took it quite seriously. It was made
as a shrine to the water gods.");
StlEye(5,0);
StlMouth(5,1);
...
I won't be able to talk about my past.");
MsgDisp("主人公","It's fine......");
StlEye(5,0);
StlMouth(5,0);
VoicePlay("B050500300_05_110");
MsgDisp("Hiiragi","Look though. It's been a few years but
I was finally able to go inside an
igloo.");
StlEye(5,1);
StlEyeOpenLevel(5,5,1);
StlMouth(5,1);
VoicePlay("B050500300_05_120");
MsgDisp("Hiiragi","On top of that, although there may be
no water goddess, there's another
beautiful goddess here.");
MsgDisp("主人公","Eh......");
...
Including the skiing, I also got
