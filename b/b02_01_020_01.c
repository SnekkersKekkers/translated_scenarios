...
MsgDisp("Kazama","Hazuki Kei is looking at me... Again...");
MsgDisp("主人公","Umm...");
ChEye(1,3);
ChMouth(1,2);
ChMotion(1,3);
VoicePlay("B020102001_01_010");
MsgDisp("Kazama","I've got it.
It's that powerful gaze of his.
That's why I'm so uneasy.");
MsgDisp("主人公","Haha, is that so?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
