...
MsgDisp("Honda","I decided to read every single book
in the library.");
...
MsgDisp("Honda","No, I couldn't do it.
Just when I was getting close, they
swapped out the library cards for a
...
MsgDisp("Honda","It isn't. If you can't remember
if you've read it or not, that means
you didn't really learn from it, right?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,3);
VoicePlay("B070300000_03_360");
MsgDisp("Honda","But thanks to that, I was freed from
the library curse and started to go
outside. It was around that time that
I discovered how much I enjoy teaching
others.");
MsgDisp("主人公","(......I see, as a junior high schooler
｛本多＊＊｝ was even
more of a bookworm than he is now.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(3,-1);
