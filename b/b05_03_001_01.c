...
Quiz King, there are a bunch of crabs
...
MsgDisp("Girl","Y-Yeah. There are a lot, huh?");
MsgClose();
ScrFadeOut(0);
...
MsgDisp("Boy","The Quiz King doesn't understand
women at all, huh?");
MsgClose();
...
MsgDisp("Boy","By the way, Quiz King, are you
and Onee-chan dating?");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,4,1);
