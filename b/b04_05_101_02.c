...
many times already?");
        MsgDisp("主人公","But it's different to when I
came here in elementary school.
As the exhibits are different too.");
        ...
        MsgDisp("Hiiragi","...I'm guessing you were cute as
...
it, it's more interesting now.");
        ...
        MsgDisp("Hiiragi","We won't get any further 
like this in conversation. ");
        ChEye(5,4);
        ChMouth(5,4);
        ChMotion(5,0);
        VoicePlay("B040510102_05_100");
        MsgDisp("Hiiragi","Haa, well at the end of the day, 
I like the you now.
...Is that okay?");
        MsgDisp("主人公","(Umm, 
