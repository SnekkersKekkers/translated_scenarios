...
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("B070400001_04_020");
MsgDisp("Nanatsumori","Pfft!");
MsgDisp("主人公","Hey, why are you laughing?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","I'm bad at getting along with 
people but he can read the room.");
MsgDisp("主人公","Hmmm...");
ChEye(4,0);
ChMouth(4,2);
ChMotion(4,0,1);
VoicePlay("B070400001_04_070");
MsgDisp("Nanatsumori","Huh, am I wrong?");
MsgDisp("主人公","Eh?");
ChEye(4,0);
ChMouth(4,0);
VoicePlay("B070400001_04_080");
MsgDisp("Nanatsumori","Ah... now that you mention it.
Maybe he's trying to look a 
little cooler in front of you.");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,2,1);
