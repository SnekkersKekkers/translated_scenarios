...
react with something like \"Heeh?\"
then I came across the term DIY.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("B070700000_07_260");
MsgDisp("Mikage","Thanks to that, the usual reaction 
of \"Heeh?\" comes much quicker.
Then, what do you think?");
MsgDisp("主人公","Uummm, 
It's amazing that you can make anything
...
MsgDisp("Mikage","Yeah, the first thing I made was 
probably a dog house in middle school?");
