...
MsgSel("Let's judge based off their music!","Do you want to try it too, ｛Nanatsumori＊｝?","They're overflowing with individuality, aren't they?");
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Nanatsumori","Huh? What are you misunderstanding?");
    MsgDateResultDisp();
    break ;
    case 1:
    switch (ChPrmGet(4,6)){
...
audience.");
    ...
    MsgDisp("Nanatsumori","I can understand what each of them want to
express...
