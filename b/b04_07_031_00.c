...
MsgDisp("Mikage","It's perfect for an extracurricular
lesson, but the atmosphere is dark and a
bit heavy.");
...
I'm the type who grew up basking in the
sunlight.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
But, aren't wide, open spaces better?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
I'm a man who has taken root in the earth
and lives alongside vegetables.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
