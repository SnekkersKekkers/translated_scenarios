...
ChEye(5,0);
ChMotion(5,0);
MsgDisp("主人公","Maybe the season when the fireflies are
flying about?");
ChEye(5,4);
ChEye(6,0);
ChMouth(6,3);
...
MsgDisp("Mikage","I heard from the park manager that winter
mornings are nice too.
...
MsgDisp("Himuro","Right. But, it doesn't feel like a place
...
And don't try to get out of this with \"I
would go with Molly-san\".");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,2);
