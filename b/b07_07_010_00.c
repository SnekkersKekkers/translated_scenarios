...
The other day you asked me what I thought
about love.");
MsgDisp("主人公","Ah, yeah.");
ChEye(7,0);
ChMouth(7,0);
...
MsgDisp("Mikage","Thanking about things seriously, and
...
seriously right?");
MsgDisp("主人公","Yes...");
MsgDisp("主人公","(It was weighing on
｛御影＊＊｝'s mind that I
had asked him about love before...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChClose(7,0,0);
