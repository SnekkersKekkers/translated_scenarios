...
MsgDisp("Hiiragi","Ah, if I say something like that, Inori will
scold me.");
...
But I still think it's better when it's just
us two.");
MsgDisp("主人公","(｛Hiiragi＊＊＊｝...
Seems like he's having fun, but he's also
acting strange. What happened...)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEye(5,0);
