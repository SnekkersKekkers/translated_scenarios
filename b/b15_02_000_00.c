...
MsgDisp("Sassa","There's no way that you don't 
...
Then don't do it in the first
place. I thought it was some 
sort of prank.");
MsgDisp("主人公","Prank?");
ChEye(2,0);
ChMouth(2,0);
...
MsgDisp("Sassa","Well, judging by how it felt
just now, you were just messing.
Then, it's fine.");
...
But if you're going to joke around,
...
MsgDisp("Sassa","I was looking at your face 
and you were super serious?");
MsgDisp("主人公","Eh! Did I look like that?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("B150200000_02_070");
MsgDisp("Sassa","You did.
But, I know there was no meaning
to it, so it's fine now.
I'm going home. See ya then.");
