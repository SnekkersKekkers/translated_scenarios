...
MsgDisp("Nanatsumori","Right. It's surprising for me to put
aside what looks good in a picture.
I've liked it ever since I was a kid.");
MsgDisp("主人公","I see.");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","When you're in the aquarium, you 
feel like you've been teleported 
to the depths of the earth.");
MsgDisp("主人公","That's for sure...
These are familiar fish and jellyfish,
but there's a mystical feeling?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,3,1);
...
ChMouth(4,4);
ChMotion(4,0,1);
VoicePlay("B360403200_04_060");
MsgDisp("Nanatsumori","You're grinning.
Am I weird?");
