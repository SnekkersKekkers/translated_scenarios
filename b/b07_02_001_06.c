...
There aren't many team sports with
4 people.");
MsgDisp("主人公","Hehe.
...
MsgDisp("Sassa","The anchor isn't only about having the
fastest time. It's also about emotional
support. That's why you're the anchor.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
