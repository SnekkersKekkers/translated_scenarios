...
MsgDisp("Himuro","Frankly speaking, I don't get
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Himuro","That doesn't mean you 
have to apologize, I just wanted 
to hear your reasoning.");
    ...
    MsgDisp("Himuro","Hmm....
Maybe there's some merit to it I don't 
get. If that's the case, there is
probably a point in tagging along.");
    ...
    switch (ChPrmGet(6,6)){
        ...
        MsgDisp("Himuro","It's the museum's problem 
if children don't understand it.");
        MsgDateResultDisp();
        break ;
        case 4:
        case 5:
        ...
        MsgDisp("Himuro","Age isn't something you can 
compensate for even if 
you try your best.");
        ChEye(6,0);
        ChMouth(6,0);
        ChMotion(6,0);
        VoicePlay("B040610102_06_060");
        MsgDisp("Himuro","Even I don't like that
I'm born after you either.");
...
about, so it just came out.");
        ...
        MsgDisp("Himuro","No matter how hard I try, 
we can't take the same classes, 
not to mention it's impossible for 
us to end up in the same class.");
        ChEye(6,2);
        ChMouth(6,0);
        ChMotion(6,0);
...
you'll graduate before me.");
        ...
        MsgDisp("Himuro","No matter what, I can't get 
over this wall of one year.");
        MsgDisp("主人公","｛氷室＊＊｝......");
        ChEye(6,0);
        ChMouth(6,4);
        ChMotion(6,4);
...
It's not that I'm leaving you behind...");
        ...
        MsgDisp("Himuro","Yeah.. at the very least, 
