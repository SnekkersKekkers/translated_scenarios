...
MsgSel("Yeah, it's super fun!","It's because I'm with ｛Himuro＊＊｝.","Is ｛Himuro＊＊｝ not having fun?");
...
But, if I was given the choice, the sea would
be better. Here...we're in closer proximity.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
