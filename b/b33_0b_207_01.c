...
ChNanaType(0);
ChOpen(4,253,0,3,3,#1,#1,0,3);
ScrFadeIn(0);
ChMotion(4,1,1);
VoicePlay("B330B20701_04_000");
MsgDisp("Nanatsumori","For me it was the lion.
The king of beasts.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
ChMotion(1,0,1);
ChEyeOpenLevel(1,0);
VoicePlay("B330B20701_01_010");
MsgDisp("Kazama","Ah, I get it.");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
...
They love their flock and are always in
groups. I have more fun with everyone too.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
