...
MsgDisp("Nanatsumori","Listen. Girls shouldn't touch guys
thoughtlessly.");
MsgDisp("主人公","Yes...");
ChEye(4,2);
ChMouth(4,1);
...
MsgDisp("Nanatsumori","Ugh... If you get sad like that, it seems
like I'm the one at fault.");
ChEye(4,4);
ChMouth(4,0);
ChMotion(4,0,1);
VoicePlay("B150400000_04_050");
MsgDisp("Nanatsumori","I don't really mind... but. You can't do
that recklessly, innocently to just
anyone.");
MsgDisp("主人公","Yeah.");
ChEye(4,0);
ChMouth(4,0);
