...
MsgDisp("Mikage","It was my fault for dragging you about 
as I pleased. I also acted weird.
I'm really sorry.");
VoicePlay("B100700000_07_030");
MsgDisp("Mikage","Your unexpected reactions 
aren't anything new right?");
MsgDisp("主人公","Hehe, hey now.");
VoicePlay("B100700000_07_040");
MsgDisp("Mikage","Oh, you laughed at that huh.
If you're not too put off, 
