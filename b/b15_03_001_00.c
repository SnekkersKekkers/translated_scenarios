...
It's probably just my approach that was
off.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,4,1);
...
you're affectionate.
Honestly, I wish you'd do it more.");
MsgDisp("主人公","Really?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
So, could you teach me your technique?");
...
get scolded by my sister anymore.
So, please!");
MsgDisp("主人公","(Hmm, I don't think it's just about the
technique though...)");
MsgClose();
ScrFadeOut(0,0);
ChClose(3,0,0);
