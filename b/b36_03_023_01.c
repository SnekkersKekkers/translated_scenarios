...
Do the math and I only got to talk to you
a third as much as usual.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
MsgDisp("Honda","I think so too.
But even thinking like this shows how
precious the time with you is.");
ChEye(3,1);
ChMouth(3,4);
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
...
If I got sick and couldn't see you, it
would be even worse.");
MsgDisp("主人公","(｛Honda＊＊｝...)");
BGMStop();
MsgClose();
