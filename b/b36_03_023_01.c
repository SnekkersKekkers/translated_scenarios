...
MsgDisp("Honda","Achoo!");
MsgDisp("主人公","Are you okay? The wind's really strong
here, shall we go home?");
ChEye(3,1);
ChMouth(3,4);
ChMotion(3,0,1);
VoicePlay("B360302301_03_010");
MsgDisp("Honda","Don't wanna.");
MsgDisp("主人公","Huh∋");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,4,1);
...
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("B360302301_03_050");
MsgDisp("Honda","I need to make up for that time here!");
MsgDisp("主人公","Huh?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0,1);
VoicePlay("B360302301_03_060");
MsgDisp("Honda","Oh, did you think that sounded a bit 
childish?");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4,1);
VoicePlay("B360302301_03_070");
MsgDisp("Honda","I think so too. But even thinking like
this shows how precious the time with you
is.");
ChEye(3,1);
ChMouth(3,4);
ChMotion(3,1,1);
...
MsgDisp("Honda","Achoo!");
MsgDisp("主人公","Hey come on now... you're really going
