...
｛Kazama＊＊｝ and ｛Himuro＊＊｝ lately.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("B070200001_02_260");
MsgDisp("Sassa","Before we even realised it, there were
four of us.");
MsgDisp("主人公","Yeah.
...
MsgDisp("Sassa","Look.
Not only is it okay, but without you, it'd
all fall apart.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("B070200001_02_280");
MsgDisp("Sassa","You're like our rulebook.");
MsgDisp("主人公","Rulebook?");
ChEye(2,3);
ChMouth(2,4);
ChMotion(2,3);
ChEyeOpenLevel(2,0);
...
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("B070200001_02_320");
MsgDisp("Sassa","Try to take a closer look, then.
Those guys are always making sure you're
having a good time.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
