...
MsgDisp("Kazama","Something about this place makes me want to
come here regularly.");
...
just talk about nothing in particular.");
    ...
    switch (ChPrmGet(1,6)){
        ...
        MsgDisp("Kazama","Hey, you don't happen to be hearing anything,
do you?");
        MsgDateResultDisp();
        break ;
        case 4:
...
Hear what?");
        ...
        MsgDisp("Kazama","You're going off track again.
Obviously you can hear my normal voice.
I'm not trying to check your hearing.");
        ChEye(1,0);
        ChMouth(1,2);
        ChMotion(1,0);
...
After all, it wouldn't be fair if just one of
us could hear it.");
        ChEye(1,0);
        ChMouth(1,4);
        ChEyeOpenLevel(1,7);
...
England has a lot of ventriloquist dolls, so
I learned how to do it a little.");
