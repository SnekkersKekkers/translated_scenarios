...
even for a pro.");
MsgDisp("主人公","But ｛風真＊＊｝ could 
probably knock them down.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("Kazama","They disturbed our time together, 
so I threw it and they fell.");
MsgDisp("主人公","Ehhh?
...
But it's the person who 
interrupts who's at fault.");
ChEye(1,4);
ChMouth(1,0);
ChMotion(1,2);
ChEyeOpenLevel(1,0);
VoicePlay("B360115101_01_090");
MsgDisp("Kazama","If I throw with this image in
mind, I might come out
with a high score.");
MsgDisp("主人公","(｛風真＊＊｝......
I think finding a different 
technique might be better?)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEye(1,0);
