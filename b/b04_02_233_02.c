...
MsgDisp("Sassa","For some reason, I always look
at your face just before I jump.");
...
and looking out for me.");
        ...
        MsgDisp("Sassa","But actually, a long time ago 
I was called that often.");
        MsgDisp("主人公","Eh?");
        ChEye(2,0);
        ChMouth(2,4);
        ChMotion(2,4);
...
everyone would cry when I was it.");
        ...
        MsgDisp("Sassa","I was fast and big, 
so when I would run for real,
apparently they got scared.");
        MsgDisp("主人公","Hehe.");
        ChEye(2,0);
        ChMouth(2,3);
        ChMotion(2,4);
...
think I'll chase anyone until they cry.");
...
in an instant.");
        ...
        MsgDisp("Sassa","Then, just so I won't be mean
to you, I'll be careful.");
