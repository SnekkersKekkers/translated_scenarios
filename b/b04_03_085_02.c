...
MsgDisp("Honda","It looks like it's going 
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Honda","Yep yep, that's right! It would be good if
it was covered it snow!");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
you hoped for has appeared.");
        ...
        MsgDisp("Honda","You shouldn't be saying that to
me, but the supercomputer.");
        MsgDisp("主人公","Hehe.");
        ChEye(3,4);
        ChMouth(3,0);
        ChMotion(3,0);
        ...
        MsgDisp("主人公","(I'm glad I was able to
see this with ｛本多＊＊｝...)");
        break ;
        default :
        DbgAssert(1);
...
They're in the middle of vigorously
eating and becoming adults! ");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
