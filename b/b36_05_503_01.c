...
MsgDisp("Hiiragi","No. I'm finally able to be alone with you.
...
MsgDisp("主人公","Hmm...? What was it again...?");
ChEye(5,0);
ChMouth(5,2);
...
They said this is the seat you always sit
in on your way home from school.");
MsgDisp("主人公","That's right.
I sit here a lot.");
ChEye(5,4);
ChMotion(5,4);
VoicePlay("B360550301_05_050");
MsgDisp("Hiiragi","Maybe high school students have
designated seats?");
