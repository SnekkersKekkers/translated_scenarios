...
It's the same as my Inter-High.");
        MsgDisp("主人公","You've spent a whole year working toward
that one moment too, right?");
        ChEye(2,0);
        ChMouth(2,4);
        ChMotion(2,4,1);
...
fade suddenly!");
        MsgDisp("主人公","Hehe, ｛Sassa＊＊｝ doesn't have to
fade though?");
        ChEye(2,4);
        ChMouth(2,4);
        ChMotion(2,0);
        VoicePlay("B040208102_02_080");
        MsgDisp("Sassa","...Your smile is blooming all year
round, huh?");
        MsgDisp("主人公","Eh?");
        ChEye(2,0);
        ChMouth(2,4);
