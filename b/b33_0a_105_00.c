...
MsgDisp("Kazama","｛主人公｝, who do you want to
hear sing?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
MsgDisp("Kazama","｛主人公｝, choose already. If we
keep up like this, we'll have run out of
time without having sung a single song.");
MsgDisp("主人公","Umm...
