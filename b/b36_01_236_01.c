...
MsgDisp("Kazama","If you're this happy now, it makes me think
about what sort of expression you must have
...
MsgDisp("Kazama","I wanted to be with you then too.");
MsgDisp("主人公","Hehe, it must've been around when we were in
elementary school.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
...
I'm praising you.");
MsgDisp("主人公","Hmm.
Even ｛Kazama＊＊｝ looks like he's having fun.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
...
been able to come with ｛Kazama＊＊｝ here in
elementary school...)");
BGMStop();
MsgClose();
ScrFadeOut(0);
