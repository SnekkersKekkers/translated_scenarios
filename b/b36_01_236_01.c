...
MsgDisp("主人公","Yeah, we can finally see the 
night parade. I'm so happy!");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","If you're this happy now, it
makes me think about what sort 
of expression you must have
had when you first came here.");
ChMotion(1,0);
Wait(10,0);
ChEye(1,4);
ChMouth(1,3);
...
with you then too.");
MsgDisp("主人公","Hehe, it must've been 
around when we were in
elementary school.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
...
ChClose(1);
MsgDisp("主人公","(I wonder what it would feel 
