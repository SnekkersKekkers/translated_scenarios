...
MsgDisp("Mikage","Something like that. I'm a regular
customer. Their hamburgers are also
delicious.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("B360707000_07_070");
MsgDisp("Mikage","That being said,
dinner on your own can be lonely.");
MsgDisp("主人公","｛御影＊＊｝,
do you always have dinner alone?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("B360707000_07_080");
MsgDisp("Mikage","Yeah. That's why I always look forward
to the school cafeteria. Tell Yanosuke
and Inori to invite me too.");
MsgDisp("主人公","(｛御影＊＊｝, I'd love to
