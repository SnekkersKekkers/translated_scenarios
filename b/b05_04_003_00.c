...
MsgDisp("Nanatsumori","All things considered, this flea
market has a wide range of items.
...
MsgDisp("主人公","Hehe! You end up being drawn to
too many things don't you?");
ChEye(4,0);
ChMouth(4,2);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","It's that I haven't come 
across anything I like.");
MsgDisp("主人公","I see...
...
MsgDisp("Nanatsumori","I'm guessing it's
...
MsgDisp("Nanatsumori","Even girls can be boyish
...
MsgDisp("Nanatsumori","Ahー, it's good that they're about
to close up shop. It's easier
to negotiate a lower priceー.");
...
things in that store that were too
...
MsgDisp("主人公","｛七ツ森＊｝……");
MsgDisp("主人公","(But, I wonder if he'll show me how 
he looks like crossdressing.
