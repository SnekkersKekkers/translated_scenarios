...
ChMouth(3,4);
ChMotion(3,2);
VoicePlay("B070300001_03_220");
MsgDisp("Honda","Hmm, what do we talk about?");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,0);
VoicePlay("B070300001_03_230");
MsgDisp("Honda","Typically when guys get together, they talk
about the type of girls they like, fashion,
stuff like that.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,4);
...
Ryou-kun occasionally makes a few quips, but
Mi-kun seems pretty indifferent.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("B070300001_03_260");
MsgDisp("Honda","Even if they look bored, they still respond
properly, though.");
MsgDisp("主人公","Hehe, I can imagine that.");
ChSet(3,3);
VoicePlay("B070300001_03_270");
MsgDisp("Honda","Oh, I remember now!
We talk about you a lot when we're together.");
MsgDisp("主人公","Huh?!");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,2);
