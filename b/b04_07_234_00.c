...
MsgSel("I got to spin around like a little kid!","We really got to feel that centrifugal force.","The world...it's spinning...");
...
This is pretty intense.");
    ...
    MsgDisp("Mikage","And there's today's Miss Diligent moment.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
