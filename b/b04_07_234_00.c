...
MsgSel("I'm merry like a child!","We were able to experience the centrifrugal force","The world... it's spinning...");
...
This is pretty intense.");
    ...
    MsgDisp("Mikage","We've been blessed with Miss Serious 
again today.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
