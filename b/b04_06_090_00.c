...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Himuro","Which one...
Ah, it really is. Not too sweet, there's a
...
to the botanical garden?");
    ...
    MsgDisp("Himuro","...That's kind of hardcore. I never thought
you'd be into that sorta thing. Alright,
let's see the carnivorous plants first.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
