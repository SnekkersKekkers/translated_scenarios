...
MsgSel("Let's drink some freshly-squeezed milk!","I want to shear sheep wool!","I want to ride a pony!");
...
Then, shall we do something else?");
        ...
        MsgDisp("主人公","You're right, that does sound kind
of fun...");
        ChEye(5,3);
...
We're the only ones who did it
twice, right?");
        MsgDisp("主人公","Yeah.
