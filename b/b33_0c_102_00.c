...
MsgDisp("Hiiragi","I've always been curious about
how they clean the tank.");
...
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("B330C10200_05_010");
MsgDisp("Hiiragi","Yes, it's very clean.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,4);
VoicePlay("B330C10200_06_000");
MsgDisp("Himuro","They would move all the fish 
to another tank wouldn't they?");
MsgDisp("主人公","Seems difficult...");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("B330C10200_05_020");
MsgDisp("Hiiragi","Are there any cleaning
products for acrylic tanks?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
...
ChMouth(5,2);
MsgDisp("主人公","Ehhh?
Then, if it keeps getting 
thinner and thinner...");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,3);
VoicePlay("B330C10200_06_010");
MsgDisp("Himuro","That would be terrifying.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,5);
VoicePlay("B330C10200_07_020");
MsgDisp("Mikage","Don't worry.
It won't grind it down that much.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
ChMouth(6,4);
ChMotion(6,4);
VoicePlay("B330C10200_06_020");
MsgDisp("Himuro","Ah, that panel has \"cleaning 
organisms\" written on it.");
ChEye(5,0);
ChMouth(5,2);
ChEye(7,0);
ChMouth(7,0);
...
MsgDisp("Mikage","Yeah, probably something like 
snails or shrimp. They eat
the algae in the tank.");
MsgDisp("主人公","It's amazing huh.
for the creatures you keep t
o clean up for you.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
