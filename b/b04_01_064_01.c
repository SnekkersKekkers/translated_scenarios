...
MsgDisp("Kazama","Do you get it?
There's a lot of people out here very
excited, so being too far away is prohibited.");
...
MsgDisp("Kazama","Let's go, it's starting.
I just got told a great spot to watch from.
Over here.");
MsgDisp("主人公","Er, yeah.");
MsgClose();
SEPlay("EV_SE_626");
