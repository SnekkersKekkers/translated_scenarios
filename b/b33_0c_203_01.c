...
MsgDisp("Himuro","Yanosuke-senpai, did something
good happen?");
ChEye(5,0);
ChMouth(5,2);
ChMotion(5,0);
VoicePlay("B330C20301_05_000");
...
ChMotion(5,0);
ChEyeOpenLevel(5,9);
VoicePlay("B330C20301_05_060");
MsgDisp("Hiiragi","It's weird, isn't it?
I'll be careful.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
