...
MsgSel("Yeah, it's really fun to watch.","Is it really that different?","*Sniff sniff*... It even smells different.");
...
artist a little.");
        ...
        MsgDisp("Sassa","Sorry for saying something so weird!
It's fine to enjoy it the way you see it.");
