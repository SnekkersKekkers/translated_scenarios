...
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600001_06_240");
MsgDisp("Himuro","Nothing much.
Normal conversation.");
MsgDisp("主人公","Normal conversation?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
...
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600001_06_280");
MsgDisp("Himuro","Then, I'll nudge Ryota-senpai.");
MsgDisp("主人公","Eh, why?");
ChEye(6,1);
ChMouth(6,0);
ChMotion(6,1);
...
MsgDisp("Himuro","——Well, there are other things we 
talk about, but I can't say those.");
MsgDisp("主人公","Eh?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B070600001_06_310");
