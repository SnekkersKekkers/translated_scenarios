...
MsgSel("The whole sky being filled with stars is romantic huh?","｛Hiiragi＊＊＊｝, were you sleeping?","The seats were so soft I was sound asleep...");
...
Shall we go see it again?");
    ...
    MsgDisp("Hiiragi","No.
But you jolted awake a few times didn't
you?");
    MsgDateResultDisp();
    break ;
    case 2:
