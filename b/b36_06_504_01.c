...
MsgDisp("Himuro","It would defeat the purpose of
sneaking away.");
MsgDisp("主人公","Eh...?");
ChEye(6,0);
ChMouth(6,0);
...
ChMotion(6,2);
ChEyeOpenLevel(6,0);
VoicePlay("B360650401_06_040");
MsgDisp("Himuro","That's not the only reason.");
MsgDisp("主人公","?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B360650401_06_050");
MsgDisp("Himuro","Forget about the others already.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
