...
MsgDisp("主人公","Hey. It's not me being asked...
I'm asking ｛大地＊＊｝, right?");
ChEye(8,2);
ChMouth(8,4);
ChMotion(8,4,1);
VoicePlay("B070800000_08_520");
...
ChMouth(8,2);
ChEyeOpenLevel(8,0);
VoicePlay("B070800000_08_540");
MsgDisp("Shirahane","If so, I can't take it...");
MsgDisp("主人公","(｛大地＊＊｝...?)");
BGMStop();
MsgClose();
ScrFadeOut(0);
