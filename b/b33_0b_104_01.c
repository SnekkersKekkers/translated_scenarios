...
MsgDisp("Honda","Isn't it because it's Ryo-kun's
inner voice?");
ChEye(1,0);
ChMouth(1,2);
ChEye(4,0);
...
MsgDisp("Kazama","Huh? I was falsely accused from the start.");
ChEyeOpenLevel(1,0);
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,4,1);
VoicePlay("B330B10401_03_040");
MsgDisp("Honda","And the voice you can't hear...does that
mean it's your inner voice?");
ChEye(1,0);
ChMouth(1,2);
MsgDisp("主人公","Ehhh∈");
ChEye(1,3);
