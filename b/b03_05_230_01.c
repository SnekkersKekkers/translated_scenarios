...
park map.
So, have you decided?");
MsgSel("The Roller Coaster sounds fun!","Let's ride the Ferris Wheel.","I want to try Bungee Jumping!","I want to ride the Tea Cups.","Let's go inside the Haunted House.");
