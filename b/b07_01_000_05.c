MsgDisp("主人公","Hey, what are your hobbies, ｛Kazama＊＊｝?");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0,1);
...
MsgDisp("Kazama","Right. Fly fishing is a type of fishing
where you use a fly to lure fish, like a
flying insect.");
...
MsgDisp("主人公","(That's typical of skillful ｛Kazama＊＊｝.)");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
