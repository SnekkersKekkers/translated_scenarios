...
MsgDisp("Hiiragi","But you know, having first stepped
onto the stage at two years-old,
I have more experience with being
an actor, than I do with being a man.");
ChEyeOpenLevel(5,0);
VoicePlay("B150500400_05_050");
MsgDisp("Hiiragi","Two year-olds aren't aware of 
being a man. I'm an actor, 
before I'm a man.");
...
MsgDisp("Hiiragi","If I didn't do that, I would 
