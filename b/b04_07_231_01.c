...
MsgDisp("Mikage","It makes no difference whether I sit in the
front, back or middle right?");
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Mikage","Nice. It's the same for me anywhere.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
    ...
    MsgDisp("Mikage","Must be nice, being able to enjoy it
anywhere.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
