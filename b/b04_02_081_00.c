...
MsgSel("｛Sassa＊＊｝, the falling cherry blossoms really suit you.","The cherry blossoms are only here for such a fleeting moment...","I want to eat some tasty cherry blossom mochi.");
...
For me, I just feel like there's always next
year.");
    MsgDispBGSksp(1,1);
    MsgDispSksp(1,0);
    MsgDateResultDisp();
