MsgDisp("主人公","Hey, ｛Kazama＊＊｝, what were you like in middle
school?");
ChEye(1,4);
ChMouth(1,4);
ChMotion(1,4);
ChCheek(1,7);
VoicePlay("B070100000_01_300");
MsgDisp("Kazama","Ah that, well I was always thinking about
this place.");
MsgDisp("主人公","I see.
You definitely would've gotten homesick.");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
