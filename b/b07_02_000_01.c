...
MsgDisp("Sassa","My parents watch a lot of shows about hot
springs.");
MsgDisp("主人公","I see.");
ChEye(2,3);
ChMouth(2,4);
...
And the people on those shows get to do this
for a living...");
...
MsgDisp("Sassa","I guess I'm kind of jealous, but what do you
think they do on their days off?
Go to another hot spring?");
MsgDisp("主人公","(Uhm...
｛Sassa＊＊｝ loves watching shows about hot
springs.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
