...
Wait(60,0);
VoicePlay("B070301000_03_000");
MsgDisp("Honda","Hey, remember when you asked me about love
the other day?");
MsgDisp("主人公","Yeah, I remember.");
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("B070301000_03_010");
MsgDisp("Honda","It's been the biggest puzzle for me right 
now. I've been thinking on it a lot, but 
I still haven't found the right answer.");
ChMouth(3,2);
ChMotion(3,2);
ChMotion(3,2);
...
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("B070301000_03_030");
MsgDisp("Honda","No, not at all. In fact, it's really 
fascinating.");
ChMouth(3,3);
ChMotion(3,4);
...
MsgDisp("主人公","Um, yeah. You said you really like me...");
ChEye(3,1);
ChMouth(3,1);
ChMotion(3,5);
ChCheek(3,10);
