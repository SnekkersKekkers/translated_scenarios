...
MsgDisp("Himuro","Don't you want to spend more time together?");
MsgDisp("主人公","Eh.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B350600000_06_040");
MsgDisp("Himuro","Since we're here already, let's go somewhere.
...Just the two of us.");
MsgSel("Yeah, sounds good!","I have something else to do...");
...
Then, let's go.");
    ...
    MsgDisp("Himuro","It'll probably be troublesome if we were
found out.");
    MsgClose();
    ScrFadeOut(0);
    break ;
    ...
    MsgDisp("Himuro","If you have things to do, it can't be helped.
...Then, I'm going home.");
