...
MsgDisp("Honda","Yeah, I guess it depends on how you
define the word hobby. Do you mean it
in the sense of something you like and
do habitually......");
MsgDisp("主人公","Don't overthink it.");
ChMotion(3,4);
VoicePlay("B070300000_03_270");
MsgDisp("Honda","Okay, if it's something I do often
in my free time, I guess I take care
of creatures.");
...
MsgDisp("Honda","Yeah.
I have a lot of various plants, fish,
and insects. There are a ton of them.");
MsgDisp("主人公","Hehe, that sounds challenging.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,0,1);
VoicePlay("B070300000_03_290");
MsgDisp("Honda","Maintaining a small ecosystem of
plants, fish, and insects in an
aquarium doesn't take much effort.");
...
MsgDisp("Honda","When aquatic plants form oxygen
