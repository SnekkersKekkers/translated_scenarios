...
MsgDisp("Honda","Okay, if it's something I do a lot in my
free time, I guess it'd be looking after
living things.");
...
MsgDisp("Honda","Yeah.
I have a lot of various plants, fish, and
insects. There are a ton of them.");
...
MsgDisp("Honda","When aquatic plants form oxygen bubbles, it
makes you think of Earth's ancient oceans,
right? Then I go peek through my telescope.");
