...
huh?");
MsgSel("I think it's a bit scary...","Huh, doesn't it look like you, ｛Himuro＊＊｝?","Maybe it's due to the water pressure?");
...
If I encountered one in the ocean I'd be
kinda... No, considerably surprised.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
