...
research beforehand.");
    ...
    switch (ChPrmGet(4,6)){
        ...
        MsgDisp("Nanatsumori","There's no point in hosting an event
if it's not packed with people.");
        MsgDateResultDisp();
        break ;
        case 4:
        case 5:
        ...
        MsgDisp("Nanatsumori","Well, if this relaxing garden
were to become crowded then...");
        ChEye(4,4);
        ChMouth(4,4);
        ChMotion(4,0,1);
        VoicePlay("B040403202_04_040");
        MsgDisp("Nanatsumori","Bustling crowds are fun, 
but, this place really does suit
a relaxed atmosphere in the end.");
        MsgDisp("主人公","If this garden was filled with 
people, I would only be able to 
see the flying penguins!");
        ChEye(4,4);
        ChMouth(4,3);
        ChMotion(4,1,1);
        VoicePlay("B040403202_04_050");
        MsgDisp("Nanatsumori","Right.
If I was only looking up,
my neck would start to hurtー.");
...
That was kinda dangerous. Just now.");
        MsgDisp("主人公","Eh? Why?");
        ChEye(4,4);
        ChMouth(4,4);
        ChMotion(4,0,1);
...
lots right now?)");
    ...
    MsgDisp("Nanatsumori","Well, it's important to make 
sure they get talked about.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
