...
beforehand.");
    ...
    switch (ChPrmGet(4,6)){
        ...
        MsgDisp("Nanatsumori","There's no point in hosting an event if it's
not packed with people.");
        ...
        MsgDisp("Nanatsumori","Well, if this relaxing garden were to become
crowded then...");
        ChEye(4,4);
        ChMouth(4,4);
        ChMotion(4,0,1);
...
If I was only looking up, my neck would start
to hurt—.");
...
So much so that I wanted to hug you.");
        ...
        MsgDisp("主人公","Didn't it look like it was sparkling because
of the reflection of the penguins in the
water tank?");
        ChEye(4,5);
        ChMouth(4,2);
        ChMotion(4,0,1);
