...
I see.");
    ...
    MsgDisp("Himuro","Maybe it's because we both didn't prepare for
it enough. Should we try studying a little
for the next one?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    ...
    MsgDisp("Himuro","Do you even know enough about Rakugo to say
that it was a miss?");
    MsgDateResultDisp();
    break ;
    default :
