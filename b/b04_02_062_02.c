...
I'm glad you're here.");
    ...
    switch (ChPrmGet(2,6)){
        ...
        MsgDisp("Sassa","Yeah. What would you do if 
there were just the two of us and we
had to survive?");
        MsgDisp("主人公","I guess being with you would
be reassuring?");
        ChEye(2,0);
        ChMouth(2,4);
        ChMotion(2,4);
        ...
        MsgDisp("Sassa","I could do anything as long as
you were by my side.");
...
I would gather all the food. And you
would cook.");
        ChEye(2,0);
        ChMouth(2,2);
        ChMotion(2,2);
...
What's wrong?");
        ...
        MsgDisp("Sassa","I think catching some fish for
dinner will be the fastest. Is that
okay with you?");
