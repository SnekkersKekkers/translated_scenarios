...
MsgDisp("Kazama","If that's the case, a soba restaurant would
be nice.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
I'll also switch my answer from sauna to that
as well.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,1);
...
Something like sata andagi would be nice too.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,0);
VoicePlay("B330A30301_02_040");
MsgDisp("Sassa","You say \"something like\" but you already have
a target in mind don't you.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
MsgDisp("主人公","(Hehe, I'm looking forward to when it opens!)");
BGMStop();
MsgClose();
ScrFadeOut(0);
