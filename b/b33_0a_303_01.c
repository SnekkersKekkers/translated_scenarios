...
MsgDisp("Kazama","Ehhh.
Looks like a new shop is opening
over there.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","I'm free to hope for whatever I
want, right?");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0,1);
...
Something like sata andagi would be
nice too.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,0);
...
MsgDisp("主人公","(Hehe, I'm looking forward to when
it opens!)");
BGMStop();
MsgClose();
ScrFadeOut(0);
