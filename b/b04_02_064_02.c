...
MsgDisp("Sassa","Woah...
That guy in the Yakisoba stall was cracking
eggs one after another with just one hand.");
...
It's like they've truly mastered a craft.");
...
MsgDisp("Sassa","Alright, in respect to that guy let's go buy
some toppings!");
