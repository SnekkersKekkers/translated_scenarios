...
MsgDisp("Hiiragi","Strangely, it might be
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Hiiragi","Not judging by its temperature,
but my fashion, how is it? ");
    MsgDispSksp(1,8);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
    ...
    MsgDisp("Hiiragi","Eh? You should've said that sooner.
