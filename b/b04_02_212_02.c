...
mountain that had nothing into 
a facility like this.");
        ...
        MsgDisp("Sassa","It's amazing that he makes so 
many people happy like this.
I want to be that kind of person");
        MsgDisp("主人公","I think ｛颯砂＊＊｝ is an amazing
player that both surprises
...
kind of mascot character?");
        MsgDisp("主人公","Hehe, If` it's ｛颯砂＊＊｝, 
How about a character like
that horse plushie?");
        ChEye(2,0);
        ChMouth(2,3);
        ChMotion(2,3);
        VoicePlay("B040221202_02_050");
        MsgDisp("Sassa","Oh, a big horse that runs fast, 
a thoroughbred...
that's nice.");
        ...
        MsgDisp("Sassa","Then, 
Let's find a plush that looks like you!
