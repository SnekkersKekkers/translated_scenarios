...
MsgDisp("Sassa","Hey, why don't we have a competition?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
...
MsgDisp("Sassa","Pant, pant...was I first?");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,3,1);
VoicePlay("B330A20301_01_020");
MsgDisp("Kazama","Pant, pant...n-no it was me, right?");
SEWait();
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B330A20301_06_020");
MsgDisp("Himuro","Pant, pant...it was me.");
