MsgDisp("主人公","Recently, ｛風真＊＊｝ you're
with ｛本多＊＊｝ and
｛七ツ森＊｝ a lot but,
...
ChMotion(1,3);
ChEyeOpenLevel(1,8);
VoicePlay("B070100002_01_250");
MsgDisp("Kazama","Easy for you to say.
Listen, this will continue for 2, 3 days.");
ChEye(1,2);
ChMouth(1,1);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
left off.");
MsgDisp("主人公","They want you to join in,
｛風真＊＊｝.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("B070100002_01_270");
MsgDisp("Kazama","They'll say that trends will repeat
themselves in the end, then get me to
commentate on Simon's best sellers.");
MsgDisp("主人公","(Hehe, they have a really great
relationship.)");
BGMStop();
MsgClose();
ScrFadeOut(0);
