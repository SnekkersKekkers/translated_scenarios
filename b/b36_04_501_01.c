...
But maybe it's just the right 
sound for me right now.");
MsgDisp("主人公","Hehe.
Are you tired from hanging
out with everyone?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","The playground equipment here belongs
to the kids. It's too fragile for 
a big guy like me.");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,0,1);
