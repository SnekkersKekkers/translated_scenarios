...
MsgDisp("Nanatsumori","A man-made starry sky isn't half
bad either.
Kinda learned a thing or two, as well.");
MsgSel("The starry sky was romantic.","｛Nanatsumori＊｝, did you fall asleep?","The seats were so soft, I fell asleep...");
...
I think the night sky in Habataki is more
beautiful.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
The angle and fit of the seats are just
right. I want one for my house.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
