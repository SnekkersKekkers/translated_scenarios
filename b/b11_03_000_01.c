...
MsgDisp("Honda","Could it be that the hood and sunglasses are
to avoid people's gazes?
...
First of all, this is just an avatar and—");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,4,1);
MsgDispSksp(1,5);
...
Hah, I'll try to relax by the real sea today!");
SEPlay("EV_SE_531");
ChClose(34,0,30);
ChPosition(3,0);
ChEye(3,4);
