...
MsgDisp("Guy","It's not a mistake. See, when a stray
roams around alone, they get targeted.");
...
MsgDisp("Guy","Ugh, who are you? What guild are you from?
...
MsgDisp("Honda","I'm not getting in your way. I'm just
interested in you.");
MsgDispSksp(0);
ChEye(34,2);
ChMouth(34,1);
...
are to avoid people's gazes? You should
stop doing that.");
MsgDispSksp(0);
ChEye(34,1);
ChMouth(34,1);
...
MsgDisp("Honda","This is the sea, the real sea. Won't you
come out from the virtual world?");
MsgDispSksp(0);
ChEye(34,0);
ChMouth(34,0);
VoicePlay("B110300001_34_050");
MsgDisp("Guy","...You're actually a good person. Hah, 
I'll try to relax by the real sea today!");
SEPlay("EV_SE_531");
ChClose(34,0,30);
ChPosition(3,0);
ChEye(3,4);
...
MsgDisp("Honda","...You must be lonely, right? I can 
