...
MsgSel("I've taken perfect countermeasures for sunburn!","It makes you want to eat ice cream...","｛Himuro＊＊｝ is more dazzling.");
...
Proper measures are important after all.");
    ...
    MsgDisp("Himuro","It'll melt quickly and it'll get
annoying but...
I feel the same. Let's go buy some.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
