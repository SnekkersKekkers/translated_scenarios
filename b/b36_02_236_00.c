...
MsgDisp("Sassa","I'm the one who should say that, thank you
for coming. I wanted to see the night parade
like this, with you by my side.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("B360223600_02_010");
MsgDisp("Sassa","And the night pass to Habataki Land is a good
deal, isn't it?");
...
MsgDisp("Sassa","But how about going with just the two of us,
...
MsgDisp("Sassa","Not \"Eh?\", I'm saying I want us to be alone
for a day.");
...
MsgDisp("Sassa","Who knows?
Ah but, those two will definitely invite you
too. We think alike, after all.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,2);
ChEyeOpenLevel(2,7);
