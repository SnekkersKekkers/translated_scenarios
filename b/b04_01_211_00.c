...
MsgDisp("Kazama","Looks like they've got more rare
animals now.");
MsgSel("Let's take a closer look!","Let's take a picture with the animals!","Is there anything you wanna see, ｛Kazama＊＊｝?");
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Kazama","Oi oi, you're just asking for a
blooper reel.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
