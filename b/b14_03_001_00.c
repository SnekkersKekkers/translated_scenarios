...
world of that pop-up book we saw yesterday.");
...
MsgDisp("Honda","Wait...does that mean if we look up, we might
see ourselves from yesterday?");
MsgDisp("主人公","Eh∋");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("B140300100_03_030");
MsgDisp("Honda","Haha, good reaction!");
MsgDisp("主人公","Now you've got me imagining it!");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1,1);
ChEyeOpenLevel(3,0);
...
MsgDisp("Honda","Spending two Christmases in a row with you is
just the best.");
