...
MsgDisp("主人公","But ｛Honda＊＊｝, you seem to be
enjoying it?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,1,1);
VoicePlay("B150300400_03_060");
MsgDisp("Honda","Yeah.
Being with you is full of things I don't
understand, and it's so much fun.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,4,1);
