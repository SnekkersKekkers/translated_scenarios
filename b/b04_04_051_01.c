...
MsgDisp("Nanatsumori","Even in an artificial starry sky, 
there are sights that just make you want
to take a picture.");
...
But, a real starry sky is better.
One day, I'll take a pretty picture
of it and show it to you.");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
    ...
    MsgDisp("Nanatsumori","ＯＫ. Both
a starry sky with a new moon and a 
starry sky with a moon floating in it
