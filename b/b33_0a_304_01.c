...
MsgDisp("Himuro","forest parks have a
lot of waterside areas.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("B330A30401_02_000");
MsgDisp("Sassa","Yeah.
Maybe it's because it improves the
...
ChMouth(2,0);
ChMotion(2,4,1);
VoicePlay("B330A30401_02_010");
MsgDisp("Sassa","Surprisingly you say...
Do I give off that 
kind of rigid image?");
ChEye(1,0);
ChMouth(1,0);
...
But if Nozomu-senpai incorporated
that kind of Eastern energy..");
ChMouth(1,3);
MsgDisp("主人公","Yeah, he might get
some great records!");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
...
First let's take a break in the gazebo, 
then absorb the spring's energy? ");
ChMouth(1,2);
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,1);
...
MsgDisp("Kazama","Can four people fit 
in such a cramped space?");
ChEye(6,0);
ChMouth(6,3);
ChMotion(6,1);
VoicePlay("B330A30401_06_040");
MsgDisp("Himuro","Then, please wait
here Ryota-senpai.");
ChEye(1,0);
ChMouth(1,1);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("B330A30401_01_030");
