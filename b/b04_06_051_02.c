...
MsgDisp("Himuro","...The pair beside us weren't
even looking at the stars at all.
...
It's a public space?");
        MsgDisp("主人公","It must mean there's someone
you're that crazy about right?");
        ChEye(6,0);
        ChMouth(6,0);
        ChMotion(6,0);
...
like that one day, ｛氷室＊＊｝?");
        ...
        MsgDisp("Himuro","...I would probably be lying 
...
who it is very important.");
        ...
        MsgDisp("Himuro","There's no point in going 
