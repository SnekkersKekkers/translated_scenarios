...
MsgSel("Now that you mention it, it's kind of embarrassing...","Shall we do something heart-racing?","It's kind of hot, isn't it?");
...
My heart is beating super fast...");
        ...
        MsgDisp("主人公","(As I thought, ｛Nanatsumori＊｝ really is
cool...)");
        ChEye(4,0);
        ChMouth(4,0);
        ChEyeOpenLevel(4,10);
