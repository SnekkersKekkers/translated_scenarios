...
MsgDisp("Guy","Hey, hey∋
This girl is about to take a step 
with me into the new world——");
MsgDispSksp(1,5);
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("B110600000_06_020");
MsgDisp("Himuro","If you take even a single 
step more, I'll call the police.");
MsgDispSksp(0);
ChEye(33,2);
ChMouth(33,2);
...
MsgDisp("Himuro","Spouting meaningless nonsense to 
confuse someone and make them 
anxious is harassment.");
MsgDispSksp(0);
MsgDispSksp(1,5);
ChEye(6,1);
ChMouth(6,0);
...
MsgDisp("Himuro","Stalking and blocking someone's 
path is a clear criminal offense.");
MsgDispSksp(0);
ChEye(33,1);
ChMouth(33,1);
