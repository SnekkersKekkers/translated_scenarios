...
MsgDisp("Mikage","For an extracurricular lesson, you can't go
wrong with somewhere like this, right?");
...
I'm glad.");
    ...
    MsgDisp("Mikage","Hmm, remember that for next time, okay?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
...
But, it is an extracurricular lesson
after all.");
    MsgDateResultDisp();
    break ;
    default :
