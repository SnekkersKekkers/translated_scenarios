...
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("B140500100_05_020");
MsgDisp("Hiiragi","Yes, I'm happy but, there's also a slight
fear too. I have to ensure you do not get
bored of me.");
MsgDisp("主人公","Eh?
...
MsgDisp("主人公","Hehe, being the chairman is tough isn't
it?");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
...
stand on the same stage as me. I find
myself thinking in that manner.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("B140500100_05_050");
