...
troupe. Thanks to that I don't know 
how to interact with others my age.");
ChEye(5,0);
ChMotion(5,0);
...
ChEye(5,4);
ChMotion(5,4);
VoicePlay("B070500001_05_210");
MsgDisp("Hiiragi","Please excuse me.
Mikage-sensei is also an adult, yes.");
MsgDisp("主人公","Hehe, ｛御影＊＊｝ is definitely like
a high schooler from time to time.");
ChEye(5,3);
VoicePlay("B070500001_05_220");
MsgDisp("Hiiragi","Yes, 
so much so that I was confused.");
ChEye(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","Without you there, Inori-kun would 
have the stage to himself.");
ChEye(5,0);
ChMotion(5,4);
VoicePlay("B070500001_05_260");
MsgDisp("Hiiragi","With you there, my surroundings
are miraculously in balance.
That's why it's always lively.");
MsgDisp("主人公","Umm, is that so?");
ChEye(5,4);
ChMotion(5,0);
VoicePlay("B070500001_05_270");
MsgDisp("Hiiragi","Yes, I would be happy if we 
continued to spend time
together like this...");
MsgDisp("主人公","(I would be happy if ｛柊＊＊＊｝
