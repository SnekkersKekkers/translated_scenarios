...
definitely like a high schooler from time
to time.");
ChEye(5,3);
VoicePlay("B070500001_05_220");
MsgDisp("Hiiragi","Yes, so much so that I was confused.");
ChEye(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","With you there, my surroundings are
miraculously in balance.
...
MsgDisp("主人公","(I would be happy if
｛柊＊＊＊｝ continued to enjoy
his school life like this...)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(5,#1);
