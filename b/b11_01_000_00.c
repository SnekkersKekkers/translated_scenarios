...
Okay? Your door has just opened.");
...
MsgDisp("Kazama","Oi. What are you doing?");
ChEye(33,1);
ChMouth(33,0);
...
MsgDisp("Kazama","Hah? Stop screwing around!");
MsgDispSksp(0);
ChEye(33,1);
ChMouth(33,1);
...
MsgDisp("Kazama","What the hell was up with that guy...hey, are
you alright?");
MsgDisp("主人公","Y-Yeah.
