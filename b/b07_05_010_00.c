...
MsgDisp("Hiiragi","You asked me what I thought about \"love\"
before, right?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,4);
...
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("B070501000_05_040");
MsgDisp("Hiiragi","But neither had any relation to my own
feelings, they weren't even my own words.");
MsgDisp("主人公","Yeah.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,0);
...
ChMotion(5,2);
ChEyeOpenLevel(5,0);
VoicePlay("B070501000_05_070");
MsgDisp("Hiiragi","Which bothers me.");
MsgDisp("主人公","Umm...");
ChEye(5,0);
ChMouth(5,3);
ChMotion(5,0);
