...
ChMotion(3,4,1);
VoiceEVSPlay(3);
VoicePlay("B330B20600_03_000");
MsgDisp("Honda","｛主人公｝, what's wrong?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("B330B20600_01_000");
MsgDisp("Kazama","It's because it's a horror.");
ChEye(4,2);
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("B330B20600_04_000");
MsgDisp("Nanatsumori","It's just a movie, when it comes down
to it.");
ChEye(1,0);
ChMouth(1,2);
ChEye(3,0);
