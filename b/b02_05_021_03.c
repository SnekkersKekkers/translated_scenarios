...
ChMotion(5,4);
ChCheek(5,7);
VoicePlay("B020502103_05_000");
MsgDisp("Hiiragi","Just a moment.
I don't know what you're aiming for.");
MsgDisp("主人公","Ehh∋ What's wrong, all of a sudden?");
ChMotion(5,2);
ChEyeOpenLevel(5,8);
VoicePlay("B020502103_05_010");
MsgDisp("Hiiragi","Your outfit is charming, there can be
no doubt.
