...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Himuro","Yeah.
They're chanelling their talent 
into these works. It's like they're 
from a completely different dimension.");
    ...
    MsgDisp("Himuro","Then, why don't you put some 
effort into understanding?");
    ...
    MsgDisp("Himuro","They are made precisely because 
there's a point to them no?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
    break ;
