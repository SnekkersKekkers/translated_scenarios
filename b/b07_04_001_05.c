MsgDisp("主人公","Recently, me, ｛七ツ森＊｝,
｛風真＊＊｝ and ｛本多＊＊｝ have been
spending more time together as a four.");
VoicePlay("B070400001_04_360");
MsgDisp("Nanatsumori","Yeah.");
MsgDisp("主人公","Um... I wonder if I am
out of place?");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,2,1);
VoicePlay("B070400001_04_370");
MsgDisp("Nanatsumori","Well... you are the only girl. You're in a
special position.");
MsgDisp("主人公","Special...");
ChEye(4,0);
ChMouth(4,0);
...
MsgDisp("Nanatsumori","What. Is there something still bothering
you?");
...
worry about it. Just stay as you are.");
