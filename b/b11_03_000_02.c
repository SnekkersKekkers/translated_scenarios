...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","Seems like ｛Honda＊＊｝ isn't here yet...");
MsgDisp("","　　　　　　　　　　 ・
　　　　　　　　　　 ・
　　　　　　　　　　 ・");
MsgClose();
...
MsgDisp("Guy","Hang on a sec～?
What's with that pose?
It looks fantastic, you're nailing it!");
MsgDisp("主人公","Huh?");
ChEye(35,0);
ChMouth(35,0);
...
MsgDisp("Guy","Oh, you've got a good eye.
This gold jacket is a symbol of success.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,3,1);
MsgDispSksp(1,5);
...
MsgDisp("Guy","Of course!
I'm the CEO of a major talent agency.");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,1,1);
MsgDispSksp(1,5);
VoicePlay("B110300002_03_020");
MsgDisp("Honda","I knew it.
Can a CEO in a gold jacket afford to waste
time in a place like this?");
MsgDispSksp(0);
ChEye(35,1);
ChMouth(35,0);
VoicePlay("B110300002_35_050");
MsgDisp("Guy","Oops, time is money.
And now it's time for my board meeting.");
