...
MsgDisp("主人公","｛Mikage＊＊｝ are you asking for
recommendations?
...
MsgDisp("Mikage","But, I wonder if that TV will even turn
on...");
...
The vines from the houseplants twist
around quite nicely around it.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,5);
