...
but I'm getting bashful.");
    MsgDisp("主人公","(When you say something like that, 
I'll feel shy too...)");
    ChCheek(7,0);
    break ;
    case 1:
    ...
    MsgDisp("Mikage","Don't apologize,
I'll get embarrassed. Let's not
count what happened just now?");
    MsgDisp("主人公","(Hmmm...
