...
I lived only in a narrow world of the
theatre company.");
...
MsgDisp("Hiiragi","Ah. But thanks to that, I became a little
bit acquainted with the local specialties
of various places.");
...
MsgDisp("Hiiragi","At that time, a lot of the flavours were
too complex for me.");
