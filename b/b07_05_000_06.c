MsgDisp("主人公","｛柊＊＊＊｝, what were you 
like in middle school?");
ChMouth(5,4);
ChMotion(5,2);
VoicePlay("B070500000_05_240");
MsgDisp("Hiiragi","In a sense, I was a different person.
I lived only in a narrow world 
of the theatre company.");
MsgDisp("主人公","You toured the country with the 
theatre company. I think that's 
truly incredible.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("B070500000_05_250");
MsgDisp("Hiiragi","I suppose it was like being in a
small box, and that box was 
...
MsgDisp("Hiiragi","At that time, a lot of the 
flavors were too complex for me.");
MsgDisp("主人公","(I can't even imagine the
world ｛柊＊＊＊｝ lived in...)");
BGMStop();
MsgClose();
ScrFadeOut(0);
