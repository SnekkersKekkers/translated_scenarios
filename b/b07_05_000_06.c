MsgDisp("主人公","｛Hiiragi＊＊＊｝, what were you like in
middle school?");
ChMouth(5,4);
ChMotion(5,2);
...
MsgDisp("Hiiragi","I suppose it was like being in a small box,
and that box was transported around the
country.");
ChEye(5,0);
ChMotion(5,0);
VoicePlay("B070500000_05_260");
MsgDisp("Hiiragi","Ah. But thanks to that, I became a little bit
acquainted with the local specialties of
various places.");
VoicePlay("B070500000_05_270");
MsgDisp("Hiiragi","I received some from our patrons as backstage
presents.");
MsgDisp("主人公","Eh! There must have been all sorts of things.");
ChEye(5,4);
ChMotion(5,2);
