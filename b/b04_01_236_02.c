...
MsgSel("That fish guy's dancing... it's pulling me in","Everyone's breath is in perfect sync!","I might end up joining?");
...
Your weird dancing actually lured the fish
guy over.");
        MsgDisp("主人公","Hey.");
        ChEye(1,0);
        ChMouth(1,3);
