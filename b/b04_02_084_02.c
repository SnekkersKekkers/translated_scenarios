...
switch (MsgSelRsltGet()){
    ...
    switch (ChPrmGet(2,6)){
        ...
        MsgDisp("Sassa","I-It'll be fine.
No...camping by the water is kind of a dangerous setup...");
        MsgDateResultDisp();
        break ;
        case 4:
        case 5:
...
I might stand a chance.");
        ...
        MsgDisp("Sassa","I was thinking of how to protect you from
dangerous people.
Best plan is to carry you on my back and run.");
        ChEye(2,0);
        ChMouth(2,4);
        ChMotion(2,3);
