...
there are still more diamonds 
in the rough in Habataki City!");
MsgDisp("主人公","...Eh?");
ChEye(35,2);
ChMouth(35,0);
VoicePlay("B110400002_35_020");
MsgDisp("Guy","Yes, come, today is a success too!
I've been producing in Habataki 
City for decades, so leave it to me!");
ChEye(35,1);
ChMouth(35,0);
VoicePlay("B110400002_35_030");
MsgDisp("Guy","From today onwards you'll be 
singing and dancing in an idol group, 
True Reversal 4——");
...
here, our agency is going to file
...
This isn't really our turf so
standing out is a bit risky you know...");
MsgDispSksp(1,5);
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","That old man is apparently
...
MsgDisp("Nanatsumori","Yeah, but somehow he keeps climbing
up the ranks. Guess even weeds 
