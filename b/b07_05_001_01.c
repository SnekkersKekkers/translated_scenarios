...
but he knows much more about the world than I
do. He's an adult.");
...
MsgDisp("Hiiragi","But if I were to speak ill of him, he's an
adult with bad taste.");
MsgDisp("主人公","Ehh?");
VoicePlay("B070500001_05_070");
MsgDisp("Hiiragi","When the other person starts to get fired up,
he happily adds more fuel to the fire.");
ChEye(5,3);
ChMotion(5,0);
VoicePlay("B070500001_05_080");
MsgDisp("Hiiragi","He does that so easily.
He's an interesting and scary guy.");
MsgDisp("主人公","(On the other hand, I wonder what ｛Himuro＊＊｝
thinks of ｛Hiiragi＊＊＊｝?)");
BGMStop();
MsgClose();
ScrFadeOut(0);
