...
MsgDisp("Honda","Ah, but I especially like shows about
the Big Bang and Earth's 4.6 billion
year history.");
...
I feel like one of the participants
always waving their hands.");
...
She says it's boring watching it with
me.");
MsgDisp("主人公","Ahh, I think I can understand her
...
MsgDisp("Honda","I mean, isn't it weird to stay quiet
even though you know the answer?");
MsgDisp("主人公","(Knowing so many things can make
things difficult, huh......)");
BGMStop();
MsgClose();
ScrFadeOut(0);
ChEyeOpenLevel(3,#1);
