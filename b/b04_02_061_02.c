...
Maybe that's the beach club's strategy?");
    ...
    switch (ChPrmGet(2,6)){
        ...
        MsgDisp("Sassa","I understand wanting to ride
a dolphin. But in what situation would
you want to ride a killer whale?");
        MsgDateResultDisp();
        break ;
        case 4:
        case 5:
...
But you know, me floating in the ocean
all by myself, straddling that thing...");
...
though?");
        ...
        MsgDisp("主人公","I think it would be fun if
we rode one together.");
        ChEye(2,0);
        ChMouth(2,2);
        ChMotion(2,4);
        ChCheek(2,10);
        ...
        MsgDisp("主人公","Yeah.
It's hard to stay afloat with two
people on top.");
        ChEye(2,0);
        ChMouth(2,2);
        ChMotion(2,2);
        VoicePlay("B040206102_02_080");
        MsgDisp("Sassa","......Woah, the orca actually
has hidden potential. I didn't think
of that......");
        MsgDisp("主人公","Uhm......?
...
Hurry! Before they run out of rentals.");
        MsgClose();
        SEPlay("EV_SE_580");
        ChClose(2);
        SEWait();
