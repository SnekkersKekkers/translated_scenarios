...
MsgDisp("Kazama","I wonder if you can see autumn
leaves like this so close to the city?");
...
switch (MsgSelRsltGet()){
    ...
    MsgDisp("Kazama","Yeah, it's like a mirror, being
reflected upside down.");
    ...
    MsgDisp("Kazama","It looks that way because the
water is so transparent.");
    ...
    MsgDisp("Kazama","... Sheesh, what would you be doing,
