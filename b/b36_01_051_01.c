...
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("B360105101_01_020");
MsgDisp("Kazama","And if we blend into the shadows, we can
avoid the worst-case scenario.");
MsgDisp("主人公","Worst case scenario?");
ChEye(1,2);
ChMouth(1,0);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
ChMotion(1,0);
ChEyeOpenLevel(1,0);
VoicePlay("B360105101_01_050");
MsgDisp("Kazama","Hey, we've had enough fun with those guys.
It's been noisy all day today?");
SEPlay("EV_SE_038");
SEWait();
ChEye(1,0);
ChMouth(1,0);
