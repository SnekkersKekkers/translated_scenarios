...
training that when I hear those songs, my
body just starts moving on its own.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
Ah, keep it a secret from Ryota and Inori.");
MsgDisp("主人公","Eh, really?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("B360217001_02_060");
MsgDisp("Sassa","Both Inori and Ryota would laugh once they
heard this.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
...
MsgDisp("Sassa","Right?
They'll mess with you as soon as they spot
an opening. You better be careful too.");
