...
MsgDisp("Hiiragi","I's like to go overseas, not 
just cruise around Habataki bay.");
...
When you say it, it sounds as 
if it could simply be reality, 
...
If Theatre Troupe Habataki performed
on a ship, I guess we could go 
there for work?");
    MsgDispSksp(1,0);
    MsgDateResultDisp();
    MsgDispSksp(0);
...
As I've never been on a
boat for a prolonged trip. ");
        ChMotion(5,4);
        VoicePlay("B040502202_05_050");
        MsgDisp("Hiiragi","Before coming to Habataki City,
I traveled all over the country,
but it wasn't on a sea voyage.");
        MsgDisp("主人公","I see.
｛柊＊＊＊｝ is accustomed to travelling.");
        ChEye(5,0);
        ChMotion(5,0);
        VoicePlay("B040502202_05_060");
        MsgDisp("Hiiragi","Ah, just now you made a little
bit of a jealous face, correct?");
        MsgDisp("主人公","Yeah, but I think it 
must've been difficult...");
        ChEye(5,3);
        VoicePlay("B040502202_05_070");
        MsgDisp("Hiiragi","You're an honest person.
I experienced the cultures of lots
of different areas, and that was fun.");
        ChEye(5,2);
        ChMotion(5,2);
        VoicePlay("B040502202_05_080");
        MsgDisp("Hiiragi","But, it would be more difficult 
on a small child right?");
...
happier.");
        ...
        MsgDisp("Hiiragi","After hearing you say that,
I kind of miss the life of travel.");
        MsgDisp("主人公","(｛柊＊＊＊｝...)");
        break ;
        default :
        DbgAssert(1);
