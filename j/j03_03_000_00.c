...
I hope ｛日付｝ arrives fast!)");
    ...
    MsgDisp("主人公","Alright, then let's meet on ｛日付｝. I'll
...
Whatever you ask, from now on,
the answer is okay, get it?");
    MsgDisp("主人公","Eh!!");
...
for you at the ｛待ち合わせ場所｝.");
    ...
    MsgDisp("Honda","No......I just thought since you called,
it'd be too bad to hang up just now.");
