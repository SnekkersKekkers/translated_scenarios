switch (ChPrmGet(5,6)){
    ...
    MsgDisp("Hiiragi","......Yes.
I'm available.");
    MsgDisp("主人公","Well then,on the ｛日付｝ I will be
...
I look forward to seeing you on the day.");
    ...
    MsgDisp("主人公","(Hooray!
II can't wait for the ｛日付｝ to come!)");
    break ;
    case 3:
    VoicePlay("J030500000_05_020");
    MsgDisp("Hiiragi","......Yes, I am available.
I will go out with you.");
    MsgDisp("主人公","Then,on the ｛日付｝ I'll be waiting for
you at ｛待ち合わせ場所｝.");
...
I can't wait for the ｛日付｝ to come.)");
    ...
    MsgDisp("Hiiragi","No, it's alright. If we fill it now, I
