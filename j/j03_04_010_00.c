...
switch (ChPrmGet(4,6)){
    ...
    case 1:
    case 2:
    MsgDisp("主人公","(Oh,I'ts a phone call from ｛七ツ森＊｝ )");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEStop("EV_SE_577",0);
    SEWait();
    MsgDisp("主人公","Yes, Is ｛主人公苗字｝.");
    VoicePlay("J030401000_04_000");
    MsgDisp("Nanatsumori","Ah......I.
I know it's a voicemail thing, but okay.");
    MsgDisp("主人公","Really? Well then, ｛日付｝ I'll be
...
I hope that ｛日付｝ comes soon!)");
    ...
    SEStop("EV_SE_577",0);
    SEWait();
    MsgDisp("主人公","Yes ma'am,is ｛主人公苗字｝.");
    VoicePlay("J030401000_04_020");
    MsgDisp("Nanatsumori","Oh, I. Nanatsumori.
...
oversleeping. You can do it. Bye.");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
    MsgDisp("主人公","(Hoorayー!
I hope that ｛日付｝ comes soon!)");
