...
｛主人公苗字｝ speaking");
    ...
    MsgDisp("Honda","Hey, it's me. Is this a good time?
For calling me.");
    MsgDisp("主人公","Uh, yeah.
I don't know?");
...
commitment...... I was hoping to adjust it
somehow.");
    MsgDisp("主人公","Oh, I see. Never mind?
I'm glad you feel that way.");
    VoicePlay("J030301001_03_050");
    MsgDisp("Honda","Then next time, let's go have fun
together! Well, I'll see you later?");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
    MsgDisp("主人公","(Hmmm, too bad......)");
    break ;
...
Bingo.");
    ...
    MsgDisp("Honda","......I'm not happy about 
getting bingo at all though.");
    MsgDisp("主人公","Sorry for the bad timing.");
    VoicePlay("J030301001_03_090");
    MsgDisp("Honda","What? Why are you apologizing?
