...
MsgDisp("Nanatsumori","Once we're born as living creatures, I wonder
if it's possible to end it with just being
\"friends\".");
MsgDisp("主人公","?");
ChEye(4,2);
ChMouth(4,0);
...
MsgDisp("Nanatsumori","But even if you love someone, it doesn't mean
you'll end up together.");
VoicePlay("G020430201_04_040");
MsgDisp("Nanatsumori","Maybe, even if you love them, you might not
...
To reach the ideal goal in life, first, you
need to become friends with people.");
ChEye(4,2);
ChMouth(4,2);
ChMotion(4,2,1);
