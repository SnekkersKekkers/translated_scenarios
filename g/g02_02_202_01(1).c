...
MsgDisp("Sassa","What kind of person is Inori?");
MsgDisp("主人公","Eh, why this all of a sudden?");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
VoicePlay("G020220201_02_010");
MsgDisp("Sassa","I mean, no one in the track team 
comes on that strong.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
...
MsgDisp("Sassa","Haa......I thought I was the closest
to you, but Inori slipped past me.");
MsgDisp("主人公","Eh......");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
