...
MsgDisp("Sassa","I see. When I was picking it out, the
store clerk asked me a bunch of questions");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,2);
VoicePlay("G020210304_02_020");
MsgDisp("Sassa","They were nice about it and all, 
but I wanted to choose it myself.");
MsgDisp("主人公","Hehe. It was ｛颯砂＊＊｝ who picked it for
me right?");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
...
fashion for girls.");
MsgDisp("主人公","Something ｛颯砂＊＊｝ likes would be
better.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
...
thought. Oh, I need to cool my head!");
