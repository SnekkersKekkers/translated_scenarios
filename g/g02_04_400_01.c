...
MsgDisp("Nanatsumori","｛主人公｝. What do you think of
men who crossdress?");
...
MsgDisp("Nanatsumori","Uh... well, kind of. Like being a
witch or dressing as a high school girl.");
...
common.");
MsgDisp("主人公","I think it's the freedom to
...
MsgDisp("Nanatsumori","Hey. Isn't it true that girls
want boys that dress up like
girls?");
MsgDisp("主人公","Huuuh∋");
ChEye(4,0);
ChMouth(4,2);
...
MsgDisp("Nanatsumori","Then, maybe it's just my sister who
