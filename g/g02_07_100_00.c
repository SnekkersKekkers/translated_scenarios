ChLayout(1);
MsgClose();
ChOpen(7,255,0,3,0,#1,#1,0,0);
ChMotion(7,3);
VoicePlay("G020710000_07_000");
MsgDisp("Mikage","This is beautiful.");
...
MsgDisp("Mikage","That sounded a bit like a lecture just now.");
MsgDisp("主人公","It's like I'm occupying ｛Mikage＊＊｝'s
lesson by myself.
I'm happy.");
ChEye(7,0);
ChMouth(7,3);
...
ChMouth(7,0);
ChMotion(7,4);
VoicePlay("G020710000_07_050");
MsgDisp("Mikage","I'm kind of sneaky, aren't I?");
MsgDisp("主人公","Eh?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
...
MsgDisp("主人公","(I wonder what's up with ｛Mikage＊＊｝
today...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
