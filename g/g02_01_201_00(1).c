...
MsgDisp("Kazama","I'm only looking at you.
But near you, there's someone else, isn't
there?");
MsgDisp("主人公","Umm......");
ChEye(1,2);
ChMouth(1,0);
...
MsgDisp("Kazama","I've known for a long time.
You like beautiful things, always looking
for fun.");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","Being at a slight disadvantage is the
perfect handicap, right?");
MsgDisp("主人公","(｛風真＊＊｝, you seem troubled about
something......)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
