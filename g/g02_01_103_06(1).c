...
MsgDisp("Kazama","Hey, I wonder what your reaction would
be if you came here for the first time 
...
MsgDisp("Kazama","Yeah, I wanted to see that.
Your surprised face. Well, even now 
you're making quite an expression.");
MsgDisp("主人公","Hey.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,3,1);
VoicePlay("G020110306_01_020");
MsgDisp("Kazama","Don't be mad. 
I like seeing your surprised face.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
VoicePlay("G020110306_01_030");
MsgDisp("Kazama","So, 
I'm always thinking about surprising you.");
MsgDisp("主人公","Is that so? 
But, I don't want to be too surprised.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
...
You had a nice reaction and 
you seemed to enjoy eating it.");
ChEye(1,4);
ChMouth(1,4);
ChMotion(1,2);
...
MsgDisp("Kazama","Like how I disappeared suddenly,
suddenly came back, 
...
MsgDisp("Kazama","That's right. The biggest surprise I can
think of is......");
...
MsgDisp("主人公","(I'm looking forwards to it but
