...
MsgDisp("Hiiragi","Since meeting you, I've been able to deepen
our relationship little by little.");
ChEye(5,4);
ChMotion(5,2);
...
MsgDisp("Hiiragi","It's only natural, when you think about it.
Just like in the plays I create, love doesn't
always progress smoothly.");
ChEye(5,2);
ChMotion(5,4);
ChEyeOpenLevel(5,9);
...
MsgDisp("Hiiragi","In fact, I might have to step off the stage
that features you as the heroine.");
