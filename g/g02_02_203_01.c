...
buying the same thing in different
colours.");
...
different styles.");
MsgDisp("主人公","Sorry.
But with ｛Sassa＊＊｝'s figure, it seems
any style would fit.");
ChEye(2,0);
ChMouth(2,2);
ChMotion(2,4);
ChEyeOpenLevel(2,7);
VoicePlay("G020220301_02_040");
MsgDisp("Sassa","That's so sloppy.
You're like that sometimes, aren't you?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
ChMouth(2,0);
ChMotion(2,3);
VoicePlay("G020220301_02_070");
MsgDisp("Sassa","Yeah it is.
Try to look closely.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
VoicePlay("G020220301_02_080");
MsgDisp("Sassa","Sigh...it must be nice for those who look
