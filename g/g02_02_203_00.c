...
MsgDisp("Sassa","When you look at how fast they fly, they're
...
MsgDisp("Sassa","If you were a firefly, which would
you prefer?");
MsgDisp("主人公","Huh? If I were a firefly?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
But that's...just how Firefly You
feels, right?");
...
MsgDisp("主人公","So now we're talking about you as a firefly,
｛Sassa＊＊｝?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
MsgDisp("Sassa","Yep.
Firefly Me would fly around you, flying the
way that'd make you fall in love.");
...
MsgDisp("Sassa","Sigh...
I bet it'd be easier to be your partner if we
were fireflies...");
