...
MsgDisp("Sassa","｛主人公｝,
I just jumped all the hurdles as I
imagined them.");
MsgDisp("主人公","Yeah, it's a better time than the
last track meet.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,1);
VoicePlay("G110200602_02_010");
MsgDisp("Sassa","So that I don't forget this feeling, 
I'm going once more.");
MsgClose();
ScrFadeOut(0);
ChClose(2);
...
MsgDisp("Sassa","This is my last Inter-High. Maybe I can
give my seniors some good news.");
...
MsgDisp("Sassa","I'm only doing this for myself,
but everyone is cheering me on.
I couldn't be happier.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
VoicePlay("G110200602_02_050");
MsgDisp("Sassa","That's why I'm going to keep going
until I drop.");
