...
space for me to jump in.");
MsgDisp("主人公","Why's that? I think it's totally fine for
you to join in.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,0);
...
MsgDisp("Honda","It wasn't like I was disliked,
but at the same time, I wasn't warmly 
welcomed either......something like that?");
...
observations.");
MsgDisp("主人公","Ah! Was it when we were talking about
how the weather's been bad recently?");
ChMouth(3,4);
ChMouth(3,0);
ChMotion(3,1);
...
ChMouth(3,3);
ChMotion(3,0);
VoicePlay("G020330100_03_050");
MsgDisp("Honda","Normally, jumping from a weather topic to
meteorological observations got me a wry
smile later on.");
ChEye(3,1);
ChMotion(3,4);
ChMotion(3,1);
VoicePlay("G020330100_03_060");
MsgDisp("Honda","So I'll hold back for a while! I'll
refrain from that unless it's with you!");
MsgDisp("主人公","(Can he really hold back......
It might be tough for ｛本多＊＊｝?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChLayout(1);
