...
That suddenly, I'm remembering that cafe in
Kamakura.");
...
MsgDisp("主人公","It is a spot with mystical energy after all.");
ChMotion(5,0);
ChEyeOpenLevel(5,0);
Wait(12,0);
ChEye(5,3);
...
MsgDisp("Hiiragi","Yes, and this time too, I'm with a goddess.");
MsgDisp("主人公","Eh?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
