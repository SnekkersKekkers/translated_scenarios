...
MsgDisp("Nanatsumori","The firefly lights are so warm,
huh.");
MsgDisp("主人公","You're right. Warm, cozy colors
in the sky... Ah.");
...
MsgDisp("Nanatsumori","Oh, nice memory. There were a lot
of powerful lights and stuff.");
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","Hey, do you really see me as
a man?");
MsgDisp("主人公","Huh?");
ChEye(4,2);
ChMouth(4,4);
...
MsgDisp("Nanatsumori","That's it, huh? Gah. If it's
just that, I'll forgive you......");
ChEye(4,4);
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("G020410301_04_080");
MsgDisp("Nanatsumori","Well, that's fine. You can
visit my room again.
I'll get you a nice cake.");
MsgDisp("主人公","(Yay! But, I wonder what
｛七ツ森＊｝ meant by saying I don't see
him as a man...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
