...
huh.");
MsgDisp("主人公","You're right. Warm, cozy colors in the
sky... Ah.");
...
MsgDisp("Nanatsumori","That's it, huh? Gah. If it's just that,
I'll forgive you......");
ChEye(4,4);
ChMouth(4,3);
ChMotion(4,0,1);
...
MsgDisp("主人公","(Yay! But, I wonder what ｛七ツ森＊｝
meant by saying I don't see him as a
man...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
