...
MsgDisp("Mikage","These fireflies here, you know, 
they seem to mysteriously appear in
various colors, don't they?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
Yanosuke might just say what he sees,
but I wonder about Inori?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,5);
