...
ScrFadeIn(0);
MsgDisp("主人公","｛御影＊＊｝. You've brought the gardening
...
MsgDisp("Mikage","Teacher's privileges. Looking over at
activity logs is fun, you know?");
...
MsgDisp("Mikage","Isn't it. But I'm keeping records so I can
see the changes in you guys.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
while (1){
    ...
    MsgDisp("Mikage","Is it mud? Don't worry about it.");
    }
