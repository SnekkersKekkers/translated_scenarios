...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(This is nice weather...... Maybe I should
take a break in the courtyard for a bit?)");
MsgClose();
...
MsgDisp("Hiiragi","Thank you. Thanks to you, I didn't have to
make another trip.");
...
MsgDisp("主人公","I see. ｛柊＊＊＊｝, Don't push yourself
too hard, okay?");
ChEye(5,0);
ChMouth(5,1);
ChMotion(5,0);
...
see you facing your canvas. You look like
you're having fun.");
MsgDisp("主人公","Eh?");
ChEye(5,0);
ChMouth(5,1);
...
time.");
MsgDisp("主人公","...... That is if I can make something
I'm pleased with?");
ChEye(5,1);
ChMouth(5,1);
ChMotion(5,1);
