...
ChMouth(3,0);
ChMotion(3,1);
VoicePlay("G020310401_03_020");
MsgDisp("Honda","Yeah.
Just holding hands with someone you like can
make you feel so happy. It's amazing.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
ChEyeOpenLevel(3,0);
...
MsgDisp("Honda","They say holding hands with someone you like
makes you happy, right?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,0);
VoicePlay("G020310401_03_060");
MsgDisp("Honda","So if holding hands makes you happy, it means
the person you're holding hands with is
someone you like.");
MsgDisp("主人公","I-I see....");
ChEye(3,0);
ChMouth(3,0);
...
ChMotion(3,2);
ChCheek(3,10);
VoicePlay("G020310401_03_100");
MsgDisp("Honda","What is this reaction? Does everyone feel
this when they hold hands? Did those middle
schoolers experience this too?");
MsgDisp("主人公","(Um, maybe we should figure this out first?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChLayout(1);
