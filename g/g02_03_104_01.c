...
MsgDisp("Honda","Yeah.
Just holding hands with someone you like
can make you feel so happy. It's amazing.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4);
ChEyeOpenLevel(3,0);
...
As I try to hold your hand, my throat
feels tight...");
MsgDisp("主人公","Ehh?");
ChEye(3,5);
ChMouth(3,3);
...
this when they hold hands? Did those
middle schoolers experience this too?");
MsgDisp("主人公","(Um, maybe we should figure this
out first?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
