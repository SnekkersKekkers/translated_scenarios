...
｛Kazama＊＊｝ said he wanted to talk to me on
the way home. ...I wonder what could it be?)");
...
ScrFadeIn(0);
MsgDisp("主人公","That's right, you said you had something you
...
MsgDisp("Kazama","It's been a long time since we held hands so
naturally like that.");
MsgDisp("主人公","Eh?");
ChEye(1,0);
ChMouth(1,2);
...
MsgDisp("Kazama","We were in the same class, same
neighbourhood, and super close, yet it was
hard to find a good moment to hold hands.");
...
MsgDisp("Kazama","Hey, let's hold hands while walking home.");
MsgDisp("主人公","Y-Yeah....");
