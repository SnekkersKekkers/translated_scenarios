...
ChCheek(2,10);
ChCheek(2,0);
VoicePlay("G020210300_02_030");
MsgDisp("Sassa","It's fine if you don't remember.
The other day, I said something weird because
...
MsgDisp("Sassa","See, when you get bashful like that, it makes
me want to──");
ChEye(2,2);
ChMouth(2,4);
ChMotion(2,0);
ChCheek(2,0);
VoicePlay("G020210300_02_060");
MsgDisp("Sassa","...sigh, it's just like with these fireflies.
They're so cute and beautiful, and I want to
catch them, but I won't right now.");
