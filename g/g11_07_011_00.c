...
organic café here...)");
MsgDisp("主人公","(That's right, I should go take a look at the
vegetable garden.)");
MsgClose();
MsgClose();
ScrFadeOut(0);
...
MsgDisp("Mikage","｛主人公｝.
Sigh...the last cultural festival is over.");
MsgDisp("主人公","Yes...");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("主人公","Yes. thanks to ｛Mikage＊＊｝, we were able
to set up in front of a prime location; the
school gates.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("G110701100_07_030");
MsgDisp("Mikage","At the cultural festival, it's okay for the
cultural club to stand out, right?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("G110701100_07_040");
MsgDisp("Mikage","It would be great if it became tradition for
the Gardening club to host a café in front
of the school gates.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("G110701100_07_050");
MsgDisp("Mikage","But, I wonder if it wouldn't be as exciting
without you third years?");
MsgDisp("主人公","It'll be fine.
The second years and ｛Mikage＊＊｝ will be
there too.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
