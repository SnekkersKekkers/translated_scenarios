...
MsgDisp("Mikage","｛主人公｝. Haa......the last cultural
festival is over.");
MsgDisp("主人公","Yes......");
ChEye(7,2);
ChMouth(7,0);
...
MsgDisp("主人公","Yes. thanks to ｛御影＊＊｝, we were able
...
｛御影＊＊｝ will be there too.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("G110701100_07_060");
MsgDisp("Mikage","Ahh, that's right. The second years are
