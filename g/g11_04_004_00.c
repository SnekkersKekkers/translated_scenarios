BGOpen("sc000",1);
ScrFadeIn(0);
MsgDisp("主人公","(I feel like stopping by Cafe
Alucard for a bit...)");
...
MsgDisp("Nanatsumori","You've got to keep the
fashionista's informed.");
ChEye(4,2);
ChMouth(4,2);
ChMotion(4,1);
VoicePlay("G110400400_04_040");
MsgDisp("Nanatsumori","Just like you did the other day.
Give a shot for people who want new
...
Maybe you'll decide to have a date
with me next time too.");
MsgDisp("主人公","(A date... I see!
｛七ツ森＊｝ really is paying close
attention after all.)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
