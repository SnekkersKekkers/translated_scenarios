...
MsgDisp("Honda","This one is about the 3500km journey
of the Monarch butterfly.
Which one are you interested in?");
MsgDisp("主人公","(Hmm......I'm more interested in the book
｛本多＊＊｝ is holding so dearly than 
...
｛本多＊＊｝ was holding it so dearly.");
ChEye(3,1);
ChMouth(3,1);
ChMotion(3,1);
ChEyeOpenLevel(3,0);
VoicePlay("G110300800_03_070");
MsgDisp("Honda","Yep yep, that's fine. This is a 'Weevil
Picture Book', have at it!");
MsgDisp("主人公","(Weevil......?
