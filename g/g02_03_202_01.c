...
the stereotypical popular guy role.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("G020320201_03_050");
MsgDisp("Honda","But you didn't fall for him just because
of those superficial aspects, right?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,4);
...
Mi-kun...");
MsgDisp("主人公","(I didn't know ｛Honda＊＊｝ felt
this way...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
