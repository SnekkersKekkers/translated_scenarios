...
MsgDisp("主人公","Yeah, I wonder how many fireflies are
here.");
ChEye(1,0);
ChMouth(1,4);
ChMotion(1,1);
VoicePlay("G020120202_01_010");
MsgDisp("Kazama","Who knows. It's definitely a crazy number
though.");
MsgDisp("主人公","I hope everyone manages to find a partner.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("G020120202_01_020");
MsgDisp("Kazama","Isn't that impossible? Not that I would
know.");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("Kazama","Though I'm sure he could give you real
...
MsgDisp("Kazama","I'm just saying that Honda could actually
sate your curiosity.");
ChEye(1,2);
ChMouth(1,0);
ChMotion(1,0);
...
MsgDisp("Kazama","......Yeah, you're right. He's special
after all.");
...
but I'll figure something out. I have a
reason why I can't back down.");
