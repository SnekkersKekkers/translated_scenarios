...
MsgDisp("Kazama","You know, the time that we spend 
together seems to go by super fast......");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
VoicePlay("G110100700_01_010");
MsgDisp("Kazama","It feels like we're the 
...
Time flows slowly for us, 
And everyone else is busy as usual.");
ChEye(1,1);
ChMouth(1,0);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
MsgDisp("Kazama","It feels like we've only been together 
for an hour, but to everyone else hours
have passed......");
ChEyeOpenLevel(1,0);
Wait(10,0);
ChEye(1,0);
...
MsgDisp("Kazama","......The sun sets at the same time
for everyone though, so I won't gain 
or lose anything by staying I guess?");
ChEyeOpenLevel(1,0);
Wait(10,0);
ChEye(1,0);
ChMouth(1,2);
...
MsgDisp("Kazama","Let's just chill here
until the sun goes down a little more.");
