...
MsgDisp("Sassa","I was talking with Ryota and Inori. They
wanted to hear your inner thoughts here.");
...
MsgDisp("Sassa","I'm going to tell them that 
I came here with you right away.");
...
MsgDisp("Sassa","Yeah.
Inori might not believe me, 
so I'll need you to back me up.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
