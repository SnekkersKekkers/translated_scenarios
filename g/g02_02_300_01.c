...
MsgDisp("Sassa","The one who's watching the fireflies with you
is me.");
MsgDisp("主人公","Y-Yeah.
...
They wanted to hear your inner thoughts here.");
MsgDisp("主人公","Then...did you hear something?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("G020230001_02_020");
MsgDisp("Sassa","Nope, not at all.
But just being here with you is what matters.
So I win.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
MsgDisp("Sassa","Yeah.
Inori might not believe me, so I'll need you
to back me up.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","Heheh.");
MsgDisp("主人公","(｛Sassa＊＊｝, are you enjoying yourself...?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChLayout(1);
