...
MsgDisp("主人公","(｛風真＊＊｝ tends to overthink things, 
so even if it's just a little,
I hope I can give him a bit of push......)");
while (1){
...
MsgDisp("Kazama","I like being able to see all 
sorts of items at auctions......");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,2);
VoicePlay("G110101000_01_090");
MsgDisp("Kazama","Yeah, I see.
I'll tell him what I'm thinking,
and see if he still lets me does it.");
