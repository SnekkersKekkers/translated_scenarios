...
ChMotion(2,4);
ChEyeOpenLevel(2,0);
VoicePlay("G020210101_02_030");
MsgDisp("Sassa","And imagining Inori's thoughts would be
hilarious.");
ChEye(2,0);
ChEyeOpenLevel(2,10);
MsgDisp("主人公","｛Himuro＊＊｝'s thoughts...");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,4);
VoicePlay("G020210101_02_040");
MsgDisp("Sassa","Yeah.
He'd probably just be blunt about it and even say
abusive language——");
ChEye(2,0);
ChMouth(2,2);
ChMotion(2,4);
