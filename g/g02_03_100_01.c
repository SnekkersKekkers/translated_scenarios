...
MsgDisp("Honda","Hey, do you think I talk too much 
when I'm with you?");
...
MsgDisp("Honda","Sometimes when I'm with my family, I 
end up talking too much and it 
gets annoying for them.");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("G020310001_03_020");
MsgDisp("Honda","The other day, my sister was worried. She
asked if I do the same thing when I'm with
you.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,1);
...
MsgDisp("Honda","And when I told her I probably do,
maybe even more so with you, she got
mad at me.");
MsgDisp("主人公","Hehe!");
ChEye(3,3);
ChMouth(3,3);
...
When you laugh like thatー
I can't help but keep talking");
ChSet(3,0);
VoicePlay("G020310001_03_050");
MsgDisp("Honda","So if you ever get bored or want 
to change the topic, give me a sign.");
MsgDisp("主人公","A sign?");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,1);
...
MsgDisp("Honda","It's strange, my heart's
starting to beat really loudly......");
