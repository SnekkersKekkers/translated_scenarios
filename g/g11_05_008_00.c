...
MsgDisp("Hiiragi","Yes. Good work today.");
MsgDisp("主人公","Huh? ｛Hiiragi＊＊＊｝ is still here?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","Whether I'm actually helping is
another matter.");
...
ChEyeOpenLevel(5,#1);
SEPlay("EV_SE_712");
MsgDisp("主人公","(It looks like ｛Hiiragi＊＊＊｝ is pushing
