...
MsgDisp("主人公","｛Nanatsumori＊｝, are you taking a break?");
VoicePlay("G110400200_04_010");
MsgDisp("Nanatsumori","Yeah. Shooting some new accessories today.");
MsgDisp("主人公","I see. It was still early after all...");
ChEye(4,0);
ChMouth(4,2);
VoicePlay("G110400200_04_020");
MsgDisp("Nanatsumori","Ah... Are you interested in a new product?");
MsgDisp("主人公","Yeah. But I couldn't find any.");
ChEye(4,2);
ChMouth(4,2);
VoicePlay("G110400200_04_030");
MsgDisp("Nanatsumori","Didn't I tell you?
I'm about to be in a new shoot.");
MsgDisp("主人公","Hehe. I guess I was being too hasty?");
ChEye(4,0);
ChMouth(4,2);
ChMotion(4,2);
