...
maybe I did something to upset you.");
ChEye(4,2);
ChMouth(4,3);
ChMotion(4,2,1);
VoicePlay("G020420100_04_030");
MsgDisp("Nanatsumori","Haa......sorry. It's not to do with
anything that happened on our date today.");
ChEye(4,2);
ChMouth(4,4);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","It hurts. I'm experiencing my heart being
torn open for the first time.");
ChEyeOpenLevel(4,0);
VoicePlay("G020420100_04_070");
MsgDisp("Nanatsumori","......If you were to dislike me, 
It would be the same as the world ending.");
MsgDisp("主人公","｛七ツ森＊｝……");
ChEye(4,2);
ChMouth(4,4);
ChMotion(4,0,1);
