...
MsgDisp("Mikage","We started with bowling, 
and now we're watching fireflies.");
MsgDisp("主人公","And we went to the amusement park too.");
ChEye(7,0);
ChMouth(7,3);
VoicePlay("G020710306_07_040");
MsgDisp("Mikage","Yeah, that's right. The roller coaster at
Habataki Land Town is intense.");
