...
MsgDisp("Himuro","I started by chance,
and deep down I thought I'd get
bored of it one day.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0,1);
VoicePlay("G020640002_06_020");
MsgDisp("Himuro","But the feeling of riding the waves, 
the wind on my body, the splashes of water
flowing by while sparkling......");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("G020640002_06_030");
MsgDisp("Himuro","Before I knew it,
it had become a part of me.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("G020640002_06_040");
MsgDisp("Himuro","If I hadn't been invited to surf, 
I don't think I'd be so into it.");
MsgDisp("主人公","I see.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0,1);
VoicePlay("G020640002_06_050");
MsgDisp("Himuro","Well,
...
MsgDisp("Himuro","Wonder what would have happened
if I'd been invited to play baseball......");
...
ChMotion(6,4);
ChCheek(6,5);
VoicePlay("G020640002_06_080");
MsgDisp("Himuro","Ah, right.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("G020640002_06_090");
MsgDisp("Himuro","But I'd rather be soaked
than covered in mud.");
MsgDisp("Himuro","Mud seems like it would be a
pain to get the stains off.");
MsgDisp("主人公","Hehe.");
ChEye(6,1);
ChMouth(6,0);
ChMotion(6,2);
