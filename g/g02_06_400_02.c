...
MsgDisp("Himuro","Before I knew it, it had become a part
of me.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("G020640002_06_040");
MsgDisp("Himuro","If I hadn't been invited to surf, I don't
think I'd be so into it.");
MsgDisp("主人公","I see.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0,1);
VoicePlay("G020640002_06_050");
MsgDisp("Himuro","Well, I just can't imagine myself playing
soccer or baseball.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
