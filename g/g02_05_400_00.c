...
MsgDisp("Hiiragi","Of course, there's no problem at all. I've
been doing this since I was 2 years old.");
...
MsgDisp("Hiiragi","We are gaining recognition as a 
community theater group in Habataki City.");
MsgDisp("主人公","It's the results of ｛柊＊＊＊｝ 's hard
work.");
ChEye(5,3);
VoicePlay("G020540000_05_050");
MsgDisp("Hiiragi","Yes, I hope to continue working hard
so that the citizens of Habataki City 
will continue to recognize us.");
MsgDisp("主人公","And you've found a candidate 
for a future leading actor?");
ChEye(5,4);
ChMotion(5,4);
