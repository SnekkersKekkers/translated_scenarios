...
MsgDisp("Nanatsumori","This is bad...
Everything is sparkly and shiny...");
MsgDisp("主人公","There's a lot of fireflies over here too.
...
MsgDisp("主人公","(｛Nanatsumori＊｝, why is your face
so red?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
