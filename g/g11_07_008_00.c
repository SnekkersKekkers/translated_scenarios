...
MsgDisp("Mikage","Once you start thinking about plants on your
way home, you've become a great gardening
club member.");
MsgDisp("主人公","Really?");
ChEye(7,0);
ChMouth(7,0);
...
MsgDisp("Mikage","Though, it's going to be difficult from now
on, you know?");
MsgDisp("主人公","Eh?");
ChEye(7,0);
ChMouth(7,0);
...
MsgDisp("Mikage","Haha, it's too early to be thinking of that.
The weather's going to be nice for a while.");
MsgDisp("主人公","(Since I've joined the gardening club, I feel
like maybe I've changed a little...?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
