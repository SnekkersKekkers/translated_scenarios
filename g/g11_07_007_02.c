...
MsgDisp("主人公","｛御影＊＊｝, thank you very
much for the shearing event at
the ranch.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
...
MsgDisp("Mikage","Come on, am I just the biology
teacher at your school to you?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("G110700702_07_030");
MsgDisp("Mikage","A mysterious (manly) guy in a 
jumpsuit who jumped in and joined.");
MsgDisp("主人公","Hehe!
...
MsgDisp("主人公","Okay then, please let me know
when the next shearing event is.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
