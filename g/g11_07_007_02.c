...
I have to thank ｛Mikage＊＊｝ for the
...
MsgDisp("主人公","｛Mikage＊＊｝, thank you very much for the
shearing event at the ranch.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("G110700702_07_010");
MsgDisp("Mikage","That's great but, next time you should thank
...
MsgDisp("主人公","Okay then, please let me know when the next
shearing event is.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("主人公","(Hehe, I want to go to the ranch now instead
of interviewing ｛Mikage＊＊｝...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
