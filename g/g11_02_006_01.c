...
MsgDisp("主人公","Same as always. How is it that you always
run at exactly the same time?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("G110200601_02_010");
MsgDisp("Sassa","My stride, breathing, and form are all
the same as usual.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
specialties. Well, I'm off now!");
MsgDisp("主人公","(Hehe! ｛颯砂＊＊｝,you seem to be having a
...
MsgDisp("Sassa","That time, my senior told me to take 
the stopper that was in place off.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,0);
...
MsgDisp("Sassa","As expected of my manager! Then, I'll push
myself for the last ten minutes.");
BGMStop();
SEStop("EV_SE_FOOT_037",2);
MsgClose();
ScrFadeOut(0,0);
MsgDisp("主人公","(｛颯砂＊＊｝, It seems like you're more
motivated now than ever. I'm looking
forward to your next record!)");
MsgClose();
ChClose(2,0,0);
