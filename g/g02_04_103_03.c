...
MsgDisp("Nanatsumori","Hey, do you usually get approached like
that?");
MsgDisp("主人公","Huh?");
ChEye(4,2);
ChMouth(4,0);
...
MsgDisp("Nanatsumori","By a ladies man.
That kind of thing pisses me off.");
ChEye(4,2);
ChMouth(4,2);
ChMotion(4,2,1);
VoicePlay("G020410303_04_020");
MsgDisp("Nanatsumori","Well... the worst part is that I showed up
late today.");
MsgDisp("主人公","You did?");
ChEye(4,2);
ChMouth(4,4);
