...
MsgDisp("Himuro","But I wonder if my feelings of inferiority
would go away...");
MsgDisp("主人公","Huh?");
ChEye(6,0);
ChMouth(6,0);
...
ChMouth(6,0);
ChMotion(6,0);
MsgDisp("Himuro","No, wait.
If we're doing hypotheticals, maybe imagining
I'm the older one would be nice too.");
