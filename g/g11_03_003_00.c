...
MsgDisp("Honda","The latest edition of 'Habacha' 
just sold out......");
...
MsgDisp("Honda","But, I'm sorry. I was conflicted on what
to do as a store clerk and what to do as
your friend——");
ChEye(3,0);
ChMouth(3,1);
ChMotion(3,1);
...
the end.");
MsgDisp("主人公","I see. But as a store clerk, you did the
right thing.");
ChEye(3,2);
ChMouth(3,2);
ChMotion(3,0);
