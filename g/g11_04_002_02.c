BGOpen("ne100",1);
ScrFadeIn(0);
MsgDisp("主人公","(I just want to collect more and more fashion
items...)");
MsgDisp("主人公","(Ah...maybe I can find ｛Nanatsumori＊｝ at the
coffee shop?)");
...
Well, when something new is out I'm usually
at a photo shoot.");
MsgDisp("主人公","Hehe!");
VoicePlay("G110400202_04_040");
MsgDisp("Nanatsumori","I also find out about new releases outside of
my job, so this is where I research them.");
MsgDisp("主人公","I see.
So this is where you can get a headstart on
everyone else?");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,0);
...
MsgDisp("主人公","Okay!");
MsgDisp("主人公","(I got to look at new items on the internet
with ｛Nanatsumori＊｝!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
