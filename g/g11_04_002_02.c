BGOpen("ne100",1);
ScrFadeIn(0);
MsgDisp("主人公","(I just want to collect more
and more fashion items...)");
MsgDisp("主人公","(Ah... maybe I can find
｛七ツ森＊｝ at the coffee shop?)");
...
MsgDisp("主人公","Yeah. Because every time
you're here, there's something new
in the catalog.");
ChEye(4,0);
ChMouth(4,2);
VoicePlay("G110400202_04_030");
MsgDisp("Nanatsumori","Haha. Well, when something
new is out I'm usually at a 
photo shoot.");
MsgDisp("主人公","Hehe!");
VoicePlay("G110400202_04_040");
MsgDisp("Nanatsumori","I also find out about new releases
...
ChEye(4,2);
ChMouth(4,2);
MsgDisp("Nanatsumori","Oh, wait a second. I think
there's something new on the site.");
MsgDisp("主人公","How did you find it?");
VoicePlay("G110400202_04_080");
MsgDisp("Nanatsumori","It wasn't easy. At least now
...
Do you want to look at new items
while drinking coffee together?");
MsgDisp("主人公","Okay!");
MsgDisp("主人公","(I got to look at new items
on the internet with ｛七ツ森＊｝!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
