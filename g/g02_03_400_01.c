...
breathe.
Eventually, everything went dark before
my eyes.");
...
MsgDisp("Honda","I was scared and jumped up,
only to realize that while I was asleep,
several books had piled up on my face.");
MsgDisp("主人公","So, the suffocation was because of
the books on your face.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,1);
VoicePlay("G020340001_03_050");
MsgDisp("Honda","Yeah. I learned the hard way that
stacking up a tower of unread books by
my bedside is dangerous.");
MsgDisp("主人公","Yeah......
make sure to organize them properly, okay?");
ChEye(3,2);
ChMouth(3,4);
ChMotion(3,2);
VoicePlay("G020340001_03_060");
MsgDisp("Honda","Yeah, I'll be careful. I've had enough of
those suffocating dreams.");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
ChLayout(1);
