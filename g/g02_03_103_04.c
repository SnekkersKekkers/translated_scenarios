...
ChMouth(3,0);
ChMotion(3,4);
VoicePlay("G020310304_03_030");
MsgDisp("Honda","Actually, I was confident that I picked
something really good.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,1);
ChEyeOpenLevel(3,0);
VoicePlay("G020310304_03_040");
MsgDisp("Honda","I even asked for my sister's opinion!");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,0);
...
MsgDisp("Honda","Yeah, for your next birthday!
I've already started thinking about it. It'll
be even more surprising than the last one—");
ChEye(3,5);
ChMouth(3,4);
ChMotion(3,5);
