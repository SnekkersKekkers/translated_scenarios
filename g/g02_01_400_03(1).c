...
my Grandpa. Of course, it wasn't to sell.");
MsgDisp("主人公","Yeah");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
to hand it over. And for quite a good
price too.");
...
MsgDisp("Kazama","My grandpa is troubled. He'd give it as a
gift if it were just one person, But
...
MsgDisp("Kazama","......Geez, does it need to be said? It's
a piece of driftwood I picked up as a kid.");
ChEyeOpenLevel(1,0);
Wait(8,0);
ChMouth(1,0);
ChMotion(1,0);
...
MsgDisp("Kazama","But I noticed something when
I looked at that driftwood.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","Yeah.
It's not a big deal, 
but I'm pretty sure it's fragrant wood.");
MsgDisp("主人公","Amazing!
Since he was young,｛風真＊＊｝ has
had a great discerning eye.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","On the back of the driftwood, 
there's a badly scrawled character
of the word 'elephant'.");
MsgDisp("主人公","Ele......phant?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
VoicePlay("G020140003_01_110");
MsgDisp("Kazama","That driftwood had a
long nose like an elephant.");
