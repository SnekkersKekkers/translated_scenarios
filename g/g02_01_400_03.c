...
MsgDisp("Kazama","So, hey, we've got some driftwood on display
at my grandpa's store.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
...
MsgDisp("Kazama","But apparently, people have shown up wanting
that driftwood.
...
MsgDisp("Kazama","Hold it, why are you acting like you want it?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
ChEyeOpenLevel(1,8);
...
It's just driftwood that I picked up at the
...
MsgDisp("Kazama","But I wanted to know why people wanted it so
I went and checked out the driftwood a little
while ago.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("G020140003_01_070");
MsgDisp("Kazama","And when I did, I noticed a slight fragrance.
You know about fragrant woods?
...
So you've had a really discerning eye since
you were little, ｛Kazama＊＊｝.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
...
MsgDisp("Kazama","'cause it was shaped like an elephant with a
long nose.");
...
MsgDisp("Kazama","So you understand why we can't sell it at a
high price, yeah?");
MsgDisp("主人公","(I'm sure that ｛Kazama＊＊｝ has had a good
