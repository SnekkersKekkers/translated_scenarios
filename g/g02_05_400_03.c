...
MsgDisp("Hiiragi","Lately, I've been finding conversations with
my father quite interesting.");
...
MsgDisp("Hiiragi","Yes.
But when he's had a drink, we start talking
about things we never did before.");
ChEye(5,2);
ChEyeOpenLevel(5,9);
VoicePlay("G020540003_05_030");
MsgDisp("Hiiragi","About school.
Whether I've made more friends...and then if
...
MsgDisp("Hiiragi","It means I'm not the only one enjoying school
life now.");
