...
MsgDisp("Kazama","What would happen if those guys
found out we came here?");
...
MsgDisp("Kazama","Yeah. Sassa would probably complain about
us sneaking off or something boring like
that..");
MsgDisp("主人公","Hehe.");
ChEye(1,0);
ChMouth(1,3);
...
MsgDisp("Kazama","If he found out now, 
wouldn't he run here from his house?");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
