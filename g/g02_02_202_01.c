...
MsgDisp("Sassa","I mean, not even the underclassmen on the
track team are that blunt.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,4);
...
MsgDisp("Sassa","Hmm...... You sure make it sound like it's
...
MsgDisp("Sassa","That's not what I wanted to hear.");
ChEye(2,0);
ChMouth(2,2);
ChMotion(2,2);
