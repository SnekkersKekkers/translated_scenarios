...
when you did bungee jumping you had
different hair and no glasses...");
...
MsgDisp("Nanatsumori","Well, I only wear glasses when I go to
school and don't take them off there.");
MsgDisp("主人公","Do you have poor eyesight?");
ChEye(4,0);
ChMouth(4,0);
VoicePlay("G110400600_04_070");
MsgDisp("Nanatsumori","I can't even walk down the street alone
without my glasses.");
MsgDisp("主人公","I-I see.");
ChEye(4,0);
ChMouth(4,2);
...
MsgDisp("Nanatsumori","You're very lucky to see me because it's
rare I look like that.");
MsgDisp("主人公","(I guess it is pretty rare. I got to see
the amazing model ｛七ツ森＊｝? )");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
