...
ChMouth(2,0);
ChMotion(2,0);
VoicePlay("G020220200_02_010");
MsgDisp("Sassa","Yeah, I've never met anyone like him.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("G020220200_02_060");
MsgDisp("Sassa","Just you being close by and worrying makes
success more likely.");
MsgDisp("主人公","Really?");
ChEye(2,0);
ChMouth(2,4);
...
MsgDisp("Sassa","Alright, I know it's not a contest,
but now it feels like I'm competing
against Ryota.");
