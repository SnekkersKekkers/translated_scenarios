...
ChEye(4,2);
ChMouth(4,4);
VoicePlay("G020430000_04_030");
MsgDisp("Nanatsumori","I guess it's guilt?
Feels a bit like that.");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,1,1);
VoicePlay("G020430000_04_040");
MsgDisp("Nanatsumori","It's not that I need to put in a notice to go
on a date with you.");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,2,1);
VoicePlay("G020430000_04_050");
MsgDisp("Nanatsumori","But on days like today when we're having such
a blast, I feel bad for them.");
MsgDisp("主人公","Hehe!");
ChEye(4,2);
ChMouth(4,4);
ChMotion(4,1,1);
...
I'm actually a pretty serious guy, you know?");
