...
They do things like go shopping, sing karaoke
and eat sweets... Many things?");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
...
MsgDisp("Hiiragi","We haven't hung out since elementary school,
...
played in the park...
It was fun.");
MsgDisp("主人公","(｛Hiiragi＊＊＊｝ didn't get to hang out with his
friends much in elementary or middle
