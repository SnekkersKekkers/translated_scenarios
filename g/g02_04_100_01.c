...
MsgDisp("Nanatsumori","But I do. I have someone I like.");
MsgDisp("主人公","∈");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("G020410001_04_060");
MsgDisp("Nanatsumori","Duuude chill. Why're you so surprised?
You're funny.");
MsgDisp("主人公","But...");
ChEye(4,4);
ChMouth(4,3);
...
MsgDisp("Nanatsumori","That's one of the things I like about 
you. I can't stop feeling fond of you. 
