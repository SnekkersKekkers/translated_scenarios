...
and others that are busy. There are all
kinds.");
MsgDisp("主人公","Yeah, they're all sorts 
...
MsgDisp("Kazama","That's right. I was thinking it might be
good to have some reference, purely as a
reference.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,4);
...
From now on, I'll be wearing aprons 
in all kinds of colors on our dates.");
MsgDisp("主人公","(A colorful ｛風真＊＊｝,
