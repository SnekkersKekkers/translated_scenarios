...
MsgDisp("主人公","Even with someone you don't get
along with?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
Vice Principal Himuro? If we got along
well, he might even raise my evaluation.");
...
MsgDisp("Mikage","Vice Principal Himuro's inner thoughts...");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
ChEyeOpenLevel(7,0);
VoicePlay("G020710001_07_040");
MsgDisp("Mikage","\"Mr. Mikage! As a teacher—\"
That would be just the same as
always, huh?");
