...
MsgDisp("Kazama","I wonder how many more times we can see
this view together.");
MsgDisp("主人公","It's a view I'd like to see as many times
as possible.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("G020120101_01_010");
MsgDisp("Kazama","Oh, you said it, huh?
...
During firefly season, we'll always come
here together.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
VoicePlay("G020120101_01_040");
MsgDisp("Kazama","There won't be any time for you to come
...
MsgDisp("Kazama","But, I won't ever change.
Not in the past, not now, and not in the
future.");
ChEye(1,2);
ChMouth(1,4);
ChMotion(1,0);
...
MsgDisp("主人公","(｛風真＊＊｝, somewhat seems like he's in
pain......?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
