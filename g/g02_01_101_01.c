...
MsgDisp("Kazama","No, that's not right.
You've always been cute, since we were
kids, it's just-");
ChEye(1,2);
ChMouth(1,0);
ChMotion(1,0);
...
Okay, so Sassa and Inori seem to be
getting along with you recently.");
ChEye(1,1);
ChMouth(1,1);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("G020110101_01_040");
MsgDisp("Kazama","But I found you waaaay before them.
I'm not saying that the early bird catches
the worm.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
