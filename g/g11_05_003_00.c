...
MsgDisp("Hiiragi","I can't close the distance between
...
MsgDisp("Hiiragi","Yeah. At night, you suddenly change
when our distance comes together.
...
We are Habataki students and members
