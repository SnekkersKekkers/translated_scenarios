...
the Inter-High. I hope everyone does their
best......)");
...
MsgDisp("主人公","(Huh? ｛颯砂＊＊｝, it seems like your arms
are stiffer than usual today......?)");
while (1){
...
ChMouth(2,1);
ChMotion(2,2);
MsgDisp("Sassa","My arm? Ah, maybe I put in a bit more
force than usual.");
VoicePlay("G110200900_02_040");
ChEye(2,1);
ChMouth(2,0);
ChMotion(2,0);
MsgDisp("Sassa","Yes, thank you. I didn't even notice my
muscles were tense.");
MsgDisp("主人公","No, no.
...
ChMouth(2,0);
ChMotion(2,0);
MsgDisp("Sassa","You always look out for me, 
so you noticed.");
VoicePlay("G110200900_02_060");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,1);
MsgDisp("Sassa","Such small deviations
...
MsgDisp("主人公","(It's already the interhigh...... Let's
cheer for ｛颯砂＊＊｝ so he can finish
satisfied!)");
MsgClose();
BGMStop();
