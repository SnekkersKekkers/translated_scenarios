...
MsgDisp("Mikage","That's because the air there is bad.
Ah, I don't mean the air conditioning, I
meant the atmosphere, you know?");
...
MsgDisp("Mikage","Ah, that's right. My bad, my bad. I left
them in the science prep room. I'll go get
them later.");
...
MsgDisp("Mikage","I don't like the staff room, but that's my
room after all.
Well, let's go.");
BGMStop();
MsgClose();
