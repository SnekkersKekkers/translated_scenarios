...
MsgDisp("Hiiragi","The fireflies here live 
mush longer than normal fireflies, huh?");
ChEye(5,4);
ChMotion(5,4);
VoicePlay("G020540002_05_010");
MsgDisp("Hiiragi","It's mysterious. There are also rumours
about inner voices, hust how many secrets
are there......");
MsgDisp("主人公","Could it be due to the
benefits of the spring water?");
ChEye(5,0);
ChMotion(5,0);
VoicePlay("G020540002_05_020");
MsgDisp("Hiiragi","I see, the spring water. You do often hear
about the longevity effects of spring
water.");
ChEye(5,4);
VoicePlay("G020540002_05_030");
MsgDisp("Hiiragi","But conversely, 
how could hearing the other's 
