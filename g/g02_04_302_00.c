...
ChMouth(4,0);
ChMotion(4,0);
VoicePlay("G020430200_04_000");
MsgDisp("Nanatsumori","I...");
MsgDisp("主人公","Hm?");
ChMotion(4,2,1);
VoicePlay("G020430200_04_010");
MsgDisp("Nanatsumori","I wonder how people at school
look at me.");
VoicePlay("G020430200_04_020");
MsgDisp("Nanatsumori","I have plain thick glasses.
Maybe I'm really difficult to approach?
I probably kind of have that aura.");
MsgDisp("主人公","I'm not really sure?");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,1,1);
...
｛七ツ森＊｝. You don't have to do
anything cause you're already cool.");
ChEye(4,2);
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("G020430200_04_040");
MsgDisp("Nanatsumori","That was direct...");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,2,1);
...
MsgDisp("Nanatsumori","Like making friends, and
talking to girls?");
