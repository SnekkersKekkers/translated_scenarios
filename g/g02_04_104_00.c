...
I actually have a photo-focused social media
account.");
...
MsgDisp("Nanatsumori","Well, I haven't been updating it much lately.
I'm satisfied with my offline life.");
MsgDisp("主人公","?");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,1,1);
VoicePlay("G020410400_04_030");
MsgDisp("Nanatsumori","But you know, I have some male fans who are
really into it. Of course, they think I'm a
girl in my photos.");
MsgDisp("主人公","Y-Yeah.");
ChEye(4,2);
ChMouth(4,4);
...
altogether?");
MsgDisp("主人公","But, no matter what their feelings are, you
have a lot of fans, don't you?");
ChMotion(4,0,1);
VoicePlay("G020410400_04_090");
MsgDisp("Nanatsumori","Yeah.");
ChEye(4,0);
ChMouth(4,3);
VoicePlay("G020410400_04_100");
MsgDisp("Nanatsumori","You're sharp.
Since you're the only one who can handle this
topic, will you keep giving me advice?");
MsgDisp("主人公","(Umm, so ｛Nanatsumori＊｝ is worried about
