...
MsgDisp("Mikage","Oh, that would be nice. Maybe we should do
a 'Molly's milk stand' at lunchtime?");
MsgDisp("主人公","Is this the cow ｛御影＊＊｝ showed me at
...
MsgDisp("主人公","Yes. It would be even more fun if Molly
and the others were here too.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
...
MsgDisp("Mikage","That's right. Everything that's important
to me would be gathered here.");
