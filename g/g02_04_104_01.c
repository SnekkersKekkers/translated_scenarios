...
MsgDisp("Nanatsumori","Hey, is your family the type to celebrate
...
MsgDisp("Nanatsumori","My dad and sister are always late coming home
from work, so on those days, I spend a little
time with my mom and we have a small party.");
