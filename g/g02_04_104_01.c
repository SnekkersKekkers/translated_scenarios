...
ChMouth(4,0);
ChMotion(4,0);
VoicePlay("G020410401_04_000");
MsgDisp("Nanatsumori","Hey, 
is your family the type to celebrate 
birthdays and stuff with everyone?");
MsgDisp("主人公","Eh?");
ChEye(4,2);
ChMouth(4,0);
ChMotion(4,2,1);
...
MsgDisp("Nanatsumori","Yeah, exactly. Birthdays and Christmas, we
get presents from everyone, but that's it.");
...
ChMouth(4,3);
ChMotion(4,0,1);
VoicePlay("G020410401_04_060");
MsgDisp("Nanatsumori","My dad and sister are always late coming
home from work, so on those days, I spend
a little time with my mom and we have a
small party.");
MsgDisp("主人公","Hehe
｛七ツ森＊｝, is gentle isn't he?");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,1,1);
