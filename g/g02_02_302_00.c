...
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("G020230200_02_020");
MsgDisp("Sassa","Yeah.
It's like eating together in the cafeteria.
I really enjoy those times.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("G020230200_02_030");
MsgDisp("Sassa","Do you like eating in the cafeteria?");
MsgDisp("主人公","Yeah, it's tasty and I have fun.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("G020230200_02_040");
MsgDisp("Sassa","It's delicious, huh. No matter what's on the
menu. I like their udon.
It's good that their noodles are quite soft.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
