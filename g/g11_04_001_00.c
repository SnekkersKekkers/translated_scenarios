BGOpen("sc000",1);
ScrFadeIn(0);
MsgDisp("主人公","(Ah, this month's feature of Habacha is
...
MsgDisp("主人公","I'm looking for some limited time
sweets that were on Habacha this month▼");
ChEye(4,2);
VoicePlay("G110400100_04_020");
MsgDisp("Nanatsumori","I see...");
VoicePlay("G110400100_04_030");
MsgDisp("Nanatsumori","We don't have any more, but do
you wanna hear my review on it?");
MsgDisp("主人公","Huh? Could it be that
you already, ｛七ツ森＊｝...");
ChEye(4,0);
ChMouth(4,2);
ChMotion(4,2);
...
MsgDisp("Nanatsumori","You're welcome to sit with me
if you'd like.");
MsgDisp("主人公","Sure!
In that case...");
MsgDisp("主人公","Excuse me! A \"Seasonal All Fruit
Tart\" please!");
ChEye(4,2);
ChMouth(4,2);
ChMotion(4,2);
