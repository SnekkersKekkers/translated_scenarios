...
ChMouth(3,0);
ChMotion(3,1);
VoicePlay("G020310400_03_020");
MsgDisp("Honda","So, do they have something like romantic 
feelings, like humans?");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,2);
VoicePlay("G020310400_03_030");
MsgDisp("Honda","Or is it just instinct? Do insects even
have emotions similar to humans?");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,0);
ChEyeOpenLevel(3,0);
...
ChMouth(3,0);
ChMotion(3,1);
VoicePlay("G020310400_03_060");
MsgDisp("Honda","I like being with you. But is this
romantic love? Or just a human instinct?");
ChMotion(3,2);
