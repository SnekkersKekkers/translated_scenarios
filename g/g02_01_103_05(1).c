...
here?");
MsgDisp("主人公","Yeah, I feel it too.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","But I quickly got used to it. In
elementary school, I felt like I was
paralyzed. Kids naturally protect
themselves that way.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
...
MsgDisp("主人公","｛風真＊＊｝, you're amazing...being able
to plan and execute what you think of.");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,4);
...
MsgDisp("Kazama","But, if we ever get another chance like
that, I'll act no matter where we are.");
MsgDisp("主人公","Ehhhh∋");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
