...
MsgDisp("主人公","You're the lead actor ｛Hiiragi＊＊＊｝.");
ChEye(5,4);
...
MsgDisp("Hiiragi","...But for now, I'm standing on stage next
to you.
I'll stand tall.");
ChEye(5,3);
ChMotion(5,4);
VoicePlay("G020510100_05_040");
MsgDisp("Hiiragi","It's the least I can do to show respect to
our rivals.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
There are fireflies of strange colours
behind you...");
ChCheek(5,7);
