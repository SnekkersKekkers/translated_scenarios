...
MsgDisp("Kazama","In the midst of these countless lights, to
be able to find one's partner would be a
miracle.");
MsgDisp("主人公","Yeah.");
ChEye(1,4);
ChMouth(1,4);
...
MsgDisp("Kazama","It's the same with us.
Through miracles and coincidences, 
...
MsgDisp("Kazama","Before I knew it, 
you had gotten closer to that guy......");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,1);
...
MsgDisp("Kazama","When you're with him, 
you don't have to be cautious and 
he doesn't speak bluntly.");
...
MsgDisp("Kazama","What I said about him isn't a lie, 
but when we're talking about you, 
it's different.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
