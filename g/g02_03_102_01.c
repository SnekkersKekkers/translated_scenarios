...
VoicePlay("G020310201_03_000");
MsgDisp("Honda","Hey, I wonder how people see our
relationship.");
...
to me. Honestly, I hope it continues
forever.");
ChEye(3,2);
ChMouth(3,0);
ChMotion(3,1);
VoicePlay("G020310201_03_050");
MsgDisp("Honda","But that would mean we're stuck in this 
ambiguous relationship, wouldn't it?");
ChMouth(3,4);
ChMotion(3,0);
...
MsgDisp("Honda","It might be hard to answer
something like that out of the blue");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,0);
VoicePlay("G020310201_03_080");
MsgDisp("Honda","I just said what was on my mind, 
