...
ChMouth(3,0);
ChMotion(3,0);
VoicePlay("G110300400_03_010");
MsgDisp("Honda","I wonder what I would've thought of it if I
...
MsgDisp("Honda","Hmmm... I can't remember the movies I watched
with you, but I forget the contents of books
quite easily.");
...
ChMouth(3,1);
ChMotion(3,1);
VoicePlay("G110300400_03_040");
MsgDisp("Honda","But you know, it's okay now.
I've learned a method so I don't forget.");
ChEye(3,1);
ChMouth(3,1);
ChMotion(3,1);
VoicePlay("G110300400_03_050");
MsgDisp("Honda","It's really simple!
Just look at the spine now and again.");
ChEye(3,0);
ChMouth(3,1);
ChMotion(3,1);
VoicePlay("G110300400_03_060");
MsgDisp("Honda","Then the contents resurface in my mind.
If I do this a few times, it'll become stuck
in my memories.");
MsgDisp("主人公","I see.");
ChEye(3,0);
ChMouth(3,0);
