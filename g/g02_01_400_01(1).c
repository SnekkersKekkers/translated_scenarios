...
I suddenly remember things from the past.");
...
MsgDisp("Kazama","Or the sweets we got from the old lady
at the tobacco shop when we used 
...
MsgDisp("Kazama","It's okay. For me, it's just scenes that
come to mind.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
too? As long as they're with you.");
