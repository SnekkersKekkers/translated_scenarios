...
MsgDisp("Sassa","...When you see a view like this, it creates
...
MsgDisp("Sassa","I know I'm the one who brought it up, but.");
...
MsgDisp("Sassa","Yeah.
I've been thinking about it quite a lot since
yesterday.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("G020210200_02_060");
MsgDisp("Sassa","Well, as long as you're smiling, that's all
that matters.");
ChEye(2,3);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","So, let's save the nice atmosphere for later.");
ChEye(2,0);
ChEyeOpenLevel(2,10);
MsgDisp("主人公","(I'm not sure about a nice atmosphere... but
being with ｛Sassa＊＊｝ always makes me
happy.)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
