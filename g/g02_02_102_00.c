...
MsgDisp("Sassa","......When you see a view like this,
it creates a nice atmosphere, right?");
MsgDisp("主人公","Eh?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
MsgDisp("Sassa","Speaking of which, 
what does a nice atmosphere feel like?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","So, 
let's save the nice atmosphere for later.");
ChEye(2,0);
ChEyeOpenLevel(2,10);
