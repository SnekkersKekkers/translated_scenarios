...
MsgDisp("Kazama","It must be tough, flying around, glowing,
...
MsgDisp("Kazama","The whole time, since we met ten years ago.
I guess since you've glowed for that long,
you'd get hungry.");
ChEye(1,4);
ChMouth(1,0);
ChMotion(1,1);
