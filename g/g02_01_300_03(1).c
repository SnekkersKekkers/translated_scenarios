...
didn't they talk about this place too?");
...
much.");
MsgDisp("主人公","I think ｛七ツ森＊｝ would also enjoy it
here.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("主人公","Because they were both 
talking about this place, right?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
two of us. Without anyone finding out,
okay?");
