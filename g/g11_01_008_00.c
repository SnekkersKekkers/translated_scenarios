...
MsgDisp("Kazama","......Right. There was something I
...
MsgDisp("Kazama","......What is it? Well, it was probably
something trivial.");
...
say...... Maybe he wanted to nag me like a
Mom?)");
ChEyeOpenLevel(1,0);
Wait(10,0);
ChEye(1,0);
...
MsgDisp("Kazama","Just now you were thinking something
bad, I bet.");
...
MsgDisp("Kazama","So what was it? I have plenty of time, so
let's take the time to talk about it.");
MsgDisp("主人公","Ehhー? Can't I hear what ｛風真＊＊｝ had
to say instead?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,2);
