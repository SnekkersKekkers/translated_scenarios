...
Then recently,
I guess you were just coincidentally busy.");
...
I was polishing a plan to invite you out.
For a date.");
MsgDisp("主人公","Ah, sorry.
I was really frantic that day.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
...
was no deeper meaning behind your refusal.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
The next time he invites me, 
I should make sure I accept.)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);