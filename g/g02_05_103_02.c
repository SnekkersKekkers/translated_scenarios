...
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("G020510302_05_020");
MsgDisp("Hiiragi","Each small coincidence, when piled up, can
become a miracle.");
ChEye(5,4);
ChMotion(5,0);
VoicePlay("G020510302_05_030");
MsgDisp("Hiiragi","Speaking of which, we also had a small
coincidence, didn't we?");
MsgDisp("主人公","Eh? ......Are you perhaps talking about
our clothes today?");
ChEye(5,3);
ChMotion(5,3);
