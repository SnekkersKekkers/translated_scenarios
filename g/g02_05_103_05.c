...
departed.");
MsgDisp("主人公","It's beautiful, although that's a 
little scary......");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
...
MsgDisp("Hiiragi","That's why I think when something 
is made beautiful to the extreme,
it inevitably includes a sense of fear.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
house......");
MsgDisp("主人公","Ahh!
｛柊＊＊＊｝, you were teaching the
ghost actor all sorts of things.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,2);
ChEyeOpenLevel(5,0);
...
MsgDisp("主人公","(If ｛柊＊＊＊｝ were the one producing it,
