...
MsgDisp("Hiiragi","If you can hear even my inner voice,
then it's just a little more.");
...
MsgDisp("Hiiragi","Haa......that was a relief. You know, it's
within my nature to be true to my words.");
