...
person and touch to learn.\"
That's when I started going outside.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0,1);
VoicePlay("G020310306_03_050");
MsgDisp("Honda","I wonder how my mom would
have introduced this place to little me.");
MsgDisp("主人公","I'm sure she would have taught you
in a way that sparked your interest.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("G020310306_03_060");
MsgDisp("Honda","So, how would you introduce it? To get
your own child interested in going
outside.");
MsgDisp("主人公","Eh?");
ChMotion(3,4,1);
