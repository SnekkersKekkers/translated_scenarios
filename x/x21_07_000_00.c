...
MsgDisp("Mikage","｛主人公｝, congratulations on Rose
Queen!");
...
MsgDisp("主人公","Hey, I'm not intending 
for that to happen.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("X210700000_07_050");
MsgDisp("Mikage","Haha, sorry.
But, that part of you is also unmistakably
one of your charms.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,4);
...
ChMouth(7,3);
ChMotion(7,0);
VoicePlay("X210700000_07_070");
MsgDisp("Mikage","Show everyone the smile of the Rose Queen
they admire.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,2);
...
MsgDisp("Mikage","Congratulations. It somewhat makes me want
to cry too.");
