...
MsgDisp("Hiiragi","My own feelings are a mystery even to me,
but one thing's certain: I've grown to
like Haba High even more after today.");
MsgDisp("主人公","The school?");
ChMotion(5,4);
VoicePlay("X210500000_05_060");
MsgDisp("Hiiragi","Yes.
You being chosen as Rose Queen is proof
the whole school shares my values, right?");
ChMotion(5,0);
