...
set a new personal best.");
    ...
    MsgDisp("主人公","(But I would be happy if I was of help even
if it was just a little!)");
    ...
    MsgDisp("Mikage","Everyone at the track and field club is
grateful to you.");
    MsgDisp("主人公","Eh?");
    ChEye(7,0);
    ChMouth(7,0);
...
There were a lot of athletes who had set new
personal bests.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,0);
    VoicePlay("X110700001_07_030");
    MsgDisp("Mikage","Everyone said it was thanks to your support.
Thank you.");
    MsgDisp("主人公","(I would be happy if I was of help to
everyone.
