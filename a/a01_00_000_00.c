...
MsgDisp("Ryota","Inside there's stained glass from other
countries, and tons of antiques and
treasures!");
...
as the pinwheels in the treasure room
at Habataki Castle.");
...
Doesn't it sound just like a wedding
ceremony?");
SEVol(0.4,2);
MsgClose();
ScrFadeOut(0,1);
...
That very same Ryota is finally 
coming back...)");
SEPlay("EV_SE_629");
SEWait();
