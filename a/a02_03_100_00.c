BGOpen("sc510",1);
ScrFadeIn(0);
MsgDisp("主人公","(I've been studying in the library
and didn't see time go by.
...
MsgDisp("Honda","You are now in your classroom, 
sitting in your seat.
Now, which way is the window?");
MsgDisp("主人公","On the left?");
VoicePlay("A020310000_03_060");
MsgDisp("Honda","Yes, correct! Now think back to 
your primary school classrooms.
Do you remember?");
MsgDisp("主人公","Hmm......Oh!
...
MsgDisp("Honda","Ding-ding-ding! Right answer!");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,2);
...
MsgDisp("Honda","And I've confirmed it myself,
Each and every classroom in Haba High 
too!");
...
MsgDisp("Honda","Mm-hm, it's because it's hard
to see your notebook when the shadow 
of your hand holding your pen 
is coming from the right side.");
MsgDisp("主人公","It was designed with the students in 
mind. It's something so familiar,
yet I didn't notice at all.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("A020310000_03_110");
MsgDisp("Honda","That kind of awareness is the 
...
MsgDisp("Honda","Ah, but you know, I'm left-handed
