...
BGOpen("sc010",0);
ScrFadeIn(0);
MsgDisp("主人公","(The same path I walked in elementary school.
...
Ka-za-ma. We used to play together all the
time, remember?");
ChMotion(1,0);
Wait(12,0);
ChEye(1,4);
...
School in England starts in September, so
transferring now was a hassle.");
...
Still as carefree as always. That worries me.");
    break ;
    default :
    DbgAssert(0);
    break ;
...
MsgDisp("主人公","?
Hey, ｛Kazama＊＊｝, it sounds like they're
talking about you...");
SEStop("EV_SE_588",1);
SEStop("EV_SE_789",1);
ChEye(1,0);
