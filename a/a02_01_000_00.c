...
but I bet he's still the same
smart, lively boy I knew. )");
...
BGOpen("sc010",0);
ScrFadeIn(0);
MsgDisp("主人公","(It's the same road I always walked 
back in elementary school, how nostalgic. 
...
MsgDisp("Kazama?","I know it's been a long time since 
we last saw each other, but, a frown, 
really?");
StlOpen("ev_01_01");
StlEye(1,0);
StlMouth(1,0);
...
MsgDisp("Kazama","Yup, that's me. Ka-za-ma here.
We used to play
together a lot, remember?.");
ChMotion(1,0);
Wait(12,0);
ChEye(1,4);
ChMouth(1,3);
...
You're nothing like the elementary
school boy I saw in my dream last night!");
ChEye(1,3);
ChMouth(1,3);
ChMotion(1,3);
...
MsgDisp("Kazama","Yeah. Didn't expect this either.
I told your mom yesterday,
She didn't tell you?");
MsgDisp("主人公","Sorry ｛風真＊＊｝, I was so surprised
to hear that you came back, maybe I 
wasn't listening all that well...");
...
BGMVol(0.5,0.5);
MsgDisp("Kazama","In first grade, we used to walk up 
this same street to get to school 
together, remember?");
MsgDisp("主人公","Right......
...
MsgDisp("Kazama","It's fine. My flight back home got
delayed so I just kind of stopped
by out of the blue.");
MsgDisp("主人公","Eh∋
So you really just
got back yesterday?");
...
MsgDisp("Kazama","Yeah. I came back early.
School in England starts in September,
so transferring now took some work.");
MsgDisp("主人公","Oh, that makes sense......");
NSSEye(1,6);
NSSMouth(1,3);
NSSEyeOpenLevel(1,5);
VoicePlay("A020100000_01_120");
MsgDisp("Kazama","I thought I'd miss the April start  
here, but I managed to make it  
just in time, somehow.");
NSSEye(1,0);
NSSMouth(1,0);
VoicePlay("A020100000_01_130");
MsgDisp("Kazama","My dad still has work over there, but 
since Grandpa owns an antique store here
I decided to come live here on my own 
for a while.");
...
ringing bell?");
    ...
    MsgDisp("Kazama","Well yeah, that too. At that time, 
together in that church, we-");
    break ;
    case 1:
    MsgDisp("主人公","The wishes we made together to
the pinwheel?");
    NSSEye(1,6);
    NSSMouth(1,3);
    NSSCheek(1,7);
...
will come true......");
    break ;
    case 2:
    MsgDisp("主人公","A lot of time has passed, I 
wonder what you're talking about......");
    NSSEye(1,2);
    NSSMouth(1,0);
    VoicePlay("A020100000_01_180");
    MsgDisp("Kazama","\"A lot of time\", huh......  
You really haven't changed.  
Still as carefree. I'm worried.");
    break ;
    default :
    DbgAssert(0);
    break ;
...
MsgDisp("School Girl A","I know right! My grandpa even 
called him \"young master\" once!
It's like he's royalty or something!");
MsgDisp("主人公","?
｛風真＊＊｝, I think they're talking
about you......");
SEStop("EV_SE_588",1);
SEStop("EV_SE_789",1);
ChEye(1,0);
