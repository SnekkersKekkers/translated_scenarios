BGOpen("sc512",0);
ScrFadeIn(0);
MsgDisp("主人公","(Let's see......The track and field 
office should be right around here......)");
MsgDisp("主人公","(The club's advisor is Mikage-sensei,
but he said the club captain is the 
...
Mikage-sensei is the club advisor,
...
MsgDisp("主人公","So that's how it is... I see.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("A020220000_02_040");
MsgDisp("Sassa?","Yeah. Let me walk you to the captain!
He's on the field!");
...
MsgDisp("Sassa?","Did I make it sound that way?
I know it might seem like my 
personality's just as big as I am......
Kind of an issue.");
MsgDisp("主人公","Hehe.");
ChEye(2,0);
ChMouth(2,4);
...
MsgDisp("Sassa","I'm Sassa Nozomu, regular member of 
the club. So you don't have to treat me 
any differently!");
MsgDisp("主人公","Ah, my name is
｛主人公姓名｝.
...
MsgDisp("Manager","Every month, on the third Sunday of 
the month, the club is holding general 
practice. So be sure to participate.");
MsgDisp("主人公","Understood!");
VoicePlay("A020220000_39_010");
MsgDisp("Manager","Well then,
I'll be counting on you from today on,
manager!");
...
MsgDisp("主人公","Yeah, I'll do whatever I can
to help you guys!");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,1);
...
MsgDisp("Sassa","Well, I'm still thinking about it.
There are eight events: short distance, 
long distance, jumping, and throwing. 
And then, we count scores.");
ChEye(2,3);
ChMouth(2,4);
ChMotion(2,1);
ChEyeOpenLevel(2,0);
VoicePlay("A020220000_02_130");
MsgDisp("Sassa","I'm a track and field idiot who's
aiming for a clean sweep. 1st place in 
every category. It surprises people.");
ChEye(2,0);
ChMotion(2,0);
ChEyeOpenLevel(2,10);
