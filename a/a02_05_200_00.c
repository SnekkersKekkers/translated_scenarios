...
and I would like to join the student 
council!");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Student Council President","No one told you? Hiiragi-kun is the
chairman of the Habataki Theater Troupe
even though he's still a high schooler. 
On top of that he's a member of our 
student council.");
...
MsgDisp("Student Council President","Huh, you're right. Well then, 
let's make our school exciting!");
MsgDisp("主人公","Yes!!");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
BGMStop();
ChClose(5);
MsgDisp("主人公","(｛柊＊＊＊｝, was it...... I can't believe
the theater troupe chairman is in the same
