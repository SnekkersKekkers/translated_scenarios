...
MsgDisp("Kazama?","That's why I'm telling you
I can't accept it.");
...
MsgDisp("Hiiragi","Ah, it's you. Hello.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("E010530200_01_010");
MsgDisp("Kazama","You always seem to show up
at the most random times.");
MsgDisp("主人公","Anyway...... What happened
between you two?");
ChEye(1,2);
ChMouth(1,1);
ChMotion(1,0);
...
I'm worried because Kazama-kun
won't accept my gift.");
ChEyeOpenLevel(5,0);
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Kazama","Since it's my work,
I can handle antiques or collectibles.");
ChMouth(1,0);
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("E010530200_05_040");
MsgDisp("Hiiragi","I saw Kazama-kun reading a book
on kintsugi when the tea bowl
I was using on stage broke.");
...
MsgDisp("Hiiragi","Great, I'll take you up
on that then.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Kazama","It's settled, then. Let's go.");
MsgClose();
SEPlay("EV_SE_856");
BGMStop();
ChClose(1,0,30);
