...
I'm worried because Kazama-kun won't accept
my gift.");
ChEyeOpenLevel(5,0);
ChEye(1,0);
ChMouth(1,2);
...
MsgDisp("Kazama","Since it's my work, I can handle antiques or
collectibles.");
ChMouth(1,0);
ChEye(5,4);
ChMouth(5,4);
...
MsgDisp("Hiiragi","I saw Kazama-kun reading a book on kintsugi
when the tea bowl I was using on stage broke.");
...
taught me. You use lacquer and gold powder to
