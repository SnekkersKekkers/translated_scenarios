...
ChNanaType(0);
ChOpen(4,255,0,0,0,#1,#1,0,2,0,30);
VoicePlay("E010620200_04_010");
...
it's more like we happened to meet,
or maybe we were drawn to each other......
or something?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
MsgDisp("Himuro","Just now I saw Minoru-senpai
frantically taking a picture of something
infront of the store.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,4);
VoicePlay("E010620200_06_040");
MsgDisp("Himuro","He was in an odd position,
...
ChMouth(6,4);
ChMotion(6,3);
VoicePlay("E010620200_06_050");
MsgDisp("Himuro","Minoru-senpai was
desperately trying to take pictures
of the candy store cat mascot.");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,0);
...
MsgDisp("Nanatsumori","He was also sneaking around
Himuro-kun's feet.
......Right?");
ChEye(6,0);
ChMouth(6,0);
...
Himuro-kun, you've been drawn to the
cat too, huh?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,2);
