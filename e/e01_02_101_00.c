...
My dad was admitted so I went and 
gave him a visit.");
ChEye(2,2);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("主人公","Is that so? I hope he gets well soon.
But ｛颯砂＊＊｝, is your dad......");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("E010210100_02_040");
MsgDisp("Sassa","Yeah, he's a sports teacher at university.");
MsgDisp("主人公","Awesome!
...
blood, rather. She's got the high school
record.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
competitor. He says theory of coaching is
