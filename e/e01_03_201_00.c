...
MsgDisp("Honda","Yep yep! I found the book I wanted
right away, but Mii-kun is still confused
about what accessories he wants.");
...
The way Dahon says it makes it sound
like we came here together.");
MsgDisp("主人公","Ah, ｛七ツ森＊｝.");
ChEye(4,0);
ChMouth(4,3);
ChMotion(4,0,1);
...
Are you also shopping at the flea
market?");
...
MsgDisp("Honda","I got it. Why don't you choose? 
...
MsgDisp("Honda","Ehh∋
Why? I wanted the three of us to
choose something together!");
MsgDisp("主人公","Hehe, yeah. Maybe that would've
been nice.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,4,1);
...
MsgDisp("Honda","Well, I'll go check out the used
books section one more time.");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
BGMStop();
ChClose(3);
