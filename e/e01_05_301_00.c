...
MsgDisp("主人公","Ah, ｛Nanatsumori＊｝, what a coincidence!");
...
MsgDisp("主人公","Thank goodness ｛Hiiragi＊＊＊｝ picked it up.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Nanatsumori","Ahh, no doubt about it.
It must have been the fallen angel version.
That one's super rare!");
ChEye(5,3);
ChMouth(5,2);
ChMotion(5,4);
