...
ChMotion(9,0,1);
ChEyeOpenLevel(9,10);
VoicePlay("E010830000_08_020");
ChEye(8,0);
ChMouth(8,5);
ChMotion(8,3,1);
MsgDisp("Daichi","Ah.");
VoicePlay("E010830000_09_020");
ChEye(9,3);
ChMouth(9,0);
ChEyeOpenLevel(9,8);
MsgDisp("Kuya","Hello.");
...
VoicePlay("E010830000_08_030");
ChEye(8,2);
ChMouth(8,4);
ChMotion(8,2,1);
MsgDisp("Daichi","I made plans to watch a
movie with big bro, but......");
VoicePlay("E010830000_09_030");
ChEye(9,2);
ChMouth(9,0);
ChMotion(9,4,1);
MsgDisp("Kuya","I was asked for directions, and
while I was showing them, the movie
had finished......");
MsgDisp("主人公","I see.");
...
Kuya-san spoke so differently just
now, so I......");
VoicePlay("E010830000_09_060");
ChEye(9,3);
ChMouth(9,0);
ChMotion(9,4,1);
ChEyeOpenLevel(9,6);
...
ChMouth(8,3);
ChMotion(8,4,1);
MsgDisp("Daichi","He should talk as if he's with
me more often, huh?");
VoicePlay("E010830000_09_070");
ChEye(9,3);
ChMouth(9,0);
ChMotion(9,0,1);
MsgDisp("Kuya","When in Rome, do as the Romans do.");
VoicePlay("E010830000_08_070");
ChEye(8,2);
ChMouth(8,0);
ChMotion(8,0,1);
MsgDisp("Daichi","But he seems a bit distant.
He doesn't act like the same
big bro when he's out");
VoicePlay("E010830000_09_080");
ChEye(9,3);
ChMouth(9,0);
ChMotion(9,4,1);
ChEyeOpenLevel(9,8);
MsgDisp("Kuya","Haha! I guess Dai-chan
...
ChMouth(8,3);
ChMotion(8,3,1);
MsgDisp("Daichi","Of course! I'm proud
he's my brother!");
MsgDisp("主人公","(Both ｛大地＊＊｝ and Kuya are
so funny and kind......
