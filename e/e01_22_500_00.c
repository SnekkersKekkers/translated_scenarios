...
MsgDisp("Hikaru","Hikaru guesses it would be better to learn it
properly, after all?");
MsgDisp("主人公","Come to think of it, ｛ひかる＊｝, don't
you speak in French sometimes?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("E012250000_22_040");
MsgDisp("Hikaru","That's right! Hikaru was inspired by Mizuki
of the Sudo group. She really has that Tres
Bien sort of feeling～▼");
MsgDisp("主人公","I see...!");
ChEye(22,2);
ChMouth(22,0);
ChMotion(22,2,1);
...
MsgDisp("Hikaru","It's not worth going so far as to study for
it, though.
Hmm...");
MsgDisp("主人公","Hmm, since it's just a trial class, why don't
you try it out?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
...
If Hikaru tries but can't keep up, then it's
really impossible!");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,0,1);
...
ChClose(22);
MsgDisp("主人公","(I see.
｛ひかる＊｝ uses French because she was
influenced by someone she admires...)");
MsgClose();
ScrFadeOut(0,0);
