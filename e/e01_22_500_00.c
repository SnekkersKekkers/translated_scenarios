...
MsgDisp("Hikaru","Hikaru guesses it would be better to 
learn it properly, after all?");
...
Hikaru studied.
Hmm......");
MsgDisp("主人公","Hmm, since it's just a trial class,
...
If Hikaru tries but can't keep up,
