...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(It's time to go home. ......Huh? Over
there, is that......)");
...
MsgDisp("Hikaru","Hmm......");
MsgDisp("主人公","｛ひかる＊｝! What are you looking at?");
ChEye(22,0);
ChMouth(22,0);
ChMotion(22,3,1);
...
BGMStop();
ChClose(22);
MsgDisp("主人公","(I see. ｛ひかる＊｝ uses French
because she was influenced by someone she
admires......)");
MsgClose();
ScrFadeOut(0,0);
