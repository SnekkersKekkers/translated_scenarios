...
MsgDisp("Hiiragi","I wanted to give Goro-sensei a
ticket to the Habataki Theater Company,
so I asked Hikaru.");
ChEye(22,0);
ChMouth(22,0);
ChMotion(22,0,1);
...
MsgDisp("主人公","Okay!");
MsgDisp("主人公","(The head of the theater company
and the model. They're both so amazing,
but they're also so kind.)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
