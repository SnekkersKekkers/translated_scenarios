...
MsgDisp("Hiiragi","Yes, I was out shopping for the
theatre company-");
ChEye(5,3);
ChMouth(5,2);
ChMotion(5,0);
VoicePlay("E010620000_05_020");
MsgDisp("Hiiragi","Oh, that's right,
would you know what \"Pop pop\" is?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0,1);
...
MsgDisp("Himuro","It's probably cushioning material. Like
the bubble wrap used for fragile items");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("E010620000_05_050");
MsgDisp("Hiiragi","Ah, perhaps. The request came from the
props department.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
...
MsgDisp("Himuro","That's just a way of saying
to crush something.");
VoicePlay("E010620000_05_090");
MsgDisp("Hiiragi","I don't know what that means,
