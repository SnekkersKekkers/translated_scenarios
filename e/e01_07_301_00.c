...
MsgDisp("Mikage","Yo.
The story is Honda's wish came true and
he got a treasure.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1);
...
MsgDisp("Honda","Ahー, now I feel like looking through
it again.
...
MsgDisp("Mikage","That's Honda's talent. When he has an
interest he gets so invested that he
...
MsgDisp("Mikage","Maybe you'll be studied at 
