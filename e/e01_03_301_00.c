...
MsgDisp("主人公","Ah, ｛本多＊＊｝.
Yeah, but I'm already on my way home
now. What about you?");
ChEye(3,4);
ChMouth(3,0);
ChMotion(3,4,1);
...
Honda-kun taught me an effective 
strategy.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
VoicePlay("E010330100_03_020");
MsgDisp("Honda","Yep yep. Yano-kun has a lot of shopping
to do so the strategy will make a big
...
MsgDisp("Hiiragi","Yes, he was very helpful. It took one 
hour less than I had planned. Thanks to 
him, I think I can get something else.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
So I guess I should think about it
for the next time?");
MsgDisp("主人公","Ehh?
...
BGMStop();
ChClose(3);
MsgDisp("主人公","(Hmm, but I'd prefer to take my time
when it comes to choosing clothes and
accessories......)");
MsgClose();
ScrFadeOut(0,0);
