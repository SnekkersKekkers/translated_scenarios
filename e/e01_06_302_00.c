...
MsgDisp("Vice Principal Himuro","......Hmm, hello.");
ChEye(6,2);
ChMouth(6,2);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
...
MsgDisp("Vice Principal Himuro","Inori.
...
MsgDisp("Vice Principal Himuro","Alright.
...
MsgDisp("Himuro","You were giggling just now,
weren't you?");
...
MsgDisp("Vice Principal Himuro","Sorry. That's it for me today.
...
MsgDisp("Vice Principal Himuro","We'll be off now.
