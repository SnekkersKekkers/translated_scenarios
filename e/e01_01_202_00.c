...
MsgDisp("Kazama?","Do you have to bother me with this 
all the time?
Leave me alone.");
MsgDisp("主人公","｛風真＊＊｝, ｛颯砂＊＊｝!");
MsgClose();
...
MsgDisp("Sassa","Amazing, the three childhood friends 
all together!");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
He's still got a good spring, so I 
was recommending the sports club to him.");
ChEye(1,2);
ChMotion(1,0);
ChEyeOpenLevel(1,0);
...
MsgDisp("Kazama","Sassa, why did you have 
to make it more interesting than it is?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
right?");
MsgDisp("主人公","Amazing! Did you manage 
to catch up to them?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
...
MsgDisp("Sassa","Yeah, it was brilliant. Ryota has always
had an exceptional sports sense, but he
didn't join any team!");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
...
I got, as long as you're around, 
I feel mediocre.");
MsgDisp("主人公","Is that so?
But you can do anything, ｛風真＊＊｝, 
...
MsgDisp("Kazama","If you're so eager to recruit someone,
why don't you recruit this one? 
...
Maybe I understand ｛風真＊＊｝ 's feelings
a bit!')");
MsgClose();
ScrFadeOut(0,0);
