...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(Phew... Is it time to head home already?)");
...
MsgDisp("Honda","Hey∋ It's not Sakkun, it's you.");
ChEye(3,0);
...
MsgDisp("Sassa","Huh∋ You're here too?");
ChEye(2,0);
...
ChMouth(2,4);
ChMotion(2,4);
MsgDisp("Sassa","Hu-h. That's what I like about you, Iku!
