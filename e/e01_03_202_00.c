...
MsgDisp("Honda?","Back when I was in elementary school
I would play against my Dad on 
Saturdays.");
MsgDisp("主人公","｛本多＊＊｝, ｛氷室＊＊｝, what
are you guys up to?");
MsgClose();
...
MsgDisp("Honda","I was playing Shogi with an old man
at the park when Nori-kun came by and
...
Isn't Shogi better when it's played
face to face against people?");
MsgDisp("主人公","Ah, it would be interesting to watch
the two of you compete.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,1);
VoicePlay("E010320200_06_040");
MsgDisp("Himuro","I won't be doing that. You only say
that because you didn't get to see
that old man's confusion earlier.");
...
MsgDisp("Himuro","If we make it a rule to not talk
during the game, I'll consider it. But
that's impossible for you, right?");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,1,1);
...
MsgDisp("Honda","Banning talking is no fun. That old
man seemed to be having fun listening
to me too......");
