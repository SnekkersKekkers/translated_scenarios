...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(......Alright then, I guess it's
...
MsgDisp("Honda?","Here, look. Isn't that nice?
...
MsgDisp("Kazama","You guys are laughing 
...
MsgDisp("Kazama","Yeah, I was asked to 
take this shift on short notice.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,4,1);
VoicePlay("E010320000_03_030");
MsgDisp("Honda","Seeing Ryo-kun wearing the same 
uniform as I do at my part-time job 
made me really happy.");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,0,1);
VoicePlay("E010320000_01_050");
MsgDisp("Kazama","Because of that, Honda-kun went all
the way back just to get the apron from
his part-time job.");
MsgDisp("主人公","Hehe.
...
MsgDisp("Honda","I thought I'd take a picture and send
it to you. But it looks like that is no
longer necessary.");
ChMotion(1,0);
ChEyeOpenLevel(1,0);
Wait(12,0);
...
At least he changed his mind, thanks
to you. Cya later.");
