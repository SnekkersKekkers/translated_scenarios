...
BGOpen("fp100",1);
ScrFadeIn(0);
MsgDisp("主人公","(......Hm? Infront of the store window
is......)");
MsgClose();
BGMPlay("BGM_C07_MIKAGE_A",0.01);
ChOpen(7,255,3,1,4,#1,#1,0,0);
MsgDisp("主人公","Hello, ｛御影＊＊｝. What are you
doing?");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("Nanatsumori","｛主人公｝. Bad time to call out.");
ChEye(7,0);
ChMouth(7,4);
ChMotion(7,1);
...
MsgDisp("Nanatsumori","Mikage-sensei, you were about to enter the
beauty salon, weren't you?");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("Nanatsumori","Yeah. I'm curious about Mikage-sensei's
hairstyle.");
...
MsgDisp("Mikage","Actually...... The person who always did
my hair at the salon quit and I haven't
gone back.");
ChEye(7,2);
ChMouth(7,3);
ChMotion(7,1);
