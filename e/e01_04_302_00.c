...
MsgDisp("Nanatsumori","He thinks you're being hit on by some flashy
guy called NANA.
AKA me."); 
MsgDisp("主人公","Ah...");
ChEyeOpenLevel(4,#1);
...
MsgDisp("Nanatsumori","We were able to prevent it, though I feel it
almost led to another misunderstanding.");
MsgDisp("主人公","(What other misunderstanding could there be?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
