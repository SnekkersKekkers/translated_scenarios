...
MsgDisp("Mikage","Oh, I often come here on
my days off. The food they sell there
is delicious.");
...
MsgDisp("Mikage","There are a lot of beauties
waiting for me back at home.");
MsgDisp("主人公","I see.
I do remember you saying you
have a lot of plants.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("E010710100_07_050");
MsgDisp("Mikage","That's right. See you, then.
