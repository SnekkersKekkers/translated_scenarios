...
MsgDisp("Himuro","I'll tell you now, the nutritional
balance for all my meals is calculated
ahead of time.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
MsgDisp("Himuro","But no matter how many times I'm warned, I
can't help but have instant ramen and soda
after surfing.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0);
