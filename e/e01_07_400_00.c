...
MsgDisp("Michiru","Hey, Mari do you know what
\"hiyashi chuka\" is?");
MsgDisp("主人公","Yeah.");
ChEye(21,0);
ChMouth(21,4);
...
If it was on the cafeteria menu, I'd
eat it all the time.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("E010740000_07_030");
MsgDisp("Mikage","So, I'd like both of you to vote
for it in the cafeteria request box.");
ChEye(21,0);
ChMouth(21,3);
ChMotion(21,3);
...
ChPosition(21,0);
Wait(30);
MsgDisp("主人公","Hehe. ｛御影＊＊｝, will you ask others for
help too?");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,4);
