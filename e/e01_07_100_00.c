...
MsgDisp("Mikage","I wouldn't go into
a fancy store wearing this.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("E010710000_07_020");
MsgDisp("Mikage","I was tending to the soil
at the Green Farm in Forest Park.");
...
MsgDisp("Mikage","I don't need to take care
of them every day.
...
MsgDisp("主人公","Huh......
are you talking about us students......?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,3);
VoicePlay("E010710000_07_060");
MsgDisp("Mikage","I think you can find beauty
in every field.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,0);
