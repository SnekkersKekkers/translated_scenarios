...
MsgDisp("Sassa","Oh, we just ran into
each other here.
Right?");
ChEye(4,0);
ChMouth(4,0);
...
I thought I saw a guy with the same 
shopping bag as me and it happened
to be Sassa.");
MsgDisp("主人公","Heh...... What a surprise,
I didn't think your interests overlapped.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,2);
...
MsgDisp("Nanatsumori","I don't have a lot of it. But it's
comfortable to wear at home, and I can
coordinate it in various ways too.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("E010220200_02_030");
MsgDisp("Sassa","Mixing and matching clothes
requires the best sense of style.
...
MsgDisp("Nanatsumori","True. Sometimes you like the design,
but the size just doesn't fit. With sports
brands, that's not a problem.");
MsgDisp("主人公","You're both so tall,
choosing clothes must be difficult.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
