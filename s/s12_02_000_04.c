...
Don't talk about next year yet!");
    ...
    MsgDisp("Sassa","See, doesn't the demon look like it's
laughing?");
...
I'll jog home.");
    ...
    ChClose(2);
    MsgDisp("主人公","(There's only a few days left of our high
school life.
Let's spend it without regrets!)");
    break ;
    case 3:
    ChEye(2,0);
    ChMouth(2,0);
...
than a wish.");
    ...
    MsgDisp("Sassa","When I stood next to you and clapped my
hands together, I remembered a lot of
things.");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,0);
...
wanted to give thanks.");
    ...
    MsgDisp("Sassa","Sometimes, when I'm concentrating during a
competition, there's this moment where it
...
I was shocked when I looked at you.");
    ...
    MsgDisp("Sassa","I thought you looked so serious with your
hands together like that.");
    ...
    MsgDisp("Sassa","Hmm, I guess it's because I'm relieved?
