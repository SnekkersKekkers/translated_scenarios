...
beginning of the year with you. It seems
...
Okay, let's try our best.");
    ...
    MsgDisp("Hiiragi","With you, I'm sure everything will
be enjoyable.");
    ChEye(5,0);
    ChMouth(5,4);
    ChMotion(5,0);
...
people at your performances?");
    ...
    MsgDisp("Hiiragi","Hm, I wonder.
Standing in front of a lot of people
isn't really the same as being in the
middle of a crowd.");
    MsgDisp("主人公","I see.");
    ChEye(5,4);
    ChMotion(5,0);
    VoicePlay("S120500000_05_100");
    MsgDisp("Hiiragi","Yes, but when you're next to me,
waiting around doesn't seem so bad.
The voices don't seem as loud.");
    MsgDisp("主人公","Voices?");
    ChMotion(5,4);
    VoicePlay("S120500000_05_110");
    MsgDisp("Hiiragi","Yeah, there were a few people who
appear to be regulars of mine. But they
seemed to shy away at the sight of you.");
    MsgDisp("主人公","Eh?");
    ChMotion(5,0);
