...
｛本多＊＊｝, what's wrong?");
    ...
    MsgDisp("Honda","I want to tell the Gods: Thank you
...
Let's live without regrets!)");
    ...
    MsgDisp("Honda","This is the end. Our last New Years
...
Do you regret anything?");
    ...
    MsgDisp("Honda","Alright, think about it while
we walk. I'll take you home.");
    ...
    MsgDisp("Honda","I really wanted to spend New Years
with you this year. So let me just thank
you for that.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
...
What's this about?");
    ...
    MsgDisp("Honda","Because it's our last New Years
while in high school, we don't know what
will happen next year, right?");
    MsgDisp("主人公","Oh......I see.");
    ChEye(3,4);
    ChMouth(3,3);
    ChMotion(3,4,1);
    VoicePlay("S120300004_03_090");
    MsgDisp("Honda","Of course, I'd like to spend next
New Years with you as well. But that's 
up to you, I guess?");
    MsgDisp("主人公","Eh?");
    ChEye(3,0);
    ChMouth(3,3);
...
We can chat along the way. Let's go.");
    SEPlay("EV_SE_FOOT_WALK_AWAY_TWO_LONG");
    BGMStop();
    MsgClose();
    ScrFadeOut(0,0);
