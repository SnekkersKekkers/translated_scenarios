...
Wearing a kimono was the right choice!)");
    ...
    MsgDisp("Mikage","Ah, my bad. What's wrong with me.
You look gorgeous in a kimono, huh?");
    ...
    MsgDisp("Mikage","I saw something nice early this
year.
...
｛御影＊＊｝......!)");
    ...
    MsgDisp("Mikage","Seeing sweet pea like this so early
in the year is so nice, isn't it?");
...
It was worth it to wear the kimono.");
    ...
    MsgDisp("Mikage","The kimono is definitely beautiful,
but sweet peas are fine in whatever they 
wear.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,2);
...
aren't they?");
    ...
    MsgDisp("主人公","(｛御影＊＊｝ seems really happy
about it. But vegetables......?)");
    break ;
    default :
    DbgAssert(1);
    break ;
