...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Kazama","I guess it's safe to say that
we've arrived.");
    MsgDisp("主人公","It's still bright outside, so
don't worry about it, okay?");
    ...
    MsgDisp("Kazama","It's not a matter of how bright it
is. Especially for you, it's that.");
    MsgDisp("主人公","Huh?");
    ChEye(1,0);
    ChMouth(1,2);
    ChMotion(1,1);
...
That power that draws you in is stronger
than usual. Be careful today. Cya later.");
    MsgClose();
...
What kind of question is that?");
    MsgDisp("主人公","Eh? I just wanted to know your
plans......
Oh, are you going in?");
    ChEye(1,2);
    ChMouth(1,2);
...
to do?");
    ...
    MsgDisp("Kazama","Sigh, I'm sorry, but I'm really
busy. I've been helping Grandpa clean
...
I'm just happy I got to spend New Years
with you. I couldn't ask for more.");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,0);
