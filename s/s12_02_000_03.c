...
See you.");
    ...
    MsgClose();
    ChClose(2);
    MsgDisp("主人公","(This year, ｛Sassa＊＊｝ is also trying
his best.
...
prayed earnestly.");
    MsgDisp("主人公","I see.
Since it's ｛Sassa＊＊｝, I'm sure you'll
do well.");
    ChEye(2,3);
    ChMouth(2,3);
    ChMotion(2,5);
...
A stubborn guy like me who does everything
by himself can somehow just listen to you.");
    MsgDisp("主人公","...Why?");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,4);
