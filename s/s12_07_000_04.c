...
switch (ChPrmGet(7,6)){
    ...
    MsgDisp("Mikage","It's your final winter vacation
of high school. Live properly so you 
don't have any regrets, okay?");
    MsgDisp("主人公","Yeah, I'll be graduating soon......");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,1);
    VoicePlay("S120700004_07_060");
    MsgDisp("Mikage","That's right. It was packed this year. Did
you get to make a wish properly?");
    MsgDisp("主人公","Yes.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
Shall we talk about our wishes while
we walk?");
    MsgDisp("主人公","Ehh?");
    ...
    MsgDisp("Mikage","......Did you forget to make your
wish?");
    MsgDisp("主人公","Hehe!
...
It's almost time.");
    MsgDisp("主人公","Already? It's still okay......");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
If only there was something you forgot 
to wish for......");
    MsgDisp("主人公","Eh......");
    ChEye(7,0);
    ChMouth(7,0);
...
Come, I'll take you home. Let's go.");
