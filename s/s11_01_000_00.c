...
MsgDisp("主人公","｛Kazama＊＊｝, will you be okay?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("S110100000_01_010");
MsgDisp("Kazama","It's nothing.
I just have to brace myself.");
MsgDisp("主人公","It's great how you think that way.");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,2);
VoicePlay("S110100000_01_020");
MsgDisp("Kazama","Wait a sec, you're the one I'm worried about.
