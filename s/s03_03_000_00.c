...
Good luck this year too.");
    MsgDisp("主人公","This year, we're together again. Would you
like to go to the shrine with me?");
    break ;
    case 3:
    SEPlay("EV_SE_663");
    SEWait();
...
But somehow you rang me first.");
    MsgDisp("主人公","Hehe.
Hey, if it's okay with you, would you
like to visit the shrine together?");
    break ;
    default :
    DbgAssert(1);
    break ;
