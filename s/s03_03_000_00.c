switch (ChPrmGet(3,6)){
    ...
    MsgDisp("Honda","Hello?");
    MsgDisp("主人公","Ah, ｛本多＊＊｝? Happy New Year.");
...
Let's treat each other well this year!");
    MsgDisp("主人公","Yep. Let's meet up a lot this year. Would
you like to visit the shrine?");
    break ;
    case 4:
    case 5:
    SEPlay("EV_SE_663");
...
But somehow you rang me first.");
    MsgDisp("主人公","Hehe. Hey, if it's okay with you, would
you like to visit the shrine together?");
    break ;
    default :
    DbgAssert(1);
    break ;
