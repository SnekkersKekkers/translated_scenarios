...
Oh, when you look up, try to find my
head in the crowd.");
...
time like this.");
    ...
    MsgDisp("Sassa","The air at the shrine is so clean,
and it feels good when it's so crowded.");
...
I have to turn that hard work into
hard results.");
    MsgDisp("主人公","I want to support (｛颯砂＊＊｝
and his challenges again this year!)");
    break ;
    case 4:
    case 5:
    ChEye(2,0);
...
Everyone's having fun.");
    ...
    MsgDisp("Sassa","I'm having more fun than
...
That's a difficult one.");
    ...
    MsgDisp("Sassa","My wish is something I work on
myself. It's not something to ask God
for.");
    MsgDisp("主人公","......I see.");
    break ;
    default :
