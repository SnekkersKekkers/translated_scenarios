...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Shirahane","No need. This is my way of 
thanking you too.");
    ChEye(8,3);
    ChMouth(8,3);
    ChMotion(8,0,1);
    VoicePlay("S120800005_08_020");
    MsgDisp("Shirahane","We only have a few days left in
our high school lives. So let's live
without any regrets!");
    MsgDisp("主人公","Agreed!");
    ChEye(8,3);
    ChMouth(8,3);
    ...
    ChClose(8,0,30);
    MsgDisp("主人公","(As ｛大地＊＊｝ says,
I need to live without any regrets......!)");
    break ;
    case 4:
    case 5:
    MsgDisp("","　　　　　　　　　　 ・
