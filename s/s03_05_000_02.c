switch (ChPrmGet(5,6)){
    ...
    MsgDisp("Hiiragi","Sorry. The beginning of this year is
pretty busy for me...");
...
Guess I'll go alone then.)");
    ...
    MsgDisp("Hiiragi","Ahh...... I'm about to have dinner with
the board members.");
    MsgDisp("主人公","I see......that's too bad.");
    VoicePlay("S030500002_05_030");
    MsgDisp("Hiiragi","Sorry. If you go, get a fortune on my
behalf.");
    MsgDisp("主人公","Ehh∋");
...
I wanted to go to the shrine with you.");
    ...
    MsgDisp("Hiiragi","It can't be helped. I'll send my spirit
with you. Bye.");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
