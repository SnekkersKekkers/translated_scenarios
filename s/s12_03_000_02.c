...
It was fun visiting with ｛Honda＊＊｝.");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,1,1);
    VoicePlay("S120300002_03_010");
    MsgDisp("Honda","Right. That means we both are off to a
great start this year. Happy New Years!");
...
See you later then!");
    ...
    MsgDisp("Honda","It's been a great start to the New Year,
thanks to you.");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
...
so quickly.");
    MsgDisp("主人公","Right?
Thanks to ｛Honda＊＊｝, I also had a fun
time.");
    ChEye(3,3);
    ChMouth(3,3);
    ChMotion(3,3,1);
...
while...");
    ...
    MsgDisp("Honda","Haha, this story is getting too long.
