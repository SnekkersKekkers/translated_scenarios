...
Everyone looks like they're having fun.");
    ...
    MsgDisp("Honda","Yeah yeah, me too, me too!");
    break ;
    case 3:
    ChEye(3,3);
    ChMouth(3,3);
...
I wonder what everyone's wishing for.");
    ...
    MsgDisp("Honda","Right.
That you, me, and my family are in good
health. Hm, and also for my animals.");
...
say \"Everyone's Health\" instead.");
    ...
    MsgDisp("Honda","This is exactly what I expected from a New
Year's visit!
