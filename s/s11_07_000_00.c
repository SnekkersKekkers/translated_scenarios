...
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("S110700000_07_010");
MsgDisp("Mikage","Nothing to worry about.
If we draw the fortunes together,
...
MsgDisp("Mikage","Even if one person draws Bad Luck, if 
the other person gets Good Luck then
the two will neutralize each other.");
...
MsgDisp("Mikage","Look, whatever you pull, I won't be
afraid of it.");
