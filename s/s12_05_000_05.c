...
I guess I'll be graduating soon......");
    ...
    MsgDisp("Hiiragi","Yes, I prayed earnestly.
I was a bit greedy this year, so if my
wish comes true, the two of us will
visit again next year.");
    MsgDisp("主人公","Eh?");
    ChEye(5,3);
    ChMotion(5,4);
    VoicePlay("S120500002_05_100");
    MsgDisp("Hiiragi","I prayed that you would be able
...
After this, I have a meet and greet.");
    MsgDisp("主人公","Right, that's an important job
for the chairman.");
    ChEye(5,0);
    ChMotion(5,4);
    VoicePlay("S120500002_05_180");
    MsgDisp("Hiiragi","What will the New Year version of
you look like?");
    MsgDisp("主人公","Eh?");
    ChEye(5,3);
    ChMotion(5,0);
