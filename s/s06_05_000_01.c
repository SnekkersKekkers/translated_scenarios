...
It's nice.");
    ...
    MsgDisp("Hiiragi","Since you're not used to wearing one, it may
be hard to move around. Don't let it get
dirty and be careful of how you walk.");
...
I'm happy to be standing next to you.");
    ...
    MsgDisp("Hiiragi","Yes. It means that you are well dressed.");
    ...
    MsgDisp("Hiiragi","Women's kimonos are really nice, after all.");
...
Is that supposed to be a compliment...?");
    ...
    MsgDisp("Hiiragi","Yes, it's the number one compliment of
the year.");
...
But this rating won't change throughout the
rest of the year!");
