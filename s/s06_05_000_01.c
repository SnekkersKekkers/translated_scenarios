...
It's nice.");
    ...
    MsgDisp("Hiiragi","Since you're not used to wearing
one, it may be hard to move around.
Don't let it get dirty and be careful
of how you walk.");
...
It's impressive. I'm happy to be standing
next to you.");
...
It means that you are well dressed.");
    MsgDisp("主人公","(......Well, he seems happy,
so I'm happy!)");
    break ;
    case 4:
    case 5:
    ...
    MsgDisp("Hiiragi","Women's kimonos are really nice,
after all.");
...
Is that supposed to be a compliment......?");
    ...
    MsgDisp("Hiiragi","Yes, it's the number one compliment
of the year.");
