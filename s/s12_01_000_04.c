...
You're still the same as always.");
    MsgDisp("主人公","Geez, seems like there's going to be a
lot of nagging from ｛Kazama＊＊｝ this
year too...");
    ChEye(1,0);
    ChMouth(1,3);
    ChMotion(1,3);
...
I'll explain that part to you slowly on
our way home. Let's get you home.");
...
every year.");
    ...
    MsgDisp("Kazama","｛主人公｝, you've changed a bit
somehow...
