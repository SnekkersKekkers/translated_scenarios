...
switch (ChPrmGet(8,6)){
    ...
    MsgDisp("Shirahane","Let's do our best this year to bring good
fortune to each other～!");
    MsgClose();
...
I feel relieved.");
    ...
    MsgDisp("Shirahane","Yup. Should I really just go home?
...
for our shrine visit?");
    ...
    MsgDisp("Shirahane","...Oh no. New Year's was already such a
treat, how will I manage for the rest of
the year?");
    MsgDisp("主人公","???");
    ChEye(8,3);
    ChMouth(8,3);
