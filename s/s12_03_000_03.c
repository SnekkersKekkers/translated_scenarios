...
Walking home was fun too!");
    MsgDisp("主人公","Hehe, you're grinning while you
talk. Maybe you're a bit tired?");
    ChEye(3,0);
    ChEye(3,0);
    ChMotion(3,0,1);
...
Cya!");
    ...
    ChClose(3);
    Wait(30);
    MsgDisp("主人公","(I'm happy I was able to visit
the shrine with ｛本多＊＊｝.
...
in order.");
    ...
    MsgDisp("Honda","Of course, I'm happy that you were
...
I'd say there about 50 on the list.");
    ...
    MsgDisp("Honda","But I spoke so quickly in the
second half, maybe the gods missed you?");
