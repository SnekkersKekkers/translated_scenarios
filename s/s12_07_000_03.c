...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Mikage","I'm still just starting to do 
those 100 things I want to do.");
    MsgDisp("主人公","Yep.
It's still just the beginning. At least
today we did one thing.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,3);
...
So, what's the number one thing you
want to do?");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
You like to move too quickly. You need
to have patience, otherwise things are
boring.");
    MsgDisp("主人公","Uhm......
Then......");
    ChEye(7,0);
...
Thanks for spending time with me today.");
    ...
    MsgDisp("Mikage","Of course. I'll be waiting to see
you at school again, okay?");
    MsgClose();
...
　　　　　　　　　　 ・");
    ...
    MsgDisp("Mikage","Ah, my apologies for dragging you
around so much today.
But thanks to you, the year is off to
a great start.");
    MsgDisp("主人公","Ah, ｛御影＊＊｝, do you have to
go to school today too?");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,3);
...
club's fields.");
    ...
    MsgDisp("Mikage","Earlier, everyone prayed for
the pumpkins to grow well and healthy, so
don't worry.");
    MsgDisp("主人公","Hehe, that's a very kind wish
from ｛御影＊＊｝.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
real pumpkin to be healthy and strong.");
    ...
    MsgDisp("Mikage","Do you realize how red you're
turning, Miss Pumpkin?
Cya.");
    MsgClose();
    SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
    ChClose(7);
    ...
    MsgDisp("主人公","(I hope I can be with ｛御影＊＊｝
on New Year's next year too.
