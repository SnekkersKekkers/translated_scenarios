...
MsgDisp("Mikage","｛主人公｝, you sure are early
aren't you?");
...
The timing of writing on the board is also
important.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
...
Teachers and actors might be surprisingly
similar, right?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","It's almost time for the show to start,
Mikage-sensei.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,4);
VoicePlay("F100720001_07_040");
MsgDisp("Mikage","Yeah, the teacher's podium is my stage.
Shall we start?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("Hiiragi","I'll be off to be a guest at another
venue.");
MsgClose();
SEPlay("EV_SE_856");
BGMStop();
