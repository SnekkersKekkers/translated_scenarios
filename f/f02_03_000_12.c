...
MsgDisp("Honda","Mhm. Once it gets to spring, not only
the insects, but all kinds of living
things wake up!");
...
ChMotion(3,3);
ChEyeOpenLevel(3,0);
VoicePlay("F020300012_03_020");
MsgDisp("Honda","I'll be catching insects and
creature-watching, of course!");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,0);
...
park...... I get to see them hatch with
my own eyes!");
