...
MsgDisp("Himuro","I have some business with him too, 
so let's go together. Ryota-senpai, 
please wait here.");
ChEye(1,0);
ChMouth(1,0);
ChMotion(1,0);
...
MsgDisp("Himuro","Why are you going to the 
trouble of making it a trio?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("Himuro","That's because I have 
...
MsgDisp("Kazama","I also have some 
business with him now, too.");
MsgDisp("主人公","(...Hmm?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
