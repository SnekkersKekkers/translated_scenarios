...
studying by himself in the library
the other day.)");
...
BGOpen("sc330",0);
ScrFadeIn(0);
MsgDisp("主人公","(｛柊＊＊＊｝ doesn't seem to 
be in the reading area...)");
VoiceEVSPlay(5);
...
MsgDisp("Hiiragi","Do you have matters to 
discuss with me? What is it?");
MsgDisp("主人公","No.
I was just wondering if I 
could study with you.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("F100510001_05_020");
MsgDisp("Hiiragi","Is that so?
Thank you. Absolutely, please do.");
MsgDisp("主人公","Yeah.
Yeah. I don't feel motivated
...
of middle school.");
MsgDisp("主人公","That was before the theatre troupe
came to Habataki City, right?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
ChCheek(5,0);
VoicePlay("F100510001_05_050");
MsgDisp("Hiiragi","I was able to enroll
with the kindness of the board chairman.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("F100510001_05_060");
MsgDisp("Hiiragi","I can't be as good as everyone, 
but I hope to be a even just a little
closer to it. Shall we start right away?");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
BGMStop();
ChClose(5);
MsgDisp("主人公","(｛柊＊＊＊｝ is amazing.
even though he's so busy... I would
like to be able to help out any
way that I can.)");
MsgClose();
ScrFadeOut(0,0);
