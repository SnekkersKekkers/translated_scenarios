...
If not, your body won't be able to
handle it.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","It is my responsibility to guide
people, and I have been checking the
stalls as well.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
...
MsgDisp("Hiiragi","Yes. The flavours, too.
...
If I had not tested them, I could not
...
MsgDisp("主人公","(Haha, he's the yakisoba
information clerk!)");
MsgClose();
ScrFadeOut(0,0);
