...
MsgDisp("Michiru","...Ha. I think it's probably impossible
for me.");
...
even talking about it like this makes my
...
MsgDisp("主人公","Hehe! Maybe they'll think you're super
cute?");
ChEye(21,4);
ChMouth(21,4);
ChMotion(21,5);
...
MsgDisp("Michiru","Hey. Both Hikaru and Mari says the same
thing.");
ChMotion(21,4);
ChEyeOpenLevel(21,0);
VoicePlay("F032100000_21_530");
MsgDisp("Michiru","It's fine.
If there was a red string of fate, I would
follow it...");
MsgDisp("主人公","(Hmmm. Maybe ｛みちる＊｝ is a huge
romantic.))");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
