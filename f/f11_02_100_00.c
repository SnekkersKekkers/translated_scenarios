...
MsgDisp("主人公","Yep! What about you, ｛Sassa＊＊｝?");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,3);
VoicePlay("F110210000_02_010");
MsgDisp("Sassa","I'm taking it easy this festival.
There's no winning, losing, or time pressure.");
MsgDisp("主人公","Haha. Is it not enough for ｛Sassa＊＊｝?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Customer","Um, are you Sassa Nozomu from the track team?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,2);
VoicePlay("F110210000_02_030");
MsgDisp("Sassa","Huh? Uh, yeah.");
...
MsgDisp("Sassa","｛主人公｝, I'll go talk to them over there.
Afterwards, should we go try the food?");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
ChClose(2);
MsgDisp("主人公","(Hehe, guess ｛Sassa＊＊｝ really will
teach him.)");
MsgClose();
ScrFadeOut(0);
