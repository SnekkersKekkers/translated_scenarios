...
MsgDisp("Sassa","I'm taking it easy this festival. There's
no winning, losing, or time pressure.");
MsgDisp("主人公","Haha.
...
MsgDisp("Male Customer","I'm in track and field, too. How'd you do
it? How'd you set that record?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,2);
...
ChClose(2);
MsgDisp("主人公","(Hehe, guess
｛颯砂＊＊｝ really will teach him.)");
MsgClose();
ScrFadeOut(0);
