...
Her childhood friend and the prince of the
school, and they're both wonderful.");
ChEye(21,4);
ChMouth(21,4);
ChMotion(21,0);
...
MsgDisp("Michiru","So Mari, please!
I'll lend you this book, so please read it.
Won't you share my feelings with me?");
ChEye(21,4);
ChMouth(21,4);
ChMotion(21,4);
