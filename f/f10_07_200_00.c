...
BGOpen("sc510",0);
ScrFadeIn(0);
MsgDisp("主人公","(I have to move to the science
room for next class.
...
MsgDisp("Hiiragi","That would be quite surprising,
would it not?");
...
MsgDisp("Mikage","Yeah, when he smiles, I can't help
but feel a sense of relief.");
MsgDisp("主人公","Yeah.
...
MsgDisp("Mikage","If he's that happy, 
Maybe I'll make a blackboard 
for him next time.");
MsgDisp("主人公","Ehh?");
ChEye(7,0);
ChMouth(7,3);
VoicePlay("F100720000_07_050");
MsgDisp("Mikage","We should make a sliding blackboard 
for our class, too, right?");
BGMStop();
MsgClose();
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
ChClose(7);
...
Wait(60,0);
MsgDisp("主人公","(Hehe, so ｛柊＊＊＊｝ wasn't asking
him about the lesson, but was 
