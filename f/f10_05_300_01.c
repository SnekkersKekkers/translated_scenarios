...
MsgDisp("Hiiragi","｛主人公｝.
An important job of the student 
council is to enforce greetings.");
...
MsgDisp("Hiiragi","Yes. Everyone greets me
...
Don't get in the way of us enjoying
the greeting campaign, okay?");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,3);
VoicePlay("F100530001_21_020");
MsgDisp("Michiru","Mari isn't enjoying it, 
...
MsgDisp("主人公","(Hmm... I guess I'm being forced
to say it after all...?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
