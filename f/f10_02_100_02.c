...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(There's still time left of break, 
...
MsgDisp("Librarian","\"Exercise Learning Theory in Practice\" 
is scheduled to arrive next month.");
VoicePlay("F100210002_02_000");
MsgDisp("Sassa?","Is that so...?");
MsgDisp("主人公","(It's ｛颯砂＊＊｝.
\"Exercise Learning Theory
in Practice\"...)");
BGOpen("sc330",0);
MsgClose();
...
MsgDisp("Sassa","I'm a track-and-field idiot,
but I still use my head a bit.");
...
about how you should rest properly and
eat properly after putting stress on 
your body through training.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("F100210002_02_050");
MsgDisp("Sassa","Well, when it's written in a book 
...
MsgDisp("Sassa","Really? Well, they still are 
like dumbbells after all.
See you.");
...
He's giving it his all with 
his whole body and mind.)");
MsgClose();
ScrFadeOut(0);
