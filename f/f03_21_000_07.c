...
ChMouth(21,4);
ChMotion(21,2);
VoicePlay("F032100000_21_330");
MsgDisp("Michiru","My dream for the future....");
MsgDisp("主人公","I mean, maybe a top model or a fashion
...
MsgDisp("Michiru","I thought that until middle school. But...
it's a little different now.");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,0);
VoicePlay("F032100000_21_360");
MsgDisp("Michiru","Hey. Mari. Thanks to you, I can see
reality now.");
...
ChMotion(21,3);
ChEyeOpenLevel(21,0);
VoicePlay("F032100000_21_370");
MsgDisp("Michiru","Yes. Until now, I've gone with the flow,
living freely without knowing any
hardship.");
ChEye(21,0);
ChMouth(21,3);
ChMotion(21,0);
...
MsgDisp("主人公","(Hehe! I'm also looking forward to
｛みちる＊｝'s dream')");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
