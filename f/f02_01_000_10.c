...
MsgDisp("主人公","Well, Haba High's school festival is centered
around the play, right?
I want it to be a success.");
ChEye(1,4);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("F020100010_01_010");
...
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("F020100010_01_020");
MsgDisp("Kazama","OK!
Let's make it one you'll remember for years
to come. Whether it's a success or a failure.");
