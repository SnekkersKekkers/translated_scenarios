...
I'm glad.");
MsgDisp("主人公","Birthdays are always something to be happy
about, no matter how old you get.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
I've been at it since I was little, but
junior meets have a lot of limits.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("F020200004_02_030");
MsgDisp("Sassa","So just being able to compete at higher
levels made my birthdays something to look
forward to.");
...
MsgDisp("Sassa","But the important question is to what age
