...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","It's almost summer break soon.");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,5);
...
ChMouth(7,0);
ChMotion(7,3);
VoicePlay("F020700007_07_030");
MsgDisp("Mikage","Is it really that weird?
I come to school every day to take
care of the plants, but it's lonely 
without everyone there.");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("F020700007_07_040");
MsgDisp("Mikage","Even when I'm drinking tea 
...
MsgDisp("Mikage","Even if I go to school every day,
it's boring without you guys.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("F020700007_07_060");
MsgDisp("Mikage","If I really liked school,
that wouldn't be the case. ");
MsgDisp("主人公","That's because what you like 
...
MsgDisp("主人公","(So what ｛御影＊＊｝ is looking forward to
in the summer break is for school to start
again...)");
