...
You're talking about the phone game,
right?");
ChEye(4,0);
ChMouth(4,3);
...
MsgDisp("Nanatsumori","Right. The quests and training are just
brutal.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0);
...
MsgDisp("Nanatsumori","Mameko. Yeah, she's cute and looks pretty
strong. That's pretty cruel...");
