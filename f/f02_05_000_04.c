...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","Oh, ｛Hiiragi＊＊＊｝'s birthday is coming up,
isn't it?");
ChMouth(5,4);
VoicePlay("F020500004_05_000");
MsgDisp("Hiiragi","Yes, it is.
Actually, around this time of year, I get a
lot of gifts from patrons and supporters.");
MsgDisp("主人公","Even though it's not your birthday yet?");
ChEye(5,3);
ChMotion(5,3);
VoicePlay("F020500004_05_010");
MsgDisp("Hiiragi","Yes, even so.
I receive a lot of gifts around my birthday.
...
MsgDisp("Hiiragi","Although, that would be rude to my patrons...
How can I say this without any
misunderstandings?");
