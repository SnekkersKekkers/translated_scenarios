...
MsgDisp("Himuro?","I don't know if it's necessary
for athletics, but I heard about a
...
MsgDisp("Sassa","I promised it was up to me to
do what I want with that opinion.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,2);
VoicePlay("F100240002_02_040");
MsgDisp("Sassa","Inori says that when he surfs, 
he has eyes on the soles of his 
feet. That was great advice.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("F100240002_06_020");
MsgDisp("Himuro","I just do it with that kind 
of image in mind.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("F100240002_02_050");
MsgDisp("Sassa","That kind of sensation resonates 
with me as it comes from someone
who's done it before.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("F100240002_02_060");
MsgDisp("Sassa","I'll also try treating 
the feeling I get from the spikes
on my shoe against the 
...
MsgDisp("Himuro","Yes.
You should also come to the beach
sometime, Nozomu-senpai.
See you.");
MsgClose();
...
MsgDisp("Sassa","Well, if it's just us two guys, 
