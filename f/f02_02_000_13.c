...
MsgDisp("Sassa","I've never been to Nagasaki, so it'll be
super fun.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,2);
...
MsgDisp("主人公","I guess I'm looking forward to eating and
sleeping at the hotel with everyone.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,3);
...
bath. It's the best.");
MsgDisp("主人公","｛颯砂＊＊｝, you really like
baths, huh?");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,3);
