...
ChLayout(2);
ScrFadeIn(0);
MsgDisp("主人公","(I wonder if I should eat 
...
MsgDisp("Honda","Yup, I'm meeting up with
Chiru-chan and Pika-chan");
MsgDisp("主人公","Eh?");
...
Honda said he had something he wanted 
to consult us about. What is it?");
ChEye(3,2);
ChMouth(3,4);
ChMotion(3,4,1);
...
We'll give you the right advice,
so take a video and show 
it to your sister.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
MsgDisp("Hikaru","That's great! I'll teach her a 
diet method that will let you enjoy food
