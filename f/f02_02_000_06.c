...
MsgDisp("主人公","It'll be an easy victory for
｛颯砂＊＊｝.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
MsgDisp("Sassa","Nah.
From my experience, those kinds of people
are usually in another sport.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
flee.");
MsgDisp("主人公","Haha, that's definitely
｛風真＊＊｝. He doesn't seem
like he'd join a sports club.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
like that, I'm sure they'll be great in
