...
MsgDisp("Sassa","Well, maybe, but it's fun in other ways, too.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
MsgDisp("主人公","Really?
So, you scout for the track and field club?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("F020200006_02_030");
MsgDisp("Sassa","Nah.
From my experience, those kinds of people are
usually in another sport.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
MsgDisp("Sassa","So, I'm only trying to find the ones with a
hidden talent for track and field.");
MsgDisp("主人公","(If ｛Sassa＊＊｝ can find someone like that,
I'm sure they'll be great in the track and
field club...)");
