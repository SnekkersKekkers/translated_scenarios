...
church.
It seems like there's a lot of rumors.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("F020100002_01_000");
MsgDisp("Kazama","I've also heard a lot of them.
They're all weird.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
ChMouth(1,2);
ChMotion(1,4);
VoicePlay("F020100002_01_040");
MsgDisp("Kazama","I also heard about an ostrich farm.");
MsgDisp("主人公","Ostrich?
Is that about Mikage-sensei, too?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
...
MsgDisp("Kazama","Yep.
There's a rumor he's secretly keeping
ostrich chicks that are multiplying like crazy.");
