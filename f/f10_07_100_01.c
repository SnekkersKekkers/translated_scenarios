...
BGOpen("sc510",0);
ScrFadeIn(0);
MsgDisp("主人公","(I have class with ｛Mikage＊＊｝ next.
Is there anything to prepare?
I'll stop by the science prep room.)");
...
｛Mikage＊＊｝-like too, so I think that's
nice.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("主人公","You bike to work in overalls in the morning,
right?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
...
MsgDisp("Mikage","Alright, we can go to the classroom together
today.");
MsgDisp("主人公","Hehe, yes.");
BGMStop();
