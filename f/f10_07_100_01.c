...
BGOpen("sc510",0);
ScrFadeIn(0);
MsgDisp("主人公","(I have class with ｛御影＊＊｝ next.
I wonder if there's anything to 
prepare... I'll stop by
...
MsgDisp("Mikage","I've already finished changing clothes
for the day, so I'm all good.");
...
MsgDisp("主人公","You bike to work in overalls
in the morning, right?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
VoicePlay("F100710001_07_060");
MsgDisp("Mikage","Yeah, I can just go straight to 
the gardening club's field,
so it's efficient, right?");
...
MsgDisp("Mikage","Alright, we can go to the 
classroom together today.");
MsgDisp("主人公","Hehe, yes.");
BGMStop();
