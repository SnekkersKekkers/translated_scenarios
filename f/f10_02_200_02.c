...
MsgDisp("Sassa","I talked to Mikage-sensei about it.
I said I wanted to go to a hot spring
with club funds. He laughed, but 
it seems difficult.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,0);
...
MsgDisp("Hiiragi","We need to get the club 
...
MsgDisp("Sassa","First, we have to present 
...
MsgDisp("Hiiragi","Yes, I have the student council, too.
Work in the theater company is often 
unpredictable, so it seems
difficult for me.");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,4);
...
but why don't we all go to the
heated swimming pool?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("F100220002_05_030");
MsgDisp("Hiiragi","...Ah, agreed.");
MsgDisp("主人公","Eh?");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,4);
ChEyeOpenLevel(2,0);
VoicePlay("F100220002_02_060");
MsgDisp("Sassa","Alright, it's settled then.
It would be nice if we could put some 
hot spring salts in the pool though.");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,4);
ChEyeOpenLevel(5,9);
