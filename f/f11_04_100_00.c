...
MsgDisp("Nanatsumori","I'm patrolling like this
for discipline control.");
MsgDisp("主人公","I see. ｛七ツ森＊｝ is wearing his uniform
...
ChClose(4,0,30);
MsgDisp("主人公","(｛七ツ森＊｝ really has the air of
a model student when he's at school.
Good luck!)");
MsgClose();
MsgClose();
ScrFadeOut(0,0);
