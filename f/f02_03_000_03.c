...
MsgDisp("主人公","Huh? About the church?");
ChEye(3,1);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("F020300003_03_010");
MsgDisp("Honda","Yep yep! In the church's basement, there's a
huge library.
...
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("F020300003_03_040");
MsgDisp("Honda","Yep, that's the way!
One by one, fact check, and then keep
reading.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,4);
