...
MsgDisp("Kazama","Looks like Hiiragi is interested in 
the archives in the storehouse.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
...
MsgDisp("Hiiragi","Hehe, that certainly does seem 
rather easy to adapt into a play.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("F100520002_01_020");
MsgDisp("Kazama","It's not like that. It's a
\"Yuzurijou\", a certificate of 
an property transfer from ancient times.
...
MsgDisp("Hiiragi","That's true, but they were
carefully distributed amongst siblings,
I'm sure there's a story behind them.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
...
MsgDisp("Hiiragi","I'm happy to hear Kazama-kun 
say that. I shall think
about it carefully.");
...
something, both me and Ojii-chan
will be so happy.");
MsgDisp("主人公","(Yeah, I'm looking forward to
seeing what kind of show
he can create...!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
