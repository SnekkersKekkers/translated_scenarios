...
BGOpen("sc710",0);
ScrFadeIn(0);
MsgDisp("主人公","(This year's a success, too. Maybe there
are more general visitors than last year?)");
...
MsgDisp("Woman Customer B","I met him! At the horse riding lessons.");
