...
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("F020700014_07_020");
MsgDisp("Mikage","One piece of advice from your teacher.
I'm sure there are many things you
couldn't do, but you don't need
to dwell on them.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
VoicePlay("F020700014_07_030");
MsgDisp("Mikage","Remember the things you could do,
rather than the things you couldn't 
do, and live your life.");
MsgDisp("主人公","The things I could do.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,4);
VoicePlay("F020700014_07_040");
MsgDisp("Mikage","Even little things are fine.
For example... you managed to put up
with having the same homeroom
teacher for three years～, right?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
...
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("F020700014_07_070");
MsgDisp("Mikage","Then you can keep moving
forward without being caught up 
by strange regrets.");
MsgDisp("主人公","Yes!");
ChEye(7,0);
ChMouth(7,0);
...
Even if I say the same thing on the 
actual day, please act like it was your
first time hearing it, okay?");
MsgDisp("主人公","(There's only a little more time 
where I can be with ｛御影＊＊｝...
