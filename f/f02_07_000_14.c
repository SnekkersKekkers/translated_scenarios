...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","Graduation is coming up soon...");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
...
You still have a little bit of your high
school life left, right?");
MsgDisp("主人公","Yes.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
I'm sure there are many things you couldn't
do, but you don't need to dwell on them.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
...
For example... you managed to endure the same
...
MsgDisp("Mikage","Then you can keep moving forward without
being caught up by strange regrets.");
MsgDisp("主人公","Yes!");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
