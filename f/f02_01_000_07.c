...
ChMouth(1,0);
ChMotion(1,0);
VoicePlay("F020100007_01_000");
MsgDisp("Kazama","Well, since I'm here,
I'd like to do something you can
only do during summer vacation.");
MsgDisp("主人公","Like swimming in the ocean or camping?");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
ChEyeOpenLevel(1,8);
...
of us in plain clothes... 
Wouldn't that be nice?");
MsgDisp("主人公","I guess. It'd be a strange feeling.
