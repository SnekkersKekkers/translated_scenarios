...
Let's stop by the science preparation room.)");
...
MsgDisp("Mikage","I forgot I sent my suit to the dry cleaner...");
MsgDisp("主人公","Ehh∋");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,1);
...
MsgDisp("主人公","Eh? We have class in the science room next,
｛Mikage＊＊｝, don't you normally wear
overalls?");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,2);
...
MsgDisp("Mikage","Thank goodness you came, I was going to go to
class in these casual clothes...");
...
MsgDisp("主人公","(But, ｛Mikage＊＊｝ also looked good in his
casual clothes.)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
