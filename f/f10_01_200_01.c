...
MsgDisp("Mikage","｛主人公｝, are you also
enrolled? Today, we're asking ourselves...
...
ChMouth(7,3);
ChMotion(7,2);
VoicePlay("F100120001_07_040");
MsgDisp("Mikage","To not clean at all.");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,0,1);
VoicePlay("F100120001_01_030");
MsgDisp("Kazama","That's an eye-opener...");
MsgDisp("主人公","(Uh....is it?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
