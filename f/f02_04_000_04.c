...
ChMotion(4,0);
ScrFadeIn(0);
MsgDisp("主人公","Now I think about it, ｛Nanatsumori＊｝, isn't
...
MsgDisp("Nanatsumori","Not really...it just means that another year
has passed.");
...
MsgDisp("Nanatsumori","I'd like to get a huge cake and share it with
everyone at a big party.
Fill their stomachs and their hearts.");
ChEye(4,2);
ChMouth(4,4);
ChMotion(4,1,1);
VoicePlay("F020400004_04_070");
MsgDisp("Nanatsumori","...but there's nothing like that at my house.
