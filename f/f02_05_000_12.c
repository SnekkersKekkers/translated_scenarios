...
MsgDisp("Hiiragi","For that reason, this is an important time to
determine whether or not I can move up a
grade. No matter what I do, I am uneasy.");
MsgDisp("主人公","I see.
But as long as you attend regularly and study
hard, it'll be okay, right?");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,3);
...
That excitement and tension of a new semester
is the best part of spring break.");
MsgDisp("主人公","Mhm, that's right.
Talking with ｛Hiiragi＊＊＊｝ really gives me a
