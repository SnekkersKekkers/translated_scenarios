...
You always set specific goals and
keep going.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
how many metres, they're a little too
specific.");
...
MsgDisp("Sassa","Praise me when I actually get
something done.
Not now.");
...
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("F020200012_02_040");
MsgDisp("Sassa","Yeah, it'll motivate me to achieve it.
It's a very thought-out plan.");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,3);
VoicePlay("F020200012_02_050");
