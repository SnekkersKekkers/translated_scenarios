...
ScrFadeIn(0);
ChMotion(1,3);
VoicePlay("F020100003_01_000");
MsgDisp("Kazama","I learned some new things about that church.");
MsgDisp("主人公","Haha, are you treating it like the news?
It is a nice legend, though.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,3);
...
ChMotion(1,1);
ChEyeOpenLevel(1,8);
VoicePlay("F020100003_01_040");
MsgDisp("Kazama","One of the onis, a blond one, will swoop down
if you approach. The other one is huge and
glares from the flower bed.");
MsgDisp("主人公","Um, so you can't get close, right?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
VoicePlay("F020100003_01_050");
MsgDisp("Kazama","The secret they're protecting to that extent,
the one they're hiding...is Vice Principal
Himuro's spare body.");
ChEye(1,4);
ChEyeOpenLevel(1,0);
...
ChMotion(1,0);
ChEyeOpenLevel(1,8);
VoicePlay("F020100003_01_060");
MsgDisp("Kazama","He only looks human. From when he was a
homeroom teacher to when he was head teacher
to now...he had three bodies.");
MsgDisp("主人公","Um...so the oni are protecting
Himuro-sensei's spare bodies?");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,4);
