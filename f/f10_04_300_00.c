...
MsgDisp("Nanatsumori?","Nice. If I could design and make my own
...
MsgDisp("主人公","｛七ツ森＊｝, ｛みちる＊｝! I also
want to hear what you're talking about.");
...
MsgDisp("Nanatsumori","...You. How much of that did you hear just
now?");
...
This topic seems to be a taboo at school.");
ChEye(4,4);
ChMouth(4,2);
ChMotion(4,2,1);
...
MsgDisp("主人公","(I'm even more curious now that they're
whispering about it...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
