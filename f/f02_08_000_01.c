...
princess.");
MsgDisp("主人公","Yeah. There are all sorts of rumours, but
that one is one of the more well-known
ones.");
ChEye(8,0);
ChMouth(8,0);
ChMotion(8,2,1);
...
MsgDisp("Shirahane","Hehe. How 'bout we ask other students at
our school next time?");
MsgDisp("主人公","Eh?");
ChEye(8,3);
ChMouth(8,3);
ChMotion(8,3,1);
...
MsgDisp("主人公","(There are all kinds of rumors about love
at school...
