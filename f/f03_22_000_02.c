MsgDisp("主人公","What kind of food do you like,｛ひかる＊｝?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
ChEyeOpenLevel(22,0);
...
MsgDisp("Hikaru","Ehー...
Now that you ask me again... nothing 
is coming up. I like everything.");
MsgDisp("主人公","Then, do you have a 
disliked food?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,0,1);
