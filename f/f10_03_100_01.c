...
MsgDisp("Honda","Right right, it seems like
it's a girl in our year.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,4,1);
VoicePlay("F100310001_03_040");
MsgDisp("Honda","She keeps her umbrella there, and if 
she leaves it there for a week, it
gets put away, so she takes it 
home once a week.");
...
MsgDisp("Honda","I've figured out the rule for
the other one, so I'll observe it
for a while and make a hypothesis.");
MsgClose();
