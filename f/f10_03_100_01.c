...
MsgDisp("主人公","Ah are you talking about the umbrella that's
always there?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
...
And guess what, I saw it again the other day.");
...
leaves it there for a week, it gets put away,
so she takes it home once a week.");
...
MsgDisp("Honda","I've figured out the rule for the other one,
so I'll observe it for a while and make a
hypothesis.");
MsgClose();
