...
MsgDisp("Hikaru","Big sis can understand the 
lesson without the textbook, right?
...
ChMouth(22,0);
ChMotion(22,0,1);
MsgDisp("主人公","Hey, you two are in different classes,
so you have separate biology classes, 
right? Which of you have it first?");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,0);
...
MsgDisp("Hikaru","Hikaru has it first thing
...
Then, could I borrow it first, 
then hand it to Hikaru after that?");
MsgDisp("主人公","I dpn't have biology today,
so that's fine. That's good, isn't it?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,4,1);
