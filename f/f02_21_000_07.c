...
MsgDisp("Michiru","Pure white clouds against a deep blue sky.
The horizon stretches as you approach
the sea...");
MsgDisp("主人公","It's like I can hear the roar of the
waves...!");
ChEye(21,0);
ChMouth(21,3);
ChMotion(21,3);
...
MsgDisp("主人公","(I see. Being a model is quite tough...)");
MsgClose();
ScrFadeOut(0,0);
