...
MsgDisp("Mikage","It really is famous, huh? The princess waited
for the prince to return after unreasonable
demands were imposed on them.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,4);
VoicePlay("F020700001_07_020");
MsgDisp("Mikage","It's a typical story, but I think it's great
that the king allowed their marriage upon the
prince's return.");
MsgDisp("主人公","I see, without the king's blessing, those two
would not have been wedded.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("F020700001_07_030");
MsgDisp("Mikage","Right, the secret MVP of this legend is the
king. Normally, he'd find some new fault,
call a timeout, or make a new rule.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
...
MsgDisp("主人公","Hehe, I don't think I've ever thought about
the King in this story.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
ChEyeOpenLevel(7,8);
