...
MsgDisp("VP Himuro","In a survey we conducted recently among
guardians, we received many voices of
gratitude for Mikage-sensei.");
ChEye(7,5);
ChMouth(7,4);
ChMotion(7,0);
...
MsgDisp("VP Himuro","On behalf of the academy, I would like to
extend my gratitude to Mikage-sensei.
Thank you.");
...
I'm looking forward to the next evaluation!");
