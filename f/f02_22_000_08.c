...
Hikaru is already so excited it's a problem!");
MsgDisp("主人公","Hehe, what exhibit are you that excited for,
｛ひかる＊｝?");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,0,1);
...
good relationship with who, and how many new
...
MsgDisp("Hikaru","The cultural festival is an event where love
is born and fulfilled, right?");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,5,1);
