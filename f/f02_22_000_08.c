...
MsgDisp("Hikaru","That's not it～!
I wonder who has a good relationship 
with who, and how many new couples
will be born～▼");
MsgDisp("主人公","Eh...?");
ChEye(22,4);
ChMouth(22,3);
...
MsgDisp("Hikaru","The cultural festival is an event
where love is born and fulfilled, right?");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,5,1);
