...
MsgDisp("Hiiragi","Yes.
After I found the middle school 
...
of the \"past progressive tense\" we 
learned about in English class
this morning.");
MsgDisp("主人公","Hehe, I'm glad.
I'm sure you'll gradually understand
more and more.");
...
MsgDisp("主人公","Hehe.
You shouldn't cry over something
like this, okay? There is still lots
to learn, after all.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
...
Please continue to help me, teacher.");
MsgDisp("主人公","(I'm also having fun 
studying with ｛柊＊＊＊｝...!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
