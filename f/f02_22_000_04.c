...
party, but I'm so busy with work this 
time of year, that I don't have any 
personal time...");
...
MsgDisp("Hikaru","Well, the work itself is a birthday 
project, so it's exciting like a party.");
ChEye(22,2);
ChMouth(22,4);
ChMotion(22,2,1);
VoicePlay("F022200004_22_030");
MsgDisp("Hikaru","But, I wanted to have a party 
with Mari and my friends...");
MsgDisp("主人公","｛ひかる＊｝...");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,4,1);
...
definitely hold an amazing birthday 
party, so please let me invite you▼");
MsgDisp("主人公","Yeah!");
MsgClose();
ScrFadeOut(0,0);
