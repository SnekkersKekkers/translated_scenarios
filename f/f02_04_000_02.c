...
ChMouth(4,4);
ChMotion(4,1,1);
VoicePlay("F020400002_04_010");
MsgDisp("Nanatsumori","There are two main stories: 
the scary one, and the super funny one.
...
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("F020400002_04_030");
MsgDisp("Nanatsumori","It's not even that scary. In the church's
basement, there's a huge industrial
plant that's still operating.");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,0,1);
VoicePlay("F020400002_04_040");
MsgDisp("Nanatsumori","And now, they're working on a new
'student reconstruction' project......");
ChEye(4,4);
ChMouth(4,3);
VoicePlay("F020400002_04_050");
MsgDisp("Nanatsumori","No-good guys become good girls! Ugly
girls become handsome men! They call it
