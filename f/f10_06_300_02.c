...
Inorinrin is going to call Hikaru
\"Pikarin\"!");
...
If you're going to call Hikaru anything,
it should be something cuter, right～?");
ChEye(6,3);
ChMouth(6,0);
ChMotion(6,5);
...
MsgDisp("Hikaru","Ah! You were quick to call Hikaru that!
Yay♪");
ChEye(6,0);
ChMouth(6,1);
ChMotion(6,1);
