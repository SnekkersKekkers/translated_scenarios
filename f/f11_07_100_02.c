...
their family this year. Everyone seems
...
MsgDisp("Woman","That's true. Let's go.");
...
MsgDisp("主人公","Oh, are you the zookeeper? The
one that boy from earlier said was 
super interesting.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
...
ChClose(7);
MsgDisp("主人公","(Haha, typical ｛御影＊＊｝.
Both the adults and the kids are having 
fun. Should I go later, too?)");
MsgClose();
ScrFadeOut(0,0);
