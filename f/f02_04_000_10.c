...
I wonder how the school play is
shaping up.");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,0);
VoicePlay("F020400010_04_001");
MsgDisp("Nanatsumori","I hear both the script and the lead
...
MsgDisp("Nanatsumori","If you care so much about it, why not aim
for the  lead role?");
MsgDisp("主人公","Eh∋");
ChEye(4,2);
ChMouth(4,3);
...
Look, it's our last culture festival
of high school.");
ChEye(4,4);
ChMouth(4,4);
ChMotion(4,0);
