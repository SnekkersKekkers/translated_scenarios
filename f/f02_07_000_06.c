...
I have no complaints whether we win
or lose.");
...
MsgDisp("Mikage","High school sports festivals are the best
way to make memories. If you hold back,
you'll only end up with regrets.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoiceEVSPlay(7);
...
the events.");
MsgDisp("主人公","So you're not organising it, but you
...
MsgDisp("Mikage","It'll definitely be an
