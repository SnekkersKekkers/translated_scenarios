...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","The sports festival is soon.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
VoicePlay("F020700006_07_000");
MsgDisp("Mikage","Yeah, I'm looking forward to it!
I have no complaints whether we win or lose.");
MsgDisp("主人公","Hehe, ｛Mikage＊＊｝ seems to be more fired
up than the students?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
VoicePlay("F020700006_07_010");
MsgDisp("Mikage","High school sports festivals are the best way
to make memories. If you hold back, you'll
only end up with regrets.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoiceEVSPlay(7);
...
events.");
MsgDisp("主人公","So you're not organizing it, but you intend
on participating?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("F020700006_07_030");
MsgDisp("Mikage","Ah, I'm gonna do both!
The festival spirit in me is fired up.");
...
ChMouth(7,3);
ChMotion(7,2);
VoicePlay("F020700006_07_060");
MsgDisp("Mikage","It'll definitely be an unforgettable memory.");
