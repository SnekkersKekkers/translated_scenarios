...
How do you think the play will go?");
ChEye(6,1);
ChMouth(6,0);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
...
already been decided. We just have to do
it.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
put in more effort. That's all you can do.");
MsgDisp("主人公","Yes, but...｛氷室＊＊｝, do
you not get anxious?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,2);
...
MsgDisp("Himuro","Hah... I'm only human.
...
MsgDisp("Himuro","And this time, multiple grade levels
are involved... and you're working with
us, to... I can't make mistakes.");
MsgDisp("主人公","Uh, what?");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("F020600010_06_040");
MsgDisp("Himuro","It means the words I said earlier apply
to myself, too.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,2);
...
make mistakes? What does he mean by
that...)");
