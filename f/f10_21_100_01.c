...
It won't fix itself even if I keep 
moping about it.");
MsgDisp("主人公","Um...
If we thought about it together then
...
MsgDisp("Michiru","But, let me think about
it a bit more?");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,3);
VoicePlay("F102110001_21_060");
MsgDisp("Michiru","If it gets out of hand,
I'll confide in Mari.
So then...");
MsgClose();
