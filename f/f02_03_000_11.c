...
｛Honda＊＊｝, what are you going to do?");
ChEye(3,1);
ChMouth(3,3);
ChMotion(3,1);
VoicePlay("F020300011_03_000");
MsgDisp("Honda","Make snowmen.");
MsgDisp("主人公","Huh?");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,0);
...
average snowman.
I'll be extra particular about the modelling.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,4);
VoicePlay("F020300011_03_060");
MsgDisp("Honda","Although, that means...
I'll have to pay close attention to the
weather!");
MsgDisp("主人公","(I can't wait to see it when it's done!)");
