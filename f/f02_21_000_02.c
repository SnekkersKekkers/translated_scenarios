...
ChMotion(21,7);
ScrFadeIn(0);
VoicePlay("F022100002_21_000");
MsgDisp("Michiru","There's a church on school premises.
You knew, right?");
MsgDisp("主人公","Ah, yeah.");
ChEye(21,4);
ChMouth(21,3);
...
MsgDisp("Michiru","He turns the bad students into honour
students to make Haba High a super elite
school, I suppose.");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,3);
VoicePlay("F022100002_21_040");
MsgDisp("Michiru","Apparently, Mikage-sensei is also being
targeted as an exception.");
ChEye(21,4);
ChMouth(21,4);
ChMotion(21,4);
...
even though it's just a rumour?)");
MsgClose();
ScrFadeOut(0,0);
