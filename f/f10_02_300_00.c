...
I guess we should ask Marie for 
her opinion here too, right?");
ChEye(2,0);
ChMouth(2,2);
ChMotion(2,2);
...
when we're talking about Sassa-kun, 
...
He has an image of being big and 
...
I don't know who you heard this from, 
but I'm not especially scared of them.");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("F100230000_22_030");
MsgDisp("Hikaru","Hehe, isn't that good?
I'm saying that's his charm.
It's cute that a strong-looking
...
MsgDisp("Hikaru","It seems that he's not
aware of it himself.");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,0);
