...
You can't talk about Sassa-kun without
mentioning this.");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,4);
...
He has an image of being big and strong, but
...
I don't know who you heard this from, but I'm
not especially scared of them.");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,3,1);
VoicePlay("F100230000_22_030");
MsgDisp("Hikaru","Hehe, isn't that good? Hikaru's saying that's
...
MsgDisp("Hikaru","It seems that he's not aware of it himself.");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,0);
