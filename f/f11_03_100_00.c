...
MsgDisp("Honda","Anyone who wins in a quiz
gets a reward haircut! Interesting, right?
It was Pika-chan's idea.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,4,1);
...
MsgDisp("主人公","(｛本多＊＊｝ will never lose, so
he'll be fine.)");
MsgClose();
ScrFadeOut(0,0);
