...
At the end, the prince comes to pick up the
princess and they get married.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
VoicePlay("F020100001_01_020");
MsgDisp("Kazama","And, I heard there was a couple that really
tied the knot there...");
MsgDisp("主人公","They really got married...");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("F020100001_01_030");
...
sound of the bells at that church, and now,
I'm a Haba High student.");
...
going... It'll be wasted if I don't make the
most of it.");
MsgDisp("主人公","(...｛Kazama＊＊｝?)");
