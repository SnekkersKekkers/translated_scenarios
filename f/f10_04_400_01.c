...
｛Nanatsumori＊｝? Different hair, makeup, and
he's not even wearing glasses.");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,4,1);
VoicePlay("F100440001_03_040");
MsgDisp("Honda","Nah. Whether you're skinny or fat, your bone
structure stays the same. No amount of makeup
or hairstyling changes that.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0,1);
VoicePlay("F100440001_03_050");
MsgDisp("Honda","That's why, both NANA and Mi-kun are the same
to me.");
MsgDisp("主人公","I-I see.");
ChPosition(3,2);
...
I told you it's not OK to mention either of
those names, right?");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,4,1);
