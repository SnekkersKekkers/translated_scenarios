...
ScrFadeIn(0);
MsgDisp("主人公","(Umm...
I have to move classrooms for afternoon
classes, right?)");
...
MsgDisp("主人公","Ah, it's ｛Honda＊＊｝ and ｛Sassa＊＊｝.
What are you doing?");
ChEye(3,0);
ChMouth(3,3);
ChMotion(3,1,1);
VoicePlay("F100320000_03_010");
MsgDisp("Honda","Sakkun and I were talking about muscles.");
...
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
ChClose(3);
MsgDisp("主人公","(｛Honda＊＊｝ is helping ｛Sassa＊＊｝?
