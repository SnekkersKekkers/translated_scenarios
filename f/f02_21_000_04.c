...
ChMotion(21,7);
ScrFadeIn(0);
MsgDisp("主人公","Come to think of it, it's ｛みちる＊｝
and ｛ひかる＊｝'s birthday soon!'");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,0);
VoicePlay("F022100004_21_000");
MsgDisp("Michiru","Yes. The 22nd of the 11th month. The date
...
MsgDisp("Michiru","But... We're twins, so I always feel a bit
