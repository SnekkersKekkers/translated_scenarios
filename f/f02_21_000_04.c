...
ChMotion(21,7);
ScrFadeIn(0);
MsgDisp("主人公","Come to think of it, it's ｛みちる＊｝ and
｛ひかる＊｝'s birthday soon!");
ChEye(21,4);
ChMouth(21,3);
ChMotion(21,0);
...
MsgDisp("Michiru","But...
Since we're twins, I always feel a bit guilty
about receiving presents.");
MsgDisp("主人公","Why?");
ChMotion(21,3);
VoicePlay("F022100004_21_020");
MsgDisp("Michiru","Well, you have to give two people presents at
the same time.
