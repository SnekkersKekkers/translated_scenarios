...
MsgDisp("Hiiragi","It is not the first time this has happened.
To attend Haba High, I had to agree to focus
on my studies.");
ChEye(5,0);
ChMouth(5,0);
ChMotion(5,3);
...
question, you still must mark an answer on
the answer sheet. This is my mantra.");
ChEye(5,2);
ChMotion(5,2);
