...
MsgDisp("VP Himuro","It seems Mikage-sensei was just waiting for
the students to finish their duties.
...
MsgDisp("VP Himuro","However, please refrain from coming into the
classroom dressed like that.
That is all.");
MsgClose();
