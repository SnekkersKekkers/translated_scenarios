...
MsgDisp("Hikaru","Oh... are you still upset about 
...
Mari's so cute whenever she's talking
to Kazama～♪");
ChEye(1,4);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("Hikaru","Oh!
But you know, it's not just with
Kazama-kun!");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
That's right, so you can't monopolize
her.");
ChEye(22,3);
ChEye(1,2);
ChMouth(1,2);
...
MsgDisp("主人公","(I'm glad they made up, but 
can I really be happy with this...?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
