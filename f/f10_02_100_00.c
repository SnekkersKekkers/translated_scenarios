...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","(That's right, I still have 
some down time, so maybe I'll
go to the library...?)");
...
Each person has a limit of 20 books, 
you have 2 too many.");
...
SEPlay("EV_SE_FOOT_WALK_AWAY_ALONE");
SEWait();
MsgDisp("主人公","(Wow... there's someone 
lending out 20 books.)");
...
What about you?");
MsgDisp("主人公","I was thinking of borrowing one
at the top of the popularity rankings.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
hurry, someone else will borrow it.");
MsgDisp("主人公","Yeah!");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","I've returned two books,
so I would like that please.");
VoicePlay("F100210000_46_010");
MsgDisp("Librarian","Yes, 20 books then.
The loan period is two weeks.");
MsgDisp("主人公","(Ehhh∋
so the one who borrowed 20 books
was ｛颯砂＊＊｝!)");
MsgClose();
ScrFadeOut(0);
