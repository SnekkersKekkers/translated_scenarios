...
MsgDisp("Mikage","Yeah, I haven't been to Nagasaki before, so
...
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("F020700013_07_020");
MsgDisp("Mikage","Is there something you're looking forward to?");
MsgDisp("主人公","Maybe Meganebashi.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
...
ChMouth(7,3);
ChMotion(7,5);
VoicePlay("F020700013_07_040");
MsgDisp("Mikage","Ah, by the way I like pillow fights after
taking a bath.
That's something that I've wanted to try.");
MsgDisp("主人公","Umm...teachers don't bathe with students, and
you're supposed to scold them for pillow
fighting...");
ChEye(7,2);
ChMouth(7,4);
ChMotion(7,0);
...
MsgDisp("Mikage","That's troubling then. But, if I'm going to
get scolded anyways, I want to throw
pillows... It really is no good, huh～");
MsgDisp("主人公","Umm, I think you should find something else
to enjoy.");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,3);
VoicePlay("F020700013_07_070");
MsgDisp("Mikage","Something else...
I'll think about it. Sigh, I'm seriously not
