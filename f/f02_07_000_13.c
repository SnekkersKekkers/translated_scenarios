...
MsgDisp("Mikage","Yeah, I haven't been to Nagasaki before,
so I'm starting to lose sleep～");
...
MsgDisp("Mikage","Is there something you're looking
forward to?");
...
I'll think about it. Sigh, I'm seriously
