...
MsgDisp("Mikage","Is there something you're
looking forward to?");
...
MsgDisp("Mikage","Ah, by the way I like 
pillow fights after taking a bath.
...
supposed to give the students a 
warning for pillow fighting.");
ChEye(7,2);
ChMouth(7,4);
ChMotion(7,0);
...
MsgDisp("主人公","Yeah?
You'll get scolded by Vice
Principal Himuro again?");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,2);
...
Sigh, I'm seriously not going
to be able to sleep");
MsgDisp("主人公","(It doesn't seem like ｛御影＊＊｝, 
is planning on leading...)");
