...
MsgDisp("Michiru?","I'm really happy to receive support
from girls in elementary
and middle school.");
...
MsgDisp("Hikaru","Ah, Mari! I just received a 
fan letter from Honda-kun.");
MsgDisp("主人公","From ｛本多＊＊｝?");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,3);
VoicePlay("F100330000_21_010");
MsgDisp("Michiru","Hikaru, it's not from Honda-kun, 
it's from his little sister?");
ChEye(22,3);
ChMouth(22,3);
ChMotion(22,3,1);
ChEyeOpenLevel(22,0);
...
MsgDisp("Honda","Eh?
Can I not call you Hikachan and 
Chiruchan? My sister calls you that.");
ChEye(22,2);
ChMouth(22,0);
ChMotion(22,0,1);
VoicePlay("F100330000_22_040");
MsgDisp("Hikaru","Don't make your little sister 
call us weird names!");
ChEye(21,0);
ChMouth(21,3);
ChMotion(21,4);
...
Well, for your little sister
to call us that anyways.");
ChEye(3,4);
ChMouth(3,4);
ChMotion(3,4,1);
...
them is Dahon.");
MsgDisp("主人公","(Pika-chan, Chiru-chan,
Dahon, Marie...I wonder what other
people would think if they heard that?)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
