...
the princess waiting. Happy ending.");
ChMouth(4,3);
ChMotion(4,1,1);
...
MsgDisp("Nanatsumori","But it seems like this one is particularly
well known at Haba High.");
MsgDisp("主人公","Really?");
ChEye(4,4);
ChMouth(4,4);
...
Is it that church with the bell I distinctly
remember...?)");
