...
ChMotion(22,3,1);
ChEyeOpenLevel(22,0);
VoicePlay("F022200007_22_000");
MsgDisp("Hikaru","Clubs, work, people watching...
There's lo～ts to do!");
MsgDisp("主人公","Hehe, seems fulfilling, doesn't it?");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,4,1);
...
MsgDisp("Hikaru","Yay! Where should we go play? I'll think
about it lots♪");
