...
MsgDisp("Kazama","Ahh, apparently Hiiragi wants to see
the warehouse of Ojii-chan's shop.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("F100520000_05_010");
MsgDisp("Hiiragi","Yes.
I heard that the Kazama family 
storehouse has museum-quality items.");
MsgDisp("主人公","I see, ｛風真＊＊｝ is of 
an esteemed family after all.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,1);
VoicePlay("F100520000_01_020");
MsgDisp("Kazama","Well yeah.
It's strange that when you guys say it,
...
MsgDisp("Kazama","Oh, but we've already donated 
most of the things that look good.");
ChEye(5,0);
ChMouth(5,4);
ChMotion(5,4);
