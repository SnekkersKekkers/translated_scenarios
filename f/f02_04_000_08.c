...
ChMotion(4,0);
ScrFadeIn(0);
MsgDisp("主人公","The cultural festival seems like it will be
so fun!");
ChEye(4,0);
ChMouth(4,4);
ChMotion(4,1,1);
...
MsgDisp("主人公","｛Nanatsumori＊｝, you and your parents live in
the town over, right?
...
MsgDisp("Nanatsumori","Well, not that many.
But I can think of a few who are dead set on
coming to the Haba High festival.");
MsgDisp("主人公","Haha!
...
ChMouth(4,3);
ChMotion(4,1,1);
VoicePlay("F020400008_04_030");
MsgDisp("Nanatsumori","We should treat our old friends well.
