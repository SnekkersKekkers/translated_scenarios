...
ChMotion(4,0);
ScrFadeIn(0);
MsgDisp("主人公","The cultural festival seems like it will
be so fun!");
ChEye(4,0);
ChMouth(4,4);
ChMotion(4,1,1);
...
But I can think of a few who are dead set
on coming to the Haba High festival.");
MsgDisp("主人公","Haha!
...
you started high school might come
visit, right?");
