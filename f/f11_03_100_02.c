...
MsgDisp("Honda","｛主人公｝.");
MsgDisp("主人公","Ah, ｛本多＊＊｝, you're not doing
it this year?");
ChMouth(3,4);
ChMotion(3,4,1);
...
MsgDisp("Honda","You think so?
I do, too.");
ChEye(3,4);
ChMouth(3,3);
ChMotion(3,0,1);
VoicePlay("F110310002_03_080");
MsgDisp("Honda","There's no prize, so it's more like a
punishment game, you know?");
ChEye(3,1);
ChMouth(3,3);
ChMotion(3,3,1);
...
ChClose(3);
MsgDisp("主人公","(I don't think ｛本多＊＊｝ will
lose this year, either...)");
MsgClose();
ScrFadeOut(0,0);
