...
MsgDisp("Hikaru","Honda-kun's little sister is asking us for
fashion advice♪");
ChEye(21,0);
ChMouth(21,0);
ChMotion(21,3);
VoicePlay("F100330001_21_000");
MsgDisp("Michiru","She said \"Please tell me the trendy
colours for next season.\".");
ChEye(21,0);
ChMouth(21,3);
ChMotion(21,4);
...
I got it because I was my sister's human
guinea pig at that time.");
...
MsgDisp("Michiru","Hmm, you're a good big brother,
aren't you?");
ChEye(22,0);
ChMouth(22,3);
ChMotion(22,4,1);
...
MsgDisp("主人公","(Hehe, when the three of them are lined up
like this, they kinda look like siblings!)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
