...
ScrFadeIn(0);
MsgDisp("主人公","Huh...
I wonder if the culture festival play will
go well?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
ChMouth(2,4);
ChMotion(2,1);
VoicePlay("F020200010_02_070");
MsgDisp("Sassa","Try it?");
MsgDisp("主人公","Hah....");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("主人公","Got it.
Thanks, ｛颯砂＊＊｝.");
MsgDisp("主人公","(Thanks to ｛颯砂＊＊｝, the
performance will be fun...
I think?)");
