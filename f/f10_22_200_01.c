...
MsgDisp("Goro","Right.
Even so, he ran away as soon as he saw
the clothes! Come on!");
...
Lacy, fluffy shorts and
a gold riders jacket.");
ChEye(22,4);
ChMouth(22,3);
ChMotion(22,0,1);
VoicePlay("F102220001_22_030");
MsgDisp("Hikaru","Even Hikaru and the others
haven't come across that sort of design 
in their modelling work.");
ChEye(31,0);
ChMouth(31,0);
ChMotion(31,0);
VoicePlay("F102220001_31_030");
MsgDisp("Goro","I don't need run-of-the mill
designs in my world. Well then, 
adieu!");
MsgClose();
SEPlay("EV_SE_626");
ChClose(31);
