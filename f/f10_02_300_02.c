...
MsgDisp("Sassa","Oh? So even Michiru-san has a side 
that's different from how she looks?
What is it?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
...
MsgDisp("Hikaru","Hmmm...
For Hikaru, even that's just a part 
of my older sister. It's difficult.");
ChEye(21,0);
ChMouth(21,4);
ChMotion(21,5);
VoicePlay("F100230002_21_010");
MsgDisp("Michiru","You don't have to force yourself
to think about it.");
ChEye(22,0);
ChMouth(22,2);
...
MsgDisp("Sassa","Hmmm.
Maybe it's refreshing that she 
gets that bashful?");
ChEye(21,5);
ChMouth(21,4);
ChMotion(21,0);
