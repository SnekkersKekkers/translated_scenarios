...
doing it.");
MsgDisp("主人公","(Ah, these voices... It's ｛本多＊＊｝ and
｛颯砂＊＊｝! )");
...
MsgDisp("Honda","Ehh? What's that? Do I seem like that kind
of person?");
ChEye(2,0);
ChMouth(2,3);
ChMotion(2,3);
...
ChEye(3,0);
ChMouth(3,4);
MsgDisp("主人公","Ah... so that's it. ｛本多＊＊｝, sorry.");
ChEye(3,1);
ChMotion(3,2,1);
ChEyeOpenLevel(3,0);
...
MsgDisp("Sassa","Haha. Oh, please do something else! See
you.");
MsgClose();
