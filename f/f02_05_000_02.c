...
MsgDisp("Hiiragi","The inside of the locked church is entirely
occupied by Mikage-sensei and his plastic
...
I heard that a student near the church heard
a cry that sounded like a 'Moo～ '.");
MsgDisp("主人公","...a cow?");
ChMotion(5,3);
VoicePlay("F020500002_05_030");
MsgDisp("Hiiragi","Yes, it is where Mikage-sensei has been
housing his prized calf.");
MsgDisp("主人公","No way...but if it's ｛Mikage＊＊｝...");
ChMotion(5,4);
VoicePlay("F020500002_05_040");
MsgDisp("Hiiragi","I did not want to believe it, but there is no
smoke without fire.");
ChEye(5,3);
ChMotion(5,0);
