...
MsgDisp("Mikage","Hey, there seems to be more and more
tales surrounding that church legend, 
right?");
...
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("F020700003_07_020");
MsgDisp("Mikage","I am not raising ostriches there.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,3);
...
I'm curious about it, and I've even 
eaten it at home.");
...
MsgDisp("Mikage","Ostrich meat is all lean, low in 
calories, and high in protein, making
it an extremely healthy 
ingredient, ya know?");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,5);
...
when I'm asked.");
MsgDisp("主人公","Then, that rumor was definitely made
by someone who heard ｛御影＊＊｝.");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,2);
...
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("F020700003_07_080");
MsgDisp("Mikage","Yeah. But if that kind of talk comes up 
in the staff room, it'll reach Vice
Principal Himuro's ears, right?
It's scary.");
MsgDisp("主人公","Ehh?
...
MsgDisp("Mikage","Haa... there's a grain of truth 
even in rumors. How troubling.");
MsgDisp("主人公","(I wonder if ｛御影＊＊｝ is 
up to something in the church...)");
