...
switch (ChPrmGet(3,6)){
    ...
    MsgDisp("Honda","It suits the atmosphere of
...
Well, becoming the king is also an option.");
    ...
    MsgDisp("Honda","But I managed to find you because
you were shining the brightest.");
    MsgDisp("主人公","Huh?");
    ChSet(3,3);
    ChEyeOpenLevel(3,0);
    VoicePlay("R040300001_03_040");
    MsgDisp("Honda","This place looks like a castle,
so you look like a real princess!");
    MsgDisp("主人公","Really?
Thank you!");
    ChEye(3,0);
    ChMouth(3,3);
    ...
    MsgDisp("Honda","Since that's the case, shouldn't I
be escorting you, the princess?");
    MsgDisp("主人公","Hehe!");
    break ;
    case 4:
    case 5:
    ...
    MsgDisp("Honda","Yeah. You can tell
who the main heroine is because she
would shine the brightest here.");
    ChEye(3,4);
    ChMouth(3,3);
    ChMotion(3,3,1);
    VoicePlay("R040300001_03_080");
    MsgDisp("Honda","It's not just the dress either,
you yourself are sparkling.");
    MsgDisp("主人公","No way... you're giving me
too much credit.");
    ChEye(3,3);
    ChMouth(3,3);
    ChMotion(3,1,1);
    ...
    MsgDisp("Honda","I'm serious. Your modesty is
the main factor why!");
    ChEye(3,0);
    ChMouth(3,4);
    ChMotion(3,0,1);
