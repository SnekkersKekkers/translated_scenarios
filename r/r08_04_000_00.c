...
MsgDisp("Nanatsumori","Can we go to the balcony and talk for
a bit?");
...
So I want to show you a little bit
of myself.");
...
MsgDisp("Nanatsumori","Dense in a way, what you say goes beyond
my patterns of expectations.
