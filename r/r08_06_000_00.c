...
ChLayout(2);
ScrFadeIn(0);
MsgDisp("主人公","(And so, the last Christmas party of
...
I'd understand if we were in a church, 
...
MsgDisp("Himuro","When I saw you at the
party... it felt like the finale
was here.");
...
That today is our last Christmas party
at Habataki High.");
StlEye(6,2);
StlMouth(6,0);
...
I was able to exchange gifts with
you, and I made nice memories.");
StlEye(6,1);
StlMouth(6,2);
...
MsgDisp("Himuro","Unlike you, I have another 
Christmas party, next year.");
StlEye(6,2,0);
StlMouth(6,2);
StlEyeOpenLevel(6,0,1);
VoicePlay("R080600000_06_120");
MsgDisp("Himuro","I wish that I could enjoy it
like I did this year's, but
...
MsgDisp("主人公","Not at all. I'm glad I was able
to hear how you feel, ｛氷室＊＊｝.
Thank you.");
StlEye(6,0,0);
StlMouth(6,0);
StlEyeOpenLevel(6,5,1);
...
MsgDisp("Himuro","I feel like I was able to make 
a lot of memories with you in this last 
Habataki party. So I should be saying... 
Thanks.");
StlEye(6,0,0);
StlMouth(6,0);
StlEyeOpenLevel(6,0,1);
