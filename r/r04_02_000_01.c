...
distant land.");
    ...
    MsgDisp("Sassa","Well, when I see a dress, I automatically
think of a princess.");
    MsgDisp("主人公","Huh?");
    break ;
    case 3:
...
You have a different vibe from usual, so
my heart raced.");
    MsgDisp("主人公","Hehe.
...
If that's what you think.");
    ...
    MsgDisp("Sassa","The length is fine, but it's a bit tight
all over, I can't eat in this.");
    break ;
    case 4:
    case 5:
    ChEye(2,0);
...
And this must be the wedding reception.");
    MsgDisp("主人公","Huh∋");
    break ;
    default :
    DbgAssert(1);
