...
That's mine.");
    MsgDisp("主人公","Huh?　Really! I didn't know
you were participating, ｛御影＊＊｝.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,2);
...
also participating?");
    ...
    MsgDisp("Mikage","Yeah, we are having a mixed
staff and student gift exchange.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,0);
    VoicePlay("R060700003_07_050");
    MsgDisp("Mikage","Woah.
You got the present that I
brought in, huh.");
    MsgDisp("主人公","Really!
...Oh? You also got the gift that I
brought in, ｛御影＊＊｝.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,0,1);
...
That's my present you got!");
    MsgDisp("主人公","Huh∋　｛御影＊＊｝, you also got
my present!");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,2);
    ...
    MsgDisp("主人公","Hehe, so you're also participating,
huh, ｛御影＊＊｝.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
    VoicePlay("R060700003_07_110");
    MsgDisp("Mikage","Is that bad? I thought we
could mix it up a bit, yeah?");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,0,1);
