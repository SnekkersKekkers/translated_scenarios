...
that's mine.");
    MsgDisp("主人公","｛七ツ森＊｝.
I knew it!");
    MsgDisp("主人公","Ah, ｛七ツ森＊｝, you got the gift
I brought too.");
    ChEye(4,0);
    ChMouth(4,3);
...
Do you like it?");
    MsgDisp("主人公","Yeah!
Hey, ｛七ツ森＊｝, you know you got
the present I brought, right?");
    ChEye(4,0);
    ChMouth(4,3);
    ChMotion(4,0,1);
...
Is it okay if I open it?");
    ...
    MsgDisp("主人公","｛七ツ森＊｝! I'm guessing
this is your gift then,
｛七ツ森＊｝?");
    ChMouth(4,3);
    ChMotion(4,1,1);
    VoicePlay("R060400003_04_060");
    MsgDisp("Nanatsumori","Yeah. I'm glad that you
are the one that got it.");
    MsgDisp("主人公","Hehe.
I'm glad too!");
    MsgDisp("主人公","Hey, ｛七ツ森＊｝, you also got
the present that I brought in.");
    ChEye(4,4);
    ChMouth(4,3);
    ChMotion(4,0,1);
