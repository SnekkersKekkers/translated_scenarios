...
so I was hurrying to get everything ready.");
ChEye(3,0);
ChMouth(3,0);
ChMotion(3,0,1);
...
Isn't this picture book so detailed?");
MsgDisp("主人公","This is a picture book?");
StlEye(3,2);
StlMouth(3,0);
VoicePlay("R080300000_03_090");
MsgDisp("Honda","Yeah, this is the same book I got for
Christmas when I was little.");
StlEye(3,2,0);
StlMouth(3,0);
StlEyeOpenLevel(3,5,1);
VoicePlay("R080300000_03_100");
MsgDisp("Honda","I managed to find it again while being a
bookworm here.");
StlEye(3,2,0);
StlMouth(3,1);
...
Eve as a high school student comes to
an end...)");
BGMStop();
MsgClose();
ScrFadeOut(0,0);
