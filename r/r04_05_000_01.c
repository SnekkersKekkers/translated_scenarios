...
I'm so glad!");
    ...
    MsgDisp("Hiiragi","I should warn you though, you have too much
on your plate.
...
The reason I couldn't find you is because of
you and that dress.");
    ChEye(5,4);
    VoicePlay("R040500001_05_060");
    MsgDisp("Hiiragi","I can see why the other boys would want to be
in your way.");
    MsgDisp("主人公","Umm...");
    ChMotion(5,3);
    VoicePlay("R040500001_05_070");
    MsgDisp("Hiiragi","May I pretend to be an escort to kidnap you?");
    MsgDisp("主人公","Huuh?");
    ChEye(5,3);
    ChMouth(5,3);
    ChMotion(5,0);
