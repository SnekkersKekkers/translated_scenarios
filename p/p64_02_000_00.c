...
MsgDisp("Sassa","Pheeww—
This has a relaxing effect huh.
...
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("P640200000_02_040");
MsgDisp("Sassa","Like you?");
MsgDisp("主人公","(Ummm...delicious?
｛Sassa＊＊｝ is super pleased, huh?
For now, I guess it's a huge success...!)");
MsgClose();
ScrFadeOut(0,0);
ChClose(2,0,0);
BGMStop();
