...
play at this year's cultural festival, please
make sure to sign up.");
MsgDisp("主人公","(There's also the club exhibition, I wonder
what I should do...)");
...
festival in two weeks!");
    SEPlay("EV_SE_CLAP_004");
    MsgDisp("主人公","(Yeah, let's do our best in the school play!)");
    SEStop("EV_SE_CLAP_004",1);
    break ;
    default :
    DbgAssert(0);
