...
VoicePlay("P810500001_05_000");
MsgDisp("Hiiragi","It's already the cultural festival for this
year too.");
MsgDisp("主人公","I'm looking forward to it.");
ChEye(5,4);
VoicePlay("P810500001_05_010");
MsgDisp("Hiiragi","I learned how difficult it was last year, but
the sense of accomplishment from being of
help to everyone was also wonderful.");
ChEye(5,3);
ChMouth(5,3);
ChMotion(5,0,1);
...
MsgDisp("主人公","Yeah!
But, don't severely overwork yourself, okay?");
ChEye(5,4);
ChMouth(5,4);
VoicePlay("P810500001_05_030");
MsgDisp("Hiiragi","Thank you very much.
It's only at times such as this where I can
be of help.");
