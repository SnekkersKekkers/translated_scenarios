...
There are a lot of customers...)");
    ...
    MsgDisp("Honda","｛主人公｝. Pardon the intrusion! I
came for a tour.");
    MsgDisp("主人公","Ah, ｛本多＊＊｝. ...Enjoy yourself.");
    ChEye(3,4);
    ChMouth(3,4);
    ChMotion(3,4,1);
...
much fun though.");
    ...
    MsgDisp("Honda","Why? Everyone likes gaming music, and it's
also fun.");
    ChMotion(3,2,1);
...
There are a lot of customers...)");
    ...
    MsgDisp("Honda","｛主人公｝. I came to listen to some
gaming music.");
    MsgDisp("主人公","Ah, ｛本多＊＊｝...");
    ChEye(3,4);
    ChMouth(3,0);
