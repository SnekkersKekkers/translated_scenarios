...
...Enjoy yourself.");
    ...
    MsgDisp("Honda","Huh? You don't look like you're having
much fun though.");
...
have to enjoy it the most.");
    ...
    MsgDisp("主人公","Hehe,
I'm not making that kind of face!");
    SEPlay("EV_SE_038");
    SEWait();
    ChEye(3,0);
    ChMouth(3,3);
...
You often hear about game cheats, right?");
    ...
    MsgDisp("Honda","It seems like there are many cases
where they're just mistakes made 
during development");
...
I guess so...");
    ...
    MsgDisp("Honda","Ah, it's start time. Come on, let's all
enjoy the game together.");
    MsgDisp("主人公","(Yeah, since I'm performing game music,
