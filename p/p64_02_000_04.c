...
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("P640200004_02_010");
MsgDisp("Sassa","The vegetables were of course, the best.
And was the dressing homemade?");
MsgDisp("主人公","Yeah, that's right.
It was an onion and carrot dressing made with
the vegetables grown in the Gardening Club.");
ChEye(2,3);
ChMouth(2,4);
ChMotion(2,4);
ChEyeOpenLevel(2,0);
...
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("P640200004_02_030");
MsgDisp("Sassa","Of course.
The shop's ambience is the best!");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("P640200004_02_040");
MsgDisp("Sassa","Seeing you working in an apron, I'd become a
regular if this were an everyday shop.");
