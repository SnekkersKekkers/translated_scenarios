...
the cultural festival. This is important,
...
MsgDisp("Hiiragi","We have two weeks to prepare, starting next
week. In the meantime, let's get as much done
as we can, bit by bit.");
VoicePlay("P810500000_41_010");
MsgDisp("President","Yes, it will be a hectic time, so please take
care of your health.");
...
MsgDisp("Hiiragi","Let's make the cultural festival a success.");
