...
breath huh...)");
    ...
    MsgDisp("Honda","｛主人公｝. You seem busy, huh?");
    MsgDisp("主人公","Ah, ｛本多＊＊｝. Yeah, because I'm
managing.");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,4,1);
...
return it...)");
    ...
    MsgDisp("主人公","Ah, ｛本多＊＊｝... The pens that were
borrowed haven't been returned....");
    ChEye(3,0);
    ChMouth(3,0);
    ChMotion(3,0,1);
...
I'll go retrieve them.");
    MsgDisp("主人公","Ehh? I'm sorry. Even though it's the
cultural festival.");
    ChEye(3,0);
    ChMouth(3,3);
    ChMotion(3,1,1);
