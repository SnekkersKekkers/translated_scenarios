...
MsgDisp("Honda","Ehh? The lost-and-found notebook 
going missing is like the biter being bit.
It's funny.");
ChEye(3,2);
ChMouth(3,4);
ChMotion(3,2,1);
...
Let's both be careful with
looking after our things.");
MsgDisp("主人公","(Haa... even though it 
was my last cultural festival, 
