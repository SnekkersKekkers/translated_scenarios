...
MsgDisp("Hikaru","Ah—...
Isn't that a last resort? You have to put
yourself in the kid's shoes first.");
MsgClose();
SEPlay("EV_SE_FOOT_WALK_COME_ALONE_SHORT");
ChClose(22);
VoicePlay("P840D00005_22_010");
MsgDisp("Hikaru","Okay, enough crying～♪
Why don't you give Hikaru a big smile? These
big sisters will look for your Mom together▼");
