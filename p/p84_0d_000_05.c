...
First you ahve to calm that kid down.");
MsgDisp("主人公","Calm them down... Ah!
...
MsgDisp("Hikaru","Okay, enough crying～♪
Why don't you give me a big smile?
These big sisters will look 
...
MsgDisp("主人公","(Even though I was in the 
student council for three years,
In the end I caused trouble... sigh.)");
MsgClose();
ScrFadeOut(0,0);
ChClose(21,0,0);
ChClose(22,0,0);
