...
It's handmade by us, and very popular
and delicious.");
    ChEye(4,2);
    ChMouth(4,3);
    ChMotion(4,0,1);
...
Welcome!");
    ...
    MsgDisp("Nanatsumori","I was drawn here by the sweet smell
of mitarashi paste, and here you are in
a yukata. Escape is impossible.");
    MsgDisp("主人公","Hehe!
