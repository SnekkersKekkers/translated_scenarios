...
Once you are satisfied, you will not improve.");
MsgDisp("主人公","Ah, Himuro-sensei. Yes...");
ChEye(32,2);
ChMouth(32,2);
VoicePlay("P553200000_32_010");
MsgDisp("VP Himuro","However...
Just for today, we should enjoy a drink of
victory. You did well.");
