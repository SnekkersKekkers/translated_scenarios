...
This place really has an atmosphere!");
    MsgDisp("主人公","Yeah, not just the waitstaff either,
but the cooking team is also wearing
yukata.");
    ChEye(2,3);
    ChMouth(2,3);
    ChMotion(2,4);
...
customers would come......)");
    ...
    MsgDisp("Sassa","｛主人公｝,
I was lured here by the smell of those
dango.");
    MsgDisp("主人公","It's ｛颯砂＊＊｝!
Welcome!");
    ChEye(2,0);
    ...
    MsgDisp("Sassa","Wow, a yukata. It's nice.
I'm glad that smell brought me here.");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,0);
    VoicePlay("P030200000_02_050");
    MsgDisp("Sassa","I'll wait to eat the dango first
before I judge them, but I have nothing
bad to say about that yukata.");
