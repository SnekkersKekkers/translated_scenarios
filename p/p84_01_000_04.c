...
MsgDisp("主人公","Haa, I'm glad that was resolved
without incidence.");
MsgClose();
...
But I thought your firm attitude and 
quick response was very impressive.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,4);
ChEyeOpenLevel(1,8);
...
MsgDisp("Kazama","If I was of help to you,
then I'm also happy.");
MsgDisp("主人公","(Hehe, I was praised! I'm glad I was able
to show the results of my hard work over
