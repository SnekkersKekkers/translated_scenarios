...
is the best!");
MsgDisp("主人公","｛御影＊＊｝, do you like
it?");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,0);
VoicePlay("P640700004_07_010");
MsgDisp("Mikage","Yes, the vegetables are beautifully grown,
and furthermore have been beautifully
arranged.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,2);
...
You didn't just raise them, but also
researched about them carefully.");
MsgDisp("主人公","Yes!");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,1);
