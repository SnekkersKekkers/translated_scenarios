...
MsgDisp("Student President","I apologize for calling you on break.
I called you as I have a message to
deliver.");
VoicePlay("P810500102_41_010");
MsgDisp("Student President","From next week, for two weeks onwards we
...
MsgDisp("Student President","...Then, get better soon.");
SEPlay("SYS_SE_PHONE_POWER_ON");
SEWait();
