...
switch (ChPrmGet(1,6)){
    ...
    MsgDisp("School Girl","Could you make a lost 
...
I'll hand it over to them.");
    ...
    MsgDisp("Kazama","Yeah, quickly relieve them 
of their worries.");
    ...
    MsgDisp("School Girl","Just now, there was a mobile 
phone in lost property, right?");
...
I thought I had seen it before.");
    ...
    MsgDisp("主人公","Sorry.
I just thought I shouldn't just touch 
and use things as I please.");
    ChEye(1,2);
    ChMouth(1,2);
    ChMotion(1,3);
    VoicePlay("P830100000_01_060");
    MsgDisp("Kazama","Oi, seriously, you...");
    MsgDisp("主人公","Hehe, well it was properly locked, 
you know?");
    ChEye(1,0);
    ChMouth(1,2);
    ChMotion(1,3);
