...
MsgDisp("主人公","Ah, ｛七ツ森＊｝. The show went well!");
ChMotion(4,1,1);
VoicePlay("P740400004_04_010");
MsgDisp("Nanatsumori","Yeah. You put real models to shame with
that show.");
ChEye(4,0);
ChMouth(4,0);
ChMotion(4,0,1);
...
MsgDisp("Nanatsumori","Hm? Ahー...I hope you can become a good
bride?");
