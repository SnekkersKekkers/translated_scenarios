...
MsgDisp("V.P. Himuro","Make sure you show off the results of your
daily practice.");
MsgDisp("主人公","Yes......");
ChEye(32,2);
ChMouth(32,0);
VoicePlay("P513200000_32_010");
MsgDisp("V.P. Himuro","What's wrong? Your strange behavior makes
people around you uneasy.");
ChEye(32,2);
ChMouth(32,0);
VoicePlay("P513200000_32_020");
MsgDisp("V.P. Himuro","There is still time. Think for yourself
