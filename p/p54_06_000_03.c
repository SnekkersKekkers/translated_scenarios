...
MsgDisp("Himuro","Shouldn't you apologise?");
MsgDisp("主人公","Eh.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
...
MsgDisp("Himuro","There's no point in apologising to me.");
ChEye(6,1);
ChMouth(6,0);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
VoicePlay("P540600003_06_040");
MsgDisp("Himuro","Well, on the point that I had my expectations
betrayed, I want an apology.");
MsgDisp("主人公","(I should have given it my all on a regular
basis...)");
MsgClose();
ScrFadeOut(0,0);
ChClose(6,0,0);
