...
I mistook that for our class's supplies.");
VoicePlay("P840700005_48_000");
MsgDisp("School Girl","No that was because 
ours was put in that space too.");
MsgDisp("主人公","I'm sorry. Seems like management's
...
MsgDisp("主人公","(I'm glad it ended peacefully, but
I caused confusion for everyone.)");
VoiceEVSPlay(7);
...
MsgDisp("Mikage","A little mistake will
turn into a good memory.");
MsgDisp("主人公","Yes....");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,1);
