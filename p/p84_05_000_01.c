...
MsgDisp("Hiiragi","｛主人公｝. The confectionaries we used
to welcome the guests.... where did you
purchase it from?");
MsgDisp("主人公","Eh? They were sweets from the staffroom
though...");
ChEye(5,2);
ChMouth(5,2);
ChMotion(5,1);
...
then it's inevitable they would take
offence to that.");
...
MsgDisp("主人公","Ehhh∋ I-I'm very sorry. What should I
do...");
ChEye(5,2);
ChMouth(5,4);
ChMotion(5,2);
