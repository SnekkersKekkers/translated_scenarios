...
MsgDisp("Kazama","It's good to worry about others, but you
should care about yourself too.");
MsgDisp("主人公","(Uuugh, I don't even have anything to say in
response. I should have concentrated more on
preparations for the student council...)");
MsgClose();
ScrFadeOut(0,0);
ChClose(1,0,0);
