...
MsgDisp("Kazama","It's a relief to be able 
to see the face of the producer, huh?");
MsgDisp("主人公","Hehe, that's right. Mikage-sensei was in
charge of the salad leaves.");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,0);
...
I put them in the salad too, 
but they're also for sale, you know?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
