...
MsgDisp("Vice Principal Himuro","Even I, as I waved the conductor's baton, 
...
MsgDisp("Vice Principal Himuro","Ahem, I said too much.");
ChEye(32,0);
ChMouth(32,0);
VoicePlay("P553200008_32_030");
MsgDisp("Vice Principal Himuro","You are the pride of our wind ensemble.
...
MsgDisp("Vice Principal Himuro","Your heart will be passed 
onto your juniors.
I promise.");
MsgDisp("主人公","Yes.");
ChEye(32,2);
...
MsgDisp("Vice Principal Himuro","Using today's success as fuel, 
