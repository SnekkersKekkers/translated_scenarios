...
Hey, why are you laughing?");
    ...
    MsgDisp("Kazama","It's unfortunate, but
It won't fit me as well it does you, 
and it won't be as funny.");
    MsgDisp("主人公","Hey.
If you have free time,
try the maze before your shift!");
    ChEye(1,2);
    ChMouth(1,3);
    ChMotion(1,3);
    ChEyeOpenLevel(1,0);
...
entrance.");
    MsgDisp("主人公","The calf Molly is already 
