...
MsgDisp("主人公","｛颯砂＊＊｝? Huh, are you not good with
herbs?");
ChEye(2,2);
ChMouth(2,0);
ChMotion(2,0);
...
even if it's good for my body, it's still
bitter.");
...
MsgDisp("Sassa","Well, I'm glad to have been the guinea
pig.
Could I get some water?");
MsgDisp("主人公","(I should have participated more
diligently in preparations and researched
more on herb tea, huh...)");
MsgClose();
ScrFadeOut(0,0);
ChClose(2,0,0);
BGMStop();
