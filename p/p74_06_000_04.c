...
MsgDisp("Himuro","...Well, it was quite a good show wasn't
it?");
...
MsgDisp("Himuro","If I'm being honest, I didn't want anyone
else to see you wearing a wedding dress.");
ChEye(6,2);
ChMouth(6,0);
ChMotion(6,2);
ChEyeOpenLevel(6,0);
...
beautiful, and you looked good on the
runway.");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
