...
performance. I'm getting nervous...)");
    MsgClose();
...
Maybe I calmed down a little?");
    ...
    MsgDisp("Honda","Waa∋
That startled me. That sounded like
the buzzer for a  wrong answer.");
    MsgDisp("主人公","Hehe, are you okay? EVen though you
specifically wanted to relax?");
    MsgDisp("主人公","(Huh... thanks to ｛本多＊＊｝,
It seems like I'm not anxious anymore.
