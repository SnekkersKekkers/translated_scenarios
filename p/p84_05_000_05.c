...
MsgDisp("Student A","I removed the maps giving wrong information,
but the leaflets I replaced them with are
also wrong...");
MsgDisp("主人公","Ehhh∋
Then we have to retrieve those leaflets!");
VoicePlay("P840500005_40_010");
MsgDisp("Student A","They've already been distributed, so that
would be impossible.");
MsgClose();
...
MsgDisp("主人公","The maps with incorrect information about the
inside of the school have been distributed.
What should we do...");
ChEye(5,0);
ChMotion(5,4);
VoicePlay("P840500005_05_010");
MsgDisp("Hiiragi","Please calm down.
What kind of things were incorrect about it?");
MsgDisp("主人公","Now that I think about it, what was wrong
with it?");
...
retrieve it, right?");
MsgDisp("主人公","Yeah...
From the start I should have checked what it
was. I'm very sorry.");
ChEye(5,0);
ChMotion(5,0);
...
composure.");
MsgDisp("主人公","(Sigh...it's as ｛Hiiragi＊＊＊｝ says.
I have to work more calmly... I failed even
