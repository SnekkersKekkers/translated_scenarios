...
Even though it was the last cultural festival
...
ChMouth(5,4);
ChMotion(5,4);
VoicePlay("P540500005_05_010");
MsgDisp("Hiiragi","But you did your utmost best to cover for the
other member's mistakes.");
ChEye(5,4);
ChMouth(5,4);
ChMotion(5,0);
VoicePlay("P540500005_05_020");
