...
Getting their name wrong was the most
impolite.");
MsgDisp("主人公","Y-Yes.");
MsgClose();
...
MsgDisp("主人公","Ah, ｛御影＊＊｝... I got the guest's
names wrong many times...");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,3);
...
MsgDisp("主人公","Uuugh... This is no laughing matter, it's
inexcusable...");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,1);
...
MsgDisp("主人公","(Haa... If only I had looked over the list
of names properly...)");
MsgClose();
ScrFadeOut(0,0);
ChClose(7,0,0);
