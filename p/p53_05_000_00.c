...
play the sound that represents you.");
    MsgDisp("主人公","Ah, ｛Hiiragi＊＊＊｝...but I'm anxious.");
    ChEye(5,4);
    ChMouth(5,4);
    ChMotion(5,0);
    VoicePlay("P530500000_05_010");
    MsgDisp("Hiiragi","That can't be helped, correct?
If that's the case, you should get more
nervous.");
    MsgDisp("主人公","Ehh∋");
    ChEye(5,4);
    ChMouth(5,4);
...
theatre troupe. The more stressed they feel,
...
As long as you can reply calmly.");
    ...
    MsgDisp("Hiiragi","I'm a fan of the soft, sustained sound you
always play.
