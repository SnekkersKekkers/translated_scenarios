...
MsgDisp("Sassa","While I was listening to you guys perform,
I thought back to many different things
from this last year.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
...
MsgDisp("Sassa","I'm sure it's not just me, I think all
the students who heard that also thought
so too.");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
VoicePlay("P540200004_02_040");
MsgDisp("Sassa","I haven't seen you guys practising,
...
MsgDisp("Sassa","Without even realising it, with this song
