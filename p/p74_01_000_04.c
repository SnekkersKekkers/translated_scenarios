...
When you receive those congratulations, I
will too, at the same time.");
MsgDisp("主人公","Umm...");
ChEye(1,2);
ChMouth(1,3);
ChMotion(1,3);
...
The fashion show was really good, so I got
really excited.");
MsgDisp("主人公","(Yay, I'm truly glad I devoted these last
three years to the handicrafts club!)");
MsgClose();
ScrFadeOut(0,0);
ChClose(1,0,0);
