...
SEStop("EV_SE_577",0);
SEWait();
VoicePlay("P110000001_45_000");
MsgDisp("Chairperson","Hello. We are preparing for the cultural
festival for the next two weeks.");
VoicePlay("P110000001_45_010");
MsgDisp("Chairperson","Our class will be setting up a cardboard
maze. Please do your best to help with the
preparations.");
VoicePlay("P110000001_45_020");
