...
MsgDisp("Sassa","Everyone in the audience was really happy
that you recreated the sound of being
shot down.");
MsgDisp("主人公","Ugh... That's just a blunder...");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,3);
...
MsgDisp("Sassa","Well, it all comes down to whether you're
satisfied with it.");
