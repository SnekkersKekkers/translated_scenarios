...
MsgDisp("School Girl","No, I have to hurry, the good seats will be
taken～!");
...
MsgDisp("Nanatsumori","It's the student council's job to look after
lost items right?
...
model.
Haa...my last cultural festival was a fail.)");
MsgClose();
ScrFadeOut(0,0);
ChClose(4,0,0);
