...
MsgDisp("Mikage","I don't know anything
...
MsgDisp("Mikage","To properly understand the cause, 
you need to try talking to everyone.");
MsgDisp("主人公","...Yes.
That's right, huh!");
ChEye(7,0);
ChMouth(7,3);
...
You should quickly show
everyone that expression.");
MsgDisp("主人公","(｛御影＊＊｝,you're kind huh...
But I should have practiced
more with everyone.)");
MsgClose();
ScrFadeOut(0,0);
ChClose(7,0,0);
