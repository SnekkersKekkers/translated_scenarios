...
wandering around aimlessly?");
    MsgDisp("主人公","Ah, ｛御影＊＊｝. Right now I'm
patrolling.");
    ChEye(7,2);
    ChMouth(7,0);
    ChMotion(7,2);
...
Will you be alright by yourself?");
    MsgDisp("主人公","Yes. I can't do it if I've not experienced
how to patrol.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
carefully...!)");
    ...
    MsgDisp("Mikage","｛主人公｝. What are doing all alone?");
    MsgDisp("主人公","Ah, ｛御影＊＊｝. Ah right now I'm in
the middle of patrolling inside the
school.");
    ChEye(7,0);
    ChMouth(7,4);
    ChMotion(7,1);
...
you there?");
    MsgDisp("主人公","Yes. The first and second year students
