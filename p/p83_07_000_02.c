...
switch (ChPrmGet(7,6)){
    ...
    break ;
    case 3:
    MsgDisp("主人公","(I don't know what's going to happen 
at the cultural festival, so 
I have to patrol carefully...!)");
    MsgClose();
...
Will you be alright by yourself?");
    MsgDisp("主人公","Yes.
I can't do it if I've not
experienced how to patrol.");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
...
What are doing all alone?");
    MsgDisp("主人公","Ah, ｛御影＊＊｝.
Ah right now I'm in the middle
of patrolling inside the school.");
    ChEye(7,0);
    ChMouth(7,4);
    ChMotion(7,1);
...
be trouble.");
    ...
    MsgDisp("Mikage","As expected of you. Will the main building
be alright without you there?");
    MsgDisp("主人公","Yes. The first and second
year students are doing their best.");
    ChEye(7,0);
    ChMouth(7,3);
    ChMotion(7,3);
    VoicePlay("P830700002_07_070");
    MsgDisp("Mikage","That's right, before I've realized,
you've become a wonderful young lady,
haven't you?");
    ChEye(7,0);
    ChMouth(7,0);
    ChMotion(7,0);
