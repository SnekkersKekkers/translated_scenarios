...
BGOpen("sc740",0);
ScrFadeIn(0);
MsgDisp("主人公","(Yes, I was able to give a good
performance!)");
MsgClose();
SEPlay("EV_SE_544");
...
MsgDisp("Sassa","You guys seemed to be having so much fun
performing, I think the audience could
sense it too.");
ChEye(2,3);
ChMouth(2,3);
ChMotion(2,4);
...
MsgDisp("主人公","(Yay! Seems like I could give a good
performance! I had fun performing!)");
MsgClose();
ScrFadeOut(0,0);
ChClose(2,0,0);
