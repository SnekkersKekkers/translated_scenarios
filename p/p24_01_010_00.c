...
slippers perfectly.");
MsgDisp("主人公","Haa, how wonderful...both the slippers and
dress are perfect.");
ChEye(1,2);
ChMouth(1,0);
ChMotion(1,0);
VoicePlay("P240101000_01_010");
MsgDisp("Kazama","Both you and the magician don't get it.");
MsgDisp("主人公","Eh?");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
ChMotion(1,1);
ChEyeOpenLevel(1,0);
VoicePlay("P240101000_01_030");
MsgDisp("Kazama","No need.
A jersey is enough.");
MsgDisp("主人公","Jersey?");
ChEye(1,0);
ChMouth(1,0);
