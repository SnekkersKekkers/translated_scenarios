...
switch (ChPrmGet(5,6)){
    ...
    case 3:
    ScrFadeIn(0);
    MsgDisp("主人公","(I have to carefully add this to 
the materials management record...)");
...
materials. I'm so busy, that I might get
dizzy.)");
    MsgClose();
...
I would like some masking tape
and some garbage bags!");
    MsgDisp("主人公","Yeーs!
Please take the ones on the shelf.");
    VoicePlay("P830500001_39_030");
    MsgDisp("Male Student","Huh? But neither of them are there.");
    MsgDisp("主人公","Ehhh∋");
    SEPlay("EV_SE_DOOR_013");
    SEWait();
    MsgClose();
...
I'm borrowing this!");
    ...
    MsgDisp("Hiiragi","I was unsure of whether it was 
in our inventory, so I purchased some.");
