...
year. But, as expected I'm nervous still.)");
    MsgClose();
...
But, my heart is racing.");
    ...
    MsgDisp("Hiiragi","Yes, I also get nervous 
each time I perform. It all comes
from the sense of expectation.");
    ChEye(5,4);
    ChMouth(5,4);
    ChMotion(5,4);
    VoicePlay("P530500001_05_030");
    MsgDisp("Hiiragi","I don't know what's going to happen, 
but it might be better than I assumed?  ");
    MsgDisp("主人公","I see.
Better than assumed...");
    ChEye(5,0);
    ChMouth(5,4);
    ...
    MsgDisp("Hiiragi","Yes. The fact that your heart
is racing, might be an omen that
a wonderful surprise is going occur.");
    SEPlay("EV_SE_038");
    SEWait();
    ChEye(5,4);
    ChMouth(5,4);
...
Is that right...");
    ...
    MsgDisp("Hiiragi","Yes.
A moderate elation——In other words, 
...
unexpected results.");
    ...
    MsgDisp("Hiiragi","Your expression right now
gives you a good feeling about that, 
doesn't it?");
    MsgDisp("主人公","...Yes.
｛柊＊＊＊｝ told me that,
so I'm starting to think so too!");
    ChEye(5,0);
    ChMouth(5,3);
    ChMotion(5,0);
