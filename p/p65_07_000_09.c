...
MsgDisp("Mikage","｛主人公｝.
You already know, right? The customers
left with their shoulders slumped.");
MsgDisp("主人公","Yes, it was a fail, huh...");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,2);
VoicePlay("P650700009_07_010");
MsgDisp("Mikage","Yes, it was hopeless. But, it's not the
herbs and vegetables fault.");
ChEye(7,2);
ChMouth(7,0);
ChMotion(7,0);
...
MsgDisp("Mikage","Vegetables aren't just for show, 
Make sure you eat them at home.
...
It was your last school festival, but 
there'll be a time where you can 
