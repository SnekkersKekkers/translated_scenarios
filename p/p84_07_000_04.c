...
MsgDisp("Mikage","With that, it feels like the
case is closed, doesn't it?");
MsgDisp("主人公","Hehe, that's right.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,1);
VoicePlay("P840700004_07_030");
MsgDisp("Mikage","The way your confidence is born from 
your tenacity is what made this happen.
