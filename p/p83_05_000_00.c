...
switch (ChPrmGet(5,6)){
    ...
    case 3:
    ScrFadeIn(0);
    MsgDisp("主人公","Tea and confectionaries
for the guests are ready.
Ah, doesn't look like there's enough maps 
for directions around the school.)");
...
I'll bring them tea and 
confectionaries immediately. ");
    ChEye(5,4);
    ChMotion(5,0,1);
...
the theatre troupe.");
    ...
    MsgDisp("主人公","...Okay.
Then, please let me prepare the maps
for directions inside the school. ");
    ChEye(5,4);
    ChMotion(5,0);
