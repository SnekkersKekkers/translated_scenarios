...
MsgDisp("Sassa","Well, if you fell you 
can't call it a success, huh? ");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("P740200005_02_020");
MsgDisp("Sassa","But, the craftsmanship
on that dress was perfect, you know?");
MsgDisp("主人公","Yeah...");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,4);
VoicePlay("P740200005_02_030");
MsgDisp("Sassa","Then, you can try again 
someday with that dress!");
MsgDisp("主人公","Someday... huh? Will a day come where I'll
