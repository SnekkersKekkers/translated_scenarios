...
ScrFadeIn(0);
MsgDisp("主人公","Phew.
Somehow it didn't become a huge
problem but...");
MsgClose();
SEPlay("EV_SE_544");
...
MsgDisp("主人公","Ah, ｛Kazama＊＊｝... Yes.");
ChEye(1,2);
ChMouth(1,2);
ChMotion(1,0);
VoicePlay("P840100005_01_010");
MsgDisp("Kazama","You shouldn't handle it on your own.
You have to tell the teachers and the
other student council members.");
MsgDisp("主人公","Yeah, I'm very sorry.
I got flustered.");
ChEye(1,0);
ChMouth(1,2);
ChMotion(1,0);
...
MsgDisp("主人公","(Sigh... Even though it was my last
cultural festival, I inconvenienced
｛Kazama＊＊｝ and everyone...a huge fail.)");
MsgClose();
ScrFadeOut(0,0);
ChClose(1,0,0);
