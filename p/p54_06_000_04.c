...
Like to the point words
won't come out.");
ChEye(6,0);
ChMouth(6,4);
ChMotion(6,0);
VoicePlay("P540600004_06_020");
MsgDisp("Himuro","There were also people
who were so moved they cried.
Reichi san was also proud.");
...
MsgDisp("Himuro","Even if you're crying tears of joy, 
I don't want anyone to see that face.");
MsgDisp("主人公","｛氷室＊＊｝...");
ChEye(6,0);
ChMouth(6,0);
ChMotion(6,0);
VoicePlay("P540600004_06_060");
MsgDisp("Himuro","...Truly, thank you for your hard
work these last three years.");
MsgDisp("主人公","Yeah, thank you.");
MsgDisp("主人公","(I'm truly glad I gave it 
my best these last three years....)");
MsgClose();
ScrFadeOut(0,0);
ChClose(6,0,0);
ChLayout(1);
