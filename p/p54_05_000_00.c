...
Seems like my first performance went by
smoothly!)");
MsgClose();
...
MsgDisp("Hiiragi","Congratulations. The applause wouldn't
quite stop.");
...
MsgDisp("主人公","(Yay! ｛柊＊＊＊｝ seems happy! It was
worth giving my all practicing.)");
MsgClose();
ScrFadeOut(0,0);
ChClose(5,0,0);
