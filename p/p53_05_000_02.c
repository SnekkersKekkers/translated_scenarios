...
I'll close my eyes and search for your sound.");
    ...
    MsgDisp("Hiiragi","Haha, pardon me.
...
is, your last three years of hard work is the
real deal. Your current self is proof of it.");
    SEPlay("EV_SE_038");
    SEWait();
...
already plenty satisfactory.");
    ...
    MsgDisp("Hiiragi","After that, it's just a matter of whether
you're satisfied?");
    SEPlay("EV_SE_038");
    SEWait();
...
I'll play my last performance now.");
    ...
    MsgDisp("主人公","(Alright, let's perform so that I don't
regret it!)");
    MsgClose();
    ScrFadeOut(0,0);
    ChClose(5,0,0);
