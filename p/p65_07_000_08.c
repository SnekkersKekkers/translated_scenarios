...
MsgDisp("Mikage","｛主人公｝,
This stylish cafe has a good reputation.");
MsgDisp("主人公","｛御影＊＊｝, does it really!");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,2);
VoicePlay("P650700008_07_010");
MsgDisp("Mikage","Yes, not just the appearance but
the herbal tea and vegetables picked 
that morning are also popular.");
ChEye(7,0);
ChMouth(7,3);
ChMotion(7,3);
...
MsgDisp("Mikage","Yeah.
We raised nome beautiful vegetables, 
I have to thank you.");
ChEye(7,0);
ChMouth(7,0);
ChMotion(7,0);
VoicePlay("P650700008_07_050");
MsgDisp("Mikage","You had the best results at 
your final cultural festival.
Congratulations.");
MsgDisp("主人公","(Yay, a huge success!
I was able to make a good memory
at the last cultural festival
