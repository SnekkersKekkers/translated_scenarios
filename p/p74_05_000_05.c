...
MsgDisp("Hiiragi","It was difficult to
resist the urge to go to your
side and link arms with you.");
MsgDisp("主人公","｛柊＊＊＊｝...");
ChEye(5,0);
ChMotion(5,4);
...
MsgDisp("Hiiragi","It was unfortunate that you fell,
but please firmly hold your head up high.");
