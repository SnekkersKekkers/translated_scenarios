...
MsgDisp("Chairperson","At this year's cultural festival, 
we're hosting a school play. 
Would you like to join?");
MsgDisp("主人公","(There's also a club exhibition, 
I wonder what I should do......)");
MsgSel("I'll focus on the club exhibition","I'll participate in the school play");
switch (MsgSelRsltGet()){
    case 0:
    VoicePlay("P200000001_45_020");
    MsgDisp("Chairperson","Understood. Please do your best with 
the club exhibition.
Take care.");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
    ...
    MsgDisp("Chairperson","Understood. Please do your best with 
the preparations for the school play.
Take care.");
    SEPlay("SYS_SE_PHONE_POWER_ON");
    SEWait();
    break ;
...
MsgDisp("主人公","(......I need to get better soon,
