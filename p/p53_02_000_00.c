...
Have fun.");
    ...
    MsgDisp("Sassa","Huh, if you're that tense, 
you won't be able to do your music
...
you shouldn't be nervous...");
    ...
    MsgDisp("Sassa","I get it. Before I have a contest, I also
get like that.");
    MsgDisp("主人公","Even ｛颯砂＊＊｝?");
    ChEye(2,0);
    ChMouth(2,4);
...
I listen to the music I like.");
    MsgDisp("主人公","But, right now I can't 
...
After this, you're going to play 
it yourself, aren't you?");
    ...
    MsgDisp("Sassa","Yeah, see. You want to start listening to
music soon, don't you?");
...
I'm looking forwards to playing...?
