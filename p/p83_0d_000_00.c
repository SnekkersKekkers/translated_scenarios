...
ChLayout(1);
ScrFadeIn(0);
MsgDisp("主人公","Umm... I'll  clean up around here, 
After that, I'll serve tea?");
MsgClose();
...
MsgDisp("Michiru","Huhu, good work on 
the management.");
ChEye(22,0);
ChMouth(22,2);
ChMotion(22,0,1);
...
MsgDisp("Hikaru","I see～...
There are people working hard behind 
the scenes so that Hikaru and everyone
