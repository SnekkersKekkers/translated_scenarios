...
Mikage-sensei, I'm guessing. They must be
delicious.");
    ChEye(2,0);
    ChEyeOpenLevel(2,10);
...
grew? I definitely want to eat it.");
    ChEye(2,0);
    ChEyeOpenLevel(2,10);
    MsgDisp("主人公","Yeah, it's like a child I
raised under my own care, huh?");
    ChEye(2,0);
    ChMouth(2,0);
    ChMotion(2,0);
...
They not only taste good, 
but look pretty too.");
    ChEye(2,0);
    ChMouth(2,4);
    ChMotion(2,3);
    VoicePlay("P630200001_02_060");
    MsgDisp("Sassa","Then of course they take 
after their parent huh?");
    MsgDisp("主人公","Eh...?");
    ChEye(2,0);
    ChMouth(2,0);
    ChMotion(2,4);
    VoicePlay("P630200001_02_070");
    MsgDisp("Sassa","Instead of saying \"Eh\", 
You should be happy?");
