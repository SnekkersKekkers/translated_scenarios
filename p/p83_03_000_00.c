...
You're the unsung hero huh.");
    ...
    MsgDisp("Honda","That's right, I'll be waiting here for you,
so once you can catch a break, let's go
...
Thank you, ｛Honda＊＊｝.");
    ...
    MsgDisp("Honda","Then, I'll be watching you for a while then
let's wander around.");
    MsgDisp("主人公","(Alriiight, I have to show you I'm doing my
job properly!)");
    break ;
    default :
    DbgAssert(1);
