...
well. I said it so you can trust me.");
...
perform in your own style.");
    MsgDisp("主人公","(Let's do the best we can! ｛風真＊＊｝
Because they are supporting me too.)");
    MsgClose();
    ScrFadeOut(0,0);
    ChClose(1,0,0);
    break ;
