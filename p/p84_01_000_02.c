...
ChClose(1,0,0);
ScrFadeIn(0);
MsgDisp("主人公","Well then, with that, 
it seems everything is finished.");
MsgClose();
...
MsgDisp("Kazama","You were just looking after everyone, 
that you didn't get to 
comfortably enjoy yourself.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("P840100002_01_020");
MsgDisp("Kazama","Look, I bought lots of 
things that you like in advance.
Let's eat.");
...
MsgDisp("Kazama","Well... there's roasted 
sweet potatoes too.");
MsgDisp("主人公","Yay!
Thank you!");
ChEye(1,4);
...
MsgDisp("Kazama","Then, let's eat this cold
sweet potato together.");
