...
ChClose(1,0,0);
ScrFadeIn(0);
MsgDisp("主人公","Well then, with that, it seems everything is
finished.");
MsgClose();
...
It was because ｛Kazama＊＊｝ was looking out
for me.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,0);
...
you didn't get to comfortably enjoy yourself.");
ChEye(1,0);
ChMouth(1,3);
ChMotion(1,3);
VoicePlay("P840100002_01_020");
MsgDisp("Kazama","Look, I bought lots of things that you like
in advance.
Let's eat.");
