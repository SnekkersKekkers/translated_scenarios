...
BGOpen("sc740",0);
ScrFadeIn(0);
MsgDisp("主人公","(Yayー!　It was a huge success∈)");
MsgClose();
...
were noisily wondering \"who is that
...
MsgDisp("Sassa","Well... but I got to see the
bride so up close like this again.");
MsgDisp("主人公","This dress will be displayed
in the Handicrafts club for a while,
so you can come see it whenever, right?");
ChEye(2,0);
ChMouth(2,4);
ChMotion(2,0);
VoicePlay("P740200004_02_040");
MsgDisp("Sassa","I don't just want to see the dress.
What I want to see is the inside.");
MsgDisp("主人公","Inside.");
ChEye(2,0);
ChMouth(2,0);
ChMotion(2,5);
