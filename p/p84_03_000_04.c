...
MsgDisp("Honda","But I don't even know if that meal ticket is
mine....
I can't take it.");
...
MsgDisp("主人公","Yeah, they chased after you immediately, but
it seems like ｛Honda＊＊｝ was quite quickly
nowhere to be found.");
ChEye(3,0);
ChMouth(3,4);
ChMotion(3,4,1);
...
MsgDisp("主人公","The person who found it said so, so it can't
be wrong.");
ChEye(3,3);
ChMouth(3,3);
ChMotion(3,3,1);
...
MsgDisp("Honda","This is thanks to you and the person who
picked it up!
Thank you!");
MsgDisp("主人公","(I'm glad I made that lost items notebook.
I'm glad I was able to help everyone, even if
