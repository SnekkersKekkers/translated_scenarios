...
MsgDisp("V.P. Himuro","The pieces to be performed this year seems
to be getting good reviews.");
MsgDisp("主人公","Yes, I'm looking forward to it!");
ChEye(32,2);
ChMouth(32,2);
VoicePlay("P513200001_32_010");
MsgDisp("V.P. Himuro","......Hmm,that's very good. The confidence
backed by practice makes me think so.");
ChEye(32,2);
ChMouth(32,0);
VoicePlay("P513200001_32_020");
MsgDisp("V.P. Himuro","Now, It's time for finishing touches. Give
