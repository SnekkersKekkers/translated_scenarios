...
MsgDisp("School Girl","Yes! Thank you very much～!");
MsgClose();
...
MsgDisp("主人公","No. I had lent them to the drama club, so I
...
MsgDisp("Nanatsumori","No, no. Let me at least get some tea—");
ChEye(4,2);
ChMouth(4,3);
ChMotion(4,2,1);
VoicePlay("P840400002_04_030");
MsgDisp("Nanatsumori","...Is the student council's green tea okay?");
...
MsgDisp("Nanatsumori","Ohh... Capable girls hit different.");
MsgDisp("主人公","(Hehe!
I want ｛Nanatsumori＊｝ and everyone to enjoy
